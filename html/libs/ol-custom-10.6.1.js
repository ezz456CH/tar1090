!(function (t, e) {
	...
	var e = {
		...
		layer: { id: { type: 'string', required: !0 }, type: { type: 'enum', values: { fill: {}, line: {}, symbol: {}, circle: {}, heatmap: {}, 'fill-extrusion': {}, raster: {}, hillshade: {}, 'color-relief': {}, background: {} }, required: !0 }, metadata: { type: '*' }, source: { type: 'string' }, 'source-layer': { type: 'string' }, minzoom: { type: 'number', minimum: 0, maximum: 24 }, maxzoom: { type: 'number', minimum: 0, maximum: 24 }, filter: { type: 'filter' }, layout: { type: 'layout' }, paint: { type: 'paint' } },
		...
		'layout_color-relief': { visibility: { type: 'enum', values: { visible: {}, none: {} }, default: 'visible', 'property-type': 'constant' } },
		...
		paint_hillshade: {
			'hillshade-illumination-direction': { type: 'numberArray', default: 335, minimum: 0, maximum: 359, transition: !1, expression: { interpolated: !0, parameters: ['zoom'] }, 'property-type': 'data-constant' },
			'hillshade-illumination-altitude': { type: 'numberArray', default: 45, minimum: 0, maximum: 90, transition: !1, expression: { interpolated: !0, parameters: ['zoom'] }, 'property-type': 'data-constant' },
			...
			'hillshade-shadow-color': { type: 'colorArray', default: '#000000', transition: !0, expression: { interpolated: !0, parameters: ['zoom'] }, 'property-type': 'data-constant' },
			'hillshade-highlight-color': { type: 'colorArray', default: '#FFFFFF', transition: !0, expression: { interpolated: !0, parameters: ['zoom'] }, 'property-type': 'data-constant' },
			...
			'hillshade-method': { type: 'enum', values: { standard: {}, basic: {}, combined: {}, igor: {}, multidirectional: {} }, default: 'standard', expression: { interpolated: !1, parameters: ['zoom'] }, 'property-type': 'data-constant' },
		},
		'paint_color-relief': { 'color-relief-opacity': { type: 'number', default: 1, minimum: 0, maximum: 1, transition: !0, expression: { interpolated: !0, parameters: ['zoom'] }, 'property-type': 'data-constant' }, 'color-relief-color': { type: 'color', transition: !1, expression: { interpolated: !0, parameters: ['elevation'] }, 'property-type': 'color-ramp' } },
	...
	const i = ['type', 'source', 'source-layer', 'minzoom', 'maxzoom', 'filter', 'layout'];
	function n(t, e) {
		const n = {};
		for (const e in t) 'ref' !== e && (n[e] = t[e]);
		return (
			i.forEach((t) => {
				t in e && (n[t] = e[t]);
			}),
	...
	function r(t) {
		...
		for (let i = 0; i < t.length; i++) 'ref' in t[i] && (t[i] = n(t[i], e[t[i].ref]));
		return t;
	}
	...
	function E(t, e) {
		...
		if ('array' === t.kind) {
			...
			if ('value' === t.kind) for (const t of C) if (!E(t, e)) return null;
		}
		return `Expected ${S(t)} but found ${S(e)} instead.`;
	}
	function T(t, e) {
	...
	function N([t, e, i, n]) {
		let r, s;
		const o = j((0.2225045 * (t = G(t)) + 0.7168786 * (e = G(e)) + 0.0606169 * (i = G(i))) / 1);
		t === e && e === i ? (r = s = o) : ((r = j((0.4360747 * t + 0.3850649 * e + 0.1430804 * i) / F)), (s = j((0.0139322 * t + 0.0971045 * e + 0.7141733 * i) / M)));
		const a = 116 * o - 16;
	...
	function j(t) {
		return t > A ? Math.pow(t, 1 / 3) : t / L + I;
	}
	function $([t, e, i, n]) {
		let r = (t + 16) / 116,
			s = isNaN(e) ? r : r + e / 500,
			o = isNaN(i) ? r : r - i / 200;
		return (r = 1 * U(r)), (s = F * U(s)), (o = M * U(o)), [B(3.1338561 * s - 1.6168667 * r - 0.4906146 * o), B(-0.9787684 * s + 1.9161415 * r + 0.033454 * o), B(0.0719453 * s - 0.2289914 * r + 1.4052427 * o), n];
	}
	function B(t) {
		return (t = t <= 0.00304 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055) < 0 ? 0 : t > 1 ? 1 : t;
	}
	function U(t) {
		return t > k ? t * t * t : L * (t - I);
	}
	const V =
		Object.hasOwn ||
		function (t, e) {
	...
	function X(t) {
		...
		if (e) {
			const [t, i, n] = e;
			return [t / 255, i / 255, n / 255, 1];
		}
		if (t.startsWith('#')) {
			if (/^#(?:[0-9a-f]{3,4}|[0-9a-f]{6}|[0-9a-f]{8})$/.test(t)) {
				const e = t.length < 6 ? 1 : 2;
				let i = 1;
				return [q(t.slice(i, (i += e))), q(t.slice(i, (i += e))), q(t.slice(i, (i += e))), q(t.slice(i, i + e) || 'ff')];
			}
		}
		if (t.startsWith('rgb')) {
			const e = /^rgba?\(\s*([\de.+-]+)(%)?(?:\s+|\s*(,)\s*)([\de.+-]+)(%)?(?:\s+|\s*(,)\s*)([\de.+-]+)(%)?(?:\s*([,\/])\s*([\de.+-]+)(%)?)?\s*\)$/,
				i = t.match(e);
			if (i) {
				const [t, e, n, r, s, o, a, l, h, c, u, d] = i,
					g = [r || ' ', a || ' ', c].join('');
				if ('  ' === g || '  /' === g || ',,' === g || ',,,' === g) {
					const t = [n, o, h].join(''),
						i = '%%%' === t ? 100 : '' === t ? 255 : 0;
					if (i) {
						const t = [K(+e / i, 0, 1), K(+s / i, 0, 1), K(+l / i, 0, 1), u ? Z(+u, d) : 1];
						if (Y(t)) return t;
					}
				}
				return;
		...
		const i = t.match(/^hsla?\(\s*([\de.+-]+)(?:deg)?(?:\s+|\s*(,)\s*)([\de.+-]+)%(?:\s+|\s*(,)\s*)([\de.+-]+)%(?:\s*([,\/])\s*([\de.+-]+)(%)?)?\s*\)$/);
		if (i) {
			const [t, e, n, r, s, o, a, l, h] = i,
				c = [n || ' ', s || ' ', a].join('');
			if ('  ' === c || '  /' === c || ',,' === c || ',,,' === c) {
				const t = [+e, K(+r, 0, 100), K(+o, 0, 100), l ? Z(+l, h) : 1];
				if (Y(t))
					return (function ([t, e, i, n]) {
						function r(n) {
							const r = (n + t / 30) % 12,
								s = e * Math.min(i, 1 - i);
							return i - s * Math.max(-1, Math.min(r - 3, 9 - r, 1));
						}
						return (t = z(t)), (e /= 100), (i /= 100), [r(0), r(8), r(4), n];
					})(t);
			}
		}
	}
	...
	function Q(t, e, i) {
		return t.map((t, n) => J(t, e[n], i));
	}
	class tt {
		constructor(t, e, i, n = 1, r = !0) {
			(this.r = t), (this.g = e), (this.b = i), (this.a = n), r || ((this.r *= n), (this.g *= n), (this.b *= n), n || this.overwriteGetter('rgb', [t, e, i, n]));
		}
		static parse(t) {
			if (t instanceof tt) return t;
			if ('string' != typeof t) return;
			const e = X(t);
			return e ? new tt(...e, !1) : void 0;
		}
		get rgb() {
			const { r: t, g: e, b: i, a: n } = this,
				r = n || 1 / 0;
			return this.overwriteGetter('rgb', [t / r, e / r, i / r, n]);
		}
		get hcl() {
			return this.overwriteGetter(
				...
				(function (t) {
					const [e, i, n, r] = N(t),
						s = Math.sqrt(i * i + n * n);
					return [Math.round(1e4 * s) ? z(Math.atan2(n, i) * O) : NaN, s, e, r];
				})(this.rgb)
			);
		}
		get lab() {
			return this.overwriteGetter('lab', N(this.rgb));
		}
		overwriteGetter(t, e) {
			return Object.defineProperty(this, t, { value: e }), e;
		}
		toString() {
			const [t, e, i, n] = this.rgb;
			return `rgba(${[t, e, i].map((t) => Math.round(255 * t)).join(',')},${n})`;
		}
		static interpolate(t, e, i, n = 'rgb') {
			switch (n) {
				case 'rgb': {
					const [n, r, s, o] = Q(t.rgb, e.rgb, i);
					return new tt(n, r, s, o, !1);
				}
				case 'hcl': {
					const [n, r, s, o] = t.hcl,
						[a, l, h, c] = e.hcl;
					let u, d;
					if (isNaN(n) || isNaN(a)) isNaN(n) ? (isNaN(a) ? (u = NaN) : ((u = a), (1 !== s && 0 !== s) || (d = l))) : ((u = n), (1 !== h && 0 !== h) || (d = r));
					else {
						let t = a - n;
						a > n && t > 180 ? (t -= 360) : a < n && n - a > 180 && (t += 360), (u = n + i * t);
					}
					const [g, f, p, m] = (function ([t, e, i, n]) {
						return (t = isNaN(t) ? 0 : t * D), $([i, Math.cos(t) * e, Math.sin(t) * e, n]);
					})([u, null != d ? d : J(r, l, i), J(s, h, i), J(o, c, i)]);
					return new tt(g, f, p, m, !1);
				}
				case 'lab': {
					const [n, r, s, o] = $(Q(t.lab, e.lab, i));
					return new tt(n, r, s, o, !1);
				}
			}
		}
	...
	const it = ['bottom', 'center', 'top'];
	class nt {
		constructor(t, e, i, n, r, s) {
			(this.text = t), (this.image = e), (this.scale = i), (this.fontStack = n), (this.textColor = r), (this.verticalAlign = s);
		}
	}
	class rt {
		constructor(t) {
	...
	class st {
		...
		static parse(t) {
			...
			if ('number' == typeof t) return new st([t, t, t, t]);
		...
		static interpolate(t, e, i) {
			return new st(Q(t.values, e.values, i));
		}
	}
	class ot {
		constructor(t) {
		...
		static parse(t) {
			...
			if ('number' == typeof t) return new ot([t]);
			if (Array.isArray(t)) {
				for (const e of t) if ('number' != typeof e) return;
				return new ot(t);
			}
		...
		static interpolate(t, e, i) {
			return new ot(Q(t.values, e.values, i));
		}
	}
	class at {
		constructor(t) {
		...
		static interpolate(t, e, i, n = 'rgb') {
			...
			for (let s = 0; s < t.values.length; s++) r.push(tt.interpolate(t.values[s], e.values[s], i, n));
			return new at(r);
		}
	}
	...
	const ht = new Set(['center', 'left', 'right', 'top', 'bottom', 'top-left', 'top-right', 'bottom-left', 'bottom-right']);
	class ct {
		constructor(t) {
			this.values = t.slice();
		}
		static parse(t) {
			...
			if (Array.isArray(t) && !(t.length < 1) && t.length % 2 == 0) {
				for (let e = 0; e < t.length; e += 2) {
					const i = t[e],
						n = t[e + 1];
					if ('string' != typeof i || !ht.has(i)) return;
		...
		static interpolate(t, e, i) {
			const n = t.values,
				r = e.values;
			if (n.length !== r.length) throw new lt(`Cannot interpolate values of different length. from: ${t.toString()}, to: ${e.toString()}`);
			const s = [];
			for (let t = 0; t < n.length; t += 2) {
				if (n[t] !== r[t]) throw new lt(`Cannot interpolate values containing mismatched anchors. from[${t}]: ${n[t]}, to[${t}]: ${r[t]}`);
				s.push(n[t]);
				const [e, o] = n[t + 1],
					[a, l] = r[t + 1];
				s.push([J(e, a, i), J(o, l, i)]);
			}
			return new ct(s);
		}
	}
	class ut {
		...
		static fromString(t) {
			return t ? new ut({ name: t, available: !1 }) : null;
		}
	}
	class dt {
		constructor(t, e, i) {
		...
		static parse(t) {
			return t instanceof dt ? t : Array.isArray(t) && 3 === t.length && 'string' == typeof t[0] && 'string' == typeof t[1] && 'number' == typeof t[2] ? new dt(t[0], t[1], t[2]) : 'object' == typeof t && 'string' == typeof t.from && 'string' == typeof t.to && 'number' == typeof t.transition ? new dt(t.from, t.to, t.transition) : 'string' == typeof t ? new dt(t, t, 1) : void 0;
		}
	}
	function gt(t, e, i, n) {
	...
	function ft(t) {
		if (null === t || 'string' == typeof t || 'boolean' == typeof t || 'number' == typeof t || t instanceof dt || t instanceof tt || t instanceof et || t instanceof rt || t instanceof st || t instanceof ot || t instanceof at || t instanceof ct || t instanceof ut) return !0;
		if (Array.isArray(t)) {
			for (const e of t) if (!ft(e)) return !1;
			return !0;
		}
		if ('object' == typeof t) {
			for (const e in t) if (!ft(t[e])) return !1;
			return !0;
		}
		return !1;
	}
	function pt(t) {
		...
		if (t instanceof tt) return u;
		if (t instanceof dt) return d;
		if (t instanceof et) return p;
		if (t instanceof rt) return m;
		if (t instanceof st) return _;
		if (t instanceof ot) return x;
		if (t instanceof at) return y;
		if (t instanceof ct) return w;
		if (t instanceof ut) return v;
		if (Array.isArray(t)) {
			const e = t.length;
			let i;
			for (const e of t) {
	...
	function mt(t) {
		const e = typeof t;
		return null === t ? '' : 'string' === e || 'number' === e || 'boolean' === e ? String(t) : t instanceof tt || t instanceof dt || t instanceof rt || t instanceof st || t instanceof ot || t instanceof at || t instanceof ct || t instanceof ut ? t.toString() : JSON.stringify(t);
	}
	class _t {
		constructor(t, e) {
		...
		static parse(t, e) {
			...
			if (!ft(t[1])) return e.error('invalid value');
			const i = t[1];
			let n = pt(i);
			const r = e.expectedType;
			return 'array' !== n.kind || 0 !== n.N || !r || 'array' !== r.kind || ('number' == typeof r.N && 0 !== r.N) || (n = r), new _t(n, i);
		}
		evaluate() {
			return this.value;
		}
	...
	const yt = { string: h, number: l, boolean: c, object: g };
	class xt {
		constructor(t, e) {
		...
		static parse(t, e) {
			...
			if ('array' === r) {
				...
				if (t.length > 2) {
					const i = t[1];
					if ('string' != typeof i || !(i in yt) || 'object' === i) return e.error('The item type argument of "array" must be one of string, number, boolean', 1);
					(r = yt[i]), n++;
				} else r = f;
				if (t.length > 3) {
				...
				if (!yt[r]) throw new Error(`Types doesn't contain name = ${r}`);
				i = yt[r];
			}
			const s = [];
			for (; n < t.length; n++) {
		...
		evaluate(t) {
			for (let e = 0; e < this.args.length; e++) {
				...
				if (!E(this.type, pt(i))) return i;
				if (e === this.args.length - 1) throw new lt(`Expected value to be of type ${S(this.type)}, but found ${S(pt(i))} instead.`);
			}
			throw new Error();
		}
		eachChild(t) {
	...
	const vt = { 'to-boolean': c, 'to-color': u, 'to-number': l, 'to-string': h };
	class wt {
		constructor(t, e) {
			(this.type = t), (this.args = e);
		}
		static parse(t, e) {
			if (t.length < 2) return e.error('Expected at least one argument.');
			const i = t[0];
			if (!vt[i]) throw new Error(`Can't parse ${i} as it is not part of the known types`);
			...
			switch (this.type.kind) {
				...
				case 'color': {
					...
					for (const n of this.args) {
						if (((e = n.evaluate(t)), (i = null), e instanceof tt)) return e;
						if ('string' == typeof e) {
							const i = t.parseColor(e);
							if (i) return i;
						} else if (Array.isArray(e) && ((i = e.length < 3 || e.length > 4 ? `Invalid rgba value ${JSON.stringify(e)}: expected an array containing either three or four numeric values.` : gt(e[0], e[1], e[2], e[3])), !i)) return new tt(e[0] / 255, e[1] / 255, e[2] / 255, e[3]);
					}
					throw new lt(i || `Could not parse color from value '${'string' == typeof e ? e : JSON.stringify(e)}'`);
				}
				case 'padding': {
					let e;
					...
					throw new lt(`Could not parse padding from value '${'string' == typeof e ? e : JSON.stringify(e)}'`);
				}
				case 'numberArray': {
					let e;
					for (const i of this.args) {
					...
					throw new lt(`Could not parse numberArray from value '${'string' == typeof e ? e : JSON.stringify(e)}'`);
				}
				case 'colorArray': {
					let e;
					for (const i of this.args) {
					...
					throw new lt(`Could not parse colorArray from value '${'string' == typeof e ? e : JSON.stringify(e)}'`);
				}
				case 'variableAnchorOffsetCollection': {
					...
					throw new lt(`Could not parse variableAnchorOffsetCollection from value '${'string' == typeof e ? e : JSON.stringify(e)}'`);
				}
				case 'number': {
					let e = null;
					for (const i of this.args) {
					...
					throw new lt(`Could not convert ${JSON.stringify(e)} to number.`);
				}
				case 'formatted':
					return rt.fromString(mt(this.args[0].evaluate(t)));
				case 'resolvedImage':
					return ut.fromString(mt(this.args[0].evaluate(t)));
				case 'projectionDefinition':
					return this.args[0].evaluate(t);
				default:
					return mt(this.args[0].evaluate(t));
			}
		}
		eachChild(t) {
			this.args.forEach(t);
	...
	const bt = ['Unknown', 'Point', 'LineString', 'Polygon'];
	class St {
		constructor() {
		...
		parseColor(t) {
			...
			return e || ((e = tt.parse(t)), this._parseColorCache.set(t, e)), e;
		}
	}
	class Ct {
		constructor(t, e, i = [], n, r = new o(), s = []) {
			(this.registry = t), (this.path = i), (this.key = i.map((t) => `[${t}]`).join('')), (this.scope = r), (this.errors = s), (this.expectedType = n), (this._isConstant = e);
		}
		parse(t, e, i, n, r = {}) {
		...
		_parse(t, e) {
			function i(t, e, i) {
				return 'assert' === i ? new xt(e, [t]) : 'coerce' === i ? new wt(e, [t]) : t;
			}
				...
				if (r) {
					...
					if (this.expectedType) {
						...
						if (('string' !== t.kind && 'number' !== t.kind && 'boolean' !== t.kind && 'object' !== t.kind && 'array' !== t.kind) || 'value' !== r.kind) {
							if (('projectionDefinition' === t.kind && ['string', 'array'].includes(r.kind)) || (['color', 'formatted', 'resolvedImage'].includes(t.kind) && ['value', 'string'].includes(r.kind)) || (['padding', 'numberArray'].includes(t.kind) && ['value', 'number', 'array'].includes(r.kind)) || ('colorArray' === t.kind && ['value', 'string', 'array'].includes(r.kind)) || ('variableAnchorOffsetCollection' === t.kind && ['value', 'array'].includes(r.kind))) n = i(n, t, e.typeAnnotation || 'coerce');
							else if (this.checkSubtype(t, r)) return null;
						} else n = i(n, t, e.typeAnnotation || 'assert');
					}
					if (!(n instanceof _t) && 'resolvedImage' !== n.type.kind && this._isConstant(n)) {
						const t = new St();
						try {
							n = new _t(n.type, n.evaluate(t));
						} catch (t) {
		...
		concat(t, e, i) {
			...
			return new Ct(this.registry, this._isConstant, n, e || null, r, this.errors);
		}
		error(t, ...e) {
			const i = `${this.key}${e.map((t) => `[${t}]`).join('')}`;
			this.errors.push(new s(i, t));
		}
		checkSubtype(t, e) {
			const i = E(t, e);
	...
	class Tt {
		...
		static parse(t, e) {
			...
			const i = t[1];
			return e.scope.has(i) ? new Tt(i, e.scope.get(i)) : e.error(`Unknown variable "${i}". Make sure "${i}" has been bound in an enclosing "let" expression before using it.`, 1);
		}
		evaluate(t) {
	...
	class Pt {
		...
		static parse(t, e) {
			...
			const i = e.parse(t[1], 1, l),
				n = e.parse(t[2], 2, b(e.expectedType || f));
			if (!i || !n) return null;
			const r = n.type;
			return new Pt(r.itemType, i, n);
		}
		evaluate(t) {
			const e = this.index.evaluate(t),
				i = this.input.evaluate(t);
			if (e < 0) throw new lt(`Array index out of bounds: ${e} < 0.`);
			if (e >= i.length) throw new lt(`Array index out of bounds: ${e} > ${i.length - 1}.`);
			if (e !== Math.floor(e)) throw new lt(`Array index must be an integer, but found ${e} instead.`);
			return i[e];
		}
		eachChild(t) {
	...
	class Rt {
		...
		static parse(t, e) {
			if (3 !== t.length) return e.error(`Expected 2 arguments, but found ${t.length - 1} instead.`);
			const i = e.parse(t[1], 1, f),
				n = e.parse(t[2], 2, f);
			return i && n ? (T(i.type, [c, h, l, a, f]) ? new Rt(i, n) : e.error(`Expected first argument to be of type boolean, string, number or null, but found ${S(i.type)} instead`)) : null;
		}
		evaluate(t) {
			const e = this.needle.evaluate(t),
				i = this.haystack.evaluate(t);
			if (!i) return !1;
			if (!P(e, ['boolean', 'string', 'number', 'null'])) throw new lt(`Expected first argument to be of type boolean, string, number or null, but found ${S(pt(e))} instead.`);
			if (!P(i, ['string', 'array'])) throw new lt(`Expected second argument to be of type array or string, but found ${S(pt(i))} instead.`);
	...
	class Ft {
		constructor(t, e, i) {
			(this.type = l), (this.needle = t), (this.haystack = e), (this.fromIndex = i);
		}
		static parse(t, e) {
			...
			const i = e.parse(t[1], 1, f),
				n = e.parse(t[2], 2, f);
			if (!i || !n) return null;
			if (!T(i.type, [c, h, l, a, f])) return e.error(`Expected first argument to be of type boolean, string, number or null, but found ${S(i.type)} instead`);
			if (4 === t.length) {
				const r = e.parse(t[3], 3, l);
				return r ? new Ft(i, n, r) : null;
			}
			return new Ft(i, n);
		}
		evaluate(t) {
			...
			if (!P(e, ['boolean', 'string', 'number', 'null'])) throw new lt(`Expected first argument to be of type boolean, string, number or null, but found ${S(pt(e))} instead.`);
			let n;
			if ((this.fromIndex && (n = this.fromIndex.evaluate(t)), P(i, ['string']))) {
				const t = i.indexOf(e, n);
				return -1 === t ? -1 : [...i.slice(0, t)].length;
			}
			if (P(i, ['array'])) return i.indexOf(e, n);
			throw new lt(`Expected second argument to be of type array or string, but found ${S(pt(i))} instead.`);
		}
		eachChild(t) {
		...
		static parse(t, e) {
			...
			for (let o = 2; o < t.length - 1; o += 2) {
				...
				for (const t of a) {
					...
					if (i) {
						if (h.checkSubtype(i, pt(t))) return null;
					} else i = pt(t);
			...
			return a ? ('value' !== o.type.kind && e.concat(1).checkSubtype(i, o.type) ? null : new Mt(i, n, o, r, s, a)) : null;
		}
		evaluate(t) {
			const e = this.input.evaluate(t);
			return ((pt(e) === this.inputType && this.outputs[this.cases[e]]) || this.otherwise).evaluate(t);
		}
		eachChild(t) {
	...
	class It {
		...
		evaluate(t) {
			for (const [e, i] of this.branches) if (e.evaluate(t)) return i.evaluate(t);
	...
	class kt {
		...
		static parse(t, e) {
			...
			const i = e.parse(t[1], 1, f),
				n = e.parse(t[2], 2, l);
			if (!i || !n) return null;
			if (!T(i.type, [b(f), h, f])) return e.error(`Expected first argument to be of type array or string, but found ${S(i.type)} instead`);
			if (4 === t.length) {
				const r = e.parse(t[3], 3, l);
				return r ? new kt(i.type, i, n, r) : null;
			}
			return new kt(i.type, i, n);
		}
		evaluate(t) {
			const e = this.input.evaluate(t),
				i = this.beginIndex.evaluate(t);
			let n;
			if ((this.endIndex && (n = this.endIndex.evaluate(t)), P(e, ['string']))) return [...e].slice(i, n).join('');
			if (P(e, ['array'])) return e.slice(i, n);
			throw new lt(`Expected first argument to be of type array or string, but found ${S(pt(e))} instead.`);
		}
		eachChild(t) {
	...
	function Lt(t, e) {
		...
		for (; s <= o; )
			if (((a = Math.floor((s + o) / 2)), (n = t[a]), (r = t[a + 1]), n <= e)) {
				...
				if (!(n > e)) throw new lt('Input is not a number.');
				o = a - 1;
			}
		return 0;
	}
			...
			return (
				...
				(t.prototype = {
					...
					solveCurveX: function (t, e) {
						...
						var o = 0,
							a = 1;
						for (i = t, n = 0; n < 20 && ((r = this.sampleCurveX(i)), !(Math.abs(r - t) < e)); n++) t > r ? (o = i) : (a = i), (i = 0.5 * (a - o) + o);
						return i;
					},
					solve: function (t, e) {
	...
	class jt {
		...
		static interpolationFactor(t, e, i, n) {
			let r = 0;
			if ('exponential' === t.name) r = $t(e, t.base, i, n);
			else if ('linear' === t.name) r = $t(e, 1, i, n);
			else if ('cubic-bezier' === t.name) {
				const s = t.controlPoints;
				r = new Gt(s[0], s[1], s[2], s[3]).solve($t(e, 1, i, n));
			}
			return r;
		}
		static parse(t, e) {
			...
			const o = [];
			let a = null;
			('interpolate-hcl' !== i && 'interpolate-lab' !== i) || e.expectedType == y ? e.expectedType && 'value' !== e.expectedType.kind && (a = e.expectedType) : (a = u);
			...
			return R(a, l) || R(a, d) || R(a, u) || R(a, _) || R(a, x) || R(a, y) || R(a, w) || R(a, b(l)) ? new jt(a, i, n, r, o) : e.error(`Type ${S(a)} is not interpolatable.`);
		}
		evaluate(t) {
			const e = this.labels,
				i = this.outputs;
			...
			const s = Lt(e, n),
				o = e[s],
				a = e[s + 1],
				l = jt.interpolationFactor(this.interpolation, n, o, a),
				h = i[s].evaluate(t),
				c = i[s + 1].evaluate(t);
				...
				case 'interpolate':
					switch (this.type.kind) {
						case 'number':
							return J(h, c, l);
						case 'color':
							return tt.interpolate(h, c, l);
						case 'padding':
							return st.interpolate(h, c, l);
						case 'colorArray':
							return at.interpolate(h, c, l);
						case 'numberArray':
							return ot.interpolate(h, c, l);
						case 'variableAnchorOffsetCollection':
							return ct.interpolate(h, c, l);
						case 'array':
							return Q(h, c, l);
						case 'projectionDefinition':
							return dt.interpolate(h, c, l);
					}
				case 'interpolate-hcl':
					switch (this.type.kind) {
						case 'color':
							return tt.interpolate(h, c, l, 'hcl');
						case 'colorArray':
							return at.interpolate(h, c, l, 'hcl');
					}
				case 'interpolate-lab':
					switch (this.type.kind) {
						case 'color':
							return tt.interpolate(h, c, l, 'lab');
						case 'colorArray':
							return at.interpolate(h, c, l, 'lab');
					}
			}
		}
		eachChild(t) {
	...
	class Bt {
		...
		static parse(t, e) {
			...
			for (const n of t.slice(1)) {
				const t = e.parse(n, 1 + r.length, i, void 0, { typeAnnotation: 'omit' });
				if (!t) return null;
				(i = i || t.type), r.push(t);
			}
			if (!i) throw new Error('No output type');
			const s = n && r.some((t) => E(n, t.type));
			return new Bt(s ? f : i, r);
		}
		evaluate(t) {
			let e,
				i = null,
				n = 0;
			for (const r of this.args) if ((n++, (i = r.evaluate(t)), i && i instanceof ut && !i.available && (e || (e = i.name), (i = null), n === this.args.length && (i = e)), null !== i)) break;
			return i;
		}
		eachChild(t) {
			this.args.forEach(t);
	...
	function Wt(t, e, i) {
		...
		return class r {
			constructor(t, e, i) {
				(this.type = c), (this.lhs = t), (this.rhs = e), (this.collator = i), (this.hasUntypedArgument = 'value' === t.type.kind || 'value' === e.type.kind);
			}
			static parse(t, e) {
				...
				if (!s) return null;
				if (!Ut(i, s.type)) return e.concat(1).error(`"${i}" comparisons are not supported for type '${S(s.type)}'.`);
				let o = e.parse(t[2], 2, f);
				if (!o) return null;
				if (!Ut(i, o.type)) return e.concat(2).error(`"${i}" comparisons are not supported for type '${S(o.type)}'.`);
				if (s.type.kind !== o.type.kind && 'value' !== s.type.kind && 'value' !== o.type.kind) return e.error(`Cannot compare types '${S(s.type)}' and '${S(o.type)}'.`);
				n && ('value' === s.type.kind && 'value' !== o.type.kind ? (s = new xt(o.type, [s])) : 'value' !== s.type.kind && 'value' === o.type.kind && (o = new xt(s.type, [o])));
				let a = null;
				if (4 === t.length) {
			...
			evaluate(r) {
				...
				if (n && this.hasUntypedArgument) {
					const e = pt(s),
						i = pt(o);
					if (e.kind !== i.kind || ('string' !== e.kind && 'number' !== e.kind)) throw new lt(`Expected arguments for "${t}" to be (string, string) or (number, number), but found (${e.kind}, ${i.kind}) instead.`);
				}
	...
	class Jt {
		constructor(t, e, i) {
			(this.type = p), (this.locale = i), (this.caseSensitive = t), (this.diacriticSensitive = e);
		}
		static parse(t, e) {
			if (2 !== t.length) return e.error('Expected one argument.');
			const i = t[1];
			if ('object' != typeof i || Array.isArray(i)) return e.error('Collator options argument must be an object.');
			const n = e.parse(void 0 !== i['case-sensitive'] && i['case-sensitive'], 1, c);
			if (!n) return null;
			const r = e.parse(void 0 !== i['diacritic-sensitive'] && i['diacritic-sensitive'], 1, c);
			if (!r) return null;
			let s = null;
			return i.locale && ((s = e.parse(i.locale, 1, h)), !s) ? null : new Jt(n, r, s);
		}
		evaluate(t) {
			return new et(this.caseSensitive.evaluate(t), this.diacriticSensitive.evaluate(t), this.locale ? this.locale.evaluate(t) : null);
		}
		eachChild(t) {
	...
	class Qt {
		constructor(t, e, i, n, r) {
			(this.type = h), (this.number = t), (this.locale = e), (this.currency = i), (this.minFractionDigits = n), (this.maxFractionDigits = r);
		}
		static parse(t, e) {
			...
			let r = null;
			if (n.locale && ((r = e.parse(n.locale, 1, h)), !r)) return null;
			let s = null;
			if (n.currency && ((s = e.parse(n.currency, 1, h)), !s)) return null;
			let o = null;
			if (n['min-fraction-digits'] && ((o = e.parse(n['min-fraction-digits'], 1, l)), !o)) return null;
			let a = null;
			return n['max-fraction-digits'] && ((a = e.parse(n['max-fraction-digits'], 1, l)), !a) ? null : new Qt(i, r, s, o, a);
		}
		evaluate(t) {
		...
		static parse(t, e) {
			...
			for (let i = 1; i <= t.length - 1; ++i) {
				...
				if (r && 'object' == typeof s && !Array.isArray(s)) {
					...
					let i = null;
					if (s['text-font'] && ((i = e.parse(s['text-font'], 1, b(h))), !i)) return null;
					let o = null;
					if (s['text-color'] && ((o = e.parse(s['text-color'], 1, u)), !o)) return null;
					let a = null;
					if (s['vertical-align']) {
						if ('string' == typeof s['vertical-align'] && !it.includes(s['vertical-align'])) return e.error(`'vertical-align' must be one of: 'bottom', 'center', 'top' but found '${s['vertical-align']}' instead.`);
						if (((a = e.parse(s['vertical-align'], 1, h)), !a)) return null;
					}
					const c = n[n.length - 1];
					(c.scale = t), (c.font = i), (c.textColor = o), (c.verticalAlign = a);
				} else {
					const s = e.parse(t[i], 1, f);
					if (!s) return null;
					const o = s.type.kind;
					if ('string' !== o && 'value' !== o && 'null' !== o && 'resolvedImage' !== o) return e.error("Formatted text type must be 'string', 'value', 'image' or 'null'.");
					(r = !0), n.push({ content: s, scale: null, font: null, textColor: null, verticalAlign: null });
				}
			}
			return new te(n);
		}
		evaluate(t) {
			return new rt(
				this.sections.map((e) => {
					...
					return pt(i) === v ? new nt('', i, null, null, null, e.verticalAlign ? e.verticalAlign.evaluate(t) : null) : new nt(mt(i), null, e.scale ? e.scale.evaluate(t) : null, e.font ? e.font.evaluate(t).join(',') : null, e.textColor ? e.textColor.evaluate(t) : null, e.verticalAlign ? e.verticalAlign.evaluate(t) : null);
				})
			);
		}
		eachChild(t) {
	...
	class ee {
		constructor(t) {
			(this.type = v), (this.input = t);
		}
		static parse(t, e) {
			if (2 !== t.length) return e.error('Expected two arguments.');
			const i = e.parse(t[1], 1, h);
			return i ? new ee(i) : e.error('No image name provided.');
		}
		evaluate(t) {
			const e = this.input.evaluate(t),
				i = ut.fromString(e);
	...
	class ie {
		...
		static parse(t, e) {
			...
			return i ? ('array' !== i.type.kind && 'string' !== i.type.kind && 'value' !== i.type.kind ? e.error(`Expected argument of type string or array, but found ${S(i.type)} instead.`) : new ie(i)) : null;
		}
		evaluate(t) {
			const e = this.input.evaluate(t);
			if ('string' == typeof e) return [...e].length;
			if (Array.isArray(e)) return e.length;
			throw new lt(`Expected value to be of type string or array, but found ${S(pt(e))} instead.`);
		}
		eachChild(t) {
			t(this.input);
		}
	...
	function re(t, e) {
		...
		return [Math.round(i * s * ne), Math.round(n * s * ne)];
	}
	function se(t, e) {
		const i = Math.pow(2, e.z),
			n = (t[0] / ne + e.x) / i,
			r = (t[1] / ne + e.y) / i;
		return [((o = n), 360 * o - 180), ((s = r), (360 / Math.PI) * Math.atan(Math.exp(((180 - 360 * s) * Math.PI) / 180)) - 90)];
		var s, o;
	}
	function oe(t, e) {
	...
	function ce(t, e, i, n) {
		const r = [e[0] - t[0], e[1] - t[1]],
			s = [n[0] - i[0], n[1] - i[1]];
		return 0 !== (o = s)[0] * (a = r)[1] - o[1] * a[0] && !(!me(t, e, i, n) || !me(i, n, t, e));
		var o, a;
	}
	function ue(t, e, i) {
		for (const n of i) for (let i = 0; i < n.length - 1; ++i) if (ce(t, e, n[i], n[i + 1])) return !0;
		return !1;
	}
	function de(t, e, i = !1) {
		let n = !1;
		for (const r of e)
			for (let e = 0; e < r.length - 1; e++) {
				if (he(t, r[e], r[e + 1])) return i;
				le(t, r[e], r[e + 1]) && (n = !n);
			}
		return n;
	}
	function ge(t, e) {
		for (const i of e) if (de(t, i)) return !0;
		return !1;
	}
	function fe(t, e) {
		for (const i of t) if (!de(i, e)) return !1;
		for (let i = 0; i < t.length - 1; ++i) if (ue(t[i], t[i + 1], e)) return !1;
		return !0;
	}
	function pe(t, e) {
		for (const i of e) if (fe(t, i)) return !0;
		return !1;
	}
	function me(t, e, i, n) {
		const r = t[0] - i[0],
	...
	function we(t, e, i, n) {
		...
		if (e[2] - e[0] <= r / 2) {
			...
			for (const t of o) for (const n of t) xe(n, e, i, r);
		}
		return o;
	}
	class be {
			...
			if (ft(t[1])) {
				...
				if ('FeatureCollection' === e.type) {
					...
					for (const i of e.features) {
						const { type: e, coordinates: n } = i.geometry;
						'Polygon' === e && t.push(n), 'MultiPolygon' === e && t.push(...n);
					}
					if (t.length) {
						return new be(e, { type: 'MultiPolygon', coordinates: t });
					}
				} else if ('Feature' === e.type) {
					const t = e.geometry.type;
					if ('Polygon' === t || 'MultiPolygon' === t) return new be(e, e.geometry);
				} else if ('Polygon' === e.type || 'MultiPolygon' === e.type) return new be(e, e);
			}
			...
			if (null != t.geometry() && null != t.canonicalID()) {
				if ('Point' === t.geometryType())
					return (function (t, e) {
						const i = [1 / 0, 1 / 0, -1 / 0, -1 / 0],
							...
							r = t.canonicalID();
						if ('Polygon' === e.type) {
							const s = _e(e.coordinates, n, r),
								o = ve(t.geometry(), i, n, r);
							if (!ae(i, n)) return !1;
							for (const t of o) if (!de(t, s)) return !1;
						}
						if ('MultiPolygon' === e.type) {
							const s = ye(e.coordinates, n, r),
								o = ve(t.geometry(), i, n, r);
							if (!ae(i, n)) return !1;
							for (const t of o) if (!ge(t, s)) return !1;
						}
						return !0;
					})(t, this.geometries);
				if ('LineString' === t.geometryType())
					return (function (t, e) {
						...
						if ('Polygon' === e.type) {
							const s = _e(e.coordinates, n, r),
								o = we(t.geometry(), i, n, r);
							if (!ae(i, n)) return !1;
							for (const t of o) if (!fe(t, s)) return !1;
						}
						if ('MultiPolygon' === e.type) {
							const s = ye(e.coordinates, n, r),
								o = we(t.geometry(), i, n, r);
							if (!ae(i, n)) return !1;
							for (const t of o) if (!pe(t, s)) return !1;
						}
						return !0;
					})(t, this.geometries);
			}
	...
	class Se {
		...
		_down(t) {
			...
			for (; t < n; ) {
				let n = 1 + (t << 1);
				const s = n + 1;
				if ((s < this.length && i(e[s], e[n]) < 0 && (n = s), i(e[n], r) >= 0)) break;
				(e[t] = e[n]), (t = n);
			}
			e[t] = r;
		}
	...
	function Ce(t) {
		let e = 0;
		for (let i, n, r = 0, s = t.length, o = s - 1; r < s; o = r++) (i = t[r]), (n = t[o]), (e += (n.x - i.x) * (i.y + n.y));
		return e;
	}
	const Ee = 1 / 298.257223563,
		Te = Ee * (2 - Ee),
		Pe = Math.PI / 180;
	class Re {
		constructor(t) {
			const e = 6378.137 * Pe * 1e3,
				i = Math.cos(t * Pe),
				n = 1 / (1 - Te * (1 - i * i)),
				r = Math.sqrt(n);
			(this.kx = e * r * i), (this.ky = e * r * n * (1 - Te));
		}
		distance(t, e) {
		...
		pointOnLine(t, e) {
			...
			for (let a = 0; a < t.length - 1; a++) {
				...
				const g = c * c + u * u;
				g < o && ((o = g), (i = l), (n = h), (r = a), (s = d));
			}
			return { point: [i, n], index: r, t: Math.max(0, Math.min(1, s)) };
		}
		wrap(t) {
			for (; t < -180; ) t += 360;
			for (; t > 180; ) t -= 360;
	...
	function Le(t, e) {
		if (!Ie(e, t.length)) return [1 / 0, 1 / 0, -1 / 0, -1 / 0];
		const i = [1 / 0, 1 / 0, -1 / 0, -1 / 0];
		for (let n = e[0]; n <= e[1]; ++n) oe(i, t[n]);
		return i;
	}
	function Ae(t) {
		const e = [1 / 0, 1 / 0, -1 / 0, -1 / 0];
		for (const i of t) for (const t of i) oe(e, t);
		return e;
	}
	function De(t) {
	...
	function Oe(t, e, i) {
		if (!De(t) || !De(e)) return NaN;
		let n = 0,
			r = 0;
		return t[2] < e[0] && (n = e[0] - t[2]), t[0] > e[2] && (n = t[0] - e[2]), t[1] > e[3] && (r = t[1] - e[3]), t[3] < e[1] && (r = e[1] - t[3]), i.distance([0, 0], [n, r]);
	}
	function ze(t, e, i) {
		const n = i.pointOnLine(e, t);
		return i.distance(t, n.point);
	}
	function Ne(t, e, i, n, r) {
		const s = Math.min(ze(t, [i, n], r), ze(e, [i, n], r)),
			o = Math.min(ze(i, [t, e], r), ze(n, [t, e], r));
		return Math.min(s, o);
	}
	function Ge(t, e, i, n, r) {
		if (!(Ie(e, t.length) && Ie(n, i.length))) return 1 / 0;
		let s = 1 / 0;
		for (let o = e[0]; o < e[1]; ++o) {
			...
			for (let t = n[0]; t < n[1]; ++t) {
				const n = i[t],
					o = i[t + 1];
				if (ce(e, a, n, o)) return 0;
				s = Math.min(s, Ne(e, a, n, o, r));
			}
		}
		return s;
	}
	function je(t, e, i, n, r) {
		if (!(Ie(e, t.length) && Ie(n, i.length))) return NaN;
		let s = 1 / 0;
		for (let o = e[0]; o <= e[1]; ++o) for (let e = n[0]; e <= n[1]; ++e) if (((s = Math.min(s, r.distance(t[o], i[e]))), 0 === s)) return s;
		return s;
	}
	function $e(t, e, i) {
		if (de(t, e, !0)) return 0;
		let n = 1 / 0;
		for (const r of e) {
			const e = r[0],
				s = r[r.length - 1];
			if (e !== s && ((n = Math.min(n, ze(t, [s, e], i))), 0 === n)) return n;
			const o = i.pointOnLine(r, t);
			if (((n = Math.min(n, i.distance(t, o.point))), 0 === n)) return n;
		}
		return n;
	}
	function Be(t, e, i, n) {
		if (!Ie(e, t.length)) return NaN;
		for (let n = e[0]; n <= e[1]; ++n) if (de(t[n], i, !0)) return 0;
		let r = 1 / 0;
		for (let s = e[0]; s < e[1]; ++s) {
			...
			for (const t of i)
				for (let i = 0, s = t.length, a = s - 1; i < s; a = i++) {
					const s = t[a],
						l = t[i];
					if (ce(e, o, s, l)) return 0;
					r = Math.min(r, Ne(e, o, s, l, n));
				}
		}
		return r;
	}
	function Ue(t, e) {
		for (const i of t) for (const t of i) if (de(t, e, !0)) return !0;
		return !1;
	}
	function Ve(t, e, i, n = 1 / 0) {
		const r = Ae(t),
			s = Ae(e);
		if (n !== 1 / 0 && Oe(r, s, i) >= n) return n;
		if (ae(r, s)) {
			if (Ue(t, e)) return 0;
		} else if (Ue(e, t)) return 0;
		let o = 1 / 0;
		for (const n of t)
			for (let t = 0, r = n.length, s = r - 1; t < r; s = t++) {
				const r = n[s],
					a = n[t];
				for (const t of e)
					for (let e = 0, n = t.length, s = n - 1; e < n; s = e++) {
						const n = t[s],
							l = t[e];
						if (ce(r, a, n, l)) return 0;
						o = Math.min(o, Ne(r, a, n, l, i));
					}
			}
		return o;
	}
	function We(t, e, i, n, r, s) {
		if (!s) return;
		const o = Oe(Le(n, s), r, i);
		o < e && t.push([o, s, [0, 0]]);
	}
	function Xe(t, e, i, n, r, s, o) {
		if (!s || !o) return;
		const a = Oe(Le(n, s), Le(r, o), i);
		a < e && t.push([a, s, o]);
	}
	function qe(t, e, i, n, r = 1 / 0) {
		let s = Math.min(n.distance(t[0], i[0][0]), r);
		if (0 === s) return s;
		const o = new Se([[0, [0, t.length - 1], [0, 0]]], Fe),
			a = Ae(i);
		for (; o.length > 0; ) {
			const r = o.pop();
			if (r[0] >= s) continue;
			...
			if (Me(l) <= h) {
				...
				const i = ke(l, e);
				We(o, s, n, t, a, i[0]), We(o, s, n, t, a, i[1]);
			}
		}
		return s;
	}
	function Ze(t, e, i, n, r, s = 1 / 0) {
		let o = Math.min(s, r.distance(t[0], i[0]));
		if (0 === o) return o;
		const a = new Se([[0, [0, t.length - 1], [0, i.length - 1]]], Fe);
		for (; a.length > 0; ) {
			const s = a.pop();
			if (s[0] >= o) continue;
			const l = s[1],
				...
				u = n ? 50 : 100;
			if (Me(l) <= c && Me(h) <= u) {
				if (!Ie(l, t.length) && Ie(h, i.length)) return NaN;
				let s;
				if (e && n) (s = Ge(t, l, i, h, r)), (o = Math.min(o, s));
				else if (e && !n) {
					const e = t.slice(l[0], l[1] + 1);
					for (let t = h[0]; t <= h[1]; ++t) if (((s = ze(i[t], e, r)), (o = Math.min(o, s)), 0 === o)) return o;
				} else if (!e && n) {
					const e = i.slice(h[0], h[1] + 1);
					for (let i = l[0]; i <= l[1]; ++i) if (((s = ze(t[i], e, r)), (o = Math.min(o, s)), 0 === o)) return o;
				} else (s = je(t, l, i, h, r)), (o = Math.min(o, s));
			} else {
				const s = ke(l, e),
					c = ke(h, n);
				Xe(a, o, r, t, i, s[0], c[0]), Xe(a, o, r, t, i, s[0], c[1]), Xe(a, o, r, t, i, s[1], c[0]), Xe(a, o, r, t, i, s[1], c[1]);
			}
		}
		return o;
	}
	function Ke(t, e) {
		...
		const n = (function (t) {
				...
				for (const r of t) {
					const t = Ce(r);
					0 !== t && ((r.area = Math.abs(t)), void 0 === n && (n = t < 0), n === t < 0 ? (i && e.push(i), (i = [r])) : i.push(r));
				}
				return i && e.push(i), e;
			})(i).map((e) => e.map((e) => e.map((e) => se([e.x, e.y], t.canonical)))),
			r = new Re(n[0][0][0][1]);
		let s = 1 / 0;
		for (const t of e)
			for (const e of n) {
				switch (t.type) {
					case 'Point':
						s = Math.min(s, qe([t.coordinates], !1, e, r, s));
						break;
					case 'LineString':
						s = Math.min(s, qe(t.coordinates, !0, e, r, s));
						break;
					case 'Polygon':
						s = Math.min(s, Ve(e, t.coordinates, r, s));
				}
				if (0 === s) return s;
			}
		return s;
	...
	class He {
		...
		static parse(t, e) {
			...
			if (ft(t[1])) {
				const e = t[1];
				if ('FeatureCollection' === e.type) return new He(e, e.features.map((t) => Ye(t.geometry)).flat());
				if ('Feature' === e.type) return new He(e, Ye(e.geometry));
				if ('type' in e && 'coordinates' in e) return new He(e, Ye(e));
			}
		...
		evaluate(t) {
			if (null != t.geometry() && null != t.canonicalID()) {
				if ('Point' === t.geometryType())
					return (function (t, e) {
						const i = t.geometry(),
							n = i.flat().map((e) => se([e.x, e.y], t.canonical));
						if (0 === i.length) return NaN;
						const r = new Re(n[0][1]);
						let s = 1 / 0;
						for (const t of e) {
							switch (t.type) {
								case 'Point':
									s = Math.min(s, Ze(n, !1, [t.coordinates], !1, r, s));
									break;
								case 'LineString':
									s = Math.min(s, Ze(n, !1, t.coordinates, !0, r, s));
									break;
								case 'Polygon':
									s = Math.min(s, qe(n, !1, t.coordinates, r, s));
							}
							if (0 === s) return s;
						}
						return s;
				...
				if ('LineString' === t.geometryType())
					return (function (t, e) {
						...
						for (const t of e) {
							switch (t.type) {
								case 'Point':
									s = Math.min(s, Ze(n, !0, [t.coordinates], !1, r, s));
									break;
								case 'LineString':
									s = Math.min(s, Ze(n, !0, t.coordinates, !0, r, s));
									break;
								case 'Polygon':
									s = Math.min(s, qe(n, !0, t.coordinates, r, s));
							}
							if (0 === s) return s;
						}
						return s;
					})(t, this.geometries);
				if ('Polygon' === t.geometryType()) return Ke(t, this.geometries);
			}
			return NaN;
		}
		eachChild() {}
	...
	class Je {
		constructor(t) {
			(this.type = f), (this.key = t);
		}
		static parse(t, e) {
			if (2 !== t.length) return e.error(`Expected 1 argument, but found ${t.length - 1} instead.`);
			const i = t[1];
			return null == i ? e.error('Global state property must be defined.') : 'string' != typeof i ? e.error(`Global state property must be string, but found ${typeof t[1]} instead.`) : new Je(i);
		}
		evaluate(t) {
			var e;
			const i = null === (e = t.globals) || void 0 === e ? void 0 : e.globalState;
			return i && 0 !== Object.keys(i).length ? W(i, this.key) : null;
		}
		eachChild() {}
		outputDefined() {
			return !1;
	...
	const Qe = { '==': Xt, '!=': qt, '>': Kt, '<': Zt, '>=': Ht, '<=': Yt, array: xt, at: Pt, boolean: xt, case: It, coalesce: Bt, collator: Jt, format: te, image: ee, in: Rt, 'index-of': Ft, interpolate: jt, 'interpolate-hcl': jt, 'interpolate-lab': jt, length: ie, let: Et, literal: _t, match: Mt, number: xt, 'number-format': Qt, object: xt, slice: kt, step: At, string: xt, 'to-boolean': wt, 'to-color': wt, 'to-number': wt, 'to-string': wt, var: Tt, within: be, distance: He, 'global-state': Je };
	class ti {
		constructor(t, e, i, n) {
		...
		static parse(t, e) {
			...
			let a = null;
			for (const [n, s] of o) {
				a = new Ct(e.registry, si, e.path, null, e.scope);
				const o = [];
				let l = !1;
				...
				if (!l)
					if (Array.isArray(n) && n.length !== o.length) a.error(`Expected ${n.length} arguments, but found ${o.length} instead.`);
						...
						if (0 === a.errors.length) return new ti(i, r, s, o);
					}
			}
			if (1 === o.length) e.errors.push(...a.errors);
			else {
				const i = (o.length ? o : s)
						.map(([t]) => {
							return (e = t), Array.isArray(e) ? `(${e.map(S).join(', ')})` : `(${S(e.type)}...)`;
							var e;
						})
						.join(' | '),
					n = [];
	...
	function ei(t, [e, i, n, r]) {
		...
		const s = r ? r.evaluate(t) : 1,
			o = gt(e, i, n, s);
		if (o) throw new lt(o);
		return new tt(e / 255, i / 255, n / 255, s, !1);
	}
	function ii(t, e) {
		return t in e;
	}
	...
	function si(t) {
		if (t instanceof Tt) return si(t.boundExpression);
		if (t instanceof ti && 'error' === t.name) return !1;
		if (t instanceof Jt) return !1;
		if (t instanceof be) return !1;
		if (t instanceof He) return !1;
		if (t instanceof Je) return !1;
		const e = t instanceof wt || t instanceof xt;
		let i = !0;
		return (
			t.eachChild((t) => {
				i = e ? i && si(t) : i && t instanceof _t;
			}),
			!!i && oi(t) && li(t, ['zoom', 'heatmap-density', 'elevation', 'line-progress', 'accumulated', 'is-supported-script'])
		);
	}
	function oi(t) {
		if (t instanceof ti) {
	...
	function ai(t) {
		if (t instanceof ti && 'feature-state' === t.name) return !1;
		let e = !0;
		return (
			t.eachChild((t) => {
				e && !ai(t) && (e = !1);
	...
	function li(t, e) {
		if (t instanceof ti && e.indexOf(t.name) >= 0) return !1;
		let i = !0;
		return (
			t.eachChild((t) => {
				i && !li(t, e) && (i = !1);
	...
	function ui(t) {
		return 'object' == typeof t && null !== t && !Array.isArray(t) && pt(t) === g;
	}
	ti.register(Qe, {
		error: [
			{ kind: 'error' },
			[h],
			(t, [e]) => {
				throw new lt(e.evaluate(t));
			},
		],
		typeof: [h, [f], (t, [e]) => S(pt(e.evaluate(t)))],
		'to-rgba': [
			b(l, 4),
			[u],
			(t, [e]) => {
				const [i, n, r, s] = e.evaluate(t).rgb;
				return [255 * i, 255 * n, 255 * r, s];
			},
		],
		rgb: [u, [l, l, l], ei],
		rgba: [u, [l, l, l, l], ei],
		has: {
			type: c,
			overloads: [
				[[h], (t, [e]) => ii(e.evaluate(t), t.properties())],
				[[h, g], (t, [e, i]) => ii(e.evaluate(t), i.evaluate(t))],
			],
		},
		get: {
			type: f,
			overloads: [
				[[h], (t, [e]) => ni(e.evaluate(t), t.properties())],
				[[h, g], (t, [e, i]) => ni(e.evaluate(t), i.evaluate(t))],
			],
		},
		'feature-state': [f, [h], (t, [e]) => ni(e.evaluate(t), t.featureState || {})],
		...
		elevation: [l, [], (t) => t.globals.elevation || 0],
		...
		'-': {
			type: l,
			overloads: [
				[[l, l], (t, [e, i]) => e.evaluate(t) - i.evaluate(t)],
				[[l], (t, [e]) => -e.evaluate(t)],
			],
		},
		'/': [l, [l, l], (t, [e, i]) => e.evaluate(t) / i.evaluate(t)],
		'%': [l, [l, l], (t, [e, i]) => e.evaluate(t) % i.evaluate(t)],
		ln2: [l, [], () => Math.LN2],
		pi: [l, [], () => Math.PI],
		e: [l, [], () => Math.E],
		'^': [l, [l, l], (t, [e, i]) => Math.pow(e.evaluate(t), i.evaluate(t))],
		...
		min: [l, ri(l), (t, e) => Math.min(...e.map((e) => e.evaluate(t)))],
		max: [l, ri(l), (t, e) => Math.max(...e.map((e) => e.evaluate(t)))],
		...
		'filter-==': [c, [h, f], (t, [e, i]) => t.properties()[e.value] === i.value],
		...
		'filter-type-in': [c, [b(h)], (t, [e]) => e.value.indexOf(t.geometryType()) >= 0],
		'filter-id-in': [c, [b(f)], (t, [e]) => e.value.indexOf(t.id()) >= 0],
		'filter-in-small': [c, [h, b(f)], (t, [e, i]) => i.value.indexOf(t.properties()[e.value]) >= 0],
		'filter-in-large': [
			c,
			[h, b(f)],
			(t, [e, i]) =>
		...
		all: {
			type: c,
			overloads: [
				[[c, c], (t, [e, i]) => e.evaluate(t) && i.evaluate(t)],
				[
					ri(c),
					(t, e) => {
		...
		concat: [h, ri(f), (t, e) => e.map((e) => mt(e.evaluate(t))).join('')],
	...
	class di {
		constructor(t, e) {
			(this.expression = t),
				...
				(this._defaultValue = e
					? (function (t) {
							if ('color' === t.type && ui(t.default)) return new tt(0, 0, 0, 0);
							switch (t.type) {
								case 'color':
									return tt.parse(t.default) || null;
								case 'padding':
									return st.parse(t.default) || null;
								case 'numberArray':
									return ot.parse(t.default) || null;
								case 'colorArray':
									return at.parse(t.default) || null;
								case 'variableAnchorOffsetCollection':
									return ct.parse(t.default) || null;
								case 'projectionDefinition':
									return dt.parse(t.default) || null;
								default:
		...
		evaluateWithoutErrorHandling(t, e, i, n, r, s) {
			return (this._evaluator.globals = t), (this._evaluator.feature = e), (this._evaluator.featureState = i), (this._evaluator.canonical = n), (this._evaluator.availableImages = r || null), (this._evaluator.formattedSection = s), this.expression.evaluate(this._evaluator);
		}
		evaluate(t, e, i, n, r, s) {
			(this._evaluator.globals = t), (this._evaluator.feature = e || null), (this._evaluator.featureState = i || null), (this._evaluator.canonical = n), (this._evaluator.availableImages = r || null), (this._evaluator.formattedSection = s || null);
			try {
	...
	function gi(t, e) {
		const i = new Ct(
				...
				e
					? (function (t) {
							const e = { color: u, string: h, number: l, enum: h, boolean: c, formatted: m, padding: _, numberArray: x, colorArray: y, projectionDefinition: d, resolvedImage: v, variableAnchorOffsetCollection: w };
							if ('array' === t.type) return b(e[t.value] || f, t.length);
							return e[t.type];
					  })(e)
					: void 0
			),
			n = i.parse(t, void 0, void 0, void 0, e && 'string' === e.type ? { typeAnnotation: 'coerce' } : void 0);
		return n ? hi(new di(n, e)) : ci(i.errors);
	}
	class fi {
		constructor(t, e) {
			(this.kind = t), (this._styleExpression = e), (this.isStateDependent = 'constant' !== t && !ai(e.expression)), (this.globalStateRefs = yi(e.expression));
		}
		evaluateWithoutErrorHandling(t, e, i, n, r, s) {
	...
	class pi {
		constructor(t, e, i, n) {
			(this.kind = t), (this.zoomStops = i), (this._styleExpression = e), (this.isStateDependent = 'camera' !== t && !ai(e.expression)), (this.globalStateRefs = yi(e.expression)), (this.interpolationType = n);
		}
		evaluateWithoutErrorHandling(t, e, i, n, r, s) {
			return this._styleExpression.evaluateWithoutErrorHandling(t, e, i, n, r, s);
		}
		...
		interpolationFactor(t, e, i) {
			return this.interpolationType ? jt.interpolationFactor(this.interpolationType, t, e, i) : 0;
		}
	}
	function mi(t, e) {
		const i = gi(t, e);
		if ('error' === i.result) return i;
		const n = i.value.expression,
			r = oi(n);
		if (!r && 'data-driven' !== (o = e)['property-type'] && 'cross-faded-data-driven' !== o['property-type']) return ci([new s('', 'data expressions not supported')]);
		var o;
		const a = li(n, ['zoom']);
		if (
			!a &&
			...
			return ci([new s('', 'zoom expressions not supported')]);
		const l = _i(n);
		if (!l && !a) return ci([new s('', '"zoom" expression may only be used as input to a top-level "step" or "interpolate" expression.')]);
		if (l instanceof s) return ci([l]);
		if (
			l instanceof jt &&
			!(function (t) {
			...
			return ci([new s('', '"interpolate" expressions cannot be used with this property')]);
		if (!l) return hi(new fi(r ? 'constant' : 'source', i.value));
		const h = l instanceof jt ? l.interpolation : void 0;
		return hi(new pi(r ? 'camera' : 'composite', i.value, l.labels, h));
	}
	function _i(t) {
		let e = null;
		if (t instanceof Et) e = _i(t.result);
		else if (t instanceof Bt) {
			for (const i of t.args) if (((e = _i(i)), e)) break;
		} else (t instanceof At || t instanceof jt) && t.input instanceof ti && 'zoom' === t.input.name && (e = t);
		return (
			e instanceof s ||
				t.eachChild((t) => {
					const i = _i(t);
					i instanceof s ? (e = i) : !e && i ? (e = new s('', '"zoom" expression may only be used as input to a top-level "step" or "interpolate" expression.')) : e && i && e !== i && (e = new s('', 'Only one zoom-based "step" or "interpolate" subexpression may be used in an expression.'));
				}),
			e
		);
	}
	...
	function xi(t) {
		...
		switch (t[0]) {
			...
			case 'any':
			case 'all':
				for (const e of t.slice(1)) if (!xi(e) && 'boolean' != typeof e) return !1;
				return !0;
			default:
				return !0;
		}
	}
	const vi = { type: 'boolean', default: !1, transition: !1, 'property-type': 'data-driven', expression: { interpolated: !1, parameters: ['zoom', 'feature'] } };
	function wi(t) {
		if (null == t) return { filter: () => !0, needGeometry: !1, getGlobalStateRefs: () => new Set() };
		xi(t) || (t = Ci(t));
		const e = gi(t, vi);
		if ('error' === e.result) throw new Error(e.value.map((t) => `${t.key}: ${t.message}`).join(', '));
		return { filter: (t, i, n) => e.value.evaluate(t, i, {}, n), needGeometry: Si(t), getGlobalStateRefs: () => yi(e.value.expression) };
	}
	function bi(t, e) {
	...
	function Ci(t) {
		...
		var i;
		return '==' === e ? Ei(t[1], t[2], '==') : '!=' === e ? Ri(Ei(t[1], t[2], '==')) : '<' === e || '>' === e || '<=' === e || '>=' === e ? Ei(t[1], t[2], e) : 'any' === e ? ((i = t.slice(1)), ['any'].concat(i.map(Ci))) : 'all' === e ? ['all'].concat(t.slice(1).map(Ci)) : 'none' === e ? ['all'].concat(t.slice(1).map(Ci).map(Ri)) : 'in' === e ? Ti(t[1], t.slice(2)) : '!in' === e ? Ri(Ti(t[1], t.slice(2))) : 'has' === e ? Pi(t[1]) : '!has' !== e || Ri(Pi(t[1]));
	}
	function Ei(t, e, i) {
		switch (t) {
			case '$type':
	...
	function Ti(t, e) {
		...
		switch (t) {
			...
			default:
				return e.length > 200 && !e.some((t) => typeof t != typeof e[0]) ? ['filter-in-large', t, ['literal', e.sort(bi)]] : ['filter-in-small', t, ['literal', e]];
		}
	}
	function Pi(t) {
		switch (t) {
	...
	function Mi(t, e) {
		...
		const n = i && 'object' == typeof i[0][0],
			...
			s = n || !r;
		return (
			(i = i.map((t) => (!r && e.tokens && 'string' == typeof t[1] ? [t[0], zi(t[1])] : [t[0], Fi(t[1])]))),
			n
				? (function (t, e, i) {
						const n = {},
							r = {},
						...
						for (let e = 0; e < i.length; e++) {
							const o = i[e],
								a = o[0].zoom;
							void 0 === n[a] && ((n[a] = { zoom: a, type: t.type, property: t.property, default: t.default }), (r[a] = []), s.push(a)), r[a].push([o[0].value, o[1]]);
						}
						const o = Oi({}, e);
						if ('exponential' === o) {
							const i = [Ii(t), ['linear'], ['zoom']];
							for (const t of s) {
								Di(i, t, Li(n[t], e, r[t]), !1);
							}
							return i;
						}
						{
							const t = ['step', ['zoom']];
							for (const i of s) {
								Di(t, i, Li(n[i], e, r[i]), !0);
							}
							return Ai(t), t;
						}
				  })(t, e, i)
				: s
				? (function (t, e, i, n = ['zoom']) {
						const r = Oi(t, e);
						let s,
							o = !1;
						if ('interval' === r) (s = ['step', n]), (o = !0);
							...
							if ('exponential' !== r) throw new Error(`Unknown zoom function type "${r}"`);
							{
								...
								s = [Ii(t), 1 === e ? ['linear'] : ['exponential', e], n];
							}
						}
						for (const t of i) Di(s, t[0], t[1], o);
						return Ai(s), s;
				  })(t, e, i)
				: Li(t, e, i)
		);
	...
	function ki(t, e) {
		const i = Fi(((n = t.default), (r = e.default), void 0 !== n ? n : void 0 !== r ? r : void 0));
		var n, r;
	...
	function Li(t, e, i) {
		...
		if ('categorical' === n && 'boolean' == typeof i[0][0]) {
			...
			return n.push(ki(t, e)), n;
		}
		if ('categorical' === n) {
			const n = ['match', r];
			for (const t of i) Di(n, t[0], t[1], !1);
			return n.push(ki(t, e)), n;
		}
		if ('interval' === n) {
			const e = ['step', ['number', r]];
			for (const t of i) Di(e, t[0], t[1], !0);
			return Ai(e), void 0 === t.default ? e : ['case', ['==', ['typeof', r], 'number'], e, Fi(t.default)];
		}
		if ('exponential' === n) {
			const e = void 0 !== t.base ? t.base : 1,
				n = [Ii(t), 1 === e ? ['linear'] : ['exponential', e], ['number', r]];
			for (const t of i) Di(n, t[0], t[1], !1);
			return void 0 === t.default ? n : ['case', ['==', ['typeof', r], 'number'], n, Fi(t.default)];
		}
	...
	const Ni = e;
	var Gi = { thin: 100, hairline: 100, 'ultra-light': 200, 'extra-light': 200, light: 300, book: 300, regular: 400, normal: 400, plain: 400, roman: 400, standard: 400, medium: 500, 'semi-bold': 600, 'demi-bold': 600, bold: 700, 'extra-bold': 800, 'ultra-bold': 800, heavy: 900, black: 900, 'heavy-black': 900, fat: 900, poster: 900, 'ultra-black': 950, 'extra-black': 950 },
		ji = ' ',
		$i = /(italic|oblique)$/i,
		Bi = {};
	function Ui(t, e, i) {
		...
		if (!n) {
			...
			for (var r, s, o = 400, a = 'normal', l = [], h = 0, c = t.length; h < c; ++h) {
				...
				for (var g in ('normal' == d || 'italic' == d || 'oblique' == d ? ((a = s ? a : d), (s = !0), u.pop(), (d = u[u.length - 1].toLowerCase())) : $i.test(d) && ((d = d.replace($i, '')), (a = s ? a : u[u.length - 1].replace(d, '')), (s = !0)), Gi)) {
					var f = u.length > 1 ? u[u.length - 2].toLowerCase() : '';
					if (d == g || d == g.replace('-', '') || f + '-' + d == g) {
						(o = r ? o : Gi[g]), u.pop(), f && g.startsWith(f) && u.pop();
						break;
					}
				}
				r || 'number' != typeof d || ((o = d), (r = !0));
				var p = u.join(ji).replace('Klokantech Noto Sans', 'Noto Sans').replace('DIN Pro', 'Barlow').replace('Arial Unicode MS', 'Arial');
				-1 !== p.indexOf(ji) && (p = '"' + p + '"'), l.push(p);
			}
			n = Bi[t] = [a, o, l];
		}
		return n[0] + ji + n[1] + ji + e + 'px' + (i ? '/' + i : '') + ji + n[2];
	}
	var Vi = 'add',
		Wi = 'remove',
		Xi = 'propertychange',
	...
	function _n(t) {
		...
		return function () {
			...
			return (i && this === n && gn(r, i)) || ((n = this), (i = r), (e = t.apply(this, arguments))), e;
		};
	}
	function yn(t) {
		return (function () {
	...
	class bn extends an {
		...
		dispatchEvent(t) {
			...
			if (0 === --s[i]) {
				let t = o[i];
				for (delete o[i]; t--; ) this.removeEventListener(i, mn);
				delete s[i];
			}
			return a;
		}
		disposeInternal() {
			this.listeners_ && xn(this.listeners_);
		}
		getListeners(t) {
		...
		removeEventListener(t, e) {
			...
			if (!i) return;
			const n = i.indexOf(e);
			-1 !== n && (this.pendingRemovals_ && t in this.pendingRemovals_ ? ((i[n] = mn), ++this.pendingRemovals_[t]) : (i.splice(n, 1), 0 === i.length && delete this.listeners_[t]));
		}
	}
	function Sn(t, e, i, n, r) {
		if (r) {
			const r = i;
			i = function (s) {
				return t.removeEventListener(e, i), r.call(n ?? this, s);
			};
	...
	function En(t) {
		t && t.target && (t.target.removeEventListener(t.type, t.listener), xn(t));
	}
	class Tn extends bn {
		constructor() {
		...
		changed() {
			++this.revision_, this.dispatchEvent(qi);
		}
		getRevision() {
		...
		onInternal(t, e) {
			if (Array.isArray(t)) {
				const i = t.length,
					n = new Array(i);
				for (let r = 0; r < i; ++r) n[r] = Sn(this, t[r], e);
				return n;
			}
			return Sn(this, t, e);
		}
		onceInternal(t, e) {
			...
			if (Array.isArray(t)) {
				const n = t.length;
				i = new Array(n);
				for (let r = 0; r < n; ++r) i[r] = Cn(this, t[r], e);
			} else i = Cn(this, t, e);
			return (e.ol_key = i), i;
		}
		unInternal(t, e) {
	...
	function Pn(t) {
		if (Array.isArray(t)) for (let e = 0, i = t.length; e < i; ++e) En(t[e]);
		else En(t);
	}
	Tn.prototype.on, Tn.prototype.once, Tn.prototype.un;
	var Rn = Object.freeze({ __proto__: null, default: Tn, unByKey: Pn });
	function Fn() {
		throw new Error('Unimplemented abstract method.');
	}
	let Mn = 0;
	function In(t) {
		return t.ol_uid || (t.ol_uid = String(++Mn));
	}
	class kn extends wn {
		constructor(t, e, i) {
	...
	class Ln extends Tn {
		constructor(t) {
			super(), this.on, this.once, this.un, In(this), (this.values_ = null), void 0 !== t && this.setProperties(t);
		}
		get(t) {
			let e;
		...
		notify(t, e) {
			let i;
			(i = `change:${t}`), this.hasListener(i) && this.dispatchEvent(new kn(i, t, e)), (i = Xi), this.hasListener(i) && this.dispatchEvent(new kn(i, t, e));
		}
		...
		unset(t, e) {
			if (this.values_ && t in this.values_) {
				...
				delete this.values_[t], vn(this.values_) && (this.values_ = null), e || this.notify(t, i);
			}
		}
	}
	const An = 'length';
	...
	class On extends Ln {
		...
		insertAt(t, e) {
			...
			this.unique_ && this.assertUnique_(e), this.array_.splice(t, 0, e), this.updateLength_(), this.dispatchEvent(new Dn(Vi, e, t));
		}
		pop() {
		...
		removeAt(t) {
			...
			return this.array_.splice(t, 1), this.updateLength_(), this.dispatchEvent(new Dn(Wi, e, t)), e;
		}
		setAt(t, e) {
			...
			(this.array_[t] = e), this.dispatchEvent(new Dn(Wi, i, t)), this.dispatchEvent(new Dn(Vi, e, t));
		}
		updateLength_() {
			this.set(An, this.array_.length);
		}
		assertUnique_(t, e) {
			for (let i = 0, n = this.array_.length; i < n; ++i) if (this.array_[i] === t && i !== e) throw new Error('Duplicate item added to a unique collection');
		}
	}
	class zn extends wn {
		constructor(t, e, i) {
	...
	var Gn = { SINGLECLICK: 'singleclick', CLICK: Yi, DBLCLICK: Hi, POINTERDRAG: 'pointerdrag', POINTERMOVE: 'pointermove', POINTERDOWN: 'pointerdown', POINTERUP: 'pointerup', POINTEROVER: 'pointerover', POINTEROUT: 'pointerout', POINTERENTER: 'pointerenter', POINTERLEAVE: 'pointerleave', POINTERCANCEL: 'pointercancel' };
	const jn = 'undefined' != typeof navigator && void 0 !== navigator.userAgent ? navigator.userAgent.toLowerCase() : '',
		$n = jn.includes('safari') && !jn.includes('chrom') && (jn.includes('version/15.4') || /cpu (os|iphone os) 15_4 like mac os x/.test(jn)),
		Bn = jn.includes('webkit') && !jn.includes('edge'),
		Un = jn.includes('macintosh'),
		Vn = 'undefined' != typeof devicePixelRatio ? devicePixelRatio : 1,
		Wn = 'undefined' != typeof WorkerGlobalScope && 'undefined' != typeof OffscreenCanvas && self instanceof WorkerGlobalScope,
		Xn = 'undefined' != typeof Image && Image.prototype.decode,
		qn = 'function' == typeof createImageBitmap,
		Zn = (function () {
			let t = !1;
			try {
	...
	class Hn extends bn {
		constructor(t, e) {
			...
			(this.activePointers_ = []), (this.trackedTouches_ = {}), (this.element_ = i), (this.pointerdownListenerKey_ = Sn(i, Yn, this.handlePointerDown_, this)), this.originalPointerMoveEvent_, (this.relayedListenerKey_ = Sn(i, Kn, this.relayMoveEvent_, this)), (this.boundHandleTouchMove_ = this.handleTouchMove_.bind(this)), this.element_.addEventListener(sn, this.boundHandleTouchMove_, !!Zn && { passive: !1 });
		}
		emulateClick_(t) {
			let e = new Nn(Gn.CLICK, this.map_, t);
			this.dispatchEvent(e),
				void 0 !== this.clickTimeoutId_
					? (clearTimeout(this.clickTimeoutId_), (this.clickTimeoutId_ = void 0), (e = new Nn(Gn.DBLCLICK, this.map_, t)), this.dispatchEvent(e))
					: (this.clickTimeoutId_ = setTimeout(() => {
							this.clickTimeoutId_ = void 0;
							const e = new Nn(Gn.SINGLECLICK, this.map_, t);
							this.dispatchEvent(e);
					  }, 250));
		}
		updateActivePointers_(t) {
			const e = t,
				i = e.pointerId;
			if (e.type == Gn.POINTERUP || e.type == Gn.POINTERCANCEL) {
			...
			} else (e.type != Gn.POINTERDOWN && e.type != Gn.POINTERMOVE) || (this.trackedTouches_[i] = e);
			this.activePointers_ = Object.values(this.trackedTouches_);
		}
		handlePointerUp_(t) {
			this.updateActivePointers_(t);
			const e = new Nn(Gn.POINTERUP, this.map_, t, void 0, void 0, this.activePointers_);
			this.dispatchEvent(e), this.emulateClicks_ && !e.defaultPrevented && !this.dragging_ && this.isMouseActionButton_(t) && this.emulateClick_(this.down_), 0 === this.activePointers_.length && (this.dragListenerKeys_.forEach(En), (this.dragListenerKeys_.length = 0), (this.dragging_ = !1), (this.down_ = null));
		}
		...
		handlePointerDown_(t) {
			...
			const e = new Nn(Gn.POINTERDOWN, this.map_, t, void 0, void 0, this.activePointers_);
			if ((this.dispatchEvent(e), (this.down_ = new PointerEvent(t.type, t)), Object.defineProperty(this.down_, 'target', { writable: !1, value: t.target }), 0 === this.dragListenerKeys_.length)) {
				...
				this.dragListenerKeys_.push(Sn(t, Gn.POINTERMOVE, this.handlePointerMove_, this), Sn(t, Gn.POINTERUP, this.handlePointerUp_, this), Sn(this.element_, Gn.POINTERCANCEL, this.handlePointerUp_, this)), this.element_.getRootNode && this.element_.getRootNode() !== t && this.dragListenerKeys_.push(Sn(this.element_.getRootNode(), Gn.POINTERUP, this.handlePointerUp_, this));
			}
		}
		handlePointerMove_(t) {
			if (this.isMoving_(t)) {
				this.updateActivePointers_(t), (this.dragging_ = !0);
				const e = new Nn(Gn.POINTERDRAG, this.map_, t, this.dragging_, void 0, this.activePointers_);
				this.dispatchEvent(e);
			}
		}
		relayMoveEvent_(t) {
			...
			this.dispatchEvent(new Nn(Gn.POINTERMOVE, this.map_, t, e));
		}
		handleTouchMove_(t) {
		...
		disposeInternal() {
			this.relayedListenerKey_ && (En(this.relayedListenerKey_), (this.relayedListenerKey_ = null)), this.element_.removeEventListener(sn, this.boundHandleTouchMove_), this.pointerdownListenerKey_ && (En(this.pointerdownListenerKey_), (this.pointerdownListenerKey_ = null)), this.dragListenerKeys_.forEach(En), (this.dragListenerKeys_.length = 0), (this.element_ = null), super.disposeInternal();
		}
	}
	var Jn = 'postrender',
		Qn = 'movestart',
	...
	class fr {
		...
		clear() {
			(this.elements_.length = 0), (this.priorities_.length = 0), xn(this.queuedElements_);
		}
		dequeue() {
		...
		enqueue(t) {
			dr(!(this.keyFunction_(t) in this.queuedElements_), 'Tried to enqueue an `element` that was already added to the queue');
			const e = this.priorityFunction_(t);
			return e != gr && (this.elements_.push(t), this.priorities_.push(e), (this.queuedElements_[this.keyFunction_(t)] = !0), this.siftDown_(0, this.elements_.length - 1), !0);
		}
		getCount() {
		...
		reprioritize() {
			...
			const r = e.length;
			let s, o, a;
			for (o = 0; o < r; ++o) (s = e[o]), (a = t(s)), a == gr ? delete this.queuedElements_[this.keyFunction_(s)] : ((i[n] = a), (e[n++] = s));
	...
	class pr extends fr {
		...
		enqueue(t) {
			...
			if (e) {
				t[0].addEventListener(qi, this.boundHandleTileChange_);
			}
			return e;
		}
		getTilesLoading() {
		...
		handleTileChange(t) {
			const e = t.target,
				i = e.getState();
			if (i === hr || i === cr || i === ur) {
				i !== cr && e.removeEventListener(qi, this.boundHandleTileChange_);
				const t = e.getKey();
		...
		loadMoreTiles(t, e) {
			...
			for (; this.tilesLoading_ < t && i < e && this.getCount() > 0; ) {
				const t = this.dequeue()[0],
					e = t.getKey();
				t.getState() !== ar || e in this.tilesLoadingKeys_ || ((this.tilesLoadingKeys_[e] = !0), ++this.tilesLoading_, ++i, t.load());
			}
		}
	}
	var mr = 0,
		_r = 1,
		yr = { CENTER: 'center', RESOLUTION: 'resolution', ROTATION: 'rotation' };
	function xr(t, e, i) {
	...
	function Pr(t, e) {
		return Math.round(Tr(t, e));
	}
	function Rr(t, e) {
		return Math.floor(Tr(t, e));
	}
	function Fr(t, e) {
		return Math.ceil(Tr(t, e));
	}
	function Mr(t, e, i) {
		if (t >= e && t < i) return t;
		const n = i - e;
	...
	function Gr(t) {
		const e = qr();
		for (let i = 0, n = t.length; i < n; ++i) ts(e, t[i]);
		return e;
	}
	function jr(t, e, i) {
	...
	function Xr(t, e) {
		const i = t[0],
			...
			a = e[1];
		let l = Lr;
		return o < i ? (l |= Nr) : o > r && (l |= Or), a < n ? (l |= zr) : a > s && (l |= Dr), l === Lr && (l = Ar), l;
	}
	function qr() {
	...
	function ns(t, e) {
		let i;
		return (i = e(ss(t))), i || ((i = e(os(t))), i || ((i = e(fs(t))), i || ((i = e(gs(t))), i || !1)));
	}
	function rs(t) {
		let e = 0;
		return _s(t) || (e = ps(t) * us(t)), e;
	}
	function ss(t) {
		return [t[0], t[1]];
	}
	...
	function ls(t, e) {
		let i;
		if ('bottom-left' === e) i = ss(t);
		else if ('bottom-right' === e) i = os(t);
		else if ('top-left' === e) i = gs(t);
		else {
	...
	function hs(t, e, i, n, r) {
		const [s, o, a, l, h, c, u, d] = cs(t, e, i, n);
		return Zr(Math.min(s, a, h, u), Math.min(o, l, c, d), Math.max(s, a, h, u), Math.max(o, l, c, d), r);
	}
	function cs(t, e, i, n) {
		const r = (e * n[0]) / 2,
			s = (e * n[1]) / 2,
	...
	function ds(t, e, i) {
		...
		return ms(t, e) ? (t[0] > e[0] ? (n[0] = t[0]) : (n[0] = e[0]), t[1] > e[1] ? (n[1] = t[1]) : (n[1] = e[1]), t[2] < e[2] ? (n[2] = t[2]) : (n[2] = e[2]), t[3] < e[3] ? (n[3] = t[3]) : (n[3] = e[3])) : Kr(n), n;
	}
	function gs(t) {
		return [t[0], t[3]];
	}
	...
	function ys(t, e, i, n) {
		...
		return (function (t, e, i) {
			return Zr(Math.min.apply(null, t), Math.min.apply(null, e), Math.max.apply(null, t), Math.max.apply(null, e), i);
		})(s, o, i);
	}
	function xs(t, e) {
		const i = e.getExtent(),
	...
	function vs(t, e, i) {
		if (e.canWrapX()) {
			...
			xs(t, e);
			const r = ps(n);
			if (ps(t) > r && !i) return [[n[0], t[1], n[2], t[3]]];
			if (t[0] < n[0])
				return [
					[t[0] + r, t[1], n[2], t[3]],
					[n[0], t[1], t[2], t[3]],
	...
	function Ms(t, e, i) {
		const n = e.getExtent();
		let r = 0;
		return e.canWrapX() && (t[0] < n[0] || t[0] > n[2]) && ((i = i || ps(n)), (r = Math.floor((t[0] - n[0]) / i))), r;
	}
	function Is(t) {
		return Math.pow(t, 3);
	}
	...
	function zs(t, e) {
		let i = 0;
		for (let n = 0, r = t.length; n < r - 1; ++n) i += Os(t[n], t[n + 1], e);
		return i;
	}
	function Ns(t, e) {
		let i = 0;
		...
		for (let e = 0; e < n; e++) {
			const n = t[e][0],
				o = t[e][1];
			(i += Sr(n - r) * (2 + Math.sin(Sr(s)) + Math.sin(Sr(o)))), (r = n), (s = o);
		}
		return (i * e * e) / 2;
	}
	var Gs = Object.freeze({
		...
		getArea: function t(e, i) {
			...
			switch (s) {
				...
				case 'LinearRing':
					break;
				case 'Polygon':
					for (o = e.getCoordinates(), d = Math.abs(Ns(o[0], n)), l = 1, h = o.length; l < h; ++l) d -= Math.abs(Ns(o[l], n));
					break;
				case 'MultiPolygon':
					for (o = e.getCoordinates(), l = 0, h = o.length; l < h; ++l) for (a = o[l], d += Math.abs(Ns(a[0], n)), c = 1, u = a.length; c < u; ++c) d -= Math.abs(Ns(a[c], n));
					break;
		...
		getLength: function t(e, i) {
			...
			switch (s) {
				...
				case 'LineString':
				case 'LinearRing':
					(o = e.getCoordinates()), (d = zs(o, n));
					break;
				case 'MultiLineString':
				case 'Polygon':
					for (o = e.getCoordinates(), l = 0, h = o.length; l < h; ++l) d += zs(o[l], n);
					break;
				case 'MultiPolygon':
					for (o = e.getCoordinates(), l = 0, h = o.length; l < h; ++l) for (a = o[l], c = 0, u = a.length; c < u; ++c) d += zs(a[c], n);
					break;
				case 'GeometryCollection': {
					const n = e.getGeometries();
					for (l = 0, h = n.length; l < h; ++l) d += t(n[l], i);
		...
		offset: function (t, e, i, n) {
			...
			return [br(s + Math.atan2(Math.sin(i) * Math.sin(o) * Math.cos(r), Math.cos(o) - Math.sin(r) * Math.sin(a))), br(a)];
		},
	});
	function js(...t) {
		console.warn(...t);
	}
	const $s = { radians: 6370997 / (2 * Math.PI), degrees: (2 * Math.PI * 6370997) / 360, ft: 0.3048, m: 1, 'us-ft': 1200 / 3937 };
	class Bs {
		constructor(t) {
		...
		getMetersPerUnit() {
			return this.metersPerUnit_ || $s[this.units_];
		}
		getWorldExtent() {
	...
	const Us = 6378137,
		...
		Ws = [-Vs, -Vs, Vs, Vs],
		Xs = [-180, -85, 180, 85],
		qs = Us * Math.log(Math.tan(Math.PI / 2));
	class Zs extends Bs {
		constructor(t) {
			super({
				code: t,
				...
				getPointResolution: function (t, e) {
					return t / Math.cosh(e[1] / Us);
				},
			});
		}
	}
	const Ks = [new Zs('EPSG:3857'), new Zs('EPSG:102100'), new Zs('EPSG:102113'), new Zs('EPSG:900913'), new Zs('http://www.opengis.net/def/crs/EPSG/0/3857'), new Zs('http://www.opengis.net/gml/srs/epsg.xml#3857')];
	function Ys(t, e, i, n) {
		const r = t.length;
		(i = i > 1 ? i : 2), (n = n ?? i), void 0 === e && (e = i > 2 ? t.slice() : new Array(r));
		for (let i = 0; i < r; i += n) {
			e[i] = (Vs * t[i]) / 180;
			let n = Us * Math.log(Math.tan((Math.PI * (+t[i + 1] + 90)) / 360));
			n > qs ? (n = qs) : n < -qs && (n = -qs), (e[i + 1] = n);
		}
		return e;
	}
	function Hs(t, e, i, n) {
		const r = t.length;
		(i = i > 1 ? i : 2), (n = n ?? i), void 0 === e && (e = i > 2 ? t.slice() : new Array(r));
		for (let i = 0; i < r; i += n) (e[i] = (180 * t[i]) / Vs), (e[i + 1] = (360 * Math.atan(Math.exp(t[i + 1] / Us))) / Math.PI - 90);
		return e;
	}
	const Js = [-180, -90, 180, 90],
		Qs = (6378137 * Math.PI) / 180;
	class to extends Bs {
		constructor(t, e) {
			super({ code: t, units: 'degrees', extent: Js, axisOrientation: e, global: !0, metersPerUnit: Qs, worldExtent: Js });
		}
	}
	const eo = [new to('CRS:84'), new to('EPSG:4326', 'neu'), new to('urn:ogc:def:crs:OGC:1.3:CRS84'), new to('urn:ogc:def:crs:OGC:2:84'), new to('http://www.opengis.net/def/crs/OGC/1.3/CRS84'), new to('http://www.opengis.net/gml/srs/epsg.xml#4326', 'neu'), new to('http://www.opengis.net/def/crs/EPSG/0/4326', 'neu')];
	let io = {};
	let no = {};
	function ro(t, e, i) {
		const n = t.getCode(),
			r = e.getCode();
		n in no || (no[n] = {}), (no[n][r] = i);
	}
	function so(t, e) {
		return t in no && e in no[t] ? no[t][e] : null;
	}
	const oo = 0.9996,
		ao = 0.00669438,
		lo = ao * ao,
		...
		mo = po * go,
		_o = mo * go,
		yo = 0.9983242984503243,
		xo = (15 * lo) / 256 + (45 * ho) / 1024,
		vo = (35 * ho) / 3072,
		wo = 1.5 * go - (27 / 32) * po + (269 / 512) * _o,
		bo = (21 / 16) * fo - (55 / 32) * mo,
		So = (151 / 96) * po - (417 / 128) * _o,
		Co = (1097 / 512) * mo,
		Eo = 6378137;
	function To(t, e, i) {
		const n = t - 5e5,
			r = (i.north ? e : e - 1e7) / oo / (Eo * yo),
			s = r + wo * Math.sin(2 * r) + bo * Math.sin(4 * r) + So * Math.sin(6 * r) + Co * Math.sin(8 * r),
			o = Math.sin(s),
			a = o * o,
			l = Math.cos(s),
			h = o / l,
			...
			x = y * m,
			v = x * m,
			w = s - (h / ((1 - ao) / d)) * (_ / 2 - (x / 24) * (5 + 3 * c + 10 * f - 4 * p - 9 * co)) + ((v * m) / 720) * (61 + 90 * c + 298 * f + 45 * u - 252 * co - 3 * p);
		let b = (m - (y / 6) * (1 + 2 * c + f) + (v / 120) * (5 - 2 * f + 28 * c - 3 * p + 8 * co + 24 * u)) / l;
		return (b = Mr(b + Sr(Ro(i.number)), -Math.PI, Math.PI)), [br(b), br(w)];
	}
	function Po(t, e, i) {
		(t = Mr(t, -180, 180)), e < -80 ? (e = -80) : e > 84 && (e = 84);
		const n = Sr(e),
			r = Math.sin(n),
			s = Math.cos(n),
			o = r / s,
			...
			h = Sr(t),
			c = Sr(Ro(i.number)),
			u = Eo / Math.sqrt(1 - ao * r ** 2),
			d = co * s ** 2,
			g = s * Mr(h - c, -Math.PI, Math.PI),
			f = g * g,
			p = f * g,
			m = p * g,
			_ = m * g,
			y = _ * g,
			x = Eo * (yo * n - 0.002514607064228144 * Math.sin(2 * n) + xo * Math.sin(4 * n) - vo * Math.sin(6 * n)),
			v = oo * u * (g + (p / 6) * (1 - a + d) + (_ / 120) * (5 - 18 * a + l + 72 * d - 58 * co)) + 5e5;
		let w = oo * (x + u * o * (f / 2 + (m / 24) * (5 - a + 9 * d + 4 * d ** 2) + (y / 720) * (61 - 58 * a + l + 600 * d - 330 * co)));
		return i.north || (w += 1e7), [v, w];
	}
	function Ro(t) {
		return 6 * (t - 1) - 180 + 3;
	}
	const Fo = [/^EPSG:(\d+)$/, /^urn:ogc:def:crs:EPSG::(\d+)$/, /^http:\/\/www\.opengis\.net\/def\/crs\/EPSG\/0\/(\d+)$/];
	function Mo(t) {
		let e = 0;
		for (const i of Fo) {
			const n = t.match(i);
		...
		let i = 0,
			n = !1;
		return e > 32700 && e < 32761 ? (i = e - 32700) : e > 32600 && e < 32661 && ((n = !0), (i = e - 32600)), i ? { number: i, north: n } : null;
	}
	function Io(t, e) {
		return function (i, n, r, s) {
			const o = i.length;
			(r = r > 1 ? r : 2), (s = s ?? r), n || (n = r > 2 ? i.slice() : new Array(o));
			for (let r = 0; r < o; r += s) {
				const s = i[r],
					o = i[r + 1],
					a = t(s, o, e);
	...
	const ko = [
			function (t) {
				const e = Mo(t.getCode());
				return e ? { forward: Io(Po, e), inverse: Io(To, e) } : null;
			},
		],
		Lo = [
			function (t) {
				return Mo(t) ? new Bs({ code: t, units: 'm' }) : null;
			},
		];
	let Ao = !0;
	function Do(t) {
	...
	function Go(t) {
		...
		const e = io[(i = t)] || io[i.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, 'EPSG:$3')] || null;
		var i;
		if (e) return e;
		for (const e of Lo) {
			const i = e(t);
	...
	function jo(t, e, i, n) {
		let r;
		const s = (t = Go(t)).getPointResolutionFunc();
		if (s) {
			...
			if (('degrees' == s && !n) || 'degrees' == n) r = e;
				...
				const o = qo(t, Go('EPSG:4326'));
				if (o || 'degrees' === s) {
					let t = [i[0] - e / 2, i[1], i[0] + e / 2, i[1], i[0], i[1] - e / 2, i[0], i[1] + e / 2];
					t = o(t, t, 2);
					r = (Os(t.slice(0, 2), t.slice(2, 4)) + Os(t.slice(4, 6), t.slice(6, 8))) / 2;
				} else r = e * t.getMetersPerUnit();
				const a = n ? $s[n] : t.getMetersPerUnit();
				void 0 !== a && (r /= a);
			}
		}
		return r;
	...
	function Uo(t, e) {
		return t ? ('string' == typeof t ? Go(t) : t) : Go(e);
	}
	function Vo(t) {
		return function (e, i, n, r) {
			const s = e.length;
			(n = void 0 !== n ? n : 2), (r = r ?? n), (i = void 0 !== i ? i : new Array(s));
			for (let o = 0; o < s; o += r) {
				const s = t(e.slice(o, o + n)),
					a = s.length;
				for (let t = 0, n = r; t < n; ++t) i[o + t] = t >= a ? e[o + t] : s[t];
			}
			return i;
		};
	}
	function Wo(t, e) {
		return Do(), Yo(t, 'EPSG:4326', void 0 !== e ? e : 'EPSG:3857');
	}
	function Xo(t, e) {
		if (t === e) return !0;
	...
	function qo(t, e) {
		...
		let s = null,
			o = null;
		for (const i of ko) s || (s = i(t)), o || (o = i(e));
		if (!s && !o) return null;
		const a = 'EPSG:4326';
		if (o)
			if (s) r = Zo(s.inverse, o.forward);
			else {
				const t = so(i, a);
				t && (r = Zo(t, o.forward));
			}
		...
		return r && (zo(t), zo(e), ro(t, e, r)), r;
	}
	function Zo(t, e) {
		return function (i, n, r, s) {
			return (n = t(i, n, r, s)), e(n, n, r, s);
		};
	}
	function Ko(t, e) {
		return qo(Go(t), Go(e));
	...
	function Yo(t, e, i) {
		const n = Ko(e, i);
		if (!n) {
			const t = Go(e).getCode(),
				n = Go(i).getCode();
			throw new Error(`No transform available between ${t} and ${n}`);
		}
		return n(t, void 0, t.length);
	}
	function Ho(t, e, i, n) {
		return ys(t, Ko(e, i), void 0, n);
	}
	let Jo = null;
	function Qo(t) {
		Jo = Go(t);
	...
	function ea(t, e) {
		return Jo ? Yo(t, e, Jo) : t;
	}
	function ia(t, e) {
		return Jo ? Yo(t, Jo, e) : (Ao && !Cs(t, [0, 0]) && t[0] >= -180 && t[0] <= 180 && t[1] >= -90 && t[1] <= 90 && ((Ao = !1), js('Call useGeographic() from ol/proj once to work with [longitude, latitude] coordinates.')), t);
	}
	function na(t, e) {
		return Jo ? Ho(t, e, Jo) : t;
	}
	function ra(t, e) {
		return Jo ? Ho(t, Jo, e) : t;
	}
	function sa(t, e) {
		if (!Jo) return t;
		const i = Go(e).getMetersPerUnit(),
			n = Jo.getMetersPerUnit();
		return i && n ? (t * i) / n : t;
	}
	function oa() {
		$o(Ks), $o(eo), Bo(eo, Ks, Ys, Hs);
	}
	oa();
	var aa = Object.freeze({
		...
		addCoordinateTransforms: function (t, e, i, n) {
			const r = Go(t),
				s = Go(e);
			ro(r, s, Vo(i)), ro(s, r, Vo(n));
		},
		addEquivalentProjections: $o,
		addEquivalentTransforms: Bo,
		addProjection: zo,
		addProjections: No,
		...
		createSafeCoordinateTransform: function (t, e, i) {
			return function (n) {
				...
				if (t.canWrapX()) {
					const e = t.getExtent(),
						o = ps(e);
					(s = Ms((n = n.slice(0)), t, o)), s && (n[0] = n[0] - s * o), (n[0] = xr(n[0], e[0], e[2])), (n[1] = xr(n[1], e[1], e[3])), (r = i(n));
				} else r = i(n);
				return s && e.canWrapX() && (r[0] += s * ps(e.getExtent())), r;
			};
		},
		createTransformFromCoordinateTransform: Vo,
		disableCoordinateWarning: Do,
		equivalent: Xo,
		fromLonLat: Wo,
		fromUserCoordinate: ia,
		fromUserExtent: ra,
		...
		get: Go,
		getPointResolution: jo,
		getTransform: Ko,
		getTransformFromProjections: qo,
		getUserProjection: ta,
		...
		setUserProjection: Qo,
		toLonLat: function (t, e) {
			const i = Yo(t, void 0 !== e ? e : 'EPSG:3857', 'EPSG:4326'),
				n = i[0];
			return (n < -180 || n > 180) && (i[0] = Cr(n + 180, 360) - 180), i;
		},
		toUserCoordinate: ea,
		toUserExtent: na,
		toUserResolution: sa,
	...
	const la = new Array(6);
	function ha(t) {
		return ua(t, 1, 0, 0, 1, 0, 0);
	}
	function ca(t, e) {
		const i = t[0],
			n = t[1],
	...
	function fa(t, e, i) {
		return ca(t, ua(la, e, 0, 0, i, 0, 0));
	}
	function pa(t, e, i) {
		return ca(t, ua(la, 1, 0, 0, 1, e, i));
	}
	function ma(t, e, i, n, r, s, o, a) {
		const l = Math.sin(s),
			h = Math.cos(s);
	...
	function _a(t, e) {
		...
		var n;
		dr(0 !== i, 'Transformation matrix cannot be inverted');
		const r = e[0],
			s = e[1],
			o = e[2],
			a = e[3],
	...
	const ya = [1e5, 1e5, 1e5, 1e5, 2, 2];
	function xa(t) {
		return t
			.substring(7, t.length - 1)
			.split(',')
			.map(parseFloat);
	}
	function va(t, e, i, n, r, s, o) {
		(s = s || []), (o = o || 2);
		let a = 0;
		for (let l = e; l < i; l += n) {
			const e = t[l],
				i = t[l + 1];
			(s[a++] = r[0] * e + r[2] * i + r[4]), (s[a++] = r[1] * e + r[3] * i + r[5]);
			for (let e = 2; e < o; e++) s[a++] = t[l + e];
		}
		return s && s.length != a && (s.length = a), s;
	}
	function wa(t, e, i, n, r, s, o) {
		o = o || [];
		const a = Math.cos(r),
			l = Math.sin(r),
			h = s[0],
	...
	class Ca extends Ln {
		constructor() {
			super(),
				...
				(this.simplifyTransformedInternal = _n((t, e, i) => {
		...
		containsXY(t, e) {
			return 0 === this.closestPointXY(t, e, Sa, Number.MIN_VALUE);
		}
		getClosestPoint(t, e) {
		...
		getExtent(t) {
			if (this.extentRevision_ != this.getRevision()) {
				...
				(isNaN(t[0]) || isNaN(t[1])) && Kr(t), (this.extentRevision_ = this.getRevision());
			}
			return (function (t, e) {
					...
					'tile-pixels' == i.getUnits()
						? function (t, n, r) {
								const s = i.getExtent(),
									o = i.getWorldExtent(),
									a = us(o) / us(s);
								ma(ba, o[0], o[3], a, -a, 0, 0, 0);
								const l = va(t, 0, t.length, r, ba, n),
									h = Ko(i, e);
								return h ? h(l, l, r) : l;
						  }
						: Ko(i, e);
	...
	class Ea extends Ca {
		...
		computeExtent(t) {
			return Hr(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t);
		}
		getCoordinates() {
			return Fn();
		}
		...
		setFlatCoordinates(t, e) {
			(this.stride = Pa(t)), (this.layout = t), (this.flatCoordinates = e);
		}
		setCoordinates(t, e) {
			Fn();
		}
		...
		rotate(t, e) {
			...
			if (i) {
				...
				wa(i, 0, i.length, n, t, e, i), this.changed();
			}
		}
		scale(t, e, i) {
			void 0 === e && (e = t), i || (i = as(this.getExtent()));
	...
	function Ma(t, e, i, n, r, s, o) {
		...
		if (0 === h && 0 === c) u = e;
			...
			if (d > 1) u = i;
				...
				if (d > 0) {
					for (let r = 0; r < n; ++r) o[r] = Er(t[e + r], t[i + r], d);
	...
	function La(t, e, i, n, r, s, o, a, l, h, c) {
		if (e == i) return h;
		let u, d;
		if (0 === r) {
			if (((d = wr(o, a, t[e], t[e + 1])), d < h)) {
		...
		let g = e + n;
		for (; g < i; )
			if ((Ma(t, g - n, g, n, o, a, c), (d = wr(o, a, c[0], c[1])), d < h)) {
				for (h = d, u = 0; u < n; ++u) l[u] = c[u];
				(l.length = n), (g += n);
			} else g += n * Math.max(((Math.sqrt(d) - Math.sqrt(h)) / r) | 0, 1);
		if (s && (Ma(t, i - n, e, n, o, a, c), (d = wr(o, a, c[0], c[1])), d < h)) {
			for (h = d, u = 0; u < n; ++u) l[u] = c[u];
			l.length = n;
		}
		return h;
	}
	function Aa(t, e, i, n, r, s, o, a, l, h, c) {
		c = c || [NaN, NaN];
		for (let u = 0, d = i.length; u < d; ++u) {
			const d = i[u];
			(h = La(t, e, d, n, r, s, o, a, l, h, c)), (e = d);
		}
		return h;
	}
	function Da(t, e, i, n) {
	...
	function $a(t, e, i, n, r) {
		...
		for (let o = 0, a = i.length; o < a; ++o) {
			const a = i[o];
			(r[s++] = 1 === a.length && a[0] === e ? [] : ja(t, e, a, n, r[s])), (e = a[a.length - 1]);
		}
		return (r.length = s), r;
	}
	function Ba(t, e, i, n, r, s, o) {
		const a = (i - e) / n;
		if (a < 3) {
	...
	function Ua(t, e, i, n, r, s, o, a) {
		for (let l = 0, h = i.length; l < h; ++l) {
			const h = i[l];
			(o = Ba(t, e, h, n, r, s, o)), a.push(o), (e = h);
		}
		return o;
	}
	function Va(t, e) {
	...
	function Wa(t, e, i, n, r, s, o) {
		...
		(e += n), (s[o++] = h), (s[o++] = c);
		do {
			if (((a = Va(t[e], r)), (l = Va(t[e + 1], r)), (e += n) == i)) return (s[o++] = a), (s[o++] = l), o;
		} while (a == h && l == c);
		for (; e < i; ) {
			const i = Va(t[e], r),
				u = Va(t[e + 1], r);
	...
	function Xa(t, e, i, n, r, s, o, a) {
		for (let l = 0, h = i.length; l < h; ++l) {
			const h = i[l];
			(o = Wa(t, e, h, n, r, s, o)), a.push(o), (e = h);
		}
		return o;
	}
	class qa extends Ea {
		...
		closestPointXY(t, e, i, n) {
			return n < Br(this.getExtent(), t, e) ? n : (this.maxDeltaRevision_ != this.getRevision() && ((this.maxDelta_ = Math.sqrt(Ia(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, 0))), (this.maxDeltaRevision_ = this.getRevision())), La(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !0, t, e, i, n));
		}
		getArea() {
			return Ra(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride);
		}
		getCoordinates() {
			return Ga(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride);
		}
		getSimplifiedGeometryInternal(t) {
			const e = [];
			return (e.length = Ba(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e, 0)), new qa(e, 'XY');
		}
		getType() {
			return 'LinearRing';
		}
	...
	class Za extends Ea {
		...
		clone() {
			const t = new Za(this.flatCoordinates.slice(), this.layout);
		...
		computeExtent(t) {
			return Yr(this.flatCoordinates, t);
		}
		getType() {
			return 'Point';
		}
		intersectsExtent(t) {
			return Wr(t, this.flatCoordinates[0], this.flatCoordinates[1]);
		}
		setCoordinates(t, e) {
			this.setLayout(e, t, 0), this.flatCoordinates || (this.flatCoordinates = []), (this.flatCoordinates.length = Da(this.flatCoordinates, 0, t, this.stride)), this.changed();
		}
	}
	function Ka(t, e, i, n, r) {
		return !ns(r, function (r) {
			return !Ya(t, e, i, n, r[0], r[1]);
		});
	}
	...
	function Ha(t, e, i, n, r, s) {
		...
		if (!Ya(t, e, i[0], n, r, s)) return !1;
		for (let e = 1, o = i.length; e < o; ++e) if (Ya(t, i[e - 1], i[e], n, r, s)) return !1;
		return !0;
	}
	function Ja(t, e, i, n, r, s, o) {
		let a, l, h, c, u, d, g;
		const f = r[s + 1],
			p = [];
		for (let r = 0, s = i.length; r < s; ++r) {
			const s = i[r];
			for (c = t[s - n], d = t[s - n + 1], a = e; a < s; a += n) (u = t[a]), (g = t[a + 1]), ((f <= d && g <= f) || (d <= f && f <= g)) && ((h = ((f - d) / (g - d)) * (u - c) + c), p.push(h)), (c = u), (d = g);
		}
		let m = NaN,
			_ = -1 / 0;
		for (p.sort(ln), c = p[0], a = 1, l = p.length; a < l; ++a) {
			u = p[a];
			const r = Math.abs(u - c);
			r > _ && ((h = (c + u) / 2), Ha(t, e, i, n, h, f) && ((m = h), (_ = r))), (c = u);
		}
	...
	function Qa(t, e, i, n, r) {
		...
		for (let o = 0, a = i.length; o < a; ++o) {
			const a = i[o];
			(s = Ja(t, e, a, n, r, 2 * o, s)), (e = a[a.length - 1]);
		}
		return s;
	}
	...
	function el(t, e) {
		const [i, n] = t,
			[r, s] = e,
			o = ((i[0] - r[0]) * (r[1] - s[1]) - (i[1] - r[1]) * (r[0] - s[0])) / ((i[0] - n[0]) * (r[1] - s[1]) - (i[1] - n[1]) * (r[0] - s[0])),
			a = ((i[0] - r[0]) * (i[1] - n[1]) - (i[1] - r[1]) * (i[0] - n[0])) / ((i[0] - n[0]) * (r[1] - s[1]) - (i[1] - n[1]) * (r[0] - s[0]));
		if (0 <= o && o <= 1 && 0 <= a && a <= 1) return [i[0] + o * (n[0] - i[0]), i[1] + o * (n[1] - i[1])];
	}
	function il(t, e, i, n, r, s) {
		return (
			(s = s ?? es([1 / 0, 1 / 0, -1 / 0, -1 / 0], t, e, i, n)),
			!!ms(r, s) &&
				((s[0] >= r[0] && s[2] <= r[2]) ||
					(s[1] >= r[1] && s[3] <= r[3]) ||
					tl(t, e, i, n, function (t, e) {
						return (function (t, e, i) {
							let n = !1;
							const r = Xr(t, e),
								s = Xr(t, i);
							if (r === Ar || s === Ar) n = !0;
								...
								const o = t[0],
									...
									f = (g - u) / (d - c);
								let p, m;
								s & Dr && !(r & Dr) && ((p = d - (g - h) / f), (n = p >= o && p <= l)), n || !(s & Or) || r & Or || ((m = g - (d - l) * f), (n = m >= a && m <= h)), n || !(s & zr) || r & zr || ((p = d - (g - a) / f), (n = p >= o && p <= l)), n || !(s & Nr) || r & Nr || ((m = g - (d - o) * f), (n = m >= a && m <= h));
							}
							return n;
						})(r, t, e);
					}))
	...
	function nl(t, e, i, n, r) {
		return !!il(t, e, i, n, r) || !!Ya(t, e, i, n, r[0], r[1]) || !!Ya(t, e, i, n, r[0], r[3]) || !!Ya(t, e, i, n, r[2], r[1]) || !!Ya(t, e, i, n, r[2], r[3]);
	}
	function rl(t, e, i, n, r) {
		if (!nl(t, e, i[0], n, r)) return !1;
		if (1 === i.length) return !0;
		for (let e = 1, s = i.length; e < s; ++e) if (Ka(t, i[e - 1], i[e], n, r) && !il(t, i[e - 1], i[e], n, r)) return !1;
		return !0;
	}
	function sl(t, e, i, n) {
		for (; e < i - n; ) {
	...
	function hl(t, e, i, n, r) {
		...
		for (let s = 0, o = i.length; s < o; ++s) {
			const o = i[s],
				a = ol(t, e, o, n);
			(0 === s ? (r && a) || (!r && !a) : (r && !a) || (!r && a)) && sl(t, e, o, n), (e = o);
		}
		return e;
	}
	function cl(t, e, i, n, r) {
		for (let s = 0, o = i.length; s < o; ++s) e = hl(t, e, i[s], n, r);
		return e;
	}
	function ul(t, e) {
		const i = [];
	...
	class dl extends Ea {
		...
		appendLinearRing(t) {
			this.flatCoordinates ? dn(this.flatCoordinates, t.getFlatCoordinates()) : (this.flatCoordinates = t.getFlatCoordinates().slice()), this.ends_.push(this.flatCoordinates.length), this.changed();
		}
		clone() {
			const t = new dl(this.flatCoordinates.slice(), this.layout, this.ends_.slice());
			return t.applyProperties(this), t;
		}
		closestPointXY(t, e, i, n) {
			return n < Br(this.getExtent(), t, e) ? n : (this.maxDeltaRevision_ != this.getRevision() && ((this.maxDelta_ = Math.sqrt(ka(this.flatCoordinates, 0, this.ends_, this.stride, 0))), (this.maxDeltaRevision_ = this.getRevision())), Aa(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !0, t, e, i, n));
		}
		containsXY(t, e) {
			return Ha(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, t, e);
		}
		getArea() {
			return Fa(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride);
		}
		getCoordinates(t) {
			let e;
			return void 0 !== t ? ((e = this.getOrientedFlatCoordinates().slice()), hl(e, 0, this.ends_, this.stride, t)) : (e = this.flatCoordinates), ja(e, 0, this.ends_, this.stride);
		}
		getEnds() {
			return this.ends_;
		}
		getFlatInteriorPoint() {
			if (this.flatInteriorPointRevision_ != this.getRevision()) {
				const t = as(this.getExtent());
				(this.flatInteriorPoint_ = Ja(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, t, 0)), (this.flatInteriorPointRevision_ = this.getRevision());
			}
			return this.flatInteriorPoint_;
		}
		getInteriorPoint() {
			return new Za(this.getFlatInteriorPoint(), 'XYM');
		}
		getLinearRingCount() {
			return this.ends_.length;
		}
		getLinearRing(t) {
			return t < 0 || this.ends_.length <= t ? null : new qa(this.flatCoordinates.slice(0 === t ? 0 : this.ends_[t - 1], this.ends_[t]), this.layout);
		}
		getLinearRings() {
			const t = this.layout,
		...
		getOrientedFlatCoordinates() {
			if (this.orientedRevision_ != this.getRevision()) {
				...
				al(t, 0, this.ends_, this.stride) ? (this.orientedFlatCoordinates_ = t) : ((this.orientedFlatCoordinates_ = t.slice()), (this.orientedFlatCoordinates_.length = hl(this.orientedFlatCoordinates_, 0, this.ends_, this.stride))), (this.orientedRevision_ = this.getRevision());
			}
		...
		getSimplifiedGeometryInternal(t) {
			const e = [],
				i = [];
			return (e.length = Xa(this.flatCoordinates, 0, this.ends_, this.stride, Math.sqrt(t), e, 0, i)), new dl(e, 'XY', i);
		}
		getType() {
			return 'Polygon';
		}
		intersectsExtent(t) {
			return rl(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, t);
		}
		setCoordinates(t, e) {
			this.setLayout(e, t, 2), this.flatCoordinates || (this.flatCoordinates = []);
			const i = za(this.flatCoordinates, 0, t, this.stride, this.ends_);
			(this.flatCoordinates.length = 0 === i.length ? 0 : i[i.length - 1]), this.changed();
		}
	}
	function gl(t) {
		if (_s(t)) throw new Error('Cannot create polygon from empty extent');
		const e = t[0],
			i = t[1],
			n = t[2],
			r = t[3],
			s = [e, i, e, r, n, r, n, i, e, i];
		return new dl(s, 'XY', [s.length]);
	}
	function fl(t, e, i) {
		e = e || 32;
		const n = t.getStride(),
		...
		return (
			(function (t, e, i) {
				...
				for (let t = 0; t <= s; ++t) {
					const a = t * r,
						l = o + (2 * Cr(t, s) * Math.PI) / s;
					(n[a] = e[0] + i * Math.cos(l)), (n[a + 1] = e[1] + i * Math.sin(l));
				}
				t.changed();
			})(h, s, t.getRadius()),
			h
	...
	function ml(t, e, i) {
		let n = Math.min(t, e);
		return (n *= Math.log(1 + 50 * Math.max(0, t / e - 1)) / 50 + 1), i && ((n = Math.max(n, i)), (n /= Math.log(1 + 50 * Math.max(0, i / t - 1)) / 50 + 1)), xr(n, i / 2, 2 * e);
	}
	function _l(t, e, i, n, r) {
		return (
			...
			function (s, o, a, l) {
				if (void 0 !== s) {
					const o = n ? pl(t, n, a, r) : t;
					return i && l ? ml(s, o, e) : xr(s, e, o);
				}
			}
		);
	}
	...
	class wl extends Ln {
		constructor(t) {
			super(), this.on, this.once, this.un, (t = Object.assign({}, t)), (this.hints_ = [0, 0]), (this.animations_ = []), this.updateAnimationKey_, (this.projection_ = Uo(t.projection, 'EPSG:3857')), (this.viewportSize_ = [100, 100]), (this.targetCenter_ = null), this.targetResolution_, this.targetRotation_, (this.nextCenter_ = null), this.nextResolution_, this.nextRotation_, (this.cancelAnchor_ = void 0), t.projection && Do(), t.center && (t.center = ia(t.center, this.projection_)), t.extent && (t.extent = ra(t.extent, this.projection_)), this.applyOptions_(t);
		}
		applyOptions_(t) {
			const e = Object.assign({}, t);
			for (const t in yr) delete e[t];
			...
			const i = (function (t) {
				...
				if (void 0 !== t.resolutions) {
										...
										function (r, s, o, a) {
											if (void 0 !== r) {
												const l = t[0],
													h = t[t.length - 1],
													c = i ? pl(l, i, o, n) : l;
												if (a) return e ? ml(r, c, h) : xr(r, h, c);
												const u = Math.min(c, r),
													d = Math.floor(cn(t, u, s));
					...
					const h = (g ? Math.max(ps(g), us(g)) : (360 * $s.degrees) / d.getMetersPerUnit()) / vl / Math.pow(s, 0),
						m = h / Math.pow(s, r - 0);
					(i = t.maxResolution),
						void 0 !== i ? (o = 0) : (i = h / Math.pow(l, o)),
						(n = t.minResolution),
						void 0 === n && (n = void 0 !== t.maxZoom ? (void 0 !== t.maxResolution ? i / Math.pow(l, a) : h / Math.pow(l, a)) : m),
						...
						(e = t.constrainResolution
							? (function (t, e, i, n, r, s) {
									return (
										...
										function (o, a, l, h) {
											if (void 0 !== o) {
												const c = r ? pl(e, r, l, s) : e;
												if (h) return n ? ml(o, c, i) : xr(o, i, c);
												const u = 1e-9,
				...
				return { constraint: e, maxResolution: i, minResolution: n, minZoom: o, zoomFactor: l };
			})(t);
			...
			const n = (function (t) {
					if (void 0 !== t.extent) {
						...
						return Ir(t.extent, t.constrainOnlyCenter, e);
					}
					const e = Uo(t.projection, 'EPSG:3857');
					if (!0 !== t.multiWorld && e.isGlobal()) {
						const t = e.getExtent().slice();
						return (t[0] = -1 / 0), (t[2] = 1 / 0), Ir(t, !1, !1);
					}
					return kr;
				})(t),
				r = i.constraint,
					...
					if (e) {
						...
						return void 0 === e || !0 === e
							? (function () {
									const t = Sr(5);
									return function (e, i) {
										return i || void 0 === e ? e : Math.abs(e) <= t ? 0 : e;
									};
							  })()
							: !1 === e
							? xl
		...
		animate(t) {
			...
			for (let t = 0; t < e.length; ++t) {
				let i = arguments[t];
				i.center && ((i = Object.assign({}, i)), (i.center = ia(i.center, this.getProjection()))), i.anchor && ((i = Object.assign({}, i)), (i.anchor = ia(i.anchor, this.getProjection()))), (e[t] = i);
			}
		...
		animateInternal(t) {
			...
			for (; n < i; ++n) {
				const t = arguments[n],
					i = { start: r, complete: !1, anchor: t.anchor, duration: void 0 !== t.duration ? t.duration : 1e3, easing: t.easing || Ls, callback: e };
				if ((t.center && ((i.sourceCenter = s), (i.targetCenter = t.center.slice()), (s = i.targetCenter)), void 0 !== t.zoom ? ((i.sourceResolution = o), (i.targetResolution = this.getResolutionForZoom(t.zoom)), (o = i.targetResolution)) : t.resolution && ((i.sourceResolution = o), (i.targetResolution = t.resolution), (o = i.targetResolution)), void 0 !== t.rotation)) {
					i.sourceRotation = a;
					const e = Cr(t.rotation - a + Math.PI, 2 * Math.PI) - Math.PI;
					(i.targetRotation = a + e), (a = i.targetRotation);
				}
				Sl(i) ? (i.complete = !0) : (r += i.duration), l.push(i);
			}
			this.animations_.push(l), this.setHint(mr, 1), this.updateAnimations_();
		}
		getAnimating() {
			return this.hints_[mr] > 0;
		}
		getInteracting() {
			return this.hints_[_r] > 0;
		}
		cancelAnimations() {
			let t;
			this.setHint(mr, -this.hints_[mr]);
			for (let e = 0, i = this.animations_.length; e < i; ++e) {
				const i = this.animations_[e];
				if ((i[0].callback && bl(i[0].callback, !1), !t))
			...
			for (let i = this.animations_.length - 1; i >= 0; --i) {
				...
				for (let i = 0, s = n.length; i < s; ++i) {
					...
					if (void 0 !== s.sourceRotation && void 0 !== s.targetRotation) {
						const t = 1 === l ? Cr(s.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : s.sourceRotation + l * (s.targetRotation - s.sourceRotation);
						if (s.anchor) {
				...
				if (r) {
					(this.animations_[i] = null), this.setHint(mr, -1), (this.nextCenter_ = null), (this.nextResolution_ = NaN), (this.nextRotation_ = NaN);
		...
		calculateCenterRotate(t, e) {
			...
			var r, s;
			return void 0 !== n && ((i = [n[0] - e[0], n[1] - e[1]]), Es(i, t - this.getRotation()), (s = e), ((r = i)[0] += +s[0]), (r[1] += +s[1])), i;
		}
		...
		getCenter() {
			...
			return t ? ea(t, this.getProjection()) : t;
		}
		getCenterInternal() {
			return this.get(yr.CENTER);
		}
		getConstraints() {
		...
		calculateExtent(t) {
			return na(this.calculateExtentInternal(t), this.getProjection());
		}
		calculateExtentInternal(t) {
			t = t || this.getViewportSizeMinusPadding_();
			const e = this.getCenterInternal();
			dr(e, 'The view center is not defined');
			const i = this.getResolution();
			dr(void 0 !== i, 'The view resolution is not defined');
			const n = this.getRotation();
			return dr(void 0 !== n, 'The view rotation is not defined'), hs(e, i, n, t);
		}
		getMaxResolution() {
		...
		getResolution() {
			return this.get(yr.RESOLUTION);
		}
		getResolutions() {
			return this.resolutions_;
		}
		getResolutionForExtent(t, e) {
			return this.getResolutionForExtentInternal(ra(t, this.getProjection()), e);
		}
		...
		getState() {
			...
			if (r) {
				...
				n = Cl(n, this.getViewportSize_(), [t[0] / 2 + r[3], t[1] / 2 + r[0]], e, i);
			}
		...
		getZoomForResolution(t) {
			...
			if (this.resolutions_) {
				const r = cn(this.resolutions_, t, 1);
		...
		getResolutionForZoom(t) {
			if (this.resolutions_?.length) {
				...
				const e = xr(Math.floor(t), 0, this.resolutions_.length - 2),
					i = this.resolutions_[e] / this.resolutions_[e + 1];
				return this.resolutions_[e] / Math.pow(i, xr(t - e, 0, 1));
			}
			return this.maxResolution_ / Math.pow(this.zoomFactor_, t - this.minZoom_);
		}
		fit(t, e) {
			let i;
			if ((dr(Array.isArray(t) || 'function' == typeof t.getSimplifiedGeometry, 'Invalid extent or geometry provided as `geometry`'), Array.isArray(t))) {
				dr(!_s(t), 'Cannot fit empty extent provided as `geometry`');
				i = gl(ra(t, this.getProjection()));
			} else if ('Circle' === t.getType()) {
				const e = ra(t.getExtent(), this.getProjection());
				(i = gl(e)), i.rotate(this.getRotation(), as(e));
			} else {
				const e = ta();
		...
		fitInternal(t, e) {
			...
			const d = u[0] * c - u[1] * h,
				...
				p = e.callback ? e.callback : mn;
			void 0 !== e.duration ? this.animateInternal({ resolution: a, center: f, duration: e.duration, easing: e.easing }, p) : ((this.targetResolution_ = a), (this.targetCenter_ = f), this.applyTargetState_(!1, !0), bl(p, !0));
		}
		centerOn(t, e, i) {
			this.centerOnInternal(ia(t, this.getProjection()), e, i);
		}
		centerOnInternal(t, e, i) {
			this.setCenterInternal(Cl(t, e, i, this.getResolution(), this.getRotation()));
		}
		calculateCenterShift(t, e, i, n) {
			...
			if (s && t) {
				const o = this.getViewportSizeMinusPadding_(-i),
					a = Cl(t, n, [o[0] / 2 + s[3], o[1] / 2 + s[0]], e, i);
				r = [t[0] - a[0], t[1] - a[1]];
			}
			return r;
		}
		...
		adjustCenter(t) {
			const e = ea(this.targetCenter_, this.getProjection());
		...
		adjustResolution(t, e) {
			(e = e && ia(e, this.getProjection())), this.adjustResolutionInternal(t, e);
		}
		...
		adjustRotation(t, e) {
			e && (e = ia(e, this.getProjection())), this.adjustRotationInternal(t, e);
		}
		...
		setCenter(t) {
			this.setCenterInternal(t ? ia(t, this.getProjection()) : t);
		}
		setCenterInternal(t) {
		...
		applyTargetState_(t, e) {
			...
			this.get(yr.ROTATION) !== n && this.set(yr.ROTATION, n), this.get(yr.RESOLUTION) !== s && (this.set(yr.RESOLUTION, s), this.set('zoom', this.getZoom(), !0)), (o && this.get(yr.CENTER) && Cs(this.get(yr.CENTER), o)) || this.set(yr.CENTER, o), this.getAnimating() && !t && this.cancelAnimations(), (this.cancelAnchor_ = void 0);
		}
		resolveConstraints(t, e, i) {
			...
			(i = i || (0 === t ? this.cancelAnchor_ : void 0)), (this.cancelAnchor_ = void 0), (this.getResolution() === o && this.getRotation() === r && this.getCenterInternal() && Cs(this.getCenterInternal(), a)) || (this.getAnimating() && this.cancelAnimations(), this.animateInternal({ rotation: r, center: a, resolution: o, duration: t, easing: ks, anchor: i }));
		}
		beginInteraction() {
			this.resolveConstraints(0), this.setHint(_r, 1);
		}
		endInteraction(t, e, i) {
			(i = i && ia(i, this.getProjection())), this.endInteractionInternal(t, e, i);
		}
		endInteractionInternal(t, e, i) {
			this.getInteracting() && (this.setHint(_r, -1), this.resolveConstraints(t, e, i));
		}
	...
	function Sl(t) {
		return !(t.sourceCenter && t.targetCenter && !Cs(t.sourceCenter, t.targetCenter)) && t.sourceResolution === t.targetResolution && t.sourceRotation === t.targetRotation;
	}
	function Cl(t, e, i, n, r) {
		const s = Math.cos(-r);
		let o = Math.sin(-r),
	...
	const El = 'ol-hidden',
		...
		Pl = 'ol-control',
		Rl = 'ol-collapsed',
		Fl = new RegExp(['^\\s*(?=(?:(?:[-a-z]+\\s*){0,2}(italic|oblique))?)', '(?=(?:(?:[-a-z]+\\s*){0,2}(small-caps))?)', '(?=(?:(?:[-a-z]+\\s*){0,2}(bold(?:er)?|lighter|[1-9]00 ))?)', '(?:(?:normal|\\1|\\2|\\3)\\s*){0,3}((?:xx?-)?', '(?:small|large)|medium|smaller|larger|[\\.\\d]+(?:\\%|in|[cem]m|ex|p[ctx]))', '(?:\\s*\\/\\s*(normal|[\\.\\d]+(?:\\%|in|[cem]m|ex|p[ctx])?))', '?\\s*([-,\\"\\\'\\sa-z0-9]+?)\\s*$'].join(''), 'i'),
		Ml = ['style', 'variant', 'weight', 'size', 'lineHeight', 'family'],
		Il = { normal: 400, bold: 700 },
		kl = function (t) {
			const e = t.match(Fl);
			if (!e) return null;
			const i = { lineHeight: 'normal', size: '1.2em', style: 'normal', weight: '400', variant: 'normal' };
			for (let t = 0, n = Ml.length; t < n; ++t) {
				const n = e[t + 1];
				void 0 !== n && (i[Ml[t]] = 'string' == typeof n ? n.trim() : n);
			}
			return isNaN(Number(i.weight)) && i.weight in Il && (i.weight = Il[i.weight]), (i.families = i.family.split(/,\s?/).map((t) => t.trim().replace(/^['"]|['"]$/g, ''))), i;
		};
	function Ll(t, e, i, n) {
		let r;
		return (r = i && i.length ? i.shift() : Wn ? new OffscreenCanvas(t || 300, e || 300) : document.createElement('canvas')), t && (r.width = t), e && (r.height = e), r.getContext('2d', n);
	}
	let Al;
	function Dl() {
		return Al || (Al = Ll(1, 1)), Al;
	}
	function Ol(t) {
		const e = t.canvas;
	...
	class $l extends Ln {
		...
		setMap(t) {
			...
			for (let t = 0, e = this.listenerKeys.length; t < e; ++t) En(this.listenerKeys[t]);
			if (((this.listenerKeys.length = 0), (this.map_ = t), t)) {
				const e = this.target_ ?? t.getOverlayContainerStopEvent();
				this.element && e.appendChild(this.element), this.render !== mn && this.listenerKeys.push(Sn(t, Jn, this.render, this)), t.render();
			}
		}
		render(t) {}
		setTarget(t) {
	...
	var Bl = Object.freeze({ __proto__: null, default: $l });
	class Ul extends $l {
		constructor(t) {
			...
			(this.toggleButton_ = document.createElement('button')), this.toggleButton_.setAttribute('type', 'button'), this.toggleButton_.setAttribute('aria-expanded', String(!this.collapsed_)), (this.toggleButton_.title = i), this.toggleButton_.appendChild(a), this.toggleButton_.addEventListener(Yi, this.handleClick_.bind(this), !1);
			const l = e + ' ' + Tl + ' ' + Pl + (this.collapsed_ && this.collapsible_ ? ' ' + Rl : '') + (this.collapsible_ ? '' : ' ol-uncollapsible'),
				h = this.element;
		...
		collectSourceAttributions_(t) {
			const e = this.getMap().getAllLayers(),
				i = new Set(e.flatMap((e) => e.getAttributions(t)));
			if ((void 0 !== this.attributions_ && (Array.isArray(this.attributions_) ? this.attributions_.forEach((t) => i.add(t)) : i.add(this.attributions_)), !this.overrideCollapsible_)) {
		...
		async updateElement_(t) {
			...
			const e = await Promise.all(this.collectSourceAttributions_(t).map((t) => yn(() => t))),
				i = e.length > 0;
			if ((this.renderedVisible_ != i && ((this.element.style.display = i ? '' : 'none'), (this.renderedVisible_ = i)), !gn(e, this.renderedAttributions_))) {
				jl(this.ulElement_);
		...
		handleToggle_() {
			this.element.classList.toggle(Rl), this.collapsed_ ? Gl(this.collapseLabel_, this.label_) : Gl(this.label_, this.collapseLabel_), (this.collapsed_ = !this.collapsed_), this.toggleButton_.setAttribute('aria-expanded', String(!this.collapsed_));
		}
		getCollapsible() {
	...
	class Vl extends $l {
		constructor(t) {
			...
			(s.className = e + '-reset'), s.setAttribute('type', 'button'), (s.title = r), s.appendChild(this.label_), s.addEventListener(Yi, this.handleClick_.bind(this), !1);
			const o = e + ' ' + Tl + ' ' + Pl,
				a = this.element;
			(a.className = o), a.appendChild(s), (this.callResetNorth_ = t.resetNorth ? t.resetNorth : void 0), (this.duration_ = void 0 !== t.duration ? t.duration : 250), (this.autoHide_ = void 0 === t.autoHide || t.autoHide), (this.rotation_ = void 0), this.autoHide_ && this.element.classList.add(El);
		}
		handleClick_(t) {
		...
		resetNorth_() {
			...
			void 0 !== e && (this.duration_ > 0 && e % (2 * Math.PI) != 0 ? t.animate({ rotation: 0, duration: this.duration_, easing: ks }) : t.setRotation(0));
		}
		render(t) {
			...
			if (i != this.rotation_) {
				...
				if (this.autoHide_) {
					const t = this.element.classList.contains(El);
					t || 0 !== i ? t && 0 !== i && this.element.classList.remove(El) : this.element.classList.add(El);
				}
	...
	class Wl extends $l {
		constructor(t) {
			...
			(h.className = n), h.setAttribute('type', 'button'), (h.title = a), h.appendChild('string' == typeof s ? document.createTextNode(s) : s), h.addEventListener(Yi, this.handleClick_.bind(this, i), !1);
			const c = document.createElement('button');
			(c.className = r), c.setAttribute('type', 'button'), (c.title = l), c.appendChild('string' == typeof o ? document.createTextNode(o) : o), c.addEventListener(Yi, this.handleClick_.bind(this, -i), !1);
			const u = e + ' ' + Tl + ' ' + Pl,
				d = this.element;
		...
		zoomByDelta_(t) {
			...
			if (void 0 !== i) {
				...
				this.duration_ > 0 ? (e.getAnimating() && e.cancelAnimations(), e.animate({ zoom: n, duration: this.duration_, easing: ks })) : e.setZoom(n);
			}
		}
	}
	class Xl {
	...
	function Kl(t, e, i, n) {
		...
		t.getAnimating() && t.cancelAnimations(), t.animate({ resolution: o, anchor: i, duration: void 0 !== n ? n : 250, easing: ks });
	}
	class Yl extends Zl {
		constructor(t) {
		...
		handleEvent(t) {
			let e = !1;
			if (t.type == Gn.DBLCLICK) {
				const i = t.originalEvent,
					n = t.map,
					r = t.coordinate,
					s = i.shiftKey ? -this.delta_ : this.delta_;
				Kl(n.getView(), s, r, this.duration_), i.preventDefault(), (e = !0);
			}
			return !e;
		}
	}
	...
	const Jl = function (t) {
		...
		Ql = function (t) {
			const e = t.map.getTargetElement(),
				i = e.getRootNode();
			return (
				!(i instanceof ShadowRoot ? i.host : e).hasAttribute('tabindex') ||
				(function (t) {
					const e = t.map.getTargetElement(),
						i = e.getRootNode(),
						n = t.map.getOwnerDocument().activeElement;
					return i instanceof ShadowRoot ? i.host.contains(n) : e.contains(n);
				})(t)
			);
		},
		th = fn,
		eh = function (t) {
			const e = t.originalEvent;
			return 'pointerId' in e && 0 == e.button && !(Bn && Un && e.ctrlKey);
		},
		ih = pn,
		nh = function (t) {
			return t.type == Gn.SINGLECLICK;
		},
		rh = function (t) {
			const e = t.originalEvent;
			return !e.altKey && !(e.metaKey || e.ctrlKey) && !e.shiftKey;
		...
		ah = function (t) {
			const e = t.originalEvent;
			return 'pointerId' in e && 'mouse' == e.pointerType;
		},
		lh = function (t) {
			const e = t.originalEvent;
			return 'pointerId' in e && e.isPrimary && 0 === e.button;
		};
	class hh extends Zl {
		constructor(t) {
		...
		handleEvent(t) {
			...
			if ((this.updateTrackedPointers_(t), this.handlingDownUpSequence)) {
				if (t.type == Gn.POINTERDRAG) this.handleDragEvent(t), t.originalEvent.preventDefault();
				else if (t.type == Gn.POINTERUP) {
					const e = this.handleUpEvent(t);
					this.handlingDownUpSequence = e && this.targetPointers.length > 0;
				}
			} else if (t.type == Gn.POINTERDOWN) {
				const i = this.handleDownEvent(t);
				(this.handlingDownUpSequence = i), (e = this.stopDown(i));
			} else t.type == Gn.POINTERMOVE && this.handleMoveEvent(t);
			return !e;
		}
		handleMoveEvent(t) {}
		handleUpEvent(t) {
	...
	class uh extends hh {
		constructor(t) {
			super({ stopDown: pn }), (t = t || {}), (this.kinetic_ = t.kinetic), (this.lastCentroid = null), this.lastPointersCount_, (this.panning_ = !1);
			const e = t.condition ? t.condition : Hl(rh, lh);
			(this.condition_ = t.onFocusOnly ? Hl(Ql, e) : e), (this.noKinetic_ = !1);
		}
		handleDragEvent(t) {
			const e = t.map;
			this.panning_ || ((this.panning_ = !0), e.getView().beginInteraction());
			const i = this.targetPointers,
				n = e.getEventPixel(ch(i));
		...
		handleUpEvent(t) {
			...
			if (0 === this.targetPointers.length) {
				if (!this.noKinetic_ && this.kinetic_ && this.kinetic_.end()) {
					...
					i.animateInternal({ center: i.getConstrainedCenter(o), duration: 500, easing: ks });
				}
	...
	class dh extends hh {
		constructor(t) {
			(t = t || {}), super({ stopDown: pn }), (this.condition_ = t.condition ? t.condition : Jl), (this.lastAngle_ = void 0), (this.duration_ = void 0 !== t.duration ? t.duration : 250);
		}
		handleDragEvent(t) {
			if (!ah(t)) return;
			const e = t.map,
				i = e.getView();
			if (i.getConstraints().rotation === yl) return;
			const n = e.getSize(),
				r = t.pixel,
	...
	class gh extends an {
		...
		createOrUpdateGeometry() {
			...
			(i[4] = i[0].slice()), this.geometry_ ? this.geometry_.setCoordinates([i]) : (this.geometry_ = new dl([i]));
		}
		getGeometry() {
	...
	class xh extends hh {
		constructor(t) {
			super(), this.on, this.once, this.un, (t = t ?? {}), (this.box_ = new gh(t.className || 'ol-dragbox')), (this.minArea_ = t.minArea ?? 64), t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), (this.startPixel_ = null), (this.condition_ = t.condition ?? eh), (this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition);
		}
		...
		handleDragEvent(t) {
			this.startPixel_ && (this.box_.setPixels(this.startPixel_, t.pixel), this.dispatchEvent(new yh(ph, t.coordinate, t)));
		}
		handleUpEvent(t) {
			if (!this.startPixel_) return !1;
			const e = this.boxEndCondition_(t, this.startPixel_, t.pixel);
			return e && this.onBoxEnd(t), this.dispatchEvent(new yh(e ? mh : _h, t.coordinate, t)), this.box_.setMap(null), (this.startPixel_ = null), !1;
		}
		handleDownEvent(t) {
			return !!this.condition_(t) && ((this.startPixel_ = t.pixel), this.box_.setMap(t.map), this.box_.setPixels(this.startPixel_, this.startPixel_), this.dispatchEvent(new yh(fh, t.coordinate, t)), !0);
		}
		onBoxEnd(t) {}
		setActive(t) {
			t || (this.box_.setMap(null), this.startPixel_ && (this.dispatchEvent(new yh(_h, this.startPixel_, null)), (this.startPixel_ = null))), super.setActive(t);
		}
		setMap(t) {
			this.getMap() && (this.box_.setMap(null), this.startPixel_ && (this.dispatchEvent(new yh(_h, this.startPixel_, null)), (this.startPixel_ = null))), super.setMap(t);
		}
	}
	class vh extends xh {
		constructor(t) {
			super({ condition: (t = t || {}).condition ? t.condition : sh, className: t.className || 'ol-dragzoom', minArea: t.minArea }), (this.duration_ = void 0 !== t.duration ? t.duration : 200), (this.out_ = void 0 !== t.out && t.out);
		}
		onBoxEnd(t) {
			const e = this.getMap().getView();
			...
			e.fitInternal(i, { duration: this.duration_, easing: ks });
		}
	}
	var wh = 'ArrowLeft',
		bh = 'ArrowUp',
	...
	class Eh extends Zl {
		...
		handleEvent(t) {
			...
			if (t.type == en) {
				const i = t.originalEvent,
					n = i.key;
				if (this.condition_(t) && (n == Ch || n == wh || n == Sh || n == bh)) {
					const r = t.map.getView(),
						s = r.getResolution() * this.pixelDelta_;
					let o = 0,
						a = 0;
					n == Ch ? (a = -s) : n == wh ? (o = -s) : n == Sh ? (o = s) : (a = s);
					const l = [o, a];
					Es(l, r.getRotation()),
						(function (t, e, i) {
							...
							if (n) {
								...
								t.animateInternal({ duration: void 0 !== i ? i : 250, easing: As, center: t.getConstrainedCenter(r) });
							}
						})(r, l, this.duration_),
						i.preventDefault(),
						(e = !0);
	...
	class Th extends Zl {
		...
		handleEvent(t) {
			let e = !1;
			if (t.type == en || t.type == nn) {
				const i = t.originalEvent,
					n = i.key;
				if (this.condition_(t) && ('+' === n || '-' === n)) {
					const r = t.map,
						s = '+' === n ? this.delta_ : -this.delta_;
					Kl(r.getView(), s, void 0, this.duration_), i.preventDefault(), (e = !0);
				}
			}
			return !e;
		}
	...
	class Ph extends Zl {
		constructor(t) {
			...
			const e = t.condition ? t.condition : th;
			(this.condition_ = t.onFocusOnly ? Hl(Ql, e) : e), (this.lastAnchor_ = null), (this.startTime_ = void 0), this.timeoutId_, (this.mode_ = void 0), (this.trackpadEventGap_ = 400), this.trackpadTimeoutId_, (this.deltaPerZoom_ = 300);
		}
		endInteraction_() {
		...
		handleEvent(t) {
			...
			const s = e.getView();
			if ('trackpad' === this.mode_ && !s.getConstrainResolution() && !this.constrainResolution_) return this.trackpadTimeoutId_ ? clearTimeout(this.trackpadTimeoutId_) : (s.getAnimating() && s.cancelAnimations(), s.beginInteraction()), (this.trackpadTimeoutId_ = setTimeout(this.endInteraction_.bind(this), this.timeout_)), s.adjustZoom(-n / this.deltaPerZoom_, this.lastAnchor_ ? e.getCoordinateFromPixel(this.lastAnchor_) : null), (this.startTime_ = r), !1;
			this.totalDelta_ += n;
		...
		handleWheelZoom_(t) {
			...
			let i = -xr(this.totalDelta_, -this.maxDelta_ * this.deltaPerZoom_, this.maxDelta_ * this.deltaPerZoom_) / this.deltaPerZoom_;
			(e.getConstrainResolution() || this.constrainResolution_) && (i = i ? (i > 0 ? 1 : -1) : 0), Kl(e, i, this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null, this.duration_), (this.mode_ = void 0), (this.totalDelta_ = 0), (this.lastAnchor_ = null), (this.startTime_ = void 0), (this.timeoutId_ = void 0);
		}
		setMouseAnchor(t) {
	...
	class Rh extends hh {
		constructor(t) {
			const e = (t = t || {});
			e.stopDown || (e.stopDown = pn), super(e), (this.anchor_ = null), (this.lastAngle_ = void 0), (this.rotating_ = !1), (this.rotationDelta_ = 0), (this.threshold_ = void 0 !== t.threshold ? t.threshold : 0.3), (this.duration_ = void 0 !== t.duration ? t.duration : 250);
		}
		handleDragEvent(t) {
			let e = 0;
			...
			const s = t.map,
				o = s.getView();
			o.getConstraints().rotation !== yl && ((this.anchor_ = s.getCoordinateFromPixelInternal(s.getEventPixel(ch(this.targetPointers)))), this.rotating_ && (s.render(), o.adjustRotationInternal(e, this.anchor_)));
		}
		handleUpEvent(t) {
	...
	class Fh extends hh {
		constructor(t) {
			const e = (t = t || {});
			e.stopDown || (e.stopDown = pn), super(e), (this.anchor_ = null), (this.duration_ = void 0 !== t.duration ? t.duration : 400), (this.lastDistance_ = void 0), (this.lastScaleDelta_ = 1);
		}
		handleDragEvent(t) {
			let e = 1;
			const i = this.targetPointers[0],
			...
			const a = t.map,
				l = a.getView();
			1 != e && (this.lastScaleDelta_ = e), (this.anchor_ = a.getCoordinateFromPixelInternal(a.getEventPixel(ch(this.targetPointers)))), a.render(), l.adjustResolutionInternal(e, this.anchor_);
		}
		handleUpEvent(t) {
			if (this.targetPointers.length < 2) {
				const e = t.map.getView(),
	...
	function Mh(t) {
		t = t || {};
		const e = new On(),
			i = new Xl(-0.005, 0.05, 100);
		(void 0 === t.altShiftDragRotate || t.altShiftDragRotate) && e.push(new dh());
		(void 0 === t.doubleClickZoom || t.doubleClickZoom) && e.push(new Yl({ delta: t.zoomDelta, duration: t.zoomDuration }));
		(void 0 === t.dragPan || t.dragPan) && e.push(new uh({ onFocusOnly: t.onFocusOnly, kinetic: i }));
		(void 0 === t.pinchRotate || t.pinchRotate) && e.push(new Rh());
		(void 0 === t.pinchZoom || t.pinchZoom) && e.push(new Fh({ duration: t.zoomDuration }));
		(void 0 === t.keyboard || t.keyboard) && (e.push(new Eh()), e.push(new Th({ delta: t.zoomDelta, duration: t.zoomDuration })));
		(void 0 === t.mouseWheelZoom || t.mouseWheelZoom) && e.push(new Ph({ onFocusOnly: t.onFocusOnly, duration: t.zoomDuration }));
		return (void 0 === t.shiftDragZoom || t.shiftDragZoom) && e.push(new vh({ duration: t.zoomDuration })), e;
	}
	var Ih = 'opacity',
		kh = 'visible',
		Lh = 'extent',
	...
	class $h extends Ln {
		constructor(t) {
			...
			const e = Object.assign({}, t);
			'object' == typeof t.properties && (delete e.properties, Object.assign(e, t.properties)), (e[Ih] = void 0 !== t.opacity ? t.opacity : 1), dr('number' == typeof e[Ih], 'Layer opacity must be a number'), (e[kh] = void 0 === t.visible || t.visible), (e[Ah] = t.zIndex), (e[Dh] = void 0 !== t.maxResolution ? t.maxResolution : 1 / 0), (e[Oh] = void 0 !== t.minResolution ? t.minResolution : 0), (e[Nh] = void 0 !== t.minZoom ? t.minZoom : -1 / 0), (e[zh] = void 0 !== t.maxZoom ? t.maxZoom : 1 / 0), (this.className_ = void 0 !== e.className ? e.className : 'ol-layer'), delete e.className, this.setProperties(e), (this.state_ = null);
		}
		getBackground() {
		...
		getLayerState(t) {
			const e = this.state_ || { layer: this, managed: void 0 === t || t },
				i = this.getZIndex();
			return (e.opacity = xr(Math.round(100 * this.getOpacity()) / 100, 0, 1)), (e.visible = this.getVisible()), (e.extent = this.getExtent()), (e.zIndex = void 0 !== i || e.managed ? i : 1 / 0), (e.maxResolution = this.getMaxResolution()), (e.minResolution = Math.max(this.getMinResolution(), 0)), (e.minZoom = this.getMinZoom()), (e.maxZoom = this.getMaxZoom()), (this.state_ = e), e;
		}
		getLayersArray(t) {
			return Fn();
		}
		...
		setOpacity(t) {
			dr('number' == typeof t, 'Layer opacity must be a number'), this.set(Ih, t);
		}
		setVisible(t) {
			this.set(kh, t);
		}
	...
	class Vh extends $h {
		constructor(t) {
			...
			delete e.layers;
			let i = t.layers;
			super(e), this.on, this.once, this.un, (this.layersListenerKeys_ = []), (this.listenerKeys_ = {}), this.addChangeListener(Uh, this.handleLayersChanged_), i ? (Array.isArray(i) ? (i = new On(i.slice(), { unique: !0 })) : dr('function' == typeof i.getArray, 'Expected `layers` to be an array or a `Collection`')) : (i = new On(void 0, { unique: !0 })), this.setLayers(i);
		}
		handleLayerChange_() {
			this.changed();
		}
		handleLayersChanged_() {
			this.layersListenerKeys_.forEach(En), (this.layersListenerKeys_.length = 0);
			const t = this.getLayers();
			this.layersListenerKeys_.push(Sn(t, Vi, this.handleLayersAdd_, this), Sn(t, Wi, this.handleLayersRemove_, this));
			for (const t in this.listenerKeys_) this.listenerKeys_[t].forEach(En);
			xn(this.listenerKeys_);
			const e = t.getArray();
			for (let t = 0, i = e.length; t < i; t++) {
				const i = e[t];
				this.registerLayerListeners_(i), this.dispatchEvent(new Bh('addlayer', i));
			}
			this.changed();
		}
		registerLayerListeners_(t) {
			const e = [Sn(t, Xi, this.handleLayerChange_, this), Sn(t, qi, this.handleLayerChange_, this)];
			t instanceof Vh && e.push(Sn(t, 'addlayer', this.handleLayerGroupAdd_, this), Sn(t, 'removelayer', this.handleLayerGroupRemove_, this)), (this.listenerKeys_[In(t)] = e);
		}
		handleLayerGroupAdd_(t) {
			this.dispatchEvent(new Bh('addlayer', t.layer));
		}
		handleLayerGroupRemove_(t) {
			this.dispatchEvent(new Bh('removelayer', t.layer));
		}
		handleLayersAdd_(t) {
			const e = t.element;
			this.registerLayerListeners_(e), this.dispatchEvent(new Bh('addlayer', e)), this.changed();
		}
		handleLayersRemove_(t) {
			const e = t.element,
				i = In(e);
			this.listenerKeys_[i].forEach(En), delete this.listenerKeys_[i], this.dispatchEvent(new Bh('removelayer', e)), this.changed();
		}
		getLayers() {
			return this.get(Uh);
		}
		setLayers(t) {
			...
			if (e) {
				const t = e.getArray();
				for (let e = 0, i = t.length; e < i; ++e) this.dispatchEvent(new Bh('removelayer', t[e]));
			}
			this.set(Uh, t);
		}
		getLayersArray(t) {
	...
	var Wh = Object.freeze({ __proto__: null, GroupEvent: Bh, default: Vh }),
		Xh = 'prerender',
		qh = 'postrender',
		Zh = 'precompose',
		Kh = 'postcompose',
	...
	class Hh extends $h {
		constructor(t) {
			const e = Object.assign({}, t);
			delete e.source, super(e), this.on, this.once, this.un, (this.mapPrecomposeKey_ = null), (this.mapRenderKey_ = null), (this.sourceChangeKey_ = null), (this.renderer_ = null), (this.sourceReady_ = !1), (this.rendered = !1), t.render && (this.render = t.render), t.map && this.setMap(t.map), this.addChangeListener(Gh, this.handleSourcePropertyChange_);
		...
		handleSourcePropertyChange_() {
			this.sourceChangeKey_ && (En(this.sourceChangeKey_), (this.sourceChangeKey_ = null)), (this.sourceReady_ = !1);
			const t = this.getSource();
			t &&
				((this.sourceChangeKey_ = Sn(t, qi, this.handleSourceChange_, this)),
				'ready' === t.getState() &&
					((this.sourceReady_ = !0),
					setTimeout(() => {
		...
		isVisible(t) {
			...
			let n;
			if ((!t && i && (t = i.getView()), (e = t instanceof wl ? { viewState: t.getState(), extent: t.calculateExtent() } : t), !e.layerStatesArray && i && (e.layerStatesArray = i.getLayerGroup().getLayerStatesArray()), e.layerStatesArray)) {
				if (((n = e.layerStatesArray.find((t) => t.layer === this)), !n)) return !1;
			} else n = this.getLayerState();
			const r = this.getExtent();
			return Jh(n, e.viewState) && (!r || ms(r, e.extent));
		}
		getAttributions(t) {
			if (!this.isVisible(t)) return [];
			const e = this.getSource()?.getAttributions();
			if (!e) return [];
			let i = e(t instanceof wl ? t.getViewStateAndExtent() : t);
		...
		setMapInternal(t) {
			t || this.unrender(), this.set(jh, t);
		}
		getMapInternal() {
			return this.get(jh);
		}
		setMap(t) {
			this.mapPrecomposeKey_ && (En(this.mapPrecomposeKey_), (this.mapPrecomposeKey_ = null)), t || this.changed(), this.mapRenderKey_ && (En(this.mapRenderKey_), (this.mapRenderKey_ = null)), t && ((this.mapPrecomposeKey_ = Sn(t, Zh, this.handlePrecompose_, this)), (this.mapRenderKey_ = Sn(this, qi, t.render, t)), this.changed());
		}
		handlePrecompose_(t) {
			const e = t.frameState.layerStatesArray,
				i = this.getLayerState(!1);
			dr(!e.some((t) => t.layer === i.layer), 'A layer can only be added to the map once. Use either `layer.setMap()` or `map.addLayer()`, not both.'), e.push(i);
		}
		setSource(t) {
			this.set(Gh, t);
		}
	...
	function Qh(t, e, i = 0, n = t.length - 1, r = ec) {
		for (; n > i; ) {
			if (n - i > 600) {
				const s = n - i + 1,
					o = e - i + 1,
				...
				Qh(t, e, Math.max(i, Math.floor(e - (o * l) / s + h)), Math.min(n, Math.floor(e + ((s - o) * l) / s + h)), r);
			}
			const s = t[e];
			let o = i,
				a = n;
			for (tc(t, i, e), r(t[n], s) > 0 && tc(t, i, n); o < a; ) {
				for (tc(t, o, a), o++, a--; r(t[o], s) < 0; ) o++;
				for (; r(t[a], s) > 0; ) a--;
			}
			0 === r(t[i], s) ? tc(t, i, a) : (a++, tc(t, a, n)), a <= e && (i = a + 1), e <= a && (n = a - 1);
		}
	}
	function tc(t, e, i) {
		const n = t[e];
	...
	let ic = class {
			...
			for (; e; ) {
				for (let s = 0; s < e.children.length; s++) {
					const o = e.children[s],
						a = e.leaf ? n(o) : o;
					fc(t, a) && (e.leaf ? i.push(o) : gc(t, a) ? this._all(o, i) : r.push(o));
				}
				e = r.pop();
			}
			return i;
		...
		remove(t, e) {
			...
			for (; i || r.length; ) {
				if ((i || ((i = r.pop()), (a = r[r.length - 1]), (o = s.pop()), (l = !0)), i.leaf)) {
					const n = nc(t, i.children, e);
					if (-1 !== n) return i.children.splice(n, 1), r.push(i), this._condense(r), this;
				}
				l || i.leaf || !gc(i, n) ? (a ? (o++, (i = a.children[o]), (l = !1)) : (i = null)) : (r.push(i), s.push(o), (o = 0), (a = i), (i = i.children[0]));
			}
			return this;
		}
		toBBox(t) {
		...
		_build(t, e, i, n) {
			...
			let s,
				o = this._maxEntries;
			if (r <= o) return (s = pc(t.slice(e, i + 1))), rc(s, this.toBBox), s;
			n || ((n = Math.ceil(Math.log(r) / Math.log(o))), (o = Math.ceil(r / Math.pow(o, n - 1)))), (s = pc([])), (s.leaf = !1), (s.height = n);
			const a = Math.ceil(r / o),
				l = a * Math.ceil(Math.sqrt(o));
			mc(t, e, i, l, this.compareMinX);
			for (let r = e; r <= i; r += l) {
				const e = Math.min(r + l - 1, i);
				mc(t, r, e, a, this.compareMinY);
				for (let i = r; i <= e; i += a) {
					const r = Math.min(i + a - 1, e);
					s.children.push(this._build(t, i, r, n - 1));
				}
			}
			return rc(s, this.toBBox), s;
		}
			...
			for (; n.push(e), !e.leaf && n.length - 1 !== i; ) {
				...
				for (let s = 0; s < e.children.length; s++) {
					const o = e.children[s],
						a = hc(o),
						l = uc(t, o) - a;
					l < r ? ((r = l), (n = a < n ? a : n), (i = o)) : l === r && a < n && ((n = a), (i = o));
				}
				e = i || e.children[0];
			}
			return e;
		...
		_insert(t, e, i) {
			...
			for (s.children.push(t), oc(s, n); e >= 0 && r[e].children.length > this._maxEntries; ) this._split(r, e), e--;
		...
		_split(t, e) {
			...
			const s = this._chooseSplitIndex(i, r, n),
				o = pc(i.children.splice(s, i.children.length - s));
			(o.height = i.height), (o.leaf = i.leaf), rc(i, this.toBBox), rc(o, this.toBBox), e ? t[e - 1].children.push(o) : this._splitRoot(i, o);
		}
		_splitRoot(t, e) {
			(this.data = pc([t, e])), (this.data.height = t.height + 1), (this.data.leaf = !1), rc(this.data, this.toBBox);
		}
		_chooseSplitIndex(t, e, i) {
			let n,
				...
				s = 1 / 0;
			for (let o = e; o <= i - e; o++) {
				const e = sc(t, 0, o, this.toBBox),
					a = sc(t, o, i, this.toBBox),
					l = dc(e, a),
					h = hc(e) + hc(a);
		...
		_chooseSplitAxis(t, e, i) {
			const n = t.leaf ? this.compareMinX : ac,
				r = t.leaf ? this.compareMinY : lc;
		...
		_allDistMargin(t, e, i, n) {
			...
			for (let n = e; n < i - e; n++) {
				...
				oc(s, t.leaf ? r(e) : e), (a += cc(s));
			}
			for (let n = i - e - 1; n >= e; n--) {
				const e = t.children[n];
				oc(o, t.leaf ? r(e) : e), (a += cc(o));
			}
			return a;
		}
		_adjustParentBBoxes(t, e, i) {
			for (let n = i; n >= 0; n--) oc(e[n], t);
		}
		_condense(t) {
			for (let e, i = t.length - 1; i >= 0; i--) 0 === t[i].children.length ? (i > 0 ? ((e = t[i - 1].children), e.splice(e.indexOf(t[i]), 1)) : this.clear()) : rc(t[i], this.toBBox);
		}
	};
	function nc(t, e, i) {
	...
	function rc(t, e) {
		sc(t, 0, t.children.length, e, t);
	}
	function sc(t, e, i, n, r) {
		r || (r = pc(null)), (r.minX = 1 / 0), (r.minY = 1 / 0), (r.maxX = -1 / 0), (r.maxY = -1 / 0);
		for (let s = e; s < i; s++) {
	...
	function mc(t, e, i, n, r) {
		...
		for (; s.length; ) {
			...
			Qh(t, o, e, i, r), s.push(e, o, o, i);
		}
	}
	const _c = [NaN, NaN, NaN, 0];
	let yc;
	const xc = /^rgba?\(\s*(\d+%?)\s+(\d+%?)\s+(\d+%?)(?:\s*\/\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i,
		vc = /^rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)(?:\s*,\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i,
		wc = /^rgba?\(\s*(\d+%)\s*,\s*(\d+%)\s*,\s*(\d+%)(?:\s*,\s*(\d+%|\d*\.\d+|[01]))?\s*\)$/i,
		bc = /^#([\da-f]{3,4}|[\da-f]{6}|[\da-f]{8})$/i;
	function Sc(t, e) {
	...
	function Ec(t) {
		if (t.toLowerCase().startsWith('rgb')) {
			const e = t.match(vc) || t.match(xc) || t.match(wc);
			if (e) {
				const t = e[4],
					i = 100 / 255;
				return [xr((Sc(e[1], i) + 0.5) | 0, 0, 255), xr((Sc(e[2], i) + 0.5) | 0, 0, 255), xr((Sc(e[3], i) + 0.5) | 0, 0, 255), void 0 !== t ? xr(Sc(t, 100), 0, 1) : 1];
			}
			Cc(t);
		}
		if (t.startsWith('#')) {
			if (bc.test(t)) {
				...
				for (let t = 0, r = e.length; t < r; t += i) {
					let r = parseInt(e.substring(t, t + i), 16);
					1 === i && (r += r << 4), (n[t / i] = r);
				}
				return (n[3] = n[3] / 255), n;
			}
			Cc(t);
		}
		const e = (yc || (yc = Ll(1, 1, void 0, { willReadFrequently: !0, desynchronized: !0 })), yc);
		e.fillStyle = '#abcdef';
		let i = e.fillStyle;
		(e.fillStyle = t), e.fillStyle === i && ((e.fillStyle = '#fedcba'), (i = e.fillStyle), (e.fillStyle = t), e.fillStyle === i && Cc(t));
		const n = e.fillStyle;
		if (n.startsWith('#') || n.startsWith('rgba')) return Ec(n);
		e.clearRect(0, 0, 1, 1), e.fillRect(0, 0, 1, 1);
		const r = Array.from(e.getImageData(0, 0, 1, 1).data);
		return (r[3] = Tr(r[3] / 255, 3)), r;
	}
	const Tc = {};
	let Pc = 0;
	function Rc(t) {
	...
	function Fc(t) {
		return t > 0.0031308 ? 269.025 * Math.pow(t, 1 / 2.4) - 14.025 : 3294.6 * t;
	}
	function Mc(t) {
		return t > 0.2068965 ? Math.pow(t, 3) : (108 / 841) * (t - 4 / 29);
	}
	function Ic(t) {
		return t > 10.314724 ? Math.pow((t + 14.025) / 269.025, 2.4) : t / 3294.6;
	}
	function kc(t) {
		return t > 0.0088564 ? Math.pow(t, 1 / 3) : t / (108 / 841) + 4 / 29;
	}
	function Lc(t) {
		const e = Ic(t[0]),
			i = Ic(t[1]),
			n = Ic(t[2]),
			r = kc(0.222488403 * e + 0.716873169 * i + 0.06060791 * n),
			s = 500 * (kc(0.452247074 * e + 0.399439023 * i + 0.148375274 * n) - r),
			o = 200 * (r - kc(0.016863605 * e + 0.117638439 * i + 0.865350722 * n)),
			a = Math.atan2(o, s) * (180 / Math.PI);
		return [116 * r - 16, Math.sqrt(s * s + o * o), a < 0 ? a + 360 : a, t[3]];
	}
	function Ac(t) {
		if ('none' === t) return _c;
		if (Tc.hasOwnProperty(t)) return Tc[t];
		if (Pc >= 1024) {
			let t = 0;
			for (const e in Tc) 3 & t++ || (delete Tc[e], --Pc);
		}
		const e = Ec(t);
		4 !== e.length && Cc(t);
		for (const i of e) isNaN(i) && Cc(t);
		return (Tc[t] = e), ++Pc, e;
	}
	function Dc(t) {
		return Array.isArray(t) ? t : Ac(t);
	}
	function Oc(t) {
		let e = t[0];
		e != (0 | e) && (e = (e + 0.5) | 0);
		...
		let n = t[2];
		n != (0 | n) && (n = (n + 0.5) | 0);
		return 'rgba(' + e + ',' + i + ',' + n + ',' + (void 0 === t[3] ? 1 : Math.round(1e3 * t[3]) / 1e3) + ')';
	}
	function zc(t) {
		return t[0] > 0 && t[1] > 0;
	}
	...
	const jc = 1 << Gc++,
		...
		Wc = 1 << Gc++,
		Xc = Math.pow(2, 6) - 1,
		qc = { [jc]: 'boolean', [$c]: 'number', [Bc]: 'string', [Uc]: 'color', [Vc]: 'number[]', [Wc]: 'size' },
		Zc = Object.keys(qc).map(Number).sort(ln);
	function Kc(t) {
		const e = [];
		for (const i of Zc) Yc(t, i) && e.push(qc[i]);
	...
	class Jc {
		constructor(t, e) {
			if (
				...
				throw new Error(`literal expressions must have a specific type, got ${Kc(t)}`);
			(this.type = t), (this.value = e);
		}
	}
	class Qc {
	...
	function eu(t, e, i) {
		switch (typeof t) {
			case 'boolean':
				if (Hc(e, Bc)) return new Jc(Bc, t ? 'true' : 'false');
				if (!Yc(e, jc)) throw new Error(`got a boolean, but expected ${Kc(e)}`);
				return new Jc(jc, t);
			case 'number':
				if (Hc(e, Wc)) return new Jc(Wc, Nc(t));
				if (Hc(e, jc)) return new Jc(jc, !!t);
				if (Hc(e, Bc)) return new Jc(Bc, t.toString());
				if (!Yc(e, $c)) throw new Error(`got a number, but expected ${Kc(e)}`);
				return new Jc($c, t);
			case 'string':
				if (Hc(e, Uc)) return new Jc(Uc, Ac(t));
				if (Hc(e, jc)) return new Jc(jc, !!t);
				if (!Yc(e, Bc)) throw new Error(`got a string, but expected ${Kc(e)}`);
				return new Jc(Bc, t);
		}
		...
		if (Hc(e, Uc)) {
			if (3 === t.length) return new Jc(Uc, [...t, 1]);
			if (4 === t.length) return new Jc(Uc, t);
			throw new Error(`expected an array of 3 or 4 values for a color, got ${t.length}`);
		}
		if (!Yc(e, Vc)) throw new Error(`got an array of numbers, but expected ${Kc(e)}`);
		return new Jc(Vc, t);
	}
	const iu = 'get',
		nu = 'var',
		...
		Ku = {
			[iu]: nd(Qu(1, 1 / 0), Yu),
			[nu]: nd(Qu(1, 1), function (t, e, i) {
				const n = t[1];
				if ('string' != typeof n) throw new Error('expected a string argument for var operation');
				return i.variables.add(n), [new Jc(Bc, n)];
			}),
			[Zu]: nd(Qu(1, 1 / 0), Yu),
			[Vu]: nd(function (t, e, i) {
				i.featureId = !0;
			}, Ju),
			[ru]: nd(Qu(2, 1 / 0), ed(Bc)),
			[su]: nd(function (t, e, i) {
				i.geometryType = !0;
			}, Ju),
			[ou]: nd(Ju),
			[cu]: nd(Hu, Ju),
			[uu]: nd(Hu, Ju),
			[du]: nd(Hu, Ju),
			[au]: nd(Qu(2, 1 / 0), ed(jc)),
			[lu]: nd(Qu(2, 1 / 0), ed(jc)),
			[hu]: nd(Qu(1, 1), ed(jc)),
			[gu]: nd(Qu(2, 2), ed(Xc)),
			[fu]: nd(Qu(2, 2), ed(Xc)),
			[pu]: nd(Qu(2, 2), ed($c)),
			...
			[ku]: nd(Qu(1, 2), ed($c)),
			[Lu]: nd(Qu(1, 1), ed($c)),
			[Au]: nd(Qu(4, 1 / 0), id, function (t, e, i) {
				const n = t.length - 1,
					r = Bc | $c | jc,
					s = eu(t[1], r, i),
					o = eu(t[t.length - 1], e, i),
					a = new Array(n - 2);
				for (let e = 0; e < n - 2; e += 2) {
					try {
						const n = eu(t[e + 2], s.type, i);
						a[e] = n;
					} catch (t) {
						throw new Error(`failed to parse argument ${e + 1} of match expression: ${t.message}`);
					}
					try {
						const n = eu(t[e + 3], o.type, i);
						a[e + 1] = n;
					} catch (t) {
			...
			[Du]: nd(Qu(3, 3), ed($c)),
			[Ou]: nd(Qu(6, 1 / 0), id, function (t, e, i) {
				const n = t[1];
				let r;
				switch (n[0]) {
					case 'linear':
				...
				for (let n = 0; n < a.length; n += 2) {
					try {
						const e = eu(t[n + 3], $c, i);
						a[n] = e;
					} catch (t) {
						throw new Error(`failed to parse argument ${n + 2} for interpolate expression: ${t.message}`);
					}
					try {
						const r = eu(t[n + 4], e, i);
						a[n + 1] = r;
					} catch (t) {
						throw new Error(`failed to parse argument ${n + 3} for interpolate expression: ${t.message}`);
					}
				}
				return [s, o, ...a];
			}),
			[Nu]: nd(
				...
				function (t, e, i) {
					const n = t[0],
						r = t.length - 1;
					if (r % 2 == 0) throw new Error(`expected an odd number of arguments for ${n}, got ${r} instead`);
				},
				function (t, e, i) {
					const n = eu(t[t.length - 1], e, i),
						r = new Array(t.length - 1);
					for (let e = 0; e < r.length - 1; e += 2) {
						try {
							const n = eu(t[e + 1], jc, i);
							r[e] = n;
						} catch (t) {
							throw new Error(`failed to parse argument ${e} of case expression: ${t.message}`);
						}
						try {
							const s = eu(t[e + 2], n.type, i);
							r[e + 1] = s;
						} catch (t) {
			...
			[ju]: nd(Qu(1, 1 / 0), ed(Xc)),
			[$u]: nd(Qu(1, 1 / 0), ed(Xc)),
			[Bu]: nd(Qu(1, 1 / 0), ed($c)),
			[Uu]: nd(Qu(1, 4), ed($c)),
			[Wu]: nd(Qu(1, 3), ed($c)),
			[Xu]: nd(Qu(2, 2), function (t, e, i) {
				let n;
				try {
					n = eu(t[1], $c, i);
				} catch (t) {
				...
				for (let t = 0; t < s.length; t++) {
					...
					if (!(e instanceof Jc)) throw new Error(`the palette color at index ${t} must be a literal value`);
					s[t] = e;
				}
				return [n, ...s];
			}),
			[qu]: nd(Qu(1, 1), ed(jc | $c | Bc | Uc)),
		};
	function Yu(t, e, i) {
		const n = t.length - 1,
			r = new Array(n);
		for (let e = 0; e < n; ++e) {
			...
			switch (typeof n) {
				...
				case 'string':
					...
					break;
				default:
					throw new Error(`expected a string key or numeric array index for a get operation, got ${n}`);
			}
			0 === e && i.properties.add(String(n));
		}
		return r;
	}
	function Hu(t, e, i) {
	...
	function id(t, e, i) {
		const n = t[0],
			r = t.length - 1;
		if (r % 2 == 1) throw new Error(`expected an even number of arguments for operation ${n}, got ${r} instead`);
	}
	function nd(...t) {
		return function (e, i, n) {
			const r = e[0];
	...
	function od(t, e) {
		if (t instanceof Jc) {
			if (t.type === Uc && 'string' == typeof t.value) {
				const e = Ac(t.value);
				return function () {
					return e;
				};
		...
		switch (i) {
			...
			case zu:
				return (function (t) {
					const e = t.operator,
						i = t.args.length,
						n = new Array(i);
					for (let e = 0; e < i; ++e) n[e] = od(t.args[e]);
					switch (e) {
						case zu:
							return (t) => {
								for (let e = 0; e < i; ++e) {
			...
			case hu:
				return (function (t) {
					...
					switch (e) {
						case au:
							return (t) => {
								for (let e = 0; e < i; ++e) if (n[e](t)) return !0;
								return !1;
							};
						case lu:
							return (t) => {
								for (let e = 0; e < i; ++e) if (!n[e](t)) return !1;
								return !0;
							};
						case Du:
							return (t) => {
						...
						case Gu:
							return (t) => {
								const e = n[0](t);
								for (let r = 1; r < i; ++r) if (e === n[r](t)) return !0;
								return !1;
							};
						case hu:
							return (t) => !n[0](t);
				...
				return (function (t) {
					...
					switch (e) {
						...
						case Cu:
							return (t) => n[0](t) % n[1](t);
						case Eu:
							return (t) => Math.pow(n[0](t), n[1](t));
						case Tu:
							return (t) => Math.abs(n[0](t));
						case Pu:
							return (t) => Math.floor(n[0](t));
						case Ru:
							return (t) => Math.ceil(n[0](t));
						case Fu:
							return (t) => Math.round(n[0](t));
						case Mu:
							return (t) => Math.sin(n[0](t));
						case Iu:
							return (t) => Math.cos(n[0](t));
						case ku:
							return 2 === i ? (t) => Math.atan2(n[0](t), n[1](t)) : (t) => Math.atan(n[0](t));
						case Lu:
							return (t) => Math.sqrt(n[0](t));
						default:
			...
			case Nu:
				return (function (t) {
					const e = t.args.length,
						i = new Array(e);
					for (let n = 0; n < e; ++n) i[n] = od(t.args[n]);
					return (t) => {
						for (let n = 0; n < e - 1; n += 2) {
							if (i[n](t)) return i[n + 1](t);
						}
						return i[e - 1](t);
					};
				})(t);
			case Au:
				return (function (t) {
					...
					return (t) => {
						const n = i[0](t);
						for (let r = 1; r < e - 1; r += 2) if (n === i[r](t)) return i[r + 1](t);
						return i[e - 1](t);
					};
				})(t);
			case Ou:
				return (function (t) {
					...
					return (t) => {
						...
						for (let a = 2; a < e; a += 2) {
							...
							if ((h && (l = Rc(l)), e >= r)) return 2 === a ? l : h ? ld(n, r, s, o, e, l) : ad(n, r, s, o, e, l);
							(s = e), (o = l);
						}
						return o;
					};
			...
			case qu:
				return (function (t) {
					...
					if (e === qu)
						return (e) => {
							const i = n[0](e);
							return t.args[0].type === Uc ? Oc(i) : i.toString();
						};
	...
	function ld(t, e, i, n, r, s) {
		...
		return (function (t) {
			const e = (t[0] + 16) / 116,
				...
				n = (t[2] * Math.PI) / 180,
				r = Mc(e),
				s = Mc(e + (i / 500) * Math.cos(n)),
				o = Mc(e - (i / 200) * Math.sin(n)),
				a = Fc(3.021973625 * s - 1.617392459 * r - 0.404875592 * o),
				l = Fc(-0.943766287 * s + 1.916279586 * r + 0.027607165 * o),
				h = Fc(0.069407491 * s - 0.22898585 * r + 1.159737864 * o);
			return [xr((a + 0.5) | 0, 0, 255), xr((l + 0.5) | 0, 0, 255), xr((h + 0.5) | 0, 0, 255), t[3]];
		})([ad(t, e, i, o[0], r, a[0]), ad(t, e, i, o[1], r, a[1]), o[2] + ad(t, e, i, 0, r, l), ad(t, e, i, n[3], r, s[3])]);
	}
	var hd = 0,
		cd = 1,
		ud = 2,
	...
	class fd extends bn {
		constructor(t, e, i, n) {
			super(), (this.extent = t), (this.pixelRatio_ = i), (this.resolution = e), (this.state = 'function' == typeof n ? hd : n), (this.image_ = null), (this.loader = 'function' == typeof n ? n : null);
		}
		changed() {
		...
		load() {
			if (this.state == hd && this.loader) {
				(this.state = cd), this.changed();
				const t = this.getResolution(),
					e = Array.isArray(t) ? t[0] : t;
				yn(() => this.loader(this.getExtent(), e, this.getPixelRatio()))
					.then((t) => {
						'image' in t && (this.image_ = t.image), 'extent' in t && (this.extent = t.extent), 'resolution' in t && (this.resolution = t.resolution), 'pixelRatio' in t && (this.pixelRatio_ = t.pixelRatio), (t instanceof HTMLImageElement || (qn && t instanceof ImageBitmap) || t instanceof HTMLCanvasElement || t instanceof HTMLVideoElement) && (this.image_ = t), (this.state = ud);
					})
					.catch((t) => {
						(this.state = dd), console.error(t);
					})
			...
			t.src && Xn
				...
				: (function (t) {
						return new Promise((e, i) => {
							...
							function r() {
								s(), i(new Error('Image load error'));
							}
							function s() {
								t.removeEventListener('load', n), t.removeEventListener('error', r);
							}
							t.addEventListener('load', n), t.addEventListener('error', r);
						});
				  })(t)
		);
	}
	...
	const yd = new (class {
		...
		expire() {
			if (this.canExpireCache()) {
				...
				for (const e in this.cache_) {
					...
					3 & t++ || i.hasListener() || (delete this.cache_[e], delete this.patternCache_[e], --this.cacheSize_);
				}
			}
		}
		get(t, e, i) {
		...
		set(t, e, i, n, r) {
			...
			(this.cache_[s] = n),
				r &&
					(n.getImageState() === hd && n.load(),
					n.getImageState() === cd
						? n.ready().then(() => {
								this.patternCache_[s] = Dl().createPattern(n.getImage(1), 'repeat');
						  })
						: (this.patternCache_[s] = Dl().createPattern(n.getImage(1), 'repeat'))),
				o || ++this.cacheSize_;
		}
	...
	class vd extends bn {
		constructor(t, e, i, n, r) {
			super(), (this.hitDetectionImage_ = null), (this.image_ = t), (this.crossOrigin_ = i), (this.canvas_ = {}), (this.color_ = r), (this.imageState_ = void 0 === n ? hd : n), (this.size_ = t && t.width && t.height ? [t.width, t.height] : null), (this.src_ = e), this.tainted_, (this.ready_ = null);
		}
		initializeImage_() {
			(this.image_ = new Image()), null !== this.crossOrigin_ && (this.image_.crossOrigin = this.crossOrigin_);
		}
		isTainted_() {
			if (void 0 === this.tainted_ && this.imageState_ === ud) {
				xd || (xd = Ll(1, 1, void 0, { willReadFrequently: !0 })), xd.drawImage(this.image_, 0, 0);
				try {
					xd.getImageData(0, 0, 1, 1), (this.tainted_ = !1);
				} catch {
					(xd = null), (this.tainted_ = !0);
				}
			}
		...
		handleImageError_() {
			(this.imageState_ = dd), this.dispatchChangeEvent_();
		}
		handleImageLoad_() {
			(this.imageState_ = ud), (this.size_ = [this.image_.width, this.image_.height]), this.dispatchChangeEvent_();
		}
		getImage(t) {
		...
		load() {
			if (this.imageState_ === hd) {
				this.image_ || this.initializeImage_(), (this.imageState_ = cd);
				try {
		...
		replaceColor_(t) {
			if (!this.color_ || this.canvas_[t] || this.imageState_ !== ud) return;
			const e = this.image_,
				i = Ll(Math.ceil(e.width * t), Math.ceil(e.height * t)),
				n = i.canvas;
			var r;
			i.scale(t, t), i.drawImage(e, 0, 0), (i.globalCompositeOperation = 'multiply'), (i.fillStyle = 'string' == typeof (r = this.color_) ? r : Oc(r)), i.fillRect(0, 0, n.width / t, n.height / t), (i.globalCompositeOperation = 'destination-in'), i.drawImage(e, 0, 0), (this.canvas_[t] = n);
		}
		ready() {
			return (
				this.ready_ ||
					(this.ready_ = new Promise((t) => {
						if (this.imageState_ === ud || this.imageState_ === dd) t();
						else {
							const e = () => {
								(this.imageState_ !== ud && this.imageState_ !== dd) || (this.removeEventListener(qi, e), t());
							};
							this.addEventListener(qi, e);
						}
					})),
				this.ready_
			);
	...
	function wd(t, e, i, n, r, s) {
		let o = void 0 === e ? void 0 : yd.get(e, i, r);
		return o || ((o = new vd(t, t && 'src' in t ? t.src || void 0 : e, i, n, r)), yd.set(e, i, r, o, s)), s && o && !yd.getPattern(e, i, r) && yd.set(e, i, r, o, s), o;
	}
	function bd(t) {
		return t
			? Array.isArray(t)
				...
				? (function (t) {
						if (!t.offset || !t.size) return yd.getPattern(t.src, 'anonymous', t.color);
						const e = t.src + ':' + t.offset,
							i = yd.getPattern(e, void 0, t.color);
						if (i) return i;
						const n = yd.get(t.src, 'anonymous', null);
						if (n.getImageState() !== ud) return null;
						const r = Ll(t.size[0], t.size[1]);
						return r.drawImage(n.getImage(1), t.offset[0], t.offset[1], t.size[0], t.size[1], 0, 0, t.size[0], t.size[1]), wd(r.canvas, e, void 0, ud, t.color, !0), yd.getPattern(e, void 0, t.color);
				  })(t)
				: t
			: null;
	}
	const Sd = '10px sans-serif',
		Cd = '#000',
		Ed = 'round',
		Td = [],
		Pd = 'round',
	...
	let Ld,
		Ad = null;
	const Dd = {},
		Od = new Set(['serif', 'sans-serif', 'monospace', 'cursive', 'fantasy', 'system-ui', 'ui-serif', 'ui-sans-serif', 'ui-monospace', 'ui-rounded', 'emoji', 'math', 'fangsong']);
	function zd(t, e, i) {
		return `${t} ${e} 16px "${i}"`;
	}
	const Nd = (function () {
			...
			async function n(t) {
				await i.ready;
				const e = await i.load(t);
				if (0 === e.length) return !1;
				const n = kl(t),
					r = n.families[0].toLowerCase(),
					s = n.weight;
				return e.some((t) => {
					const e = t.family.replace(/^['"]|['"]$/g, '').toLowerCase(),
						i = Il[t.weight] || t.weight;
					return e === r && t.style === n.style && i == s;
				});
			}
			async function r() {
				await i.ready;
				let s = !0;
				const o = kd.getProperties(),
					a = Object.keys(o).filter((e) => o[e] < t);
				for (let e = a.length - 1; e >= 0; --e) {
					const i = a[e];
					let r = o[i];
					r < t && ((await n(i)) ? (xn(Dd), kd.set(i, t)) : ((r += 10), kd.set(i, r, !0), r < t && (s = !1)));
				}
				(e = void 0), s || (e = setTimeout(r, 100));
			}
			return async function (t) {
				i || (i = Wn ? self.fonts : document.fonts);
				const n = kl(t);
				if (!n) return;
				const s = n.families;
				let o = !1;
				for (const t of s) {
					if (Od.has(t)) continue;
					const e = zd(n.style, n.weight, t);
					void 0 === kd.get(e) && (kd.set(e, 0, !0), (o = !0));
				}
	...
	function jd(t, e) {
		return Ad || (Ad = Ll(1, 1)), t != Ld && ((Ad.font = t), (Ld = Ad.font)), Ad.measureText(e);
	}
	function $d(t, e) {
		return jd(t, e).width;
	}
	function Bd(t, e, i) {
		...
		const n = e.split('\n').reduce((e, i) => Math.max(e, $d(t, i)), 0);
		return (i[e] = n), n;
	}
	function Ud(t, e, i, n, r, s, o, a, l, h, c) {
		t.save(),
			1 !== i && (void 0 === t.globalAlpha ? (t.globalAlpha = (t) => (t.globalAlpha *= i)) : (t.globalAlpha *= i)),
	...
	class Vd {
		constructor(t) {
			(this.opacity_ = t.opacity), (this.rotateWithView_ = t.rotateWithView), (this.rotation_ = t.rotation), (this.scale_ = t.scale), (this.scaleArray_ = Nc(t.scale)), (this.displacement_ = t.displacement), (this.declutterMode_ = t.declutterMode);
		}
		clone() {
			const t = this.getScale();
			return new Vd({ opacity: this.getOpacity(), scale: Array.isArray(t) ? t.slice() : t, rotation: this.getRotation(), rotateWithView: this.getRotateWithView(), displacement: this.getDisplacement().slice(), declutterMode: this.getDeclutterMode() });
		}
		getOpacity() {
		...
		setScale(t) {
			(this.scale_ = t), (this.scaleArray_ = Nc(t));
		}
		listenImageChange(t) {
			Fn();
		}
	...
	class Wd extends Vd {
		constructor(t) {
			super({ opacity: 1, rotateWithView: void 0 !== t.rotateWithView && t.rotateWithView, rotation: void 0 !== t.rotation ? t.rotation : 0, scale: void 0 !== t.scale ? t.scale : 1, displacement: void 0 !== t.displacement ? t.displacement : [0, 0], declutterMode: t.declutterMode }),
				...
				this.size_,
				this.renderOptions_,
				(this.imageState_ = this.fill_ && this.fill_.loading() ? cd : ud),
				this.imageState_ === cd && this.ready().then(() => (this.imageState_ = ud)),
				this.render();
		}
		clone() {
			const t = this.getScale(),
				e = new Wd({ fill: this.getFill() ? this.getFill().clone() : void 0, points: this.getPoints(), radius: this.getRadius(), radius2: this.getRadius2(), angle: this.getAngle(), stroke: this.getStroke() ? this.getStroke().clone() : void 0, rotation: this.getRotation(), rotateWithView: this.getRotateWithView(), scale: Array.isArray(t) ? t.slice() : t, displacement: this.getDisplacement().slice(), declutterMode: this.getDeclutterMode() });
		...
		getImage(t) {
			const e = this.fill_?.getKey(),
				i = `${t},${this.angle_},${this.radius},${this.radius2_},${this.points_},${e}` + Object.values(this.renderOptions_).join(',');
			let n = yd.get(i, null, null)?.getImage(1);
			if (!n) {
				const e = this.renderOptions_,
					r = Math.ceil(e.size * t),
					s = Ll(r, r);
				this.draw_(e, s, t), (n = s.canvas), yd.set(i, null, null, new vd(n, void 0, null, ud, null));
			}
			return n;
		}
		getPixelRatio(t) {
		...
		createRenderOptions() {
			let t,
				...
				s = 0,
				o = 0;
			this.stroke_ && ((t = bd(this.stroke_.getColor() ?? Rd)), (o = this.stroke_.getWidth() ?? 1), (r = this.stroke_.getLineDash()), (s = this.stroke_.getLineDashOffset() ?? 0), (i = this.stroke_.getLineJoin() ?? Pd), (e = this.stroke_.getLineCap() ?? Ed), (n = this.stroke_.getMiterLimit() ?? 10));
			const a = this.calculateLineJoinSize_(i, o, n),
				l = Math.max(this.radius, this.radius2_ || 0);
			return { strokeStyle: t, strokeWidth: o, size: Math.ceil(2 * l + a), lineCap: e, lineDash: r, lineDashOffset: s, lineJoin: i, miterLimit: n };
		}
		render() {
		...
		draw_(t, e, i) {
			if ((e.scale(i, i), e.translate(t.size / 2, t.size / 2), this.createPath_(e), this.fill_)) {
				...
				null === t && (t = Cd), (e.fillStyle = bd(t)), e.fill();
			}
		...
		createHitDetectionCanvas_(t) {
			...
			if (this.fill_) {
				let i = this.fill_.getColor(),
					n = 0;
				'string' == typeof i && (i = Dc(i)), null === i ? (n = 1) : Array.isArray(i) && (n = 4 === i.length ? i[3] : 1), 0 === n && ((e = Ll(t.size, t.size)), this.drawHitDetectionCanvas_(t, e));
			}
		...
		drawHitDetectionCanvas_(t, e) {
			e.translate(t.size / 2, t.size / 2), this.createPath_(e), (e.fillStyle = Cd), e.fill(), t.strokeStyle && ((e.strokeStyle = t.strokeStyle), (e.lineWidth = t.strokeWidth), t.lineDash && (e.setLineDash(t.lineDash), (e.lineDashOffset = t.lineDashOffset)), (e.lineJoin = t.lineJoin), (e.miterLimit = t.miterLimit), e.stroke());
		}
		ready() {
	...
	class Xd extends Wd {
		...
		clone() {
			const t = this.getScale(),
				e = new Xd({ fill: this.getFill() ? this.getFill().clone() : void 0, stroke: this.getStroke() ? this.getStroke().clone() : void 0, radius: this.getRadius(), scale: Array.isArray(t) ? t.slice() : t, rotation: this.getRotation(), rotateWithView: this.getRotateWithView(), displacement: this.getDisplacement().slice(), declutterMode: this.getDeclutterMode() });
			return e.setOpacity(this.getOpacity()), e;
		}
		setRadius(t) {
	...
	class qd {
		...
		clone() {
			...
			return new qd({ color: Array.isArray(t) ? t.slice() : t || void 0 });
		}
		getColor() {
			return this.color_;
		}
		setColor(t) {
			if (null !== t && 'object' == typeof t && 'src' in t) {
				const e = wd(null, t.src, 'anonymous', void 0, t.offset ? null : t.color ? t.color : null, !(t.offset && t.size));
				e.ready().then(() => {
					this.patternImage_ = null;
				}),
					e.getImageState() === hd && e.load(),
					e.getImageState() === cd && (this.patternImage_ = e);
			}
			this.color_ = t;
		}
		getKey() {
			const t = this.getColor();
			return t ? (t instanceof CanvasPattern || t instanceof CanvasGradient ? In(t) : 'object' == typeof t && 'src' in t ? t.src + ':' + t.offset : Dc(t).toString()) : '';
		}
		loading() {
	...
	class Kd extends Vd {
		constructor(t) {
			...
			super({ opacity: e, rotation: i, scale: n, displacement: void 0 !== t.displacement ? t.displacement : [0, 0], rotateWithView: r, declutterMode: t.declutterMode }), (this.anchor_ = void 0 !== t.anchor ? t.anchor : [0.5, 0.5]), (this.normalizedAnchor_ = null), (this.anchorOrigin_ = void 0 !== t.anchorOrigin ? t.anchorOrigin : 'top-left'), (this.anchorXUnits_ = void 0 !== t.anchorXUnits ? t.anchorXUnits : 'fraction'), (this.anchorYUnits_ = void 0 !== t.anchorYUnits ? t.anchorYUnits : 'fraction'), (this.crossOrigin_ = void 0 !== t.crossOrigin ? t.crossOrigin : null);
			const s = void 0 !== t.img ? t.img : null;
			let o,
				a = t.src;
			if (
				(dr(!(void 0 !== a && s), '`image` and `src` cannot be provided at the same time'),
				(void 0 !== a && 0 !== a.length) || !s || (a = s.src || In(s)),
				dr(void 0 !== a && a.length > 0, 'A defined and non-empty `src` or `image` must be provided'),
				dr(!((void 0 !== t.width || void 0 !== t.height) && void 0 !== t.scale), '`width` or `height` cannot be provided together with `scale`'),
				void 0 !== t.src ? (o = hd) : void 0 !== s && (o = 'complete' in s ? (s.complete ? (s.src ? ud : hd) : cd) : ud),
				(this.color_ = void 0 !== t.color ? Dc(t.color) : null),
				(this.iconImage_ = wd(s, a, this.crossOrigin_, o, this.color_)),
				...
				if (t.size) [e, i] = t.size;
					...
					if (n.width && n.height) (e = n.width), (i = n.height);
						...
						const e = () => {
							...
							this.setScale(Zd(i[0], i[1], t.width, t.height));
						};
						return void this.listenImageChange(e);
					}
				}
				void 0 !== e && this.setScale(Zd(e, i, t.width, t.height));
			}
		}
		clone() {
			let t, e, i;
			return (
				this.initialOptions_ ? ((e = this.initialOptions_.width), (i = this.initialOptions_.height)) : ((t = this.getScale()), (t = Array.isArray(t) ? t.slice() : t)),
				new Kd({ anchor: this.anchor_.slice(), anchorOrigin: this.anchorOrigin_, anchorXUnits: this.anchorXUnits_, anchorYUnits: this.anchorYUnits_, color: this.color_ && this.color_.slice ? this.color_.slice() : this.color_ || void 0, crossOrigin: this.crossOrigin_, offset: this.offset_.slice(), offsetOrigin: this.offsetOrigin_, opacity: this.getOpacity(), rotateWithView: this.getRotateWithView(), rotation: this.getRotation(), scale: t, width: e, height: i, size: null !== this.size_ ? this.size_.slice() : void 0, src: this.getSrc(), displacement: this.getDisplacement().slice(), declutterMode: this.getDeclutterMode() })
			);
		}
		getAnchor() {
		...
		getWidth() {
			...
			return this.size_ ? this.size_[0] * t[0] : this.iconImage_.getImageState() == ud ? this.iconImage_.getSize()[0] * t[0] : void 0;
		}
		getHeight() {
			const t = this.getScaleArray();
			return this.size_ ? this.size_[1] * t[1] : this.iconImage_.getImageState() == ud ? this.iconImage_.getSize()[1] * t[1] : void 0;
		}
		setScale(t) {
			delete this.initialOptions_, super.setScale(t);
		}
		listenImageChange(t) {
			this.iconImage_.addEventListener(qi, t);
		}
		load() {
			this.iconImage_.load();
		}
		unlistenImageChange(t) {
			this.iconImage_.removeEventListener(qi, t);
		}
		ready() {
	...
	class Yd {
		...
		clone() {
			const t = this.getColor();
			return new Yd({ color: Array.isArray(t) ? t.slice() : t || void 0, lineCap: this.getLineCap(), lineDash: this.getLineDash() ? this.getLineDash().slice() : void 0, lineDashOffset: this.getLineDashOffset(), lineJoin: this.getLineJoin(), miterLimit: this.getMiterLimit(), width: this.getWidth() });
		}
		getColor() {
			return this.color_;
		}
	...
	class Hd {
		constructor(t) {
			(t = t || {}), (this.geometry_ = null), (this.geometryFunction_ = eg), void 0 !== t.geometry && this.setGeometry(t.geometry), (this.fill_ = void 0 !== t.fill ? t.fill : null), (this.image_ = void 0 !== t.image ? t.image : null), (this.renderer_ = void 0 !== t.renderer ? t.renderer : null), (this.hitDetectionRenderer_ = void 0 !== t.hitDetectionRenderer ? t.hitDetectionRenderer : null), (this.stroke_ = void 0 !== t.stroke ? t.stroke : null), (this.text_ = void 0 !== t.text ? t.text : null), (this.zIndex_ = t.zIndex);
		}
		clone() {
			let t = this.getGeometry();
			return t && 'object' == typeof t && (t = t.clone()), new Hd({ geometry: t ?? void 0, fill: this.getFill() ? this.getFill().clone() : void 0, image: this.getImage() ? this.getImage().clone() : void 0, renderer: this.getRenderer() ?? void 0, stroke: this.getStroke() ? this.getStroke().clone() : void 0, text: this.getText() ? this.getText().clone() : void 0, zIndex: this.getZIndex() });
		}
		getRenderer() {
			return this.renderer_;
		}
	...
	function Qd(t, e) {
		if (!Jd) {
			const t = new qd({ color: 'rgba(255,255,255,0.4)' }),
				e = new Yd({ color: '#3399CC', width: 1.25 });
			Jd = [new Hd({ image: new Xd({ fill: t, stroke: e, radius: 5 }), fill: t, stroke: e })];
		}
		return Jd;
	}
	function tg() {
		const t = {},
			e = [255, 255, 255, 1],
			i = [0, 153, 255, 1];
		return (t.Polygon = [new Hd({ fill: new qd({ color: [255, 255, 255, 0.5] }) })]), (t.MultiPolygon = t.Polygon), (t.LineString = [new Hd({ stroke: new Yd({ color: e, width: 5 }) }), new Hd({ stroke: new Yd({ color: i, width: 3 }) })]), (t.MultiLineString = t.LineString), (t.Circle = t.Polygon.concat(t.LineString)), (t.Point = [new Hd({ image: new Xd({ radius: 6, fill: new qd({ color: i }), stroke: new Yd({ color: e, width: 1.5 }) }), zIndex: 1 / 0 })]), (t.MultiPoint = t.Point), (t.GeometryCollection = t.Polygon.concat(t.LineString, t.Point)), t;
	}
	function eg(t) {
	...
	class ig {
		...
		setScale(t) {
			(this.scale_ = t), (this.scaleArray_ = Nc(void 0 !== t ? t : 1));
		}
		setStroke(t) {
			this.stroke_ = t;
		}
	...
	function rg(t) {
		const e = tu(),
			i = (function (t, e) {
				...
				for (let r = 0; r < i; ++r) {
					const i = t[r],
						s = 'filter' in i ? sd(i.filter, jc, e) : ng;
					let o;
					if (Array.isArray(i.style)) {
						const t = i.style.length;
						o = new Array(t);
						for (let n = 0; n < t; ++n) o[n] = og(i.style[n], e);
					} else o = [og(i.style, e)];
			...
			n = { variables: {}, properties: {}, resolution: NaN, featureId: null, geometryType: '' };
		return function (t, r) {
			if (((n.properties = t.getPropertiesInternal()), (n.resolution = r), e.featureId)) {
				const e = t.getId();
				n.featureId = void 0 !== e ? e : null;
			}
			return e.geometryType && (n.geometryType = rd(t.getGeometry())), i(n);
		};
	}
	function sg(t) {
		const e = tu(),
			i = t.length,
			n = new Array(i);
		for (let r = 0; r < i; ++r) n[r] = og(t[r], e);
	...
	function og(t, e) {
		const i = ag(t, '', e),
			...
			r = (function (t, e) {
				...
				if (!n) return null;
				const r = ag(t, i, e),
					s = ag(t, i + 'background-', e),
					o = lg(t, i, e),
					a = lg(t, i + 'background-', e),
					l = cg(t, i + 'font', e),
					h = hg(t, i + 'max-angle', e),
					c = hg(t, i + 'offset-x', e),
					u = hg(t, i + 'offset-y', e),
					d = ug(t, i + 'overflow', e),
					g = cg(t, i + 'placement', e),
					f = hg(t, i + 'repeat', e),
					p = mg(t, i + 'scale', e),
					m = ug(t, i + 'rotate-with-view', e),
					_ = hg(t, i + 'rotation', e),
					y = cg(t, i + 'align', e),
					x = cg(t, i + 'justify', e),
					v = cg(t, i + 'baseline', e),
					w = ug(t, i + 'keep-upright', e),
					b = gg(t, i + 'padding', e),
					S = vg(t, i + 'declutter-mode'),
					C = new ig({ declutterMode: S });
				return function (t) {
					if ((C.setText(n(t)), r && C.setFill(r(t)), s && C.setBackgroundFill(s(t)), o && C.setStroke(o(t)), a && C.setBackgroundStroke(a(t)), l && C.setFont(l(t)), h && C.setMaxAngle(h(t)), c && C.setOffsetX(c(t)), u && C.setOffsetY(u(t)), d && C.setOverflow(d(t)), g)) {
						const e = g(t);
				...
				if ('icon-src' in t)
					return (function (t, e) {
						const i = 'icon-',
							...
							o = mg(t, i + 'scale', e),
							a = hg(t, i + 'opacity', e),
							l = fg(t, i + 'displacement', e),
							h = hg(t, i + 'rotation', e),
							c = ug(t, i + 'rotate-with-view', e),
							u = yg(t, i + 'anchor-origin'),
							d = xg(t, i + 'anchor-x-units'),
							g = xg(t, i + 'anchor-y-units'),
							f = (function (t, e) {
								const i = t[e];
								if (void 0 === i) return;
								return Cg(i, e);
							...
							_ = yg(t, i + 'offset-origin'),
							y = _g(t, i + 'width'),
							x = _g(t, i + 'height'),
							v = (function (t, e) {
								const i = t[e];
								if (void 0 === i) return;
								if ('number' == typeof i) return Nc(i);
							...
							w = vg(t, i + 'declutter-mode'),
							b = new Kd({ src: r, anchorOrigin: u, anchorXUnits: d, anchorYUnits: g, color: f, crossOrigin: p, offset: m, offsetOrigin: _, height: x, width: y, size: v, declutterMode: w });
						return function (t) {
				...
				if ('shape-points' in t)
					return (function (t, e) {
						const i = 'shape-',
							...
							l = lg(t, i, e),
							h = mg(t, i + 'scale', e),
							c = fg(t, i + 'displacement', e),
							u = hg(t, i + 'rotation', e),
							d = ug(t, i + 'rotate-with-view', e),
							g = _g(t, i + 'radius2'),
							f = _g(t, i + 'angle'),
							p = vg(t, i + 'declutter-mode'),
							m = new Wd({ points: s, radius: o, radius2: g, angle: f, declutterMode: p });
						return function (t) {
				...
				if ('circle-radius' in t)
					return (function (t, e) {
						const i = 'circle-',
							...
							s = hg(t, i + 'radius', e),
							o = mg(t, i + 'scale', e),
							a = fg(t, i + 'displacement', e),
							l = hg(t, i + 'rotation', e),
							h = ug(t, i + 'rotate-with-view', e),
							c = vg(t, i + 'declutter-mode'),
							u = new Xd({ radius: 5, declutterMode: c });
						return function (t) {
							return s && u.setRadius(s(t)), n && u.setFill(n(t)), r && u.setStroke(r(t)), a && u.setDisplacement(a(t)), l && u.setRotation(l(t)), h && u.setRotateWithView(h(t)), o && u.setScale(o(t)), u;
						};
					})(t, e);
				return null;
			})(t, e),
			o = hg(t, 'z-index', e);
		if (!(i || n || r || s || vn(t))) throw new Error('No fill, stroke, point, or text symbolizer properties in style: ' + JSON.stringify(t));
		const a = new Hd();
		return function (t) {
			let e = !0;
			if (i) {
	...
	function ag(t, e, i) {
		...
		if (e + 'fill-pattern-src' in t)
			n = (function (t, e, i) {
				const n = cg(t, e + 'pattern-src', i),
					r = pg(t, e + 'pattern-offset', i),
					s = pg(t, e + 'pattern-size', i),
					o = dg(t, e + 'color', i);
				return function (t) {
					return { src: n(t), offset: r && r(t), size: s && s(t), color: o && o(t) };
				};
			})(t, e + 'fill-', i);
		else {
			if ('none' === t[e + 'fill-color']) return (t) => null;
			n = dg(t, e + 'fill-color', i);
		}
		if (!n) return null;
		const r = new qd();
		return function (t) {
			const e = n(t);
			return e === _c ? null : (r.setColor(e), r);
		};
	}
	function lg(t, e, i) {
		const n = hg(t, e + 'stroke-width', i),
			r = dg(t, e + 'stroke-color', i);
		if (!n && !r) return null;
		const s = cg(t, e + 'stroke-line-cap', i),
			o = cg(t, e + 'stroke-line-join', i),
			a = gg(t, e + 'stroke-line-dash', i),
			l = hg(t, e + 'stroke-line-dash-offset', i),
			h = hg(t, e + 'stroke-miter-limit', i),
			c = new Yd();
		return function (t) {
			if (r) {
				const e = r(t);
	...
	class Pg extends Hh {
		...
		renderDeclutter(t, e) {
			...
			i in t.declutter == !1 && (t.declutter[i] = new ic(9)), this.getRenderer().renderDeclutter(t, e);
		}
		setRenderOrder(t) {
			this.set(Tg, t);
		}
		setStyle(t) {
			this.style_ = void 0 === t ? Qd : t;
			const e = (function (t) {
				if (void 0 === t) return Qd;
				if (!t) return null;
				...
				if (i instanceof Hd) {
					...
					for (let n = 0; n < e; ++n) {
						const e = t[n];
						if (!(e instanceof Hd)) throw new Error('Expected a list of style instances');
						i[n] = e;
					}
					return i;
				}
				...
				null === t
					...
					: (function (t) {
							...
							if ('function' == typeof t) e = t;
								...
								let i;
								Array.isArray(t) ? (i = t) : (dr('function' == typeof t.getZIndex, 'Expected an `Style` or an array of `Style`'), (i = [t])),
									(e = function () {
										return i;
									});
							}
	...
	class Fg extends an {
		...
		calculateMatrices2D(t) {
			...
			ma(i, t.size[0] / 2, t.size[1] / 2, 1 / e.resolution, -1 / e.resolution, -e.rotation, -e.center[0], -e.center[1]), _a(n, i);
		}
		forEachFeatureAtCoordinate(t, e, i, n, r, s, o, a) {
			...
			for (let n = 0; n < g.length; n++)
				for (let r = p - 1; r >= 0; --r) {
					const s = f[r],
						u = s.layer;
					if (u.hasRenderer() && Jh(s, h) && o.call(a, u)) {
		...
		hasFeatureAtCoordinate(t, e, i, n, r, s) {
			return void 0 !== this.forEachFeatureAtCoordinate(t, e, i, n, fn, this, r, s);
		}
		getMap() {
			return this.map_;
		}
		...
		scheduleExpireIconCache(t) {
			yd.canExpireCache() && t.postRenderFunctions.push(Mg);
		}
	}
	function Mg(t, e) {
		yd.expire();
	...
	class Ig extends Fg {
		constructor(t) {
			super(t), (this.fontChangeListenerKey_ = Sn(kd, Xi, t.redrawText, t)), (this.element_ = document.createElement('div'));
			const e = this.element_.style;
			(e.position = 'absolute'), (e.width = '100%'), (e.height = '100%'), (e.zIndex = '0'), (this.element_.className = Tl + ' ol-layers');
		...
		dispatchRenderEvent(t, e) {
			const i = this.getMap();
			if (i.hasListener(t)) {
				const n = new Rg(t, void 0, e);
				i.dispatchEvent(n);
			}
		}
		disposeInternal() {
			En(this.fontChangeListenerKey_), this.element_.remove(), super.disposeInternal();
		}
		renderFrame(t) {
			if (!t) return void (this.renderedVisible_ && ((this.element_.style.display = 'none'), (this.renderedVisible_ = !1)));
			this.calculateMatrices2D(t), this.dispatchRenderEvent(Zh, t);
			...
			for (let s = 0, o = e.length; s < o; ++s) {
				...
				const a = o.layer,
					l = a.getSourceState();
				if (!Jh(o, i) || ('ready' != l && 'undefined' != l)) {
					a.unrender();
					continue;
				}
				const h = a.render(t, r);
				h && (h !== r && (this.children_.push(h), (r = h)), n.push(o));
			}
			this.declutter(t, n),
				(function (t, e) {
	...
	function kg(t) {
		t instanceof Hh ? t.setMapInternal(null) : t instanceof Vh && t.getLayers().forEach(kg);
	}
	function Lg(t, e) {
		if (t instanceof Hh) t.setMapInternal(e);
		else if (t instanceof Vh) {
			const i = t.getLayers().getArray();
			for (let t = 0, n = i.length; t < n; ++t) Lg(i[t], e);
		}
	}
	let Ag = class extends Ln {
		constructor(t) {
			...
			const e = (function (t) {
				...
				const i = {},
					n = t.layers && 'function' == typeof t.layers.getLayers ? t.layers : new Vh({ layers: t.layers });
				let r, s, o;
				(i[nr] = n), (i[sr] = t.target), (i[or] = t.view instanceof wl ? t.view : new wl()), void 0 !== t.controls && (Array.isArray(t.controls) ? (r = new On(t.controls.slice())) : (dr('function' == typeof t.controls.getArray, 'Expected `controls` to be an array or an `ol/Collection.js`'), (r = t.controls)));
				void 0 !== t.interactions && (Array.isArray(t.interactions) ? (s = new On(t.interactions.slice())) : (dr('function' == typeof t.interactions.getArray, 'Expected `interactions` to be an array or an `ol/Collection.js`'), (s = t.interactions)));
				void 0 !== t.overlays ? (Array.isArray(t.overlays) ? (o = new On(t.overlays.slice())) : (dr('function' == typeof t.overlays.getArray, 'Expected `overlays` to be an array or an `ol/Collection.js`'), (o = t.overlays))) : (o = new On());
			...
			(this.renderComplete_ = !1),
				...
				(this.pixelRatio_ = void 0 !== t.pixelRatio ? t.pixelRatio : Vn),
				...
				(this.controls =
					...
					(function (t) {
						t = t || {};
						const e = new On();
						return (void 0 === t.zoom || t.zoom) && e.push(new Wl(t.zoomOptions)), (void 0 === t.rotate || t.rotate) && e.push(new Vl(t.rotateOptions)), (void 0 === t.attribution || t.attribution) && e.push(new Ul(t.attributionOptions)), e;
					})()),
				(this.interactions = e.interactions || Mh({ onFocusOnly: !0 })),
				(this.overlays_ = e.overlays),
				(this.overlayIdIndex_ = {}),
				(this.renderer_ = null),
				(this.postRenderFunctions_ = []),
				(this.tileQueue_ = new pr(this.getTilePriority.bind(this), this.handleTileChange_.bind(this))),
				this.addChangeListener(nr, this.handleLayerGroupChanged_),
				this.addChangeListener(or, this.handleViewChanged_),
				this.addChangeListener(rr, this.handleSizeChanged_),
				this.addChangeListener(sr, this.handleTargetChanged_),
				this.setProperties(e.values);
			const i = this;
			!t.view ||
				t.view instanceof wl ||
				t.view.then(function (t) {
					i.setView(new wl(t));
				}),
				this.controls.addEventListener(Vi, (t) => {
					t.element.setMap(this);
				}),
				this.controls.addEventListener(Wi, (t) => {
					t.element.setMap(null);
				}),
				this.interactions.addEventListener(Vi, (t) => {
					t.element.setMap(this);
				}),
				this.interactions.addEventListener(Wi, (t) => {
					t.element.setMap(null);
				}),
				this.overlays_.addEventListener(Vi, (t) => {
					this.addOverlayInternal_(t.element);
				}),
				this.overlays_.addEventListener(Wi, (t) => {
		...
		forEachFeatureAtPixel(t, e, i) {
			...
			const n = this.getCoordinateFromPixelInternal(t),
				...
				s = void 0 !== i.layerFilter ? i.layerFilter : fn,
				o = !1 !== i.checkWrapped;
			...
			return (
				(function e(i) {
					i.forEach(function (i) {
						i instanceof Vh ? e(i.getLayers()) : t.push(i);
					});
				})(this.getLayers()),
				t
			);
		...
		hasFeatureAtPixel(t, e) {
			...
			const i = this.getCoordinateFromPixelInternal(t),
				n = void 0 !== (e = void 0 !== e ? e : {}).layerFilter ? e.layerFilter : fn,
		...
		getCoordinateFromPixel(t) {
			return ea(this.getCoordinateFromPixelInternal(t), this.getView().getProjection());
		}
		getCoordinateFromPixelInternal(t) {
			const e = this.frameState_;
			return e ? ga(e.pixelToCoordinateTransform, t.slice()) : null;
		}
		getControls() {
		...
		setLayers(t) {
			...
			if (t instanceof On) return void e.setLayers(t);
			const i = e.getLayers();
			i.clear(), i.extend(t);
		}
		getLayers() {
		...
		getPixelFromCoordinate(t) {
			const e = ia(t, this.getView().getProjection());
			return this.getPixelFromCoordinateInternal(e);
		}
		getPixelFromCoordinateInternal(t) {
			const e = this.frameState_;
			return e ? ga(e.coordinateToPixelTransform, t.slice(0, 2)) : null;
		}
		getRenderer() {
			return this.renderer_;
		}
		...
		getTilePriority(t, e, i, n) {
			return (function (t, e, i, n, r) {
				if (!t || !(i in t.wantedTiles)) return gr;
				if (!t.wantedTiles[i][e.getKey()]) return gr;
		...
		handleMapBrowserEvent(t) {
			...
			if (i === Yn || i === on || i === en) {
				const t = this.getOwnerDocument(),
					...
					n = e.target,
					r = i instanceof ShadowRoot ? (i.host === n ? i.host.ownerDocument : i) : i === t ? t.documentElement : i;
				if (this.overlayContainerStopEvent_.contains(n) || !r.contains(n)) return;
			}
		...
		handlePostRender() {
			...
			t && this.renderer_ && !t.animate && (this.renderComplete_ ? (this.hasListener(Yh) && this.renderer_.dispatchRenderEvent(Yh, t), !1 === this.loaded_ && ((this.loaded_ = !0), this.dispatchEvent(new zn(ir, this, t)))) : !0 === this.loaded_ && ((this.loaded_ = !1), this.dispatchEvent(new zn(er, this, t))));
			const i = this.postRenderFunctions_;
			if (t) for (let e = 0, n = i.length; e < n; ++e) i[e](this, t);
			i.length = 0;
		}
		handleSizeChanged_() {
		...
		handleTargetChanged_() {
			if (this.mapBrowserEventHandler_) {
				for (let t = 0, e = this.targetChangeHandlerKeys_.length; t < e; ++t) En(this.targetChangeHandlerKeys_[t]);
				(this.targetChangeHandlerKeys_ = null), this.viewport_.removeEventListener(Ki, this.boundHandleBrowserEvent_), this.viewport_.removeEventListener(on, this.boundHandleBrowserEvent_), this.mapBrowserEventHandler_.dispose(), (this.mapBrowserEventHandler_ = null), this.viewport_.remove();
			}
			...
			if (((this.targetElement_ = e), e)) {
				e.appendChild(this.viewport_), this.renderer_ || (this.renderer_ = new Ig(this)), (this.mapBrowserEventHandler_ = new Hn(this, this.moveTolerance_));
				for (const t in Gn) this.mapBrowserEventHandler_.addEventListener(Gn[t], this.handleMapBrowserEvent.bind(this));
				let t;
				if ((this.viewport_.addEventListener(Ki, this.boundHandleBrowserEvent_, !1), this.viewport_.addEventListener(on, this.boundHandleBrowserEvent_, !!Zn && { passive: !1 }), this.keyboardEventTarget_)) t = this.keyboardEventTarget_;
				else {
					const i = e.getRootNode();
					t = i instanceof ShadowRoot ? i.host : e;
				}
				this.targetChangeHandlerKeys_ = [Sn(t, en, this.handleBrowserEvent, this), Sn(t, nn, this.handleBrowserEvent, this)];
				const i = e.getRootNode();
		...
		handleViewChanged_() {
			this.viewPropertyListenerKey_ && (En(this.viewPropertyListenerKey_), (this.viewPropertyListenerKey_ = null)), this.viewChangeListenerKey_ && (En(this.viewChangeListenerKey_), (this.viewChangeListenerKey_ = null));
			const t = this.getView();
			t && (this.updateViewportSize_(this.getSize()), (this.viewPropertyListenerKey_ = Sn(t, Xi, this.handleViewPropertyChanged_, this)), (this.viewChangeListenerKey_ = Sn(t, qi, this.handleViewPropertyChanged_, this)), t.resolveConstraints(0)), this.render();
		}
		handleLayerGroupChanged_() {
			this.layerGroupPropertyListenerKeys_ && (this.layerGroupPropertyListenerKeys_.forEach(En), (this.layerGroupPropertyListenerKeys_ = null));
			const t = this.getLayerGroup();
			t && (this.handleLayerAdd_(new Bh('addlayer', t)), (this.layerGroupPropertyListenerKeys_ = [Sn(t, Xi, this.render, this), Sn(t, qi, this.render, this), Sn(t, 'addlayer', this.handleLayerAdd_, this), Sn(t, 'removelayer', this.handleLayerRemove_, this)])), this.render();
		}
		isRendered() {
		...
		renderFrame_(t) {
			const e = this.getSize(),
				...
				n = this.frameState_;
			let r = null;
			if (void 0 !== e && zc(e) && i && i.isDef()) {
				const n = i.getHints(this.frameState_ ? this.frameState_.viewHints : void 0),
					s = i.getState();
				if (((r = { animate: !1, coordinateToPixelTransform: this.coordinateToPixelTransform_, declutter: null, extent: hs(s.center, s.resolution, s.rotation, e), index: this.frameIndex_++, layerIndex: 0, layerStatesArray: this.getLayerGroup().getLayerStatesArray(), pixelRatio: this.pixelRatio_, pixelToCoordinateTransform: this.pixelToCoordinateTransform_, postRenderFunctions: [], size: e, tileQueue: this.tileQueue_, time: t, usedTiles: {}, viewState: s, viewHints: n, wantedTiles: {}, mapId: In(this), renderTargets: {} }), s.nextCenter && s.nextResolution)) {
					const t = isNaN(s.nextRotation) ? s.rotation : s.nextRotation;
					r.nextExtent = hs(s.nextCenter, s.nextResolution, t, e);
				}
			}
			if (((this.frameState_ = r), this.renderer_.renderFrame(r), r)) {
				if ((r.animate && this.render(), Array.prototype.push.apply(this.postRenderFunctions_, r.postRenderFunctions), n)) {
					(!this.previousExtent_ || (!_s(this.previousExtent_) && !Jr(r.extent, this.previousExtent_))) && (this.dispatchEvent(new zn(Qn, this, n)), (this.previousExtent_ = Kr(this.previousExtent_)));
				}
				this.previousExtent_ && !r.viewHints[mr] && !r.viewHints[_r] && !Jr(r.extent, this.previousExtent_) && (this.dispatchEvent(new zn(tr, this, r)), $r(r.extent, this.previousExtent_));
			}
			this.dispatchEvent(new zn(Jn, this, r)),
				(this.renderComplete_ = (this.hasListener(er) || this.hasListener(ir) || this.hasListener(Yh)) && !this.tileQueue_.getTilesLoading() && !this.tileQueue_.getCount() && !this.getLoadingOrNotReady()),
				this.postRenderTimeoutHandle_ ||
		...
		setLayerGroup(t) {
			const e = this.getLayerGroup();
			e && this.handleLayerRemove_(new Bh('removelayer', e)), this.set(nr, t);
		}
		setSize(t) {
			this.set(rr, t);
		}
		...
		setView(t) {
			if (!t || t instanceof wl) return void this.set(or, t);
			this.set(or, new wl());
			const e = this;
			t.then(function (t) {
				e.setView(new wl(t));
		...
		updateSize() {
			...
			if (t) {
				...
				isNaN(n) || isNaN(r) || ((e = [Math.max(0, n), Math.max(0, r)]), !zc(e) && (t.offsetWidth || t.offsetHeight || t.getClientRects().length) && js("No map visible because the map container's width or height are 0."));
			}
			const i = this.getSize();
			!e || (i && gn(e, i)) || (this.setSize(e), this.updateViewportSize_(e));
		}
	...
	class Dg extends Ln {
		...
		clone() {
			const t = new Dg(this.hasProperties() ? this.getProperties() : null);
		...
		handleGeometryChanged_() {
			this.geometryChangeKey_ && (En(this.geometryChangeKey_), (this.geometryChangeKey_ = null));
			const t = this.getGeometry();
			t && (this.geometryChangeKey_ = Sn(t, qi, this.handleGeometryChange_, this)), this.changed();
		}
		setGeometry(t) {
				...
				(this.styleFunction_ = t
					? (function (t) {
							...
							if (Array.isArray(t)) e = t;
								...
								dr('function' == typeof t.getZIndex, 'Expected an `ol/style/Style` or an array of `ol/style/Style.js`');
								e = [t];
							}
							return function () {
								return e;
	...
	function Og(t, e, i, n) {
		...
		for (let o = 0, a = i.length; o < a; ++o) {
			const a = i[o];
			(s = Hr(t, e, a[0], n)), r.push((s[0] + s[2]) / 2, (s[1] + s[3]) / 2), (e = a[a.length - 1]);
		}
		return r;
	}
	function zg(t, e, i, n, r, s, o) {
		let a, l;
		const h = (i - e) / n;
		if (1 === h) a = e;
		else if (2 === h) (a = e), (l = r);
			...
			for (let r = e + n; r < i; r += n) {
				const e = t[r],
					i = t[r + 1];
				(h += Math.sqrt((e - s) * (e - s) + (i - o) * (i - o))), c.push(h), (s = e), (o = i);
			}
			const u = r * h,
				d = (function (t, e, i) {
					let n, r;
			...
			d < 0 ? ((l = (u - c[-d - 2]) / (c[-d - 1] - c[-d - 2])), (a = e + (-d - 2) * n)) : (a = e + d * n);
		}
		(o = o > 1 ? o : 2), (s = s || new Array(o));
		for (let e = 0; e < o; ++e) s[e] = void 0 === a ? NaN : void 0 === l ? t[a + e] : Er(t[a + e], t[a + n + e], l);
		return s;
	}
	function Ng(t, e, i, n, r, s) {
		if (i == e) return null;
		let o;
		...
		o = [];
		for (let e = 0; e < n - 1; ++e) o.push(Er(t[(a - 1) * n + e], t[a * n + e], c));
		return o.push(r), o;
	}
	class Gg extends Ea {
		constructor(t, e, i) {
		...
		clone() {
			const t = new Gg(this.flatCoordinates.slice(), void 0, this.layout);
			return t.applyProperties(this), t;
		}
		closestPointXY(t, e, i, n) {
			const r = this.flatCoordinates,
		...
		computeExtent(t) {
			const e = this.flatCoordinates,
				i = e[this.stride] - e[0];
			return Zr(e[0] - i, e[1] - i, e[0] + i, e[1] + i, t);
		}
		getRadius() {
		...
		intersectsExtent(t) {
			if (ms(t, this.getExtent())) {
				const e = this.getCenter();
				return (t[0] <= e[0] && t[2] >= e[0]) || (t[1] <= e[1] && t[3] >= e[1]) || ns(t, this.intersectsCoordinate.bind(this));
			}
			return !1;
		}
		setCenter(t) {
		...
		rotate(t, e) {
			const i = this.getCenter(),
				n = this.getStride();
			this.setCenter(wa(i, 0, i.length, n, t, e, i)), this.changed();
		}
	}
	Gg.prototype.transform;
	class jg extends Ca {
		constructor(t) {
			super(), (this.geometries_ = t), (this.changeEventsKeys_ = []), this.listenGeometriesChange_();
		}
		unlistenGeometriesChange_() {
			this.changeEventsKeys_.forEach(En), (this.changeEventsKeys_.length = 0);
		}
		listenGeometriesChange_() {
			const t = this.geometries_;
			for (let e = 0, i = t.length; e < i; ++e) this.changeEventsKeys_.push(Sn(t[e], qi, this.changed, this));
		}
		clone() {
			const t = new jg($g(this.geometries_));
			return t.applyProperties(this), t;
		}
		closestPointXY(t, e, i, n) {
			if (n < Br(this.getExtent(), t, e)) return n;
		...
		computeExtent(t) {
			...
			for (let i = 0, n = e.length; i < n; ++i) Qr(t, e[i].getExtent());
			return t;
		}
		getGeometries() {
	...
	class Ug extends Ea {
		...
		appendCoordinate(t) {
			dn(this.flatCoordinates, t), this.changed();
		}
		clone() {
			const t = new Ug(this.flatCoordinates.slice(), this.layout);
			return t.applyProperties(this), t;
		}
		closestPointXY(t, e, i, n) {
			return n < Br(this.getExtent(), t, e) ? n : (this.maxDeltaRevision_ != this.getRevision() && ((this.maxDelta_ = Math.sqrt(Ia(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, 0))), (this.maxDeltaRevision_ = this.getRevision())), La(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !1, t, e, i, n));
		}
		forEachSegment(t) {
			return tl(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t);
		}
		getCoordinateAtM(t, e) {
			return 'XYM' != this.layout && 'XYZM' != this.layout ? null : ((e = void 0 !== e && e), Ng(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e));
		}
		getCoordinates() {
			return Ga(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride);
		}
		getCoordinateAt(t, e) {
			return zg(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e, this.stride);
		}
		getLength() {
			return Bg(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride);
		}
		getFlatMidpoint() {
		...
		getSimplifiedGeometryInternal(t) {
			const e = [];
			return (e.length = Ba(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e, 0)), new Ug(e, 'XY');
		}
		getType() {
			return 'LineString';
		}
		intersectsExtent(t) {
			return il(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, this.getExtent());
		}
		setCoordinates(t, e) {
			this.setLayout(e, t, 1), this.flatCoordinates || (this.flatCoordinates = []), (this.flatCoordinates.length = Oa(this.flatCoordinates, 0, t, this.stride)), this.changed();
		}
	...
	class Vg extends Ea {
		constructor(t, e, i) {
			if ((super(), (this.ends_ = []), (this.maxDelta_ = -1), (this.maxDeltaRevision_ = -1), Array.isArray(t[0]))) this.setCoordinates(t, e);
				...
				for (let t = 0, r = e.length; t < r; ++t) {
					dn(i, e[t].getFlatCoordinates()), n.push(i.length);
				}
		...
		appendLineString(t) {
			dn(this.flatCoordinates, t.getFlatCoordinates().slice()), this.ends_.push(this.flatCoordinates.length), this.changed();
		}
		clone() {
			const t = new Vg(this.flatCoordinates.slice(), this.layout, this.ends_.slice());
			return t.applyProperties(this), t;
		}
		closestPointXY(t, e, i, n) {
			return n < Br(this.getExtent(), t, e) ? n : (this.maxDeltaRevision_ != this.getRevision() && ((this.maxDelta_ = Math.sqrt(ka(this.flatCoordinates, 0, this.ends_, this.stride, 0))), (this.maxDeltaRevision_ = this.getRevision())), Aa(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !1, t, e, i, n));
		}
		getCoordinateAtM(t, e, i) {
			return ('XYM' != this.layout && 'XYZM' != this.layout) || 0 === this.flatCoordinates.length
				...
				: ((e = void 0 !== e && e),
				  (i = void 0 !== i && i),
				  (function (t, e, i, n, r, s, o) {
						if (o) return Ng(t, e, i[i.length - 1], n, r, s);
						let a;
						...
						for (let s = 0, o = i.length; s < o; ++s) {
							...
							if (e != o) {
								...
								if (r <= t[o - 1]) return Ng(t, e, o, n, r, !1);
								e = o;
							}
						}
						return null;
		...
		getCoordinates() {
			return ja(this.flatCoordinates, 0, this.ends_, this.stride);
		}
		getEnds() {
			return this.ends_;
		}
		getLineString(t) {
			return t < 0 || this.ends_.length <= t ? null : new Ug(this.flatCoordinates.slice(0 === t ? 0 : this.ends_[t - 1], this.ends_[t]), this.layout);
		}
		getLineStrings() {
			const t = this.flatCoordinates,
				e = this.ends_,
		...
		getLength() {
			...
			let e = 0,
				i = 0;
			for (let n = 0, r = t.length; n < r; ++n) (i += Bg(this.flatCoordinates, e, t[n], this.stride)), (e = t[n]);
			return i;
		}
		getFlatMidpoints() {
			const t = [],
		...
		getSimplifiedGeometryInternal(t) {
			const e = [],
				i = [];
			return (e.length = Ua(this.flatCoordinates, 0, this.ends_, this.stride, t, e, 0, i)), new Vg(e, 'XY', i);
		}
		getType() {
	...
	class Wg extends Ea {
		...
		appendPoint(t) {
			dn(this.flatCoordinates, t.getFlatCoordinates()), this.changed();
		}
		clone() {
			const t = new Wg(this.flatCoordinates.slice(), this.layout);
			return t.applyProperties(this), t;
		}
		closestPointXY(t, e, i, n) {
			if (n < Br(this.getExtent(), t, e)) return n;
		...
		getPoint(t) {
			...
			return t < 0 || e <= t ? null : new Za(this.flatCoordinates.slice(t * this.stride, (t + 1) * this.stride), this.layout);
		}
		getPoints() {
			const t = this.flatCoordinates,
				e = this.layout,
			...
			for (let r = 0, s = t.length; r < s; r += i) {
				const s = new Za(t.slice(r, r + i), e);
				n.push(s);
			}
			return n;
		}
	...
	class Xg extends Ea {
		constructor(t, e, i) {
			if ((super(), (this.endss_ = []), (this.flatInteriorPointsRevision_ = -1), (this.flatInteriorPoints_ = null), (this.maxDelta_ = -1), (this.maxDeltaRevision_ = -1), (this.orientedRevision_ = -1), (this.orientedFlatCoordinates_ = null), !i && !Array.isArray(t[0]))) {
				...
				for (let t = 0, e = n.length; t < e; ++t) {
					...
					dn(r, e.getFlatCoordinates()), s.push(o);
				}
		...
		appendPolygon(t) {
			...
			if (this.flatCoordinates) {
				...
				dn(this.flatCoordinates, t.getFlatCoordinates()), (e = t.getEnds().slice());
		...
		clone() {
			...
			const i = new Xg(this.flatCoordinates.slice(), this.layout, e);
			return i.applyProperties(this), i;
		}
		closestPointXY(t, e, i, n) {
			return n < Br(this.getExtent(), t, e)
				? n
				: (this.maxDeltaRevision_ != this.getRevision() &&
						((this.maxDelta_ = Math.sqrt(
							(function (t, e, i, n, r) {
								for (let s = 0, o = i.length; s < o; ++s) {
									const o = i[s];
									(r = ka(t, e, o, n, r)), (e = o[o.length - 1]);
								}
								return r;
							})(this.flatCoordinates, 0, this.endss_, this.stride, 0)
						)),
						(this.maxDeltaRevision_ = this.getRevision())),
				  (function (t, e, i, n, r, s, o, a, l, h, c) {
						c = c || [NaN, NaN];
						for (let u = 0, d = i.length; u < d; ++u) {
							const d = i[u];
							(h = Aa(t, e, d, n, r, s, o, a, l, h, c)), (e = d[d.length - 1]);
						}
						return h;
		...
		getCoordinates(t) {
			let e;
			return void 0 !== t ? ((e = this.getOrientedFlatCoordinates().slice()), cl(e, 0, this.endss_, this.stride, t)) : (e = this.flatCoordinates), $a(e, 0, this.endss_, this.stride);
		}
		getEndss() {
			return this.endss_;
		}
		getFlatInteriorPoints() {
			if (this.flatInteriorPointsRevision_ != this.getRevision()) {
				const t = Og(this.flatCoordinates, 0, this.endss_, this.stride);
				(this.flatInteriorPoints_ = Qa(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, t)), (this.flatInteriorPointsRevision_ = this.getRevision());
			}
			return this.flatInteriorPoints_;
		}
		getInteriorPoints() {
			return new Wg(this.getFlatInteriorPoints().slice(), 'XYM');
		}
		getOrientedFlatCoordinates() {
			if (this.orientedRevision_ != this.getRevision()) {
				const t = this.flatCoordinates;
				ll(t, 0, this.endss_, this.stride) ? (this.orientedFlatCoordinates_ = t) : ((this.orientedFlatCoordinates_ = t.slice()), (this.orientedFlatCoordinates_.length = cl(this.orientedFlatCoordinates_, 0, this.endss_, this.stride))), (this.orientedRevision_ = this.getRevision());
			}
			return this.orientedFlatCoordinates_;
		}
		getSimplifiedGeometryInternal(t) {
			const e = [],
				i = [];
			return (
				(e.length = (function (t, e, i, n, r, s, o, a) {
					for (let l = 0, h = i.length; l < h; ++l) {
						const h = i[l],
							c = [];
						(o = Xa(t, e, h, n, r, s, o, c)), a.push(c), (e = h[h.length - 1]);
					}
					return o;
		...
		getPolygon(t) {
			...
			return new dl(this.flatCoordinates.slice(e, n), this.layout, i);
		}
		getPolygons() {
			const t = this.layout,
				e = this.flatCoordinates,
			...
			for (let s = 0, o = i.length; s < o; ++s) {
				...
				const l = new dl(e.slice(r, a), t, o);
				n.push(l), (r = a);
			}
			return n;
		}
		...
		setCoordinates(t, e) {
			...
			const i = Na(this.flatCoordinates, 0, t, this.stride, this.endss_);
	...
	const qg = [1, 0, 0, 1, 0, 0];
	class Zg {
		constructor(t, e, i, n, r, s) {
			this.styleFunction, this.extent_, (this.id_ = s), (this.type_ = t), (this.flatCoordinates_ = e), (this.flatInteriorPoints_ = null), (this.flatMidpoints_ = null), (this.ends_ = i || null), (this.properties_ = r), this.squaredTolerance_, (this.stride_ = n), this.simplifiedGeometry_;
		}
		get(t) {
			return this.properties_[t];
		}
		getExtent() {
			return this.extent_ || (this.extent_ = 'Point' === this.type_ ? Yr(this.flatCoordinates_) : Hr(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2)), this.extent_;
		}
		getFlatInteriorPoint() {
			if (!this.flatInteriorPoints_) {
				const t = as(this.getExtent());
				this.flatInteriorPoints_ = Ja(this.flatCoordinates_, 0, this.ends_, 2, t, 0);
			}
			return this.flatInteriorPoints_;
		}
		getFlatInteriorPoints() {
			if (!this.flatInteriorPoints_) {
				const t = ul(this.flatCoordinates_, this.ends_),
					e = Og(this.flatCoordinates_, 0, t, 2);
				this.flatInteriorPoints_ = Qa(this.flatCoordinates_, 0, t, 2, e);
			}
			return this.flatInteriorPoints_;
		}
		getFlatMidpoint() {
			return this.flatMidpoints_ || (this.flatMidpoints_ = zg(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2, 0.5)), this.flatMidpoints_;
		}
		getFlatMidpoints() {
		...
		transform(t) {
			const e = (t = Go(t)).getExtent(),
				i = t.getWorldExtent();
			if (e && i) {
				const t = us(i) / us(e);
				ma(qg, i[0], i[3], t, -t, 0, 0, 0), va(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2, qg, this.flatCoordinates_);
			}
		}
		applyTransform(t) {
		...
		clone() {
			return new Zg(this.type_, this.flatCoordinates_.slice(), this.ends_?.slice(), this.stride_, Object.assign({}, this.properties_), this.id_);
		}
		getEnds() {
			return this.ends_;
		}
		enableSimplifyTransformed() {
			return (
				(this.simplifyTransformed = _n((t, e) => {
					...
					switch (this.type_) {
						case 'LineString':
							(i.length = Ba(i, 0, this.simplifiedGeometry_.flatCoordinates_.length, this.simplifiedGeometry_.stride_, t, i, 0)), (n = [i.length]);
							break;
						case 'MultiLineString':
							(n = []), (i.length = Ua(i, 0, this.simplifiedGeometry_.ends_, this.simplifiedGeometry_.stride_, t, i, 0, n));
							break;
						case 'Polygon':
							(n = []), (i.length = Xa(i, 0, this.simplifiedGeometry_.ends_, this.simplifiedGeometry_.stride_, Math.sqrt(t), i, 0, n));
					}
					return n && (this.simplifiedGeometry_ = new Zg(this.type_, i, n, 2, this.properties_, this.id_)), (this.squaredTolerance_ = t), this.simplifiedGeometry_;
				})),
				this
			);
		}
	}
	Zg.prototype.getFlatCoordinates = Zg.prototype.getOrientedFlatCoordinates;
	class Kg {
	...
	class Yg extends Kg {
		constructor(t, e, i, n, r, s, o) {
			super(),
				...
				(this.extent_ = i),
				(this.transform_ = n),
				(this.transformRotation_ = n ? Tr(Math.atan2(n[1], n[0]), 10) : 0),
		...
		drawImages_(t, e, i, n) {
			...
			const r = va(t, e, i, n, this.transform_, this.pixelCoordinates_),
				s = this.context_,
			...
			for (let t = 0, e = r.length; t < e; t += 2) {
				...
				if (0 !== l || 1 != this.imageScale_[0] || 1 != this.imageScale_[1]) {
					...
					ma(o, t, n, 1, 1, l, -t, -n), s.save(), s.transform.apply(s, o), s.translate(t, n), s.scale(this.imageScale_[0], this.imageScale_[1]), s.drawImage(this.image_, this.imageOriginX_, this.imageOriginY_, this.imageWidth_, this.imageHeight_, -this.imageAnchorX_, -this.imageAnchorY_, this.imageWidth_, this.imageHeight_), s.restore();
		...
		moveToLineTo_(t, e, i, n, r) {
			const s = this.context_,
				o = va(t, e, i, n, this.transform_, this.pixelCoordinates_);
			s.moveTo(o[0], o[1]);
			let a = o.length;
			r && (a -= 2);
		...
		drawCircle(t) {
			if ((this.squaredTolerance_ && (t = t.simplifyTransformed(this.squaredTolerance_, this.userTransform_)), ms(this.extent_, t.getExtent()))) {
		...
		setContextTextState_(t) {
			const e = this.context_,
				...
				n = t.textAlign ? t.textAlign : Fd;
			i ? (i.font != t.font && ((i.font = t.font), (e.font = t.font)), i.textAlign != n && ((i.textAlign = n), (e.textAlign = n)), i.textBaseline != t.textBaseline && ((i.textBaseline = t.textBaseline), (e.textBaseline = t.textBaseline))) : ((e.font = t.font), (e.textAlign = n), (e.textBaseline = t.textBaseline), (this.contextTextState_ = { font: t.font, textAlign: n, textBaseline: t.textBaseline }));
		}
		setFillStrokeStyle(t, e) {
			if (t) {
				const e = t.getColor();
				this.fillState_ = { fillStyle: bd(e || Cd) };
			...
			if (e) {
				const t = e.getColor(),
					...
					a = e.getMiterLimit(),
					l = n || Td;
				this.strokeState_ = { lineCap: void 0 !== i ? i : Ed, lineDash: 1 === this.pixelRatio_ ? l : l.map((t) => t * this.pixelRatio_), lineDashOffset: (r || 0) * this.pixelRatio_, lineJoin: void 0 !== s ? s : Pd, lineWidth: (void 0 !== o ? o : 1) * this.pixelRatio_, miterLimit: void 0 !== a ? a : 10, strokeStyle: bd(t || Rd) };
		...
		setTextStyle(t) {
			if (t) {
				...
				if (e) {
					const t = e.getColor();
					this.textFillState_ = { fillStyle: bd(t || Cd) };
				...
				if (i) {
					const t = i.getColor(),
						...
						o = i.getWidth(),
						a = i.getMiterLimit();
					this.textStrokeState_ = { lineCap: void 0 !== e ? e : Ed, lineDash: n || Td, lineDashOffset: r || 0, lineJoin: void 0 !== s ? s : Pd, lineWidth: void 0 !== o ? o : 1, miterLimit: void 0 !== a ? a : 10, strokeStyle: bd(t || Rd) };
				...
				const n = t.getFont(),
					...
					c = t.getTextAlign(),
					u = t.getTextBaseline();
				(this.textState_ = { font: void 0 !== n ? n : Sd, textAlign: void 0 !== c ? c : Fd, textBaseline: void 0 !== u ? u : Md }), (this.text_ = void 0 !== h ? (Array.isArray(h) ? h.reduce((t, e, i) => t + (i % 2 ? ' ' : e), '') : h) : ''), (this.textOffsetX_ = void 0 !== r ? this.pixelRatio_ * r : 0), (this.textOffsetY_ = void 0 !== s ? this.pixelRatio_ * s : 0), (this.textRotateWithView_ = void 0 !== o && o), (this.textRotation_ = void 0 !== a ? a : 0), (this.textScale_ = [this.pixelRatio_ * l[0], this.pixelRatio_ * l[1]]);
			} else this.text_ = '';
		}
	}
	const Hg = {
		Point: function (t, e, i, n, r, s) {
			const o = i.getImage(),
				a = i.getText(),
				l = a && a.getText(),
				h = s && o && l ? {} : void 0;
			if (o) {
				if (o.getImageState() != ud) return;
				const s = t.getBuilder(i.getZIndex(), 'Image');
				s.setImageStyle(o, h), s.drawPoint(e, n, r);
			}
			if (l) {
				const s = t.getBuilder(i.getZIndex(), 'Text');
				s.setTextStyle(a, h), s.drawText(e, n, r);
			}
		},
		LineString: function (t, e, i, n, r) {
			...
			if (s) {
				...
				o.setFillStrokeStyle(null, s), o.drawLineString(e, n, r);
			}
			const o = i.getText();
			if (o && o.getText()) {
				const s = t.getBuilder(i.getZIndex(), 'Text');
				s.setTextStyle(o), s.drawText(e, n, r);
			}
		},
		Polygon: function (t, e, i, n, r) {
			...
			if (s || o) {
				...
				a.setFillStrokeStyle(s, o), a.drawPolygon(e, n, r);
			}
			const a = i.getText();
			if (a && a.getText()) {
				const s = t.getBuilder(i.getZIndex(), 'Text');
				s.setTextStyle(a), s.drawText(e, n, r);
			}
		},
		MultiPoint: function (t, e, i, n, r, s) {
			const o = i.getImage(),
				a = o && 0 !== o.getOpacity(),
				l = i.getText(),
				h = l && l.getText(),
			...
			if (a) {
				if (o.getImageState() != ud) return;
				const s = t.getBuilder(i.getZIndex(), 'Image');
				s.setImageStyle(o, c), s.drawMultiPoint(e, n, r);
			}
			if (h) {
				const s = t.getBuilder(i.getZIndex(), 'Text');
				s.setTextStyle(l, c), s.drawText(e, n, r);
			}
		},
		MultiLineString: function (t, e, i, n, r) {
			...
			if (s) {
				const o = t.getBuilder(i.getZIndex(), 'LineString');
				o.setFillStrokeStyle(null, s), o.drawMultiLineString(e, n, r);
			}
			const o = i.getText();
			if (o && o.getText()) {
				const s = t.getBuilder(i.getZIndex(), 'Text');
		...
		MultiPolygon: function (t, e, i, n, r) {
			...
			if (o || s) {
				const a = t.getBuilder(i.getZIndex(), 'Polygon');
				a.setFillStrokeStyle(s, o), a.drawMultiPolygon(e, n, r);
			}
			const a = i.getText();
			if (a && a.getText()) {
				const s = t.getBuilder(i.getZIndex(), 'Text');
		...
		GeometryCollection: function (t, e, i, n, r, s) {
			const o = e.getGeometriesArray();
			let a, l;
			for (a = 0, l = o.length; a < l; ++a) {
				(0, Hg[o[a].getType()])(t, o[a], i, n, r, s);
			}
		},
		Circle: function (t, e, i, n, r) {
			...
			if (s || o) {
				...
				a.setFillStrokeStyle(s, o), a.drawCircle(e, n, r);
			}
			const a = i.getText();
			if (a && a.getText()) {
	...
	function Jg(t, e) {
		return parseInt(In(t), 10) - parseInt(In(e), 10);
	}
	function Qg(t, e) {
		const i = tf(t, e);
		return i * i;
	...
	function ef(t, e, i, n, r, s, o, a) {
		const l = [],
			h = i.getImage();
		if (h) {
			let t = !0;
			const e = h.getImageState();
			e == ud || e == dd ? (t = !1) : e == hd && h.load(), t && l.push(h.ready());
		}
		const c = i.getFill();
	...
	function nf(t, e, i, n, r) {
		if ('GeometryCollection' == e.getType()) {
			...
			for (let e = 0, o = s.length; e < o; ++e) nf(t, s[e], i, n, r);
			return;
		}
		t.getBuilder(i.getZIndex(), 'Default').drawCustom(e, n, i.getRenderer(), i.getHitDetectionRenderer(), r);
	}
	function rf(t, e, i, n, r, s, o) {
		...
		a.open('GET', 'function' == typeof t ? t(i, n, r) : t, !0),
			...
			(a.onload = function (t) {
				if (!a.status || (a.status >= 200 && a.status < 300)) {
					...
					try {
						let n;
						'text' == t || 'json' == t ? (n = a.responseText) : 'xml' == t ? (n = a.responseXML || a.responseText) : 'arraybuffer' == t && (n = a.response), n ? s(e.readFeatures(n, { extent: i, featureProjection: r }), e.readProjection(n)) : o();
					} catch {
						o();
					}
				} else o();
	...
	class lf {
		constructor(t) {
			(this.rbush_ = new ic(t)), (this.items_ = {});
		}
		insert(t, e) {
			const i = { minX: t[0], minY: t[1], maxX: t[2], maxY: t[3], value: e };
			this.rbush_.insert(i), (this.items_[In(e)] = i);
		}
		load(t, e) {
		...
		update(t, e) {
			const i = this.items_[In(e)];
			Jr([i.minX, i.minY, i.maxX, i.maxY], t) || (this.remove(e), this.insert(t, e));
		}
		getAll() {
		...
		getExtent(t) {
			...
			return Zr(e.minX, e.minY, e.maxX, e.maxY, t);
		}
		concat(t) {
	...
	class hf extends Ln {
		constructor(t) {
			super(), (this.projection = Go(t.projection)), (this.attributions_ = cf(t.attributions)), (this.attributionsCollapsible_ = t.attributionsCollapsible ?? !0), (this.loading = !1), (this.state_ = void 0 !== t.state ? t.state : 'ready'), (this.wrapX_ = void 0 !== t.wrapX && t.wrapX), (this.interpolate_ = !!t.interpolate), (this.viewResolver = null), (this.viewRejector = null);
			const e = this;
		...
		setAttributions(t) {
			(this.attributions_ = cf(t)), this.changed();
		}
		setState(t) {
	...
	var uf = 'addfeature',
		...
		gf = 'clear',
		ff = 'removefeature',
		pf = 'featuresloadstart',
		mf = 'featuresloadend',
		_f = 'featuresloaderror';
	class yf extends wn {
		constructor(t, e, i) {
	...
	class xf extends hf {
		constructor(t) {
			super({ attributions: (t = t || {}).attributions, interpolate: !0, projection: void 0, state: 'ready', wrapX: void 0 === t.wrapX || t.wrapX }), this.on, this.once, this.un, (this.loader_ = mn), (this.format_ = t.format || null), (this.overlaps_ = void 0 === t.overlaps || t.overlaps), (this.url_ = t.url), void 0 !== t.loader ? (this.loader_ = t.loader) : void 0 !== this.url_ && (dr(this.format_, '`format` must be set when `url` is set'), (this.loader_ = sf(this.url_, this.format_))), (this.strategy_ = void 0 !== t.strategy ? t.strategy : of);
			const e = void 0 === t.useSpatialIndex || t.useSpatialIndex;
			let i, n;
			(this.featuresRtree_ = e ? new lf() : null), (this.loadedExtentsRtree_ = new lf()), (this.loadingExtentsCount_ = 0), (this.nullGeometryFeatures_ = {}), (this.idIndex_ = {}), (this.uidIndex_ = {}), (this.featureChangeKeys_ = {}), (this.featuresCollection_ = null), Array.isArray(t.features) ? (n = t.features) : t.features && ((i = t.features), (n = i.getArray())), e || void 0 !== i || (i = new On(n)), void 0 !== n && this.addFeaturesInternal(n), void 0 !== i && this.bindFeaturesCollection_(i);
		}
		addFeature(t) {
		...
		addFeatureInternal(t) {
			...
			this.dispatchEvent(new yf(uf, t));
		}
		setupChangeEvents_(t, e) {
			e instanceof Zg || (this.featureChangeKeys_[t] = [Sn(e, qi, this.handleFeatureChange_, this), Sn(e, Xi, this.handleFeatureChange_, this)]);
		}
		addToIndex_(t, e) {
			let i = !0;
			if (void 0 !== e.getId()) {
				...
				if (t in this.idIndex_)
					if (e instanceof Zg) {
						...
						n instanceof Zg ? (Array.isArray(n) ? n.push(e) : (this.idIndex_[t] = [n, e])) : (i = !1);
					} else i = !1;
				else this.idIndex_[t] = e;
			}
			return i && (dr(!(t in this.uidIndex_), 'The passed `feature` was already added to the source'), (this.uidIndex_[t] = e)), i;
		}
		addFeatures(t) {
		...
		addFeaturesInternal(t) {
			...
			if ((this.featuresRtree_ && this.featuresRtree_.load(e, n), this.hasListener(uf))) for (let t = 0, e = i.length; t < e; t++) this.dispatchEvent(new yf(uf, i[t]));
		}
		bindFeaturesCollection_(t) {
			let e = !1;
			this.addEventListener(uf, function (i) {
				e || ((e = !0), t.push(i.feature), (e = !1));
			}),
				this.addEventListener(ff, function (i) {
					e || ((e = !0), t.remove(i.feature), (e = !1));
				}),
				t.addEventListener(Vi, (t) => {
					e || ((e = !0), this.addFeature(t.element), (e = !1));
				}),
				t.addEventListener(Wi, (t) => {
		...
		clear(t) {
			if (t) {
				for (const t in this.featureChangeKeys_) {
					this.featureChangeKeys_[t].forEach(En);
				}
		...
		forEachFeatureAtCoordinateDirect(t, e) {
			...
			return this.forEachFeatureInExtent(i, function (i) {
				...
				if (n instanceof Zg || n.intersectsCoordinate(t)) return e(i);
			});
		}
		...
		forEachFeatureIntersectingExtent(t, e) {
			return this.forEachFeatureInExtent(t, function (i) {
				const n = i.getGeometry();
				if (n instanceof Zg || n.intersectsExtent(t)) {
					const t = e(i);
					if (t) return t;
				}
			});
		...
		getFeatures() {
			let t;
			return this.featuresCollection_ ? (t = this.featuresCollection_.getArray().slice(0)) : this.featuresRtree_ && ((t = this.featuresRtree_.getAll()), vn(this.nullGeometryFeatures_) || dn(t, Object.values(this.nullGeometryFeatures_))), t;
		}
				...
				this.featuresRtree_.forEachInExtent(a, function (t) {
					if (e(t)) {
						const e = t.getGeometry(),
							l = o;
						if (((o = e instanceof Zg ? 0 : e.closestPointXY(i, n, s, o)), o < l)) {
							r = t;
							const e = Math.sqrt(o);
		...
		handleFeatureChange_(t) {
			...
			this.changed(), this.dispatchEvent(new yf(df, e));
		}
		hasFeature(t) {
			const e = t.getId();
			return void 0 !== e ? e in this.idIndex_ : In(t) in this.uidIndex_;
		}
		isEmpty() {
			return this.featuresRtree_ ? this.featuresRtree_.isEmpty() && vn(this.nullGeometryFeatures_) : !this.featuresCollection_ || 0 === this.featuresCollection_.getLength();
		}
		loadFeatures(t, e, i) {
			...
			for (let t = 0, s = r.length; t < s; ++t) {
				...
				n.forEachInExtent(s, function (t) {
					return Vr(t.extent, s);
				}) ||
					(++this.loadingExtentsCount_,
					this.dispatchEvent(new yf(pf)),
					this.loader_.call(
						this,
						s,
						e,
						i,
						(t) => {
							--this.loadingExtentsCount_, this.dispatchEvent(new yf(mf, void 0, t));
						},
						() => {
							--this.loadingExtentsCount_, this.dispatchEvent(new yf(_f));
						}
					),
		...
		removeLoadedExtent(t) {
			const e = this.loadedExtentsRtree_,
				i = e.forEachInExtent(t, function (e) {
					if (Jr(e.extent, t)) return e;
				});
			i && e.remove(i);
		}
		removeFeatures(t) {
			let e = !1;
			for (let i = 0, n = t.length; i < n; ++i) e = this.removeFeatureInternal(t[i]) || e;
			e && this.changed();
		}
		removeFeature(t) {
			if (!t) return;
		...
		removeFeatureInternal(t) {
			...
			i?.forEach(En), delete this.featureChangeKeys_[e];
			const n = t.getId();
			if (void 0 !== n) {
				const e = n.toString(),
					i = this.idIndex_[e];
				i === t ? delete this.idIndex_[e] : Array.isArray(i) && (i.splice(i.indexOf(t), 1), 1 === i.length && (this.idIndex_[e] = i[0]));
			}
			return delete this.uidIndex_[e], this.hasListener(ff) && this.dispatchEvent(new yf(ff, t)), !0;
		}
		...
		setUrl(t) {
			dr(this.format_, '`format` must be set when `url` is set'), (this.url_ = t), this.setLoader(sf(t, this.format_));
		}
		setOverlaps(t) {
	...
	class zf extends Kg {
		...
		appendFlatPointCoordinates(t, e) {
			const i = this.getBufferedMaxExtent(),
				...
				r = this.coordinates;
			let s = r.length;
			for (let o = 0, a = t.length; o < a; o += e) (n[0] = t[o]), (n[1] = t[o + 1]), Ur(i, n) && ((r[s++] = n[0]), (r[s++] = n[1]));
			return s;
		}
		appendFlatLineCoordinates(t, e, i, n, r, s) {
			...
			let d,
				...
				f,
				p = !0;
			for (d = e + n; d < i; d += n) (u[0] = t[d]), (u[1] = t[d + 1]), (f = Xr(l, u)), f !== g ? (p && ((o[a++] = h), (o[a++] = c), (p = !1)), (o[a++] = u[0]), (o[a++] = u[1])) : f === Ar ? ((o[a++] = u[0]), (o[a++] = u[1]), (p = !1)) : (p = !0), (h = u[0]), (c = u[1]), (g = f);
		...
		drawCustom(t, e, i, n, r) {
			...
			switch (s) {
				case 'MultiPolygon':
					...
					this.instructions.push([Cf, a, u, t, i, $a, r]), this.hitDetectionInstructions.push([Cf, a, u, t, n || i, $a, r]);
					break;
				case 'Polygon':
				case 'MultiLineString':
					(c = []), (l = 'Polygon' == s ? t.getOrientedFlatCoordinates() : t.getFlatCoordinates()), (d = this.drawCustomCoordinates_(l, 0, t.getEnds(), o, c)), this.instructions.push([Cf, a, c, t, i, ja, r]), this.hitDetectionInstructions.push([Cf, a, c, t, n || i, ja, r]);
					break;
				case 'LineString':
				case 'Circle':
					(l = t.getFlatCoordinates()), (h = this.appendFlatLineCoordinates(l, 0, l.length, o, !1, !1)), this.instructions.push([Cf, a, h, t, i, Ga, r]), this.hitDetectionInstructions.push([Cf, a, h, t, n || i, Ga, r]);
					break;
				case 'MultiPoint':
					(l = t.getFlatCoordinates()), (h = this.appendFlatPointCoordinates(l, o)), h > a && (this.instructions.push([Cf, a, h, t, i, Ga, r]), this.hitDetectionInstructions.push([Cf, a, h, t, n || i, Ga, r]));
					break;
				case 'Point':
					(l = t.getFlatCoordinates()), this.coordinates.push(l[0], l[1]), (h = this.coordinates.length), this.instructions.push([Cf, a, h, t, i, void 0, r]), this.hitDetectionInstructions.push([Cf, a, h, t, n || i, void 0, r]);
			}
			this.endGeometry(e);
		}
		beginGeometry(t, e, i) {
			(this.beginGeometryInstruction1_ = [vf, e, 0, t, i]), this.instructions.push(this.beginGeometryInstruction1_), (this.beginGeometryInstruction2_ = [vf, e, 0, t, i]), this.hitDetectionInstructions.push(this.beginGeometryInstruction2_);
		}
		finish() {
		...
		reverseHitDetectionInstructions() {
			...
			let n,
				r,
				s = -1;
			for (e = 0; e < i; ++e) (n = t[e]), (r = n[0]), r == Pf ? (s = e) : r == vf && ((n[2] = e), un(this.hitDetectionInstructions, s, e), (s = -1));
		}
		fillStyleToState(t, e = {}) {
			if (t) {
				const i = t.getColor();
				(e.fillPatternScale = i && 'object' == typeof i && 'src' in i ? this.pixelRatio : 1), (e.fillStyle = bd(i || Cd));
		...
		createStroke(t) {
			return [If, t.strokeStyle, t.lineWidth * this.pixelRatio, t.lineCap, t.lineJoin, t.miterLimit, t.lineDash ? this.applyPixelRatio(t.lineDash) : null, t.lineDashOffset * this.pixelRatio];
		}
		updateFillStyle(t, e) {
			const i = t.fillStyle;
			('string' == typeof i && t.currentFillStyle == i) || (this.instructions.push(e.call(this, t)), (t.currentFillStyle = i));
		}
		updateStrokeStyle(t, e) {
			const i = t.strokeStyle,
				...
				a = t.lineWidth,
				l = t.miterLimit;
			(t.currentStrokeStyle != i || t.currentLineCap != n || (r != t.currentLineDash && !gn(t.currentLineDash, r)) || t.currentLineDashOffset != s || t.currentLineJoin != o || t.currentLineWidth != a || t.currentMiterLimit != l) && (e.call(this, t), (t.currentStrokeStyle = i), (t.currentLineCap = n), (t.currentLineDash = r), (t.currentLineDashOffset = s), (t.currentLineJoin = o), (t.currentLineWidth = a), (t.currentMiterLimit = l));
		}
		endGeometry(t) {
		...
		getBufferedMaxExtent() {
			if (!this.bufferedMaxExtent_ && ((this.bufferedMaxExtent_ = $r(this.maxExtent)), this.maxLineWidth > 0)) {
				const t = (this.resolution * (this.maxLineWidth + 1)) / 2;
				jr(this.bufferedMaxExtent_, t, this.bufferedMaxExtent_);
			}
	...
	class Nf extends zf {
		...
		drawFlatCoordinatess_(t, e, i, n) {
			const r = this.state,
				...
				a = i.length;
			this.instructions.push(Df), this.hitDetectionInstructions.push(Df);
			for (let r = 0; r < a; ++r) {
				const s = i[r],
					a = this.coordinates.length,
					l = this.appendFlatLineCoordinates(t, e, s, n, !0, !o),
					h = [Ff, a, l];
				this.instructions.push(h), this.hitDetectionInstructions.push(h), o && (this.instructions.push(Of), this.hitDetectionInstructions.push(Of)), (e = s);
			}
			return s && (this.instructions.push(Lf), this.hitDetectionInstructions.push(Lf)), o && (this.instructions.push(Af), this.hitDetectionInstructions.push(Af)), e;
		}
		drawCircle(t, e, i) {
			const n = this.state,
				r = n.fillStyle,
			...
			this.setFillStrokeStyles_(), this.beginGeometry(t, e, i), void 0 !== n.fillStyle && this.hitDetectionInstructions.push([Mf, Cd]), void 0 !== n.strokeStyle && this.hitDetectionInstructions.push([If, n.strokeStyle, n.lineWidth, n.lineCap, n.lineJoin, n.miterLimit, Td, 0]);
			const o = t.getFlatCoordinates(),
				a = t.getStride(),
				l = this.coordinates.length;
			this.appendFlatLineCoordinates(o, 0, o.length, a, !1, !1);
			const h = [bf, l];
			this.instructions.push(Df, h), this.hitDetectionInstructions.push(Df, h), void 0 !== n.fillStyle && (this.instructions.push(Lf), this.hitDetectionInstructions.push(Lf)), void 0 !== n.strokeStyle && (this.instructions.push(Af), this.hitDetectionInstructions.push(Af)), this.endGeometry(e);
		}
		drawPolygon(t, e, i) {
			const n = this.state,
				r = n.fillStyle,
		...
		finish() {
			...
			if (0 !== t) {
				...
				for (let i = 0, n = e.length; i < n; ++i) e[i] = Va(e[i], t);
			}
			return super.finish();
		}
	...
	function jf(t, e, i, n, r) {
		...
		for (o = i; o < n; o += r) {
			const i = e[o],
				n = e[o + 1];
			void 0 !== h && ((g = i - h), (f = n - c), (l = Math.sqrt(g * g + f * f)), void 0 !== u && ((y += a), (s = Math.acos((u * g + d * f) / (a * l))), s > t && (y > _ && ((_ = y), (p = x), (m = o)), (y = 0), (x = o - r))), (a = l), (u = g), (d = f)), (h = i), (c = n);
		}
		return (y += l), y > _ ? [x, o] : [p, m];
	}
	const $f = { left: 0, center: 0.5, right: 1, top: 0, middle: 0.5, hanging: 0.2, alphabetic: 0.8, ideographic: 0.8, bottom: 1 };
	const Bf = {
		Circle: Nf,
		Default: zf,
		Image: class extends zf {
			constructor(t, e, i, n) {
			...
			drawPoint(t, e, i) {
				if (!this.image_ || (this.maxExtent && !Ur(this.maxExtent, t.getFlatCoordinates()))) return;
				this.beginGeometry(t, e, i);
				const n = t.getFlatCoordinates(),
					r = t.getStride(),
					s = this.coordinates.length,
					o = this.appendFlatPointCoordinates(n, r);
				this.instructions.push([Tf, s, o, this.image_, this.anchorX_ * this.imagePixelRatio_, this.anchorY_ * this.imagePixelRatio_, Math.ceil(this.height_ * this.imagePixelRatio_), this.opacity_, this.originX_ * this.imagePixelRatio_, this.originY_ * this.imagePixelRatio_, this.rotateWithView_, this.rotation_, [(this.scale_[0] * this.pixelRatio) / this.imagePixelRatio_, (this.scale_[1] * this.pixelRatio) / this.imagePixelRatio_], Math.ceil(this.width_ * this.imagePixelRatio_), this.declutterMode_, this.declutterImageWithText_]),
					this.hitDetectionInstructions.push([Tf, s, o, this.hitDetectionImage_, this.anchorX_, this.anchorY_, this.height_, 1, this.originX_, this.originY_, this.rotateWithView_, this.rotation_, this.scale_, this.width_, this.declutterMode_, this.declutterImageWithText_]),
					this.endGeometry(e);
			}
			drawMultiPoint(t, e, i) {
				if (!this.image_) return;
				...
				const n = t.getFlatCoordinates(),
					r = [];
				for (let e = 0, i = n.length; e < i; e += t.getStride()) (this.maxExtent && !Ur(this.maxExtent, n.slice(e, e + 2))) || r.push(n[e], n[e + 1]);
		...
		LineString: class extends zf {
			...
			drawLineString(t, e, i) {
				const n = this.state,
					...
					s = n.lineWidth;
				if (void 0 === r || void 0 === s) return;
				this.updateStrokeStyle(n, this.applyStroke), this.beginGeometry(t, e, i), this.hitDetectionInstructions.push([If, n.strokeStyle, n.lineWidth, n.lineCap, n.lineJoin, n.miterLimit, Td, 0], Df);
				const o = t.getFlatCoordinates(),
					a = t.getStride();
				this.drawFlatCoordinates_(o, 0, o.length, a), this.hitDetectionInstructions.push(Af), this.endGeometry(e);
			}
			drawMultiLineString(t, e, i) {
				const n = this.state,
					r = n.strokeStyle,
				...
				this.hitDetectionInstructions.push(Af), this.endGeometry(e);
			}
			finish() {
				const t = this.state;
				return null != t.lastStroke && t.lastStroke != this.coordinates.length && this.instructions.push(Af), this.reverseHitDetectionInstructions(), (this.state = null), super.finish();
			}
			applyStroke(t) {
				null != t.lastStroke && t.lastStroke != this.coordinates.length && (this.instructions.push(Af), (t.lastStroke = this.coordinates.length)), (t.lastStroke = 0), super.applyStroke(t), this.instructions.push(Df);
			}
		},
		Polygon: Nf,
		Text: class extends zf {
			constructor(t, e, i, n) {
				super(t, e, i, n), (this.labels_ = null), (this.text_ = ''), (this.textOffsetX_ = 0), (this.textOffsetY_ = 0), (this.textRotateWithView_ = void 0), (this.textKeepUpright_ = void 0), (this.textRotation_ = 0), (this.textFillState_ = null), (this.fillStates = {}), (this.fillStates[Cd] = { fillStyle: Cd }), (this.textStrokeState_ = null), (this.strokeStates = {}), (this.textState_ = {}), (this.textStates = {}), (this.textKey_ = ''), (this.fillKey_ = ''), (this.strokeKey_ = ''), (this.declutterMode_ = void 0), (this.declutterImageWithText_ = void 0);
			}
			finish() {
				...
				if ('line' !== s.placement || ('LineString' != l && 'MultiLineString' != l && 'Polygon' != l && 'MultiPolygon' != l)) {
					...
					switch (l) {
						...
						case 'MultiLineString':
							...
							break;
						case 'Polygon':
							(h = t.getFlatInteriorPoint()), s.overflow || n.push(h[2] / this.resolution), (c = 3);
							break;
						case 'MultiPolygon':
							const e = t.getFlatInteriorPoints();
							h = [];
							for (let t = 0, i = e.length; t < i; t += 3) s.overflow || n.push(e[t + 2] / this.resolution), h.push(e[t], e[t + 1]);
							if (0 === h.length) return;
							c = 2;
					}
					const r = this.appendFlatPointCoordinates(h, c);
					if (r === a) return;
					if (n && (r - a) / 2 !== h.length / c) {
						let t = a / 2;
						n = n.filter((e, i) => {
							const n = o[2 * (t + i)] === h[i * c] && o[2 * (t + i) + 1] === h[i * c + 1];
							return n || --t, n;
						});
					}
					...
					this.beginGeometry(t, e, i);
					let g = s.padding;
					if (g != Id && (s.scale[0] < 0 || s.scale[1] < 0)) {
						let t = s.padding[0],
							e = s.padding[1],
							i = s.padding[2],
							n = s.padding[3];
						s.scale[0] < 0 && ((e = -e), (n = -n)), s.scale[1] < 0 && ((t = -t), (i = -i)), (g = [t, e, i, n]);
					}
					...
					const p = 1 / f,
						m = u ? u.slice(0) : null;
					m && (m[1] = Cd), this.hitDetectionInstructions.push([Tf, a, r, null, NaN, NaN, NaN, 1, 0, 0, this.textRotateWithView_, this.textRotation_, [p, p], NaN, this.declutterMode_, this.declutterImageWithText_, g, m, d, this.text_, this.textKey_, this.strokeKey_, this.fillKey_ ? Cd : this.fillKey_, this.textOffsetX_, this.textOffsetY_, n]), this.endGeometry(e);
				} else {
					if (!ms(this.maxExtent, t.getExtent())) return;
					let n;
					...
					for (let t = 0, e = n.length; t < e; ++t) {
						let e;
						e = r ? Gf(r * this.resolution, h, d, n[t], c) : [h.slice(d, n[t])];
						for (let i = 0, r = e.length; i < r; ++i) {
							const r = e[i];
							let l = 0,
								h = r.length;
							if (null == u) {
								const t = jf(s.maxAngle, r, 0, r.length, 2);
								(l = t[0]), (h = t[1]);
							}
			...
			saveTextStates_() {
				...
				r in this.textStates || (this.textStates[r] = { font: e.font, textAlign: e.textAlign || Fd, justify: e.justify, textBaseline: e.textBaseline || Md, scale: e.scale });
			...
			drawChars_(t, e) {
				...
				this.instructions.push([Ef, t, e, l, n.overflow, o, n.maxAngle, a, h, r, u * a, c, s, 1, this.declutterMode_, this.textKeepUpright_]), this.hitDetectionInstructions.push([Ef, t, e, l, n.overflow, o ? Cd : o, n.maxAngle, a, h, r, u * a, c, s, 1 / a, this.declutterMode_, this.textKeepUpright_]);
			}
			setTextStyle(t, e) {
				let i, n, r;
				if (t) {
					const e = t.getFill();
					e ? ((n = this.textFillState_), n || ((n = {}), (this.textFillState_ = n)), (n.fillStyle = bd(e.getColor() || Cd))) : ((n = null), (this.textFillState_ = n));
					const s = t.getStroke();
					if (s) {
						...
						const t = s.getLineDash(),
							...
							i = s.getWidth(),
							n = s.getMiterLimit();
						(r.lineCap = s.getLineCap() || Ed), (r.lineDash = t ? t.slice() : Td), (r.lineDashOffset = void 0 === e ? 0 : e), (r.lineJoin = s.getLineJoin() || Pd), (r.lineWidth = void 0 === i ? 1 : i), (r.miterLimit = void 0 === n ? 10 : n), (r.strokeStyle = bd(s.getColor() || Rd));
					} else (r = null), (this.textStrokeState_ = r);
					i = this.textState_;
					const o = t.getFont() || Sd;
					Nd(o);
					const a = t.getScaleArray();
					(i.overflow = t.getOverflow()), (i.font = o), (i.maxAngle = t.getMaxAngle()), (i.placement = t.getPlacement()), (i.textAlign = t.getTextAlign()), (i.repeat = t.getRepeat()), (i.justify = t.getJustify()), (i.textBaseline = t.getTextBaseline() || Md), (i.backgroundFill = t.getBackgroundFill()), (i.backgroundStroke = t.getBackgroundStroke()), (i.padding = t.getPadding() || Id), (i.scale = void 0 === a ? [1, 1] : a);
					const l = t.getOffsetX(),
						h = t.getOffsetY(),
						c = t.getRotateWithView(),
						u = t.getKeepUpright(),
						d = t.getRotation();
					(this.text_ = t.getText() || ''), (this.textOffsetX_ = void 0 === l ? 0 : l), (this.textOffsetY_ = void 0 === h ? 0 : h), (this.textRotateWithView_ = void 0 !== c && c), (this.textKeepUpright_ = void 0 === u || u), (this.textRotation_ = void 0 === d ? 0 : d), (this.strokeKey_ = r ? ('string' == typeof r.strokeStyle ? r.strokeStyle : In(r.strokeStyle)) + r.lineCap + r.lineDashOffset + '|' + r.lineWidth + r.lineJoin + r.miterLimit + '[' + r.lineDash.join() + ']' : ''), (this.textKey_ = i.font + i.scale + (i.textAlign || '?') + (i.repeat || '?') + (i.justify || '?') + (i.textBaseline || '?')), (this.fillKey_ = n && n.fillStyle ? ('string' == typeof n.fillStyle ? n.fillStyle : '|' + In(n.fillStyle)) : '');
				} else this.text_ = '';
	...
	class Uf {
		...
		getBuilder(t, e) {
			...
			let r = n[e];
			if (void 0 === r) {
				(r = new (0, Bf[e])(this.tolerance_, this.maxExtent_, this.resolution_, this.pixelRatio_)), (n[e] = r);
			}
			return r;
		}
	}
	function Vf(t, e, i, n, r, s, o, a, l, h, c, u, d = !0) {
		let g = t[e],
			f = t[e + 1],
			p = 0,
			m = 0,
			...
			y = 0;
		function x() {
			(p = g), (m = f), (g = t[(e += n)]), (f = t[e + 1]), (y += _), (_ = Math.sqrt((g - p) * (g - p) + (f - m) * (f - m)));
		}
		do {
			x();
		} while (e < i - n && y + _ < s);
	...
	class Wf {
		constructor() {
			(this.instructions_ = []),
				(this.zIndex = 0),
				(this.offset_ = 0),
				(this.context_ = new Proxy(Dl(), {
					get: (t, e) => {
						if ('function' == typeof Dl()[e]) return this.push_(e), this.pushMethodArgs_;
					},
	...
	const Jf = new RegExp('[' + String.fromCharCode(1425) + '-' + String.fromCharCode(2303) + String.fromCharCode(64285) + '-' + String.fromCharCode(65023) + String.fromCharCode(65136) + '-' + String.fromCharCode(65276) + String.fromCharCode(67584) + '-' + String.fromCharCode(69631) + String.fromCharCode(124928) + '-' + String.fromCharCode(126975) + ']');
	function Qf(t, e) {
		return 'start' === e ? (e = Jf.test(t) ? 'right' : 'left') : 'end' === e && (e = Jf.test(t) ? 'left' : 'right'), $f[e];
	}
	function tp(t, e, i) {
		return i > 0 && t.push('\n', ''), t.push(e, ''), t;
	}
	...
	class ip {
		...
		createLabel(t, e, i, n) {
			...
			const s = n ? this.strokeStates[n] : null,
				...
				c = a.justify ? $f[a.justify] : Qf(Array.isArray(t) ? t[0] : t, a.textAlign || Fd),
			...
			(1 == h[0] && 1 == h[1]) || x.push('scale', h), n && (x.push('strokeStyle', s.strokeStyle), x.push('lineWidth', u), x.push('lineCap', s.lineCap), x.push('lineJoin', s.lineJoin), x.push('miterLimit', s.miterLimit), x.push('setLineDash', [s.lineDash]), x.push('lineDashOffset', s.lineDashOffset)), i && x.push('fillStyle', o.fillStyle), x.push('textBaseline', 'middle'), x.push('textAlign', 'center');
			const S = 0.5 - c;
			let C = c * y + S * u;
			const E = [],
				T = [];
			...
			for (let t = 0, e = d.length; t < e; t += 2) {
				...
				r !== P && (n && E.push('font', r), i && T.push('font', r), (P = r)), (R = Math.max(R, m[M]));
				const s = [e, C + S * p[M] + c * (p[M] - _[I]), 0.5 * (u + R) + F];
				(C += p[M]), n && E.push('strokeText', s), i && T.push('fillText', s), ++M;
			}
		...
		replayTextBackground_(t, e, i, n, r, s, o) {
			t.beginPath(), t.moveTo.apply(t, e), t.lineTo.apply(t, i), t.lineTo.apply(t, n), t.lineTo.apply(t, r), t.lineTo.apply(t, e), s && ((this.alignAndScaleFill_ = s[2]), (t.fillStyle = s[1]), this.fill_(t)), o && (this.setStrokeStyle_(t, o), t.stroke());
		}
		calculateImageOrLabelDimensions_(t, e, i, n, r, s, o, a, l, h, c, u, d, g, f, p) {
			...
			let C;
			return (
				(f || 0 !== c) && ((qf[0] = b), (Yf[0] = b), (qf[1] = S), (Zf[1] = S), (Zf[0] = b + v), (Kf[0] = Zf[0]), (Kf[1] = S + w), (Yf[1] = Kf[1])),
				0 !== c ? ((C = ma([1, 0, 0, 1, 0, 0], i, n, 1, 1, c, -i, -n)), ga(C, qf), ga(C, Zf), ga(C, Kf), ga(C, Yf), Zr(Math.min(qf[0], Zf[0], Kf[0], Yf[0]), Math.min(qf[1], Zf[1], Kf[1], Yf[1]), Math.max(qf[0], Zf[0], Kf[0], Yf[0]), Math.max(qf[1], Zf[1], Kf[1], Yf[1]), Xf)) : Zr(Math.min(b, b + v), Math.min(S, S + w), Math.max(b, b + v), Math.max(S, S + w), Xf),
				d && ((m = Math.round(m)), (_ = Math.round(_))),
				{ drawImageX: m, drawImageY: _, drawImageW: y, drawImageH: x, originX: l, originY: h, declutterBox: { minX: Xf[0], minY: Xf[1], maxX: Xf[2], maxY: Xf[3], value: p }, canvasTransform: C, scale: u }
			);
		}
		replayImageOrLabel_(t, e, i, n, r, s, o) {
			...
			return l.minX - h <= e[0] && l.maxX + h >= 0 && l.minY - h <= e[1] && l.maxY + h >= 0 && (a && this.replayTextBackground_(t, qf, Zf, Kf, Yf, s, o), Ud(t, n.canvasTransform, r, i, n.originX, n.originY, n.drawImageW, n.drawImageH, n.drawImageX, n.drawImageY, n.scale)), !0;
		}
		fill_(t) {
			const e = this.alignAndScaleFill_;
			if (e) {
				const i = ga(this.renderedTransform_, [0, 0]),
					n = 512 * this.pixelRatio;
				t.save(), t.translate(i[0] % n, i[1] % n), 1 !== e && t.scale(e, e), t.rotate(this.viewRotation_);
			}
			t.fill(), e && t.restore();
		}
		setStrokeStyle_(t, e) {
			(t.strokeStyle = e[1]), e[1] && ((t.lineWidth = e[2]), (t.lineCap = e[3]), (t.lineJoin = e[4]), (t.miterLimit = e[5]), (t.lineDashOffset = e[7]), t.setLineDash(e[6]));
		}
		drawLabelWithPointPlacement_(t, e, i, n) {
			const r = this.textStates[e],
				...
				a = this.pixelRatio,
				l = Qf(Array.isArray(t) ? t[0] : t, r.textAlign || Fd),
				h = $f[r.textBaseline || Md],
		...
		execute_(t, e, i, n, r, s, o, a) {
			...
			let h;
			this.pixelCoordinates_ && gn(i, this.renderedTransform_) ? (h = this.pixelCoordinates_) : (this.pixelCoordinates_ || (this.pixelCoordinates_ = []), (h = va(this.coordinates, 0, this.coordinates.length, 2, i, this.pixelCoordinates_)), da(this.renderedTransform_, i));
			let c = 0;
			const u = n.length;
			let d,
				g,
			...
			const R = this.coordinateCache_,
				...
				M = Math.round(1e12 * Math.atan2(-i[1], i[0])) / 1e12,
				I = { context: t, pixelRatio: this.pixelRatio, resolution: this.resolution, rotation: F },
				k = this.instructions != n || this.overlaps ? 0 : 200;
			let L, A, D, O;
			for (; c < u; ) {
				const i = n[c];
				switch (i[0]) {
					case vf:
						(L = i[1]), (O = i[3]), L.getGeometry() ? (void 0 === o || ms(o, O.getExtent()) ? ++c : (c = i[2] + 1)) : (c = i[2]), l && (l.zIndex = i[4]);
						break;
					case wf:
						T > k && (this.fill_(t), (T = 0)), P > k && (t.stroke(), (P = 0)), T || P || (t.beginPath(), (m = NaN), (_ = NaN)), ++c;
						break;
					case bf:
						E = i[1];
						const n = h[E],
							...
							N = h[E + 3] - u,
							G = Math.sqrt(z * z + N * N);
						t.moveTo(n + G, u), t.arc(n, u, G, 0, 2 * Math.PI, !0), ++c;
						break;
					case Sf:
						t.closePath(), ++c;
						break;
					case Cf:
						...
						const j = i[3],
							$ = i[4],
							B = i[5];
						(I.geometry = j), (I.feature = L), c in R || (R[c] = []);
						const U = R[c];
						B ? B(h, E, d, 2, U) : ((U[0] = h[E]), (U[1] = h[E + 1]), (U.length = 2)), l && (l.zIndex = i[6]), $(U, I), ++c;
						break;
					case Tf:
						(E = i[1]), (d = i[2]), (v = i[3]), (g = i[4]), (f = i[5]);
						let V = i[6];
						const W = i[7],
							X = i[8],
							q = i[9],
						...
						const J = i[15];
						if (!v && i.length >= 20) {
							(w = i[19]), (b = i[20]), (S = i[21]), (C = i[22]);
							const t = this.drawLabelWithPointPlacement_(w, b, S, C);
							(v = t.label), (i[3] = v);
							const e = i[23];
						...
						let Q, tt, et, it;
						i.length > 25 && (Q = i[25]), i.length > 17 ? ((tt = i[16]), (et = i[17]), (it = i[18])) : ((tt = Id), (et = null), (it = null)), Z && M ? (K += F) : Z || M || (K -= F);
						let nt = 0;
						for (; E < d; E += 2) {
							if (Q && Q[nt++] < H / this.pixelRatio) continue;
							const i = this.calculateImageOrLabelDimensions_(v.width, v.height, h[E], h[E + 1], H, V, g, f, X, q, K, Y, r, tt, !!et || !!it, L),
								n = [t, e, v, i, W, et, it];
							if (a) {
								let t, e, r, s, o;
								if (J) {
									const i = d - E;
									if (!J[i]) {
										J[i] = { args: n, declutterMode: p };
										continue;
									}
									const s = J[i];
									(t = s.args), (e = s.declutterMode), delete J[i], (r = Hf(t));
								}
								if ((!t || ('declutter' === e && a.collides(r)) || (s = !0), ('declutter' === p && a.collides(i.declutterBox)) || (o = !0), 'declutter' === e && 'declutter' === p)) {
									const t = s && o;
									(s = t), (o = t);
								}
								s && ('none' !== e && a.insert(r), this.replayImageOrLabel_.apply(this, t)), o && ('none' !== p && a.insert(i.declutterBox), this.replayImageOrLabel_.apply(this, n));
					...
					case Ef:
						...
						S = i[9];
						const ut = i[10];
						(w = i[11]), Array.isArray(w) && (w = w.reduce(ep, '')), (b = i[12]);
						const dt = [i[13], i[13]];
						p = i[14] || 'declutter';
						const gt = i[15],
							ft = this.textStates[b],
							pt = ft.font,
							mt = [ft.scale[0] * ht, ft.scale[1] * ht];
						let _t;
						pt in this.widths_ ? (_t = this.widths_[pt]) : ((_t = {}), (this.widths_[pt] = _t));
						const yt = Bg(h, rt, st, 2),
							xt = Math.abs(mt[0]) * Bd(pt, w, _t);
						if (at || xt <= yt) {
							const i = Vf(h, rt, st, 2, w, (yt - xt) * Qf(w, this.textStates[b].textAlign), lt, Math.abs(mt[0]), Bd, pt, _t, M ? 0 : this.viewRotation_, gt);
							t: if (i) {
								const n = [];
								let r, s, o, l, h;
								if (S)
									for (r = 0, s = i.length; r < s; ++r) {
										(h = i[r]), (o = h[4]), (l = this.createLabel(o, b, '', S)), (g = h[2] + (mt[0] < 0 ? -ut : ut)), (f = ot * l.height + (2 * (0.5 - ot) * ut * mt[1]) / mt[0] - ct);
										const s = this.calculateImageOrLabelDimensions_(l.width, l.height, h[0], h[1], l.width, l.height, g, f, 0, 0, h[3], dt, !1, Id, !1, L);
										if (a && 'declutter' === p && a.collides(s.declutterBox)) break t;
										n.push([t, e, l, s, 1, null, null]);
									}
								if (C)
									for (r = 0, s = i.length; r < s; ++r) {
										(h = i[r]), (o = h[4]), (l = this.createLabel(o, b, C, '')), (g = h[2]), (f = ot * l.height - ct);
										const s = this.calculateImageOrLabelDimensions_(l.width, l.height, h[0], h[1], l.width, l.height, g, f, 0, 0, h[3], dt, !1, Id, !1, L);
										if (a && 'declutter' === p && a.collides(s.declutterBox)) break t;
										n.push([t, e, l, s, 1, null, null]);
									}
								a && 'none' !== p && a.load(n.map(Hf));
					...
					case Rf:
						...
						break;
					case Ff:
						for (E = i[1], d = i[2], A = h[E], D = h[E + 1], t.moveTo(A, D), m = (A + 0.5) | 0, _ = (D + 0.5) | 0, E += 2; E < d; E += 2) (A = h[E]), (D = h[E + 1]), (y = (A + 0.5) | 0), (x = (D + 0.5) | 0), (E != d - 2 && y === m && x === _) || (t.lineTo(A, D), (m = y), (_ = x));
						++c;
						break;
					case Mf:
						(this.alignAndScaleFill_ = i[2]), T && (this.fill_(t), (T = 0), P && (t.stroke(), (P = 0))), (t.fillStyle = i[1]), ++c;
						break;
					case If:
						P && (t.stroke(), (P = 0)), this.setStrokeStyle_(t, i), ++c;
						break;
					case kf:
						k ? P++ : t.stroke(), ++c;
						break;
		...
		executeHitDetection(t, e, i, n, r) {
			return (this.viewRotation_ = i), this.execute_(t, [t.canvas.width, t.canvas.height], e, this.hitDetectionInstructions, !0, n, r);
		}
	}
	const np = ['Polygon', 'Circle', 'LineString', 'Image', 'Text', 'Default'],
		rp = ['Image', 'Text'],
		sp = np.filter((t) => !rp.includes(t));
	class op {
		constructor(t, e, i, n, r, s, o) {
			(this.maxExtent_ = t), (this.overlaps_ = n), (this.pixelRatio_ = i), (this.resolution_ = e), (this.renderBuffer_ = s), (this.executorsByZIndex_ = {}), (this.hitDetectionContext_ = null), (this.hitDetectionTransform_ = [1, 0, 0, 1, 0, 0]), (this.renderedContext_ = null), (this.deferredZIndexContexts_ = {}), this.createExecutors_(r, o);
		}
		clip(t, e) {
		...
		createExecutors_(t, e) {
			for (const i in t) {
				...
				for (const t in r) {
					const i = r[t];
					n[t] = new ip(this.resolution_, this.pixelRatio_, this.overlaps_, i, e);
				}
			}
		}
		hasExecutors(t) {
		...
		forEachFeatureAtCoordinate(t, e, i, n, r, s) {
			const o = 2 * (n = Math.round(n)) + 1,
				a = ma(this.hitDetectionTransform_, n + 0.5, n + 0.5, 1 / e, -1 / e, -i, -t[0], -t[1]),
				l = !this.hitDetectionContext_;
			l && (this.hitDetectionContext_ = Ll(o, o));
			const h = this.hitDetectionContext_;
			let c;
			h.canvas.width !== o || h.canvas.height !== o ? ((h.canvas.width = o), (h.canvas.height = o)) : l || h.clearRect(0, 0, o, o), void 0 !== this.renderBuffer_ && ((c = [1 / 0, 1 / 0, -1 / 0, -1 / 0]), ts(c, t), jr(c, e * (this.renderBuffer_ + n), c));
			const u = (function (t) {
				if (void 0 !== ap[t]) return ap[t];
				const e = 2 * t + 1,
					i = t * t,
					n = new Array(i + 1);
				for (let r = 0; r <= t; ++r)
			...
			function g(t, e, i) {
				...
				for (let l = 0, c = u.length; l < c; l++)
					if (a[u[l]] > 0) {
						if (!s || 'none' === i || ('Image' !== d && 'Text' !== d) || s.includes(t)) {
							const i = (u[l] - 3) / 4,
								s = n - (i % o),
								a = n - ((i / o) | 0),
								h = r(t, e, s * s + a * a);
			...
			let p, m, _, y, x;
			for (f.sort(ln), p = f.length - 1; p >= 0; --p) {
				const t = f[p].toString();
				for (_ = this.executorsByZIndex_[t], m = np.length - 1; m >= 0; --m) if (((d = np[m]), (y = _[d]), void 0 !== y && ((x = y.executeHitDetection(h, a, i, g, c)), x))) return x;
			}
		}
		getClipCoords(t) {
				...
				for (let c = 0, d = s.length; c < d; ++c) {
					...
					if (void 0 !== g) {
						const s = null === o ? void 0 : g.getZIndexContext(),
							c = s ? s.getContext() : t,
							u = this.maxExtent_ && 'Image' !== d && 'Text' !== d;
						if ((u && (c.save(), this.clip(c, i)), s && 'Text' !== d && 'Image' !== d ? s.pushFunction((t) => g.execute(t, e, i, n, r, o)) : g.execute(c, e, i, n, r, o), u && c.restore(), s)) {
							s.offset();
							const t = a[h] * l + np.indexOf(d);
		...
		renderDeferred() {
			const t = this.deferredZIndexContexts_,
				e = Object.keys(t).map(Number).sort(ln);
			for (let i = 0, n = e.length; i < n; ++i)
				t[e[i]].forEach((t) => {
	...
	const ap = {};
	const lp = 0.5;
	function hp(t, e, i, n, r, s, o, a, l) {
		const h = l ? na(r, l) : r,
			c = Ll(t[0] * lp, t[1] * lp);
		c.imageSmoothingEnabled = !1;
		const u = c.canvas,
			d = new Yg(c, lp, r, null, o, a, l ? qo(ta(), l) : null),
			g = i.length,
			f = Math.floor(16777215 / g),
			p = {};
		for (let t = 1; t <= g; ++t) {
			const e = i[t - 1],
				r = e.getStyleFunction() || n;
			if (!r) continue;
			let o = r(e, s);
			if (!o) continue;
			Array.isArray(o) || (o = [o]);
			...
			for (let t = 0, i = o.length; t < i; ++t) {
				...
				if (!n || !ms(h, n.getExtent())) continue;
				const r = i.clone(),
					s = r.getFill();
				s && s.setColor(a);
				const l = r.getStroke();
				...
				if (c) {
					...
					if (!t) continue;
					const e = Ll(t[0], t[1], void 0, { alpha: !1 }),
						i = e.canvas;
					(e.fillStyle = a), e.fillRect(0, 0, i.width, i.height), r.setImage(new Kd({ img: i, anchor: c.getAnchor(), anchorXUnits: 'pixels', anchorYUnits: 'pixels', offset: c.getOrigin(), opacity: 1, size: c.getSize(), scale: c.getScale(), rotation: c.getRotation(), rotateWithView: c.getRotateWithView() }));
				}
		...
		const m = Object.keys(p).map(Number).sort(ln);
		for (let t = 0, i = m.length; t < i; ++t) {
			...
			for (const t in i) {
				...
				for (let t = 0, i = n.length; t < i; t += 2) {
					d.setStyle(n[t + 1]);
					for (let i = 0, r = e.length; i < r; ++i) d.setTransform(e[i]), d.drawGeometry(n[t]);
				}
			}
		}
	...
	function cp(t, e, i) {
		const n = [];
		if (i) {
			const r = Math.floor(Math.round(t[0]) * lp),
				s = Math.floor(Math.round(t[1]) * lp),
				o = 4 * (xr(r, 0, i.width - 1) + xr(s, 0, i.height - 1) * i.width),
				a = i.data[o],
				l = i.data[o + 1],
	...
	class up extends Tn {
		...
		handleImageChange_(t) {
			const e = t.target;
			(e.getState() !== ud && e.getState() !== dd) || this.renderIfReadyAndVisible();
		}
		loadImage(t) {
			let e = t.getState();
			return e != ud && e != dd && t.addEventListener(qi, this.boundHandleImageChange_), e == hd && (t.load(), (e = t.getState())), e == ud;
		}
	...
	class fp extends up {
		...
		getImageData(t, e, i) {
			let n;
			gp || (gp = Ll(1, 1, void 0, { willReadFrequently: !0 })), gp.clearRect(0, 0, 1, 1);
			try {
				gp.drawImage(t, e, i, 1, 1, 0, 0, 1, 1), (n = gp.getImageData(0, 0, 1, 1).data);
			} catch {
				return (gp = null), null;
			}
			return n;
		...
		useContainer(t, e, i) {
			...
			let r, s;
			if (t && t.className === n && (!i || (t && t.style.backgroundColor && gn(Dc(t.style.backgroundColor), Dc(i))))) {
			...
			if (
				...
				(function (t, e) {
					const i = xa(t),
						n = xa(e);
					for (let t = 0; t < 6; ++t) if (0 !== Math.round((i[t] - n[t]) * ya[t])) return !1;
					return !0;
				})(s.canvas.style.transform, e)
					? ((this.container = t), (this.context = s), (this.containerReused = !0))
				...
				let t = r.style;
				(t.position = 'absolute'), (t.width = '100%'), (t.height = '100%'), (s = Ll());
				const e = s.canvas;
		...
		clipUnrotated(t, e, i) {
			const n = gs(i),
				...
				s = os(i),
				o = ss(i);
			ga(e.coordinateToPixelTransform, n), ga(e.coordinateToPixelTransform, r), ga(e.coordinateToPixelTransform, s), ga(e.coordinateToPixelTransform, o);
			const a = this.inversePixelTransform;
			ga(a, n), ga(a, r), ga(a, s), ga(a, o), t.save(), t.beginPath(), t.moveTo(Math.round(n[0]), Math.round(n[1])), t.lineTo(Math.round(r[0]), Math.round(r[1])), t.lineTo(Math.round(s[0]), Math.round(s[1])), t.lineTo(Math.round(o[0]), Math.round(o[1])), t.clip();
		}
		prepareContainer(t, e) {
			const i = t.extent,
				...
				s = t.pixelRatio,
				o = Math.round((ps(i) / n) * s),
				a = Math.round((us(i) / n) * s);
			ma(this.pixelTransform, t.size[0] / 2, t.size[1] / 2, 1 / s, 1 / s, r, -o / 2, -a / 2), _a(this.inversePixelTransform, this.pixelTransform);
			const l = 'matrix(' + this.pixelTransform.join(', ') + ')';
		...
		dispatchRenderEvent_(t, e, i) {
			...
			if (n.hasListener(t)) {
				const r = new Rg(t, this.inversePixelTransform, i, e);
				n.dispatchEvent(r);
			}
		}
		preRender(t, e) {
			(this.frameState = e), e.declutter || this.dispatchRenderEvent_(Xh, t, e);
		}
		postRender(t, e) {
			e.declutter || this.dispatchRenderEvent_(qh, t, e);
		}
		renderDeferredInternal(t) {}
		getRenderContext(t) {
			return t.declutter && !this.deferredContext_ && (this.deferredContext_ = new Wf()), t.declutter ? this.deferredContext_.getContext() : this.context;
		}
		renderDeferred(t) {
			t.declutter && (this.dispatchRenderEvent_(Xh, this.context, t), t.declutter && this.deferredContext_ && (this.deferredContext_.draw(this.context), this.deferredContext_.clear()), this.renderDeferredInternal(t), this.dispatchRenderEvent_(qh, this.context, t));
		}
		getRenderTransform(t, e, i, n, r, s, o) {
			const a = r / 2,
				...
				u = -t[0] + o,
				d = -t[1];
			return ma(this.tempTransform, a, l, h, c, -i, u, d);
		}
		disposeInternal() {
	...
	class pp extends fp {
		...
		renderWorlds(t, e, i) {
			const n = e.extent,
				...
				f = !(g[mr] || g[_r]),
				p = this.context,
				m = Math.round((ps(n) / o) * d),
				_ = Math.round((us(n) / o) * d),
				y = c.getWrapX() && a.canWrapX(),
				x = y ? ps(h) : null,
				v = y ? Math.ceil((n[2] - h[2]) / x) + 1 : 1;
			let w = y ? Math.floor((n[0] - h[0]) / x) : 0;
			do {
				let n = this.getRenderTransform(s, o, 0, d, m, _, w * x);
				e.declutter && (n = n.slice(0)), t.execute(p, [p.canvas.width, p.canvas.height], n, l, f, void 0 === i ? np : i ? rp : sp, i ? u && e.declutter[u] : void 0);
			} while (++w < v);
		}
		setDrawContext_() {
			1 !== this.opacity_ && ((this.targetContext_ = this.context), (this.context = Ll(this.context.canvas.width, this.context.canvas.height, dp)));
		}
		resetDrawContext_() {
			if (1 !== this.opacity_ && this.targetContext_) {
				const t = this.targetContext_.globalAlpha;
				(this.targetContext_.globalAlpha = this.opacity_), this.targetContext_.drawImage(this.context.canvas, 0, 0), (this.targetContext_.globalAlpha = t), Ol(this.context), dp.push(this.context.canvas), (this.context = this.targetContext_), (this.targetContext_ = null);
			}
		}
		renderDeclutter(t) {
		...
		renderFrame(t, e) {
			...
			let o = s && !s.isEmpty();
			if (!o) {
				if (!(this.getLayer().hasListener(Xh) || this.getLayer().hasListener(qh))) return this.container;
			}
			this.setDrawContext_(), this.preRender(r, t);
			const a = n.projection;
			if (((this.clipped_ = !1), o && i.extent && this.clipping)) {
				const e = ra(i.extent, a);
				(o = ms(e, t.extent)), (this.clipped_ = o && !Vr(e, t.extent)), this.clipped_ && this.clipUnrotated(r, t, e);
			}
			return o && this.renderWorlds(s, t, !this.getLayer().getDeclutter() && void 0), !t.declutter && this.clipped_ && r.restore(), this.postRender(r, t), this.renderedRotation_ !== n.rotation && ((this.renderedRotation_ = n.rotation), (this.hitDetectionImageData_ = null)), t.declutter || this.resetDrawContext_(), this.container;
		}
		getFeatures(t) {
			return new Promise((e) => {
				if (this.frameState && !this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
					const t = this.frameState.size.slice(),
						...
						l = t[0] * lp,
						h = t[1] * lp;
					a.push(this.getRenderTransform(e, i, n, lp, l, h, 0).slice());
					const c = o.getSource(),
						u = r.getExtent();
					if (c.getWrapX() && r.canWrapX() && !Vr(u, s)) {
						let t = s[0];
						const r = ps(u);
						let o,
							c = 0;
						for (; t < u[0]; ) --c, (o = r * c), a.push(this.getRenderTransform(e, i, n, lp, l, h, o).slice()), (t += r);
						for (c = 0, t = s[2]; t > u[2]; ) ++c, (o = r * c), a.push(this.getRenderTransform(e, i, n, lp, l, h, o).slice()), (t -= r);
					}
					const d = ta();
					this.hitDetectionImageData_ = hp(t, a, this.renderedFeatures_, o.getStyleFunction(), s, i, n, Qg(i, this.renderedPixelRatio_), d ? r : null);
				}
				e(cp(t, this.renderedFeatures_, this.hitDetectionImageData_));
			});
		}
		forEachFeatureAtCoordinate(t, e, i, n, r) {
		...
		prepareFrame(t) {
			...
			const p = l.center.slice(),
				...
				y = [m.slice()],
				x = h.getExtent();
			if (i.getWrapX() && h.canWrapX() && !Vr(x, t.extent)) {
				const t = ps(x),
					e = Math.max(ps(m) / 2, t);
				(m[0] = x[0] - e), (m[2] = x[2] + e), Fs(p, h);
				const i = xs(y[0], h);
				i[0] < x[0] && i[2] < x[2] ? y.push([i[0] + t, i[1], i[2] + t, i[3]]) : i[0] > x[0] && i[2] > x[2] && y.push([i[0] - t, i[1], i[2] - t, i[3]]);
			}
			if (this.ready && this.renderedResolution_ == c && this.renderedRevision_ == d && this.renderedRenderOrder_ == f && this.renderedFrameDeclutter_ === !!t.declutter && Vr(this.wrappedRenderedExtent_, m)) return gn(this.renderedExtent_, _) || ((this.hitDetectionImageData_ = null), (this.renderedExtent_ = _)), (this.renderedCenter_ = p), (this.replayGroupChanged = !1), !0;
			this.replayGroup_ = null;
			const v = new Uf(tf(c, u), m, c, u),
				w = ta();
			let b;
			if (w) {
				for (let t = 0, e = y.length; t < e; ++t) {
					const e = na(y[t], h);
					i.loadFeatures(e, sa(c, h), w);
				}
				b = qo(w, h);
			} else for (let t = 0, e = y.length; t < e; ++t) i.loadFeatures(y[t], c, h);
			const S = Qg(c, u);
			let C = !0;
			const E = (t, i) => {
					let n;
					...
					if ((r && (n = r(t, c)), n)) {
						const e = this.renderFeature(t, S, n, v, b, this.getLayer().getDeclutter(), i);
						C = C && !e;
					}
				},
				T = na(m, h),
				P = i.getFeaturesInExtent(T);
			f && P.sort(f);
			for (let t = 0, e = P.length; t < e; ++t) E(P[t], t);
			(this.renderedFeatures_ = P), (this.ready = C);
			const R = v.finish(),
				F = new op(m, c, u, i.getOverlaps(), R, e.getRenderBuffer(), !!t.declutter);
		...
		renderFeature(t, e, i, n, r, s, o) {
			if (!i) return !1;
			let a = !1;
			if (Array.isArray(i)) for (let l = 0, h = i.length; l < h; ++l) a = ef(n, t, i[l], e, this.boundHandleStyleImageChange_, r, s, o) || a;
			else a = ef(n, t, i, e, this.boundHandleStyleImageChange_, r, s, o);
			return a;
		}
	}
	class mp extends Pg {
	...
	class _p extends fd {
		constructor(t, e, i, n, r) {
			super(t, e, i, void 0 !== r ? hd : ud), (this.loader_ = void 0 !== r ? r : null), (this.canvas_ = n), (this.error_ = null);
		}
		getError() {
			return this.error_;
		}
		handleLoad_(t) {
			t ? ((this.error_ = t), (this.state = dd)) : (this.state = ud), this.changed();
		}
		load() {
			this.state == hd && ((this.state = cd), this.changed(), this.loader_(this.handleLoad_.bind(this)));
		}
		getImage() {
			return this.canvas_;
		}
	...
	class yp extends bn {
		constructor(t, e, i) {
			super(), (i = i || {}), (this.tileCoord = t), (this.state = e), (this.key = ''), (this.transition_ = void 0 === i.transition ? 250 : i.transition), (this.transitionStarts_ = {}), (this.interpolate = !!i.interpolate);
		}
		changed() {
			this.dispatchEvent(qi);
		}
		...
		setState(t) {
			if (this.state !== ur) {
				if (this.state !== cr && this.state > t) throw new Error('Tile load sequence violation');
		...
		getAlpha(t, e) {
			...
			const n = e - i + 1e3 / 60;
			return n >= this.transition_ ? 1 : Is(n / this.transition_);
		}
		inTransition(t) {
	...
	class xp extends yp {
		...
		setImage(t) {
			(this.image_ = t), (this.state = hr), this.unlistenImage_(), this.changed();
		}
		handleImageError_() {
			(this.state = cr),
				this.unlistenImage_(),
		...
		handleImageLoad_() {
			const t = this.image_;
			t.naturalWidth && t.naturalHeight ? (this.state = hr) : (this.state = ur), this.unlistenImage_(), this.changed();
		}
		load() {
			this.state == cr && ((this.state = ar), (this.image_ = new Image()), null !== this.crossOrigin_ && (this.image_.crossOrigin = this.crossOrigin_)),
				this.state == ar &&
					((this.state = lr),
					this.changed(),
	...
	function Tp(t, e, i, n, r) {
		return void 0 !== r ? ((r.minX = t), (r.maxX = e), (r.minY = i), (r.maxY = n), r) : new Ep(t, e, i, n);
	}
	const Pp = [];
	class Rp extends yp {
		constructor(t, e, i, n, r) {
			super(t, e, { transition: 0 }), (this.context_ = null), (this.executorGroups = {}), (this.loadingSourceTiles = 0), (this.hitDetectionImageData = {}), (this.replayState_ = {}), (this.sourceTiles = []), (this.errorTileKeys = {}), this.wantedResolution, (this.getSourceTiles = n.bind(void 0, this)), (this.removeSourceTiles_ = r), (this.wrappedTileCoord = i);
		}
		getContext() {
			return this.context_ || (this.context_ = Ll(1, 1, Pp)), this.context_;
		}
		hasContext() {
			return !!this.context_;
		}
		...
		release() {
			this.context_ && (Ol(this.context_), Pp.push(this.context_.canvas), (this.context_ = null)), this.removeSourceTiles_(this), (this.sourceTiles.length = 0), super.release();
		}
	}
	let Fp = class extends yp {
		constructor(t, e, i, n, r, s) {
		...
		load() {
			this.state == ar && (this.setState(lr), this.tileLoadFunction_(this, this.url_), this.loader_ && this.loader_(this.extent, this.resolution, this.projection));
		}
		onLoad(t, e) {
			this.setFeatures(t);
		}
		...
		setFeatures(t) {
			(this.features_ = t), this.setState(hr);
		}
		setLoader(t) {
			this.loader_ = t;
		}
	};
	const Mp = 'https://api.mapbox.com';
	function Ip(t) {
		const e = 'mapbox://';
	...
	function kp(t, e, i) {
		...
		const s = n.slice(8);
		return `${Mp}/styles/v1/${s}/sprite?access_token=${e}`;
	}
	function Lp(t, e) {
		const i = Ip(t);
		...
		const r = i.slice(7);
		return `${Mp}/styles/v1/${r}?&access_token=${e}`;
	}
	const Ap = ['a', 'b', 'c', 'd'];
	function Dp(t, e, i, n) {
		const r = new URL(t, n || location.href),
			s = Ip(t);
		...
		return Ap.map((t) => `https://${t}.tiles.mapbox.com/v4/${s}/{z}/{x}/{y}.vector.pbf?access_token=${e}`);
	}
	...
	function Bp(t) {
		let e = zp[t.id];
		return e || ((e = {}), (zp[jp(t)] = e)), e;
	}
	function Up(t) {
		let e = Np[t.id];
		return e || ((e = {}), (Np[jp(t)] = e)), e;
	}
	function Vp(t) {
		return (t * Math.PI) / 180;
	}
	...
	const Kp = {};
	function Yp(t, e, i = {}, n) {
		if (e in Kp) return n && (n.url = Kp[e][0].url), Kp[e][1];
		const r = (i.transformRequest && i.transformRequest(e, t)) || e,
			s = function (t) {
				return delete Kp[e], Promise.reject(new Error('Error fetching source ' + e));
			},
			o = function (t) {
				return delete Kp[e], t.ok ? t.json() : Promise.reject(new Error('Error fetching source ' + e));
			},
			a = yn(() => r)
				.then((t) => (t instanceof Response ? (n && (n.url = t.url), o(t)) : (t instanceof Request || (t = new Request(t)), t.headers.get('Accept') || t.headers.set('Accept', 'application/json'), n && (n.url = t.url), fetch(t).then(o).catch(s))))
				.catch(s);
		return (Kp[e] = [r, a]), a;
	}
	function Hp(t, e) {
		if ('string' != typeof t) return Promise.resolve(t);
		if (!t.trim().startsWith('{')) return Yp('Style', (t = Lp(t, e.accessToken)), e);
		try {
	...
	function Qp(t, e, i = {}) {
		...
		if (!r || i.transformRequest) {
			...
			i.transformRequest &&
				(s = (t, e) => {
					...
					if (t instanceof Fp)
						t.setLoader((e, i, r) => {
							const s = function (i) {
								i.arrayBuffer().then((i) => {
									const n = t.getFormat().readFeatures(i, { extent: e, featureProjection: r });
									t.setFeatures(n);
								});
							};
							yn(() => n)
								.then((e) => {
									if (e instanceof Response) return s(e);
									fetch(e)
										.then(s)
										.catch((e) => t.setState(cr));
								})
								.catch((e) => t.setState(cr));
						});
					else {
			...
			const o = t.url;
			if (o && !t.tiles) {
				const n = Dp(o, i.accessToken, i.accessTokenParam || 'access_token', e || location.href);
				if (o.startsWith('mapbox://')) r = Promise.resolve({ tileJson: Object.assign({}, t, { url: void 0, tiles: n }), tileLoadFunction: s });
				else {
					const t = {};
					r = Yp('Source', n[0], i, t).then(function (e) {
						return (
							(e.tiles = e.tiles.map(function (n) {
								return 'tms' === e.scheme && (n = n.replace('{y}', '{-y}')), Dp(n, i.accessToken, i.accessTokenParam || 'access_token', t.url)[0];
							})),
				...
				t.tiles
					? ((t = Object.assign({}, t, {
							tiles: t.tiles.map(function (n) {
								return 'tms' === t.scheme && (n = n.replace('{y}', '{-y}')), Dp(n, i.accessToken, i.accessTokenParam || 'access_token', e || location.href)[0];
							}),
					  })),
	...
	function tm(t, e, i, n) {
		const r = [2 * i * e.pixelRatio + e.width, 2 * i * e.pixelRatio + e.height],
			s = Xp(r[0], r[1]),
			o = s.getContext('2d');
	...
	const nm = Array(256).join(' ');
	function rm(t, e) {
		if (e >= 0.05) {
			let i = '';
			const n = t.split('\n'),
				r = nm.slice(0, Math.round(e / 0.1));
	...
	let sm;
	function om() {
		return sm || (sm = Xp(1, 1).getContext('2d')), sm;
	}
	function am(t, e) {
		return om().measureText(t).width + (t.length - 1) * e;
	}
	const lm = {};
	function hm(t, e, i, n) {
		if (-1 !== t.indexOf('\n')) {
			const r = t.split('\n'),
				s = [];
			for (let t = 0, o = r.length; t < o; ++t) s.push(hm(r[t], e, i, n));
			return s.join('\n');
		}
		const r = i + ',' + e + ',' + t + ',' + n;
		let s = lm[r];
		if (!s) {
			...
			if (o.length > 1) {
				...
				for (let t = 0, e = o.length; t < e; ++t) {
					const e = o[t],
						i = a + (a ? ' ' : '') + e;
					am(i, n) <= r ? (a = i) : (a && l.push(a), (a = e));
				}
				a && l.push(a);
				for (let t = 0, e = l.length; t < e && e > 1; ++t) {
					const i = l[t];
					if (am(i, n) < 0.35 * r) {
						const r = t > 0 ? am(l[t - 1], n) : 1 / 0,
							s = t < e - 1 ? am(l[t + 1], n) : 1 / 0;
				...
				for (let t = 0, e = l.length - 1; t < e; ++t) {
					const i = l[t],
						s = l[t + 1];
					if (am(i, n) > 0.7 * r && am(s, n) < 0.6 * r) {
						const o = i.split(' '),
							a = o.pop();
						am(a, n) < 0.2 * r && ((l[t] = o.join(' ')), (l[t + 1] = a + ' ' + s)), (e -= 1);
					}
				}
				s = l.join('\n');
			} else s = t;
	...
	kd.on('propertychange', () => {
		for (const t in lm) delete lm[t];
	});
	const cm = ['Arial', 'Courier New', 'Times New Roman', 'Verdana', 'sans-serif', 'serif', 'monospace', 'cursive', 'fantasy'],
		um = {};
	const dm = { Point: 1, MultiPoint: 1, LineString: 2, MultiLineString: 2, Polygon: 3, MultiPolygon: 3 },
		gm = { center: [0.5, 0.5], left: [0, 0.5], right: [1, 0.5], top: [0.5, 0], bottom: [0.5, 1], 'top-left': [0, 0], 'top-right': [1, 0], 'bottom-left': [0, 1], 'bottom-right': [1, 1] },
		fm = { zoom: 0, distanceFromCenter: 0 };
	let pm, mm;
	function _m(t, e, i, n, r, s) {
		const o = t.id;
		r || ((r = {}), console.warn('No functionCache provided to getValue()')), r[o] || (r[o] = {});
		const a = r[o];
		if (!a[i]) {
			let n = (t[e] || Op)[i];
			const r = Ni[`${e}_${t.type}`][i];
			void 0 === n && (n = r.default);
			let s = ((l = n), Array.isArray(l) && l.length > 0 && 'string' == typeof l[0] && l[0] in Qe);
			if ((!s && ui(n) && ((n = Mi(n, r)), (s = !0)), s)) {
				const t = (function (t, e) {
					const i = mi(t, e);
					if ('error' === i.result) throw new Error(i.value.map((t) => `${t.key}: ${t.message}`).join(', '));
					return i.value;
				})(n, r);
				a[i] = t.evaluate.bind(t);
			} else
				'color' == r.type && (n = tt.parse(n)),
					(a[i] = function () {
						return n;
					});
		}
	...
	function ym(t, e, i, n) {
		if (!_m(t, 'layout', `${i}-allow-overlap`, e, n)) return 'declutter';
		return _m(t, 'layout', `${i}-ignore-placement`, e, n) ? 'none' : 'obstacle';
	}
	function xm(t, e, i, n) {
		if ((n || console.warn('No filterCache provided to evaluateFilter()'), !(t in n)))
			try {
				n[t] = wi(e).filter;
			} catch (e) {
	...
	ti.register(Qe, { ...ti.definitions, pitch: [{ kind: 'number' }, [], (t) => fm.pitch || 90], 'distance-from-center': [{ kind: 'number' }, [], (t) => fm.distanceFromCenter || 0] });
	let vm = !1;
	function wm(t, e) {
		if (t) {
			if (!vm && (0 === t.a || 0 === e)) return;
			const i = t.a;
	...
	const bm = /\{[^{}}]*\}/g;
	function Sm(t, e) {
		return t.replace(bm, function (t) {
			return e[t.slice(1, -1)] || '';
		});
	}
	function Cm(t, e) {
		let i = t.split(':')[0];
		return i === t && (i = 'default'), e[i];
	}
	let Em = !1;
	const Tm = {};
	function Pm(t, e, i, n = Wp, s = void 0, o = void 0, a = void 0, l = void 0) {
		if (('string' == typeof e && (e = JSON.parse(e)), 8 != e.version)) throw new Error('glStyle version 8 required.');
		Tm[$p(e, t)] = Array.from(arguments);
		const h = {};
		('string' == typeof o || o instanceof Request || o instanceof Response || o instanceof Promise) && (o = { default: o });
		for (const e in o) {
			const i = o[e];
			yn(() => i).then(async (i) => {
				let n;
				if ('undefined' != typeof Image) {
					const r = new Image();
					if ('string' == typeof i) (r.crossOrigin = 'anonymous'), (r.src = i);
					else {
						let t;
						i instanceof Request ? (t = await fetch(i)) : i instanceof Response && (t = i);
						const e = await t.blob();
						(n = URL.createObjectURL(e)), (r.src = n);
					}
					r.addEventListener('load', function i() {
						r.removeEventListener('load', i), (h[e] = { image: r, size: [r.width, r.height] }), t.changed(), n && URL.revokeObjectURL(n);
					}),
						r.addEventListener('error', function t() {
							URL.revokeObjectURL(n), r.removeEventListener('error', t);
						});
				} else if ('undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope) {
					const t = self;
					t.postMessage({ action: 'loadImage', src: i }),
						t.addEventListener('message', function (t) {
							'imageLoaded' === t.data.action && t.data.src === i && (h[e] = { image: t.data.image, size: [t.data.image.width, t.data.image.height] });
						});
				}
			});
		}
		...
		for (let t = 0, n = c.length; t < n; ++t) {
			const n = c[t],
				r = n.id;
			if (('string' == typeof i && n.source == i) || (Array.isArray(i) && -1 !== i.indexOf(r))) {
				const i = n['source-layer'];
				if (_) {
					if (n.source !== _) throw new Error(`Layer "${r}" does not use source "${_}`);
				} else {
					_ = n.source;
					const t = e.sources[_];
					if (!t) throw new Error(`Source "${_}" is not defined`);
					const i = t.type;
					if ('vector' !== i && 'geojson' !== i) throw new Error(`Source "${_}" is not of type "vector" or "geojson", but "${i}"`);
				}
				let s = u[i];
				s || ((s = []), (u[i] = s)), s.push({ layer: n, index: t }), d.push(r);
			}
		}
		const y = new Yd(),
			x = new qd(),
			...
			w = function (i, r, o) {
				...
				if (!d) return;
				let _ = n.indexOf(r);
				-1 == _ && (_ = qp(r, n)), (fm.zoom = _), (fm.distanceFromCenter = 0);
				const w = i.getGeometry(),
					b = dm[w.getType()],
					S = t.get('map');
				if (S && S instanceof Ag && 1 === b) {
					const t = S.getSize();
					if (t) {
						const e = S.getView().getCenter(),
							i = as(w.getExtent());
						fm.distanceFromCenter = Ps(e, i) / r / t[1];
					}
				}
				const C = { id: i.getId(), properties: c, type: b },
					E = t.get('mapbox-featurestate')[i.getId()];
				let T,
					P = -1;
				for (let n = 0, u = d.length; n < u; ++n) {
					const u = d[n],
						w = u.layer,
						S = w.id;
					if (void 0 !== o && o !== S) continue;
					const R = w.layout || Op,
						F = w.paint || Op;
					if ('none' === R.visibility || ('minzoom' in w && _ < w.minzoom) || ('maxzoom' in w && _ >= w.maxzoom)) continue;
					const M = w.filter;
					if (!M || xm(S, M, C, m)) {
						let n, o, d, m, _, S;
						T = w;
						const M = u.index;
						if (3 == b && ('fill' == w.type || 'fill-extrusion' == w.type))
							if (((o = _m(w, 'paint', w.type + '-opacity', C, p, E)), w.type + '-pattern' in F)) {
								const t = _m(w, 'paint', w.type + '-pattern', C, p, E);
								if (t) {
									const e = 'string' == typeof t ? Sm(t, c) : t.toString(),
										i = Cm(e, h);
									if (s && s[e] && i) {
										++P, (S = v[P]), (S && S.getFill() && !S.getStroke() && !S.getText()) || ((S = new Hd({ fill: new qd() })), (v[P] = S)), (d = S.getFill()), S.setZIndex(M);
										const t = e + '.' + o;
										let n = f[t];
										if (!n) {
											const r = s[e],
												a = Xp(r.width, r.height),
												l = a.getContext('2d');
											(l.globalAlpha = o), l.drawImage(i.image, r.x, r.y, r.width, r.height, 0, 0, r.width, r.height), (n = l.createPattern(a, 'repeat')), (f[t] = n);
										}
										d.setColor(n);
									}
								}
							} else (n = wm(_m(w, 'paint', w.type + '-color', C, p, E), o)), w.type + '-outline-color' in F && (_ = wm(_m(w, 'paint', w.type + '-outline-color', C, p, E), o)), _ || (_ = n), (n || _) && (++P, (S = v[P]), (!S || (n && !S.getFill()) || (!n && S.getFill()) || (_ && !S.getStroke()) || (!_ && S.getStroke()) || S.getText()) && ((S = new Hd({ fill: n ? new qd() : void 0, stroke: _ ? new Yd() : void 0 })), (v[P] = S)), n && ((d = S.getFill()), d.setColor(n)), _ && ((m = S.getStroke()), m.setColor(_), m.setWidth(0.5)), S.setZIndex(M));
						if (1 != b && 'line' == w.type) {
							n = 'line-pattern' in F ? void 0 : wm(_m(w, 'paint', 'line-color', C, p, E), _m(w, 'paint', 'line-opacity', C, p, E));
							const t = _m(w, 'paint', 'line-width', C, p, E);
							n &&
								t > 0 &&
								(++P,
								(S = v[P]),
								(S && S.getStroke() && !S.getFill() && !S.getText()) || ((S = new Hd({ stroke: new Yd() })), (v[P] = S)),
								(m = S.getStroke()),
								m.setLineCap(_m(w, 'layout', 'line-cap', C, p, E)),
								m.setLineJoin(_m(w, 'layout', 'line-join', C, p, E)),
								m.setMiterLimit(_m(w, 'layout', 'line-miter-limit', C, p, E)),
								m.setColor(n),
								m.setWidth(t),
								m.setLineDash(
									F['line-dasharray']
										? _m(w, 'paint', 'line-dasharray', C, p, E).map(function (e) {
												return e * t;
										  })
										: null
								),
						...
						let I,
							...
							$ = null,
							B = 0;
						if ((1 == b || 2 == b) && 'icon-image' in R) {
							const e = _m(w, 'layout', 'icon-image', C, p, E);
							if (e) {
								let n;
								I = 'string' == typeof e ? Sm(e, c) : e.toString();
								const o = l ? l(t, I) : void 0,
									a = Cm(I, h);
								if ((s && s[I] && a) || o) {
									const t = _m(w, 'layout', 'icon-rotation-alignment', C, p, E);
									if (2 == b) {
										const e = i.getGeometry();
										if (e.getFlatMidpoint || e.getFlatMidpoints) {
											const i = e.getExtent();
											if (Math.sqrt(Math.max(Math.pow((i[2] - i[0]) / r, 2), Math.pow((i[3] - i[1]) / r, 2))) > 150) {
												const i = 'MultiLineString' === e.getType() ? e.getFlatMidpoints() : e.getFlatMidpoint();
												mm || ((pm = [NaN, NaN]), (mm = new Zg('Point', pm, [], 2, {}, void 0))), (n = mm), (pm[0] = i[0]), (pm[1] = i[1]);
												if ('line' === _m(w, 'layout', 'symbol-placement', C, p, E) && 'map' === t) {
													const t = e.getStride(),
									...
									if (2 !== b || n) {
										const e = _m(w, 'layout', 'icon-size', C, p, E),
											i = void 0 !== F['icon-color'] ? _m(w, 'paint', 'icon-color', C, p, E) : null;
										if (!i || 0 !== i.a) {
											const n = _m(w, 'paint', 'icon-halo-color', C, p, E),
												r = _m(w, 'paint', 'icon-halo-width', C, p, E);
											let l = `${I}.${e}.${r}.${n}`;
											if ((null !== i && (l += `.${i}`), (k = g[l]), !k)) {
												const h = ym(w, C, 'icon', p);
												let c;
												'icon-offset' in R && ((c = _m(w, 'layout', 'icon-offset', C, p, E).slice(0)), (c[0] *= e), (c[1] *= -e));
												let u = i ? [255 * i.r, 255 * i.g, 255 * i.b, i.a] : void 0;
												if (o) {
													const i = { color: u, rotateWithView: 'map' === t, displacement: c, declutterMode: h, scale: e };
													'string' == typeof o ? (i.src = o) : ((i.img = o), (i.imgSize = [o.width, o.height])), (k = new Kd(i));
												} else {
													const o = s[I];
													let l, d, g;
													if (r) o.sdf ? ((l = tm(im(a.image, o, i || [0, 0, 0, 1]), { x: 0, y: 0, width: o.width, height: o.height, pixelRatio: o.pixelRatio }, r, n)), (u = void 0)) : (l = tm(a.image, o, r, n));
													else {
														if (o.sdf && !a.unSDFed) {
															const t = im(a.image, { x: 0, y: 0, width: a.size[0], height: a.size[1] }, { r: 1, g: 1, b: 1 });
															(a.image = t), (a.unSDFed = !0);
														}
														(l = a.image), (d = [o.width, o.height]), (g = [o.x, o.y]);
													}
													k = new Kd({ color: u, img: l, imgSize: a.size, size: d, offset: g, rotateWithView: 'map' === t, scale: e / o.pixelRatio, displacement: c, declutterMode: h });
												}
												g[l] = k;
											}
										}
										k && (++P, (S = v[P]), (S && S.getImage() && !S.getFill() && !S.getStroke()) || ((S = new Hd()), (v[P] = S)), S.setGeometry(n), k.setRotation(B + Vp(_m(w, 'layout', 'icon-rotate', C, p, E))), k.setOpacity(_m(w, 'paint', 'icon-opacity', C, p, E)), k.setAnchor(gm[_m(w, 'layout', 'icon-anchor', C, p, E)]), S.setImage(k), ($ = S.getText()), S.setText(void 0), S.setZIndex(M), (j = !0), (L = !1));
									} else L = !0;
								}
							}
						}
						if (1 == b && 'circle' === w.type) {
							++P, (S = v[P]), (S && S.getImage() && !S.getFill() && !S.getStroke()) || ((S = new Hd()), (v[P] = S));
							const t = 'circle-radius' in F ? _m(w, 'paint', 'circle-radius', C, p, E) : 5,
								e = wm(_m(w, 'paint', 'circle-stroke-color', C, p, E), _m(w, 'paint', 'circle-stroke-opacity', C, p, E)),
								i = _m(w, 'paint', 'circle-translate', C, p, E),
								n = wm(_m(w, 'paint', 'circle-color', C, p, E), _m(w, 'paint', 'circle-opacity', C, p, E)),
								r = _m(w, 'paint', 'circle-stroke-width', C, p, E),
								s = t + '.' + e + '.' + n + '.' + r + '.' + i[0] + '.' + i[1];
							(k = g[s]), k || ((k = new Xd({ radius: t, displacement: [i[0], -i[1]], stroke: e && r > 0 ? new Yd({ width: r, color: e }) : void 0, fill: n ? new qd({ color: n }) : void 0, declutterMode: 'none' })), (g[s] = k)), S.setImage(k), ($ = S.getText()), S.setText(void 0), S.setGeometry(void 0), S.setZIndex(M), (j = !0);
						}
						if ('text-field' in R) {
							z = Math.round(_m(w, 'layout', 'text-size', C, p, E));
							const t = _m(w, 'layout', 'text-font', C, p, E);
							(O = _m(w, 'layout', 'text-line-height', C, p, E)), (D = Ui(a ? a(t, e.metadata ? e.metadata['ol:webfonts'] : void 0) : t, z, O)), D.includes('sans-serif') || (D += ',sans-serif'), (N = _m(w, 'layout', 'text-letter-spacing', C, p, E)), (G = _m(w, 'layout', 'text-max-width', C, p, E));
							const i = _m(w, 'layout', 'text-field', C, p, E);
							(A =
								'object' == typeof i && i.sections
									? 1 === i.sections.length
										? i.toString()
										: i.sections.reduce((e, i, n) => {
												const r = i.fontStack ? i.fontStack.split(',') : t,
													s = Ui(a ? a(r) : r, z * (i.scale || 1), O);
												let o = i.text;
												if ('\n' === o) return e.push('\n', ''), e;
												if (2 == b) return e.push(rm(o, N), s), e;
												o = hm(o, s, G, N).split('\n');
												for (let t = 0, i = o.length; t < i; ++t) t > 0 && e.push('\n', ''), e.push(o[t], s);
												return e;
										  }, [])
									: Sm(i, c).trim()),
								(o = _m(w, 'paint', 'text-opacity', C, p, E));
						}
						if (A && o && !L) {
							j || (++P, (S = v[P]), (S && S.getText() && !S.getFill() && !S.getStroke()) || ((S = new Hd()), (v[P] = S)), S.setImage(void 0), S.setGeometry(void 0));
							const t = ym(w, C, 'text', p);
							S.getText() || S.setText($), ($ = S.getText()), (!$ || ('getDeclutterMode' in $ && $.getDeclutterMode() !== t)) && (($ = new ig({ padding: [2, 2, 2, 2], declutterMode: t })), S.setText($));
							const e = _m(w, 'layout', 'text-transform', C, p, E);
							'uppercase' == e ? (A = Array.isArray(A) ? A.map((t, e) => (e % 2 ? t : t.toUpperCase())) : A.toUpperCase()) : 'lowercase' == e && (A = Array.isArray(A) ? A.map((t, e) => (e % 2 ? t : t.toLowerCase())) : A.toLowerCase());
							const i = Array.isArray(A) ? A : 2 == b ? rm(A, N) : hm(A, D, G, N);
							if (($.setText(i), $.setFont(D), $.setRotation(Vp(_m(w, 'layout', 'text-rotate', C, p, E))), 'function' == typeof $.setKeepUpright)) {
								const t = _m(w, 'layout', 'text-keep-upright', C, p, E);
								$.setKeepUpright(t);
							}
							const n = _m(w, 'layout', 'text-anchor', C, p, E),
								r = j || 1 == b ? 'point' : _m(w, 'layout', 'symbol-placement', C, p, E);
							let s;
							if (('line-center' === r ? ($.setPlacement('line'), (s = 'center')) : $.setPlacement(r), 'line' === r && 'function' == typeof $.setRepeat)) {
								const t = _m(w, 'layout', 'symbol-spacing', C, p, E);
								$.setRepeat(2 * t);
							}
							$.setOverflow('point' === r);
							let a = _m(w, 'paint', 'text-halo-width', C, p, E);
							const l = _m(w, 'layout', 'text-offset', C, p, E),
								h = _m(w, 'paint', 'text-translate', C, p, E);
							let c = 0,
								u = 0;
							if ('point' == r) {
								(s = 'center'), -1 !== n.indexOf('left') ? ((s = 'left'), (u = a)) : -1 !== n.indexOf('right') && ((s = 'right'), (u = -a));
								const t = _m(w, 'layout', 'text-rotation-alignment', C, p, E);
								$.setRotateWithView('map' == t);
							} else $.setMaxAngle((Vp(_m(w, 'layout', 'text-max-angle', C, p, E)) * A.length) / i.length), $.setRotateWithView(!1);
							$.setTextAlign(s);
							let d = 'middle';
							0 == n.indexOf('bottom') ? ((d = 'bottom'), (c = -a - 0.5 * (O - 1) * z)) : 0 == n.indexOf('top') && ((d = 'top'), (c = a + 0.5 * (O - 1) * z)), $.setTextBaseline(d);
							const g = _m(w, 'layout', 'text-justify', C, p, E);
							$.setJustify('auto' === g ? void 0 : g), $.setOffsetX(l[0] * z + u + h[0]), $.setOffsetY(l[1] * z + c + h[1]), x.setColor(wm(_m(w, 'paint', 'text-color', C, p, E), o)), $.setFill(x);
							const f = wm(_m(w, 'paint', 'text-halo-color', C, p, E), o);
							if (f && a > 0) {
								y.setColor(f), (a *= 2);
								const t = 0.5 * z;
								y.setWidth(a <= t ? a : t), $.setStroke(y);
							} else $.setStroke(void 0);
							const m = _m(w, 'layout', 'text-padding', C, p, E),
								_ = $.getPadding();
							m !== _[0] && ((_[0] = m), (_[1] = m), (_[2] = m), (_[3] = m)), S.setZIndex(M);
						}
					}
				}
				return P > -1 ? ((v.length = P + 1), Em && ('set' in i ? i.set('mapbox-layer', T) : (i.getProperties()['mapbox-layer'] = T)), v) : void 0;
			};
		return t.setStyle(w), t.set('mapbox-layers', d), t.set('mapbox-source', _), t.set('mapbox-featurestate', t.get('mapbox-featurestate') || {}), w;
	}
	class Rm {
		constructor() {
			(this.dataProjection = void 0), (this.defaultFeatureProjection = void 0), (this.featureClass = Dg), (this.supportedMediaTypes = null);
		}
		getReadOptions(t, e) {
			if (e) {
				let i = e.dataProjection ? Go(e.dataProjection) : this.readProjection(t);
				e.extent && i && 'tile-pixels' === i.getUnits() && ((i = Go(i)), i.setWorldExtent(e.extent)), (e = { dataProjection: i, featureProjection: e.featureProjection });
			}
	...
	function Fm(t, e, i) {
		const n = i ? Go(i.featureProjection) : null,
			r = i ? Go(i.dataProjection) : null;
		let s = t;
		if (n && r && !Xo(n, r)) {
			e && (s = t.clone());
			const i = e ? n : r,
				o = e ? r : n;
			'tile-pixels' === i.getUnits() ? s.transform(i, o) : s.applyTransform(Ko(i, o));
		}
	...
	const Mm = { Point: Za, LineString: Ug, Polygon: dl, MultiPoint: Wg, MultiLineString: Vg, MultiPolygon: Xg };
	function Im(t, e) {
		const i = t.geometry;
		if (!i) return [];
		if (Array.isArray(i)) return i.map((e) => Im({ ...t, geometry: e })).flat();
		...
		return Fm(
			new Zg(
				...
				'Polygon' === n
					? (function (t, e, i) {
							return Array.isArray(e[0]) ? (ll(t, 0, e, i) || cl((t = t.slice()), 0, e, i), t) : (al(t, 0, e, i) || hl((t = t.slice()), 0, e, i), t);
					  })(i.flatCoordinates, i.ends, r)
					: i.flatCoordinates,
				i.ends?.flat(),
				r,
				t.properties || {},
	...
	function km(t, e) {
		if (!t) return null;
		if (Array.isArray(t)) {
			const i = t.map((t) => km(t, e));
			return new jg(i);
		}
		return Fm(new (0, Mm[t.type])(t.flatCoordinates, t.layout || 'XY', t.ends), !1, e);
	}
	class Lm extends Rm {
		constructor() {
			super();
		...
		readFeature(t, e) {
			return this.readFeatureFromObject(Am(t), this.getReadOptions(t, e));
		}
		readFeatures(t, e) {
			return this.readFeaturesFromObject(Am(t), this.getReadOptions(t, e));
		}
		...
		readGeometry(t, e) {
			return this.readGeometryFromObject(Am(t), this.getReadOptions(t, e));
		}
		readGeometryFromObject(t, e) {
			return Fn();
		}
		readProjection(t) {
			return this.readProjectionFromObject(Am(t));
		}
	...
	class Dm extends Lm {
		constructor(t) {
			(t = t || {}), super(), (this.dataProjection = Go(t.dataProjection ? t.dataProjection : 'EPSG:4326')), t.featureProjection && (this.defaultFeatureProjection = Go(t.featureProjection)), t.featureClass && (this.featureClass = t.featureClass), (this.geometryName_ = t.geometryName), (this.extractGeometryName_ = t.extractGeometryName), (this.supportedMediaTypes = ['application/geo+json', 'application/vnd.geo+json']);
		}
		readFeatureFromObject(t, e) {
			let i = null;
			i = 'Feature' === t.type ? t : { type: 'Feature', geometry: t, properties: null };
			const n = Om(i.geometry);
			if (this.featureClass === Zg) return Im({ geometry: n, id: i.id, properties: i.properties }, e);
			const r = new Dg();
			return this.geometryName_ ? r.setGeometryName(this.geometryName_) : this.extractGeometryName_ && i.geometry_name && r.setGeometryName(i.geometry_name), r.setGeometry(km(n, e)), 'id' in i && r.setId(i.id), i.properties && r.setProperties(i.properties, !0), r;
		}
		readFeaturesFromObject(t, e) {
			let i = null;
		...
		readProjectionFromObject(t) {
			...
			let i;
			if (e)
				if ('name' == e.type) i = Go(e.properties.name);
				else {
					if ('EPSG' !== e.type) throw new Error('Unknown SRS type');
					i = Go('EPSG:' + e.properties.code);
				}
		...
		writeFeatureObject(t, e) {
			...
			const r = t.getProperties(),
				s = t.getGeometry();
			return s && ((i.geometry = zm(s, e)), delete r[t.getGeometryName()]), vn(r) || (i.properties = r), i;
		}
		writeFeaturesObject(t, e) {
			e = this.adaptOptions(e);
			const i = [];
		...
		writeGeometryObject(t, e) {
			return zm(t, this.adaptOptions(e));
		}
	}
	function Om(t, e) {
		if (!t) return null;
		...
		switch (t.type) {
			case 'Point':
				i = (function (t) {
					...
					return { type: 'Point', flatCoordinates: e, layout: Ta(e.length) };
				})(t);
				break;
			case 'LineString':
				i = (function (t) {
					const e = t.coordinates,
						i = e.flat();
					return { type: 'LineString', flatCoordinates: i, ends: [i.length], layout: Ta(e[0]?.length || 2) };
				})(t);
				break;
			case 'Polygon':
				i = (function (t) {
					const e = t.coordinates,
						...
						n = e[0]?.[0]?.length,
						r = za(i, 0, e, n);
					return { type: 'Polygon', flatCoordinates: i, ends: r, layout: Ta(n) };
				})(t);
				break;
			case 'MultiPoint':
				i = (function (t) {
					const e = t.coordinates;
					return { type: 'MultiPoint', flatCoordinates: e.flat(), layout: Ta(e[0]?.length || 2) };
				})(t);
				break;
			case 'MultiLineString':
				i = (function (t) {
					const e = t.coordinates,
						...
						n = [],
						r = za(n, 0, e, i);
					return { type: 'MultiLineString', flatCoordinates: n, ends: r, layout: Ta(i) };
				})(t);
				break;
			case 'MultiPolygon':
				i = (function (t) {
					const e = t.coordinates,
						...
						n = e[0]?.[0]?.[0].length || 2,
						r = Na(i, 0, e, n);
					return { type: 'MultiPolygon', flatCoordinates: i, ends: r, layout: Ta(n) };
				})(t);
				break;
			case 'GeometryCollection':
				i = (function (t) {
	...
	const Nm = 4294967296,
		Gm = 1 / Nm,
		jm = 'undefined' == typeof TextDecoder ? null : new TextDecoder('utf-8');
	class $m {
		...
		readFields(t, e, i = this.length) {
			for (; this.pos < i; ) {
				const i = this.readVarint(),
					n = i >> 3,
					r = this.pos;
				(this.type = 7 & i), t(n, e, this), this.pos === r && this.skip(i);
			}
			return e;
		}
		readMessage(t, e) {
		...
		readFixed64() {
			const t = this.dataView.getUint32(this.pos, !0) + this.dataView.getUint32(this.pos + 4, !0) * Nm;
			return (this.pos += 8), t;
		}
		readSFixed64() {
			const t = this.dataView.getUint32(this.pos, !0) + this.dataView.getInt32(this.pos + 4, !0) * Nm;
			return (this.pos += 8), t;
		}
		readFloat() {
									  ...
									  n < 128
											...
											: ((n = e[this.pos]),
											  ...
											  (function (t, e, i) {
													const n = i.buf;
													let r, s;
													if (((s = n[i.pos++]), (r = (112 & s) >> 4), s < 128)) return Bm(t, r, e);
													if (((s = n[i.pos++]), (r |= (127 & s) << 3), s < 128)) return Bm(t, r, e);
													if (((s = n[i.pos++]), (r |= (127 & s) << 10), s < 128)) return Bm(t, r, e);
													if (((s = n[i.pos++]), (r |= (127 & s) << 17), s < 128)) return Bm(t, r, e);
													if (((s = n[i.pos++]), (r |= (127 & s) << 24), s < 128)) return Bm(t, r, e);
													if (((s = n[i.pos++]), (r |= (1 & s) << 31), s < 128)) return Bm(t, r, e);
		...
		readString() {
			...
			return (
				(this.pos = t),
				t - e >= 12 && jm
					? jm.decode(this.buf.subarray(e, t))
					: (function (t, e, i) {
							let n = '',
								r = e;
							for (; r < i; ) {
								...
								1 === h ? e < 128 && (l = e) : 2 === h ? ((s = t[r + 1]), 128 == (192 & s) && ((l = ((31 & e) << 6) | (63 & s)), l <= 127 && (l = null))) : 3 === h ? ((s = t[r + 1]), (o = t[r + 2]), 128 == (192 & s) && 128 == (192 & o) && ((l = ((15 & e) << 12) | ((63 & s) << 6) | (63 & o)), (l <= 2047 || (l >= 55296 && l <= 57343)) && (l = null))) : 4 === h && ((s = t[r + 1]), (o = t[r + 2]), (a = t[r + 3]), 128 == (192 & s) && 128 == (192 & o) && 128 == (192 & a) && ((l = ((15 & e) << 18) | ((63 & s) << 12) | ((63 & o) << 6) | (63 & a)), (l <= 65535 || l >= 1114112) && (l = null))),
									null === l ? ((l = 65533), (h = 1)) : l > 65535 && ((l -= 65536), (n += String.fromCharCode(((l >>> 10) & 1023) | 55296)), (l = 56320 | (1023 & l))),
		...
		writeFixed64(t) {
			this.realloc(8), this.dataView.setInt32(this.pos, -1 & t, !0), this.dataView.setInt32(this.pos + 4, Math.floor(t * Gm), !0), (this.pos += 8);
		}
		writeSFixed64(t) {
			this.realloc(8), this.dataView.setInt32(this.pos, -1 & t, !0), this.dataView.setInt32(this.pos + 4, Math.floor(t * Gm), !0), (this.pos += 8);
		}
		writeVarint(t) {
			(t = +t || 0) > 268435455 || t < 0
				? (function (t, e) {
						let i, n;
						t >= 0 ? ((i = t % 4294967296 | 0), (n = (t / 4294967296) | 0)) : ((i = ~(-t % 4294967296)), (n = ~(-t / 4294967296)), 4294967295 ^ i ? (i = (i + 1) | 0) : ((i = 0), (n = (n + 1) | 0)));
		...
		writeString(t) {
			...
			const i = this.pos - e;
			i >= 128 && Um(e, i, this), (this.pos = e - 1), this.writeVarint(i), (this.pos += i);
		}
		writeFloat(t) {
	...
	function Um(t, e, i) {
		...
		i.realloc(n);
		for (let e = i.pos - 1; e >= t; e--) i.buf[e + n] = i.buf[e];
	}
	function Vm(t, e) {
	...
	class Qm extends Rm {
		constructor(t) {
			super(), (t = t || {}), (this.dataProjection = new Bs({ code: '', units: 'tile-pixels' })), (this.featureClass = t.featureClass ? t.featureClass : Zg), (this.geometryName_ = t.geometryName), (this.layerName_ = t.layerName ? t.layerName : 'layer'), (this.layers_ = t.layers ? t.layers : null), (this.idProperty_ = t.idProperty), (this.supportedMediaTypes = ['application/vnd.mapbox-vector-tile', 'application/x-protobuf']);
		}
		readRawGeometry_(t, e, i, n) {
			...
			for (; t.pos < r; ) {
				...
				if ((o--, 1 === s || 2 === s)) (a += t.readSVarint()), (l += t.readSVarint()), 1 === s && h > c && (n.push(h), (c = h)), i.push(a, l), (h += 2);
				else {
		...
		createFeature_(t, e, i) {
			...
			if (this.featureClass === Zg) (r = new this.featureClass(h, a, l, 2, s, o)), r.transform(i.dataProjection);
			else {
				let t;
				if ('Polygon' == h) {
					const e = ul(a, l);
					t = e.length > 1 ? new Xg(a, 'XY', e) : new dl(a, 'XY', l);
				} else t = 'Point' === h ? new Za(a, 'XY') : 'LineString' === h ? new Ug(a, 'XY') : 'MultiPoint' === h ? new Wg(a, 'XY') : 'MultiLineString' === h ? new Vg(a, 'XY', l) : null;
		...
		readFeatures(t, e) {
			const i = this.layers_,
				n = Go((e = this.adaptOptions(e)).dataProjection);
	...
	function t_(t, e, i) {
		if (3 === t) {
			...
			i.readFields(e_, t, n), (t.length = t.features.length), t.length && (e[t.name] = t);
		}
	}
	function e_(t, e, i) {
	...
	class r_ extends fp {
		...
		prepareFrame(t) {
			const e = t.layerStatesArray[t.layerIndex],
				...
				o = t.viewHints;
			let a = t.extent;
			if ((void 0 !== e.extent && (a = ds(a, ra(e.extent, n.projection))), !o[mr] && !o[_r] && !_s(a)))
				if (s) {
					const t = n.projection,
						e = s.getImage(a, r, i, t);
					e && (this.loadImage(e) ? (this.image = e) : e.getState() === gd && (this.image = null));
		...
		getData(t) {
			...
			const i = this.getLayer(),
				n = ga(e.pixelToCoordinateTransform, t.slice()),
				r = i.getExtent();
			if (r && !Ur(r, n)) return null;
		...
		renderFrame(t, e) {
			...
			let y = !1,
				x = !0;
			if (l.extent) {
				const e = ra(l.extent, c.projection);
				(x = ms(e, t.extent)), (y = x && !Vr(e, t.extent)), y && this.clipUnrotated(_, t, e);
			}
			const v = i.getImage(),
				w = ma(this.tempTransform, p / 2, m / 2, g, f, 0, (a * (n[0] - u[0])) / s, (a * (u[1] - n[3])) / o);
			...
			if ((this.getLayer().getSource().getInterpolate() || (_.imageSmoothingEnabled = !1), this.preRender(_, t), x && b >= 0.5 && S >= 0.5)) {
				const t = w[4],
					e = w[5],
					i = l.opacity;
				1 !== i && (_.save(), (_.globalAlpha = i)), _.drawImage(v, 0, 0, +v.width, +v.height, t, e, b, S), 1 !== i && _.restore();
			}
	...
	class c_ extends yp {
		...
		getSize() {
			...
			const t = a_(this.data_);
			return t ? [t.width, t.height] : h_;
		}
		getData() {
			return this.data_;
		}
		...
		load() {
			if (this.state !== ar && this.state !== cr) return;
			(this.state = lr), this.changed();
			const t = this;
			this.loader_()
				.then(function (e) {
					(t.data_ = e), (t.state = hr), t.changed();
				})
				.catch(function (e) {
					(t.error_ = e), (t.state = cr), t.changed();
				});
		}
		disposeInternal() {
			this.controller_ && (this.controller_.abort(l_), (this.controller_ = null)), super.disposeInternal();
		}
	}
	let u_;
	const d_ = [];
	...
	function m_(t, e, i, n, r, s, o, a, l, h, c, u, d, g) {
		const f = Ll(Math.round(i * t), Math.round(i * e), d_);
		if ((u || (f.imageSmoothingEnabled = !1), 0 === l.length)) return f.canvas;
		function p(t) {
			return Math.round(t * i) / i;
		}
		f.scale(i, i), (f.globalCompositeOperation = 'lighter');
		...
		(d && 1 === l.length && 0 === h) ||
			((_ = Ll(Math.round(ps(m) * y), Math.round(us(m) * y), d_)),
				...
				if (t.image.width > 0 && t.image.height > 0) {
					if (t.clipExtent) {
						...
						const e = (t.clipExtent[0] - m[0]) * y,
							i = -(t.clipExtent[3] - m[3]) * y,
							n = ps(t.clipExtent) * y,
							r = us(t.clipExtent) * y;
						_.rect(u ? e : Math.round(e), u ? i : Math.round(i), u ? n : Math.round(e + n) - Math.round(e), u ? r : Math.round(i + r) - Math.round(i)), _.clip();
					}
					const e = (t.extent[0] - m[0]) * y,
						i = -(t.extent[3] - m[3]) * y,
						n = ps(t.extent) * y,
						r = us(t.extent) * y;
					_.drawImage(t.image, h, h, t.image.width - 2 * h, t.image.height - 2 * h, u ? e : Math.round(e), u ? i : Math.round(i), u ? n : Math.round(e + n) - Math.round(e), u ? r : Math.round(i + r) - Math.round(i)), t.clipExtent && _.restore();
				}
			}));
		const v = gs(o);
		return (
			a.getTriangles().forEach(function (t, e, i) {
				...
				if (
					...
					(function () {
						if (void 0 === u_) {
							const t = Ll(6, 6, d_);
							(t.globalCompositeOperation = 'lighter'), (t.fillStyle = 'rgba(210, 0, 0, 0.75)'), g_(t, 4, 5, 4, 0), g_(t, 4, 5, 0, 5);
							const e = t.getImageData(0, 0, 3, 3).data;
							(u_ = f_(e, 0) || f_(e, 4) || f_(e, 8)), Ol(t), d_.push(t.canvas);
						}
						return u_;
					})() || !u)
				) {
					...
					const t = 4,
						e = y - b,
						i = w - S;
					for (let n = 0; n < t; n++) f.lineTo(b + p(((n + 1) * e) / t), S + p((n * i) / (t - 1))), n != t - 1 && f.lineTo(b + p(((n + 1) * e) / t), S + p(((n + 1) * i) / (t - 1)));
					f.lineTo(C, E);
				...
				if ((f.clip(), f.transform(R[0], R[2], R[1], R[3], y, w), f.translate(m[0] - T, m[3] - P), _)) (F = _.canvas), f.scale(x, -x);
					...
					const t = l[0],
						e = t.extent;
					(F = t.image), f.scale(ps(e) / F.width, -us(e) / F.height);
				}
				f.drawImage(F, 0, 0), f.restore();
			}),
			_ && (Ol(_), d_.push(_.canvas)),
			c &&
				(f.save(),
	...
	class __ {
		constructor(t, e, i, n, r, s, o) {
			...
			let a = {};
			const l = o ? Vo((t) => ga(o, Yo(t, this.targetProj_, this.sourceProj_))) : Ko(this.targetProj_, this.sourceProj_);
			(this.transformInv_ = function (t) {
				...
				(this.canWrapXInSource_ = this.sourceProj_.canWrapX() && !!n && !!this.sourceProj_.getExtent() && ps(n) >= ps(this.sourceProj_.getExtent())),
				(this.sourceWorldWidth_ = this.sourceProj_.getExtent() ? ps(this.sourceProj_.getExtent()) : null),
				(this.targetWorldWidth_ = this.targetProj_.getExtent() ? ps(this.targetProj_.getExtent()) : null);
			const h = gs(i),
				c = fs(i),
				u = os(i),
				d = ss(i),
				...
				_ = 10 + (s ? Math.max(0, Math.ceil(Math.log2(rs(i) / (s * s * 256 * 256)))) : 0);
		...
		addQuad_(t, e, i, n, r, s, o, a, l) {
			const h = Gr([r, s, o, a]),
				c = this.sourceWorldWidth_ ? ps(h) / this.sourceWorldWidth_ : null,
				u = this.sourceWorldWidth_,
				d = this.sourceProj_.canWrapX() && c > 0.5 && c < 1;
			let g = !1;
			if (l > 0) {
				if (this.targetProj_.isGlobal() && this.targetWorldWidth_) {
					g = ps(Gr([t, e, i, n])) / this.targetWorldWidth_ > 0.25 || g;
				}
				!d && this.sourceProj_.isGlobal() && c && (g = c > 0.25 || g);
			}
			if (!g && this.maxSourceExtent_ && isFinite(h[0]) && isFinite(h[1]) && isFinite(h[2]) && isFinite(h[3]) && !ms(h, this.maxSourceExtent_)) return;
			let f = 0;
			...
			if (l > 0) {
				if (!g) {
					...
					let s;
					if (d) {
						s = (Cr(r[0], u) + Cr(o[0], u)) / 2 - Cr(n[0], u);
			...
			11 & f || this.addTriangle_(t, i, n, r, o, a), 14 & f || this.addTriangle_(t, i, e, r, o, s), f && (13 & f || this.addTriangle_(e, n, t, s, a, r), 7 & f || this.addTriangle_(e, n, i, s, a, o));
		}
	...
	class y_ extends yp {
		constructor(t, e, i, n, r, s, o, a, l, h, c, u) {
			super(r, ar, u), (this.renderEdges_ = void 0 !== c && c), (this.pixelRatio_ = o), (this.gutter_ = a), (this.canvas_ = null), (this.sourceTileGrid_ = e), (this.targetTileGrid_ = n), (this.wrappedTileCoord_ = s || r), (this.sourceTiles_ = []), (this.sourcesListenerKeys_ = null), (this.sourceZ_ = 0), (this.clipExtent_ = t.canWrapX() ? t.getExtent() : void 0);
			const d = n.getTileCoordExtent(this.wrappedTileCoord_),
				g = this.targetTileGrid_.getExtent();
			let f = this.sourceTileGrid_.getExtent();
			const p = g ? ds(d, g) : d;
			if (0 === rs(p)) return void (this.state = ur);
			const m = t.getExtent();
			m && (f = f ? ds(f, m) : m);
			const _ = n.getResolution(this.wrappedTileCoord_[0]),
				y = (function (t, e, i, n) {
					...
					return (
						(!isFinite(s) || s <= 0) &&
							ns(i, function (i) {
								return (s = p_(t, e, i, n)), isFinite(s) && s > 0;
							}),
						s
					);
				})(t, i, p, _);
			if (!isFinite(y) || y <= 0) return void (this.state = ur);
			const x = void 0 !== h ? h : 0.5;
			if (((this.triangulation_ = new __(t, i, p, f, y * x, _)), 0 === this.triangulation_.getTriangles().length)) return void (this.state = ur);
			this.sourceZ_ = e.getZForResolution(y);
			let v = this.triangulation_.calculateSourceExtent();
			if ((f && (t.canWrapX() ? ((v[1] = xr(v[1], f[1], f[3])), (v[3] = xr(v[3], f[1], f[3]))) : (v = ds(v, f))), rs(v))) {
				let i = 0,
					n = 0;
				t.canWrapX() && ((i = ps(m)), (n = Math.floor((v[0] - m[0]) / i)));
				vs(v.slice(), t, !0).forEach((t) => {
					...
					0 === this.sourceTiles_.length && (this.state = ur);
			} else this.state = ur;
		}
		getImage() {
			return this.canvas_;
		...
		reproject_() {
			...
			if (
				(this.sourceTiles_.forEach((e) => {
					const i = e.tile;
					if (i && i.getState() == hr) {
						const n = this.sourceTileGrid_.getTileCoordExtent(i.tileCoord);
						(n[0] += e.offset), (n[2] += e.offset);
						const r = this.clipExtent_?.slice();
						r && ((r[0] += e.offset), (r[2] += e.offset)), t.push({ extent: n, clipExtent: r, image: i.getImage() });
					}
				}),
				...
				(this.canvas_ = m_(n, r, this.pixelRatio_, o, this.sourceTileGrid_.getExtent(), s, a, this.triangulation_, t, this.gutter_, this.renderEdges_, this.interpolate)), (this.state = hr);
			}
			this.changed();
		}
		load() {
				...
				(this.sourcesListenerKeys_ = []),
					this.sourceTiles_.forEach(({ tile: e }) => {
						...
						if (i == ar || i == lr) {
							...
							const i = Sn(e, qi, (n) => {
								const r = e.getState();
								(r != hr && r != cr && r != ur) || (En(i), t--, 0 === t && (this.unlistenSources_(), this.reproject_()));
							});
					...
					0 === t
						...
						: this.sourceTiles_.forEach(function ({ tile: t }, e, i) {
								t.getState() == ar && t.load();
						  });
			}
		}
		unlistenSources_() {
			this.sourcesListenerKeys_.forEach(En), (this.sourcesListenerKeys_ = null);
		}
		release() {
			this.canvas_ && (Ol(this.canvas_.getContext('2d')), d_.push(this.canvas_), (this.canvas_ = null)), super.release();
		}
	}
	class x_ {
		constructor(t) {
		...
		get(t, e) {
			...
			return dr(void 0 !== i, 'Tried to get a value for a key that does not exist in the cache'), i === this.newest_ || (i === this.oldest_ ? ((this.oldest_ = this.oldest_.newer), (this.oldest_.older = null)) : ((i.newer.older = i.older), (i.older.newer = i.newer)), (i.newer = null), (i.older = this.newest_), (this.newest_.newer = i), (this.newest_ = i)), i.value_;
		}
		remove(t) {
			const e = this.entries_[t];
			return dr(void 0 !== e, 'Tried to get a value for a key that does not exist in the cache'), e === this.newest_ ? ((this.newest_ = e.older), this.newest_ && (this.newest_.newer = null)) : e === this.oldest_ ? ((this.oldest_ = e.newer), this.oldest_ && (this.oldest_.older = null)) : ((e.newer.older = e.older), (e.older.newer = e.newer)), delete this.entries_[t], --this.count_, e.value_;
		}
		getCount() {
			return this.count_;
		}
		...
		set(t, e) {
			dr(!(t in this.entries_), 'Tried to set a value for a key that is used already');
	...
	function w_(t) {
		return (e = t[0]), (i = t[1]), (n = t[2]), (i << e) + n;
		var e, i, n;
	}
	function b_(t, e, i, n, r) {
		return `${In(t)},${e},${(function (t, e, i) {
			return t + '/' + e + '/' + i;
		})(i, n, r)}`;
	}
	function S_(t, e, i) {
		if (!(i in t)) return (t[i] = new Set([e])), !0;
		const n = t[i],
			r = n.has(e);
		return r || n.add(e), !r;
	}
	...
	function E_(t, e) {
		const i = t.layerStatesArray[t.layerIndex];
		i.extent && (e = ds(e, ra(i.extent, t.viewState.projection)));
	...
	class T_ extends fp {
		constructor(t, e) {
			super(t), (e = e || {}), (this.extentChanged = !0), (this.renderComplete = !1), (this.renderedExtent_ = null), this.renderedPixelRatio, (this.renderedProjection = null), (this.renderedTiles = []), this.renderedSourceKey_, this.renderedSourceRevision_, (this.tempExtent = [1 / 0, 1 / 0, -1 / 0, -1 / 0]), (this.tempTileRange_ = new Ep(0, 0, 0, 0)), (this.tempTileCoord_ = v_(0, 0, 0));
			const i = void 0 !== e.cacheSize ? e.cacheSize : 512;
			(this.tileCache_ = new x_(i)), (this.maxStaleKeys = 0.5 * i);
		}
		getTileCache() {
		...
		getOrCreateTile(t, e, i, n) {
			const r = this.tileCache_,
				s = this.getLayer().getSource(),
				o = b_(s, s.getKey(), t, e, i);
			let a;
			if (r.containsKey(o)) a = r.get(o);
			else {
				if (((a = s.getTile(t, e, i, n.pixelRatio, n.viewState.projection)), !a)) return null;
				r.set(o, a);
			}
			return a;
		}
		...
		getData(t) {
			...
			for (let t = a.getZForResolution(s.resolution); t >= a.getMinZoom(); --t) {
				const i = a.getTileCoordForCoordAndZ(n, t),
					r = this.getTile(t, i[1], i[2], e);
				if (!r || r.getState() !== hr) continue;
				const h = a.getOrigin(t),
					c = Nc(a.getTileSize(t)),
					u = a.getResolution(t);
				let d;
				if (r instanceof xp || r instanceof y_) d = r.getImage();
				else {
					if (!(r instanceof c_)) continue;
					if (((d = a_(r.getData())), !d)) continue;
				}
				const g = Math.floor(l * ((n[0] - h[0]) / u - i[1] * c[0])),
					f = Math.floor(l * ((h[1] - n[1]) / u - i[2] * c[1])),
		...
		enqueueTiles(t, e, i, n, r) {
			...
			const c = t.wantedTiles[h],
				u = o.getMapInternal(),
				d = Math.max(i - r, l.getMinZoom(), l.getZForResolution(Math.min(o.getMaxResolution(), u ? u.getView().getResolutionForZoom(Math.max(o.getMinZoom(), 0)) : l.getResolution(0)), a.zDirection)),
				g = s.rotation,
				f = g ? cs(s.center, s.resolution, g, t.size) : void 0;
			for (let r = i; r >= d; --r) {
				const i = l.getTileRangeForExtentAndZ(e, r, this.tempTileRange_),
					s = l.getResolution(r);
				for (let e = i.minX; e <= i.maxX; ++e)
					for (let o = i.minY; o <= i.maxY; ++o) {
						if (g && !l.tileCoordIntersectsViewport([r, e, o], f)) continue;
						const i = this.getTile(r, e, o, t);
						if (!i) continue;
						if (!S_(n, i, r)) continue;
						const a = i.getKey();
						if (((c[a] = !0), i.getState() === ar && !t.tileQueue.isKeyQueued(a))) {
							const n = v_(r, e, o, this.tempTileCoord_);
							t.tileQueue.enqueue([i, h, l.getTileCoordCenter(n), s]);
						}
					}
			}
		}
		findStaleTile_(t, e) {
			const i = this.tileCache_,
				...
				o = this.getStaleKeys();
			for (let t = 0; t < o.length; ++t) {
				const a = b_(this.getLayer().getSource(), o[t], n, r, s);
				if (i.containsKey(a)) {
					const t = i.peek(a);
					if (t.getState() === hr) return t.endTransition(In(this)), S_(e, t, n), !0;
				}
			}
			return !1;
		}
		findAltTiles_(t, e, i, n) {
			...
			for (let t = r.minX; t <= r.maxX; ++t)
				for (let e = r.minY; e <= r.maxY; ++e) {
					const r = b_(a, l, i, t, e);
					let h = !1;
					if (o.containsKey(r)) {
						const t = o.peek(r);
						t.getState() === hr && (S_(n, t, i), (h = !0));
					}
					h || (s = !1);
				}
			return s;
		...
		renderFrame(t, e) {
			...
			const i = t.layerStatesArray[t.layerIndex],
				...
				l = this.getLayer(),
				h = l.getSource(),
				c = h.getTileGridForProjection(r),
				u = c.getZForResolution(s, h.zDirection),
				d = c.getResolution(u),
				g = h.getKey();
			...
			let f = t.extent;
			const p = h.getTilePixelRatio(a);
			this.prepareContainer(t, e);
			const m = this.context.canvas.width,
				_ = this.context.canvas.height,
				y = i.extent && ra(i.extent, r);
			y && (f = ds(f, ra(i.extent, r)));
			const x = (d * m) / 2 / p,
				v = (d * _) / 2 / p,
				w = [o[0] - x, o[1] - v, o[0] + x, o[1] + v],
				b = {};
			this.renderedTiles.length = 0;
			const S = l.getPreload();
			if (t.nextExtent) {
				const e = c.getZForResolution(n.nextResolution, h.zDirection),
					i = E_(t, t.nextExtent);
				this.enqueueTiles(t, i, e, b, S);
			}
			const C = E_(t, f);
			if (
				(this.enqueueTiles(t, C, u, b, 0),
				S > 0 &&
					setTimeout(() => {
						this.enqueueTiles(t, C, u - 1, b, S - 1);
					}, 0),
				!(u in b))
			)
			...
			for (const e of b[u]) {
				...
				i !== cr && (this.renderComplete = !1);
				if (this.findStaleTile_(n, b)) {
					C_(b, e, u), (t.animate = !0);
					continue;
				}
				if (this.findAltTiles_(c, n, u + 1, b)) continue;
				const r = c.getMinZoom();
				for (let t = u - 1; t >= r; --t) {
					if (this.findAltTiles_(c, n, t, b)) break;
				}
			}
			const P = ((d / s) * a) / p,
				R = this.getRenderContext(t);
			ma(this.tempTransform, m / 2, _ / 2, P, P, 0, -m / 2, -_ / 2), i.extent && this.clipUnrotated(R, t, y), h.getInterpolate() || (R.imageSmoothingEnabled = !1), this.preRender(R, t);
			...
			for (let e = F.length - 1; e >= 0; --e) {
				const i = F[e],
					n = h.getTilePixelSize(i, a, r),
					s = c.getResolution(i) / d,
					o = n[0] * s * P,
					l = n[1] * s * P,
					u = c.getTileCoordForCoordAndZ(gs(w), i),
					g = c.getTileCoordExtent(u),
					f = ga(this.tempTransform, [(p * (g[0] - w[0])) / d, (p * (w[3] - g[3])) / d]),
					m = p * h.getGutterForProjection(r);
				for (const e of b[i]) {
					if (e.getState() !== hr) continue;
					const n = e.tileCoord,
						r = u[1] - n[1],
						s = Math.round(f[0] - (r - 1) * o),
						a = u[2] - n[2],
						c = Math.round(f[1] - (a - 1) * l),
						d = Math.round(f[0] - r * o),
						g = Math.round(f[1] - a * l),
						p = s - d,
						_ = c - g,
						y = 1 === F.length;
					let x = !1;
					M = [d, g, d + p, g, d + p, g + _, d, g + _];
					for (let t = 0, e = I.length; t < e; ++t)
						if (!y && i < k[t]) {
							const e = I[t];
							ms([d, g, d + p, g + _], [e[0], e[3], e[4], e[7]]) && (x || (R.save(), (x = !0)), R.beginPath(), R.moveTo(M[0], M[1]), R.lineTo(M[2], M[3]), R.lineTo(M[4], M[5]), R.lineTo(M[6], M[7]), R.moveTo(e[6], e[7]), R.lineTo(e[4], e[5]), R.lineTo(e[2], e[3]), R.lineTo(e[0], e[1]), R.clip());
						}
					I.push(M), k.push(i), this.drawTile(e, t, d, g, p, _, m, y), x && R.restore(), this.renderedTiles.unshift(e), this.updateUsedTiles(t.usedTiles, h, e);
				}
			}
			if (((this.renderedResolution = d), (this.extentChanged = !this.renderedExtent_ || !Jr(this.renderedExtent_, w)), (this.renderedExtent_ = w), (this.renderedPixelRatio = a), this.postRender(this.context, t), i.extent && R.restore(), (R.imageSmoothingEnabled = !0), this.renderComplete)) {
				const e = (t, e) => {
					const i = In(h),
						n = e.wantedTiles[i],
						r = n ? Object.keys(n).length : 0;
		...
		drawTile(t, e, i, n, r, s, o, a) {
			let l;
			if (t instanceof c_) {
				if (((l = a_(t.getData())), !l)) throw new Error('Rendering array data is not yet supported');
			...
			const h = this.getRenderContext(e),
				...
				g = d !== h.globalAlpha;
			g && (h.save(), (h.globalAlpha = d)), h.drawImage(l, o, o, l.width - 2 * o, l.height - 2 * o, i, n, r, s), g && h.restore(), d !== u.opacity ? (e.animate = !0) : a && t.endTransition(c);
		}
		getImage() {
	...
	var P_ = 'preload',
		R_ = 'useInterimTilesOnError';
	class F_ extends Hh {
		constructor(t) {
			t = t || {};
			const e = Object.assign({}, t),
				i = t.cacheSize;
			delete t.cacheSize, delete e.preload, delete e.useInterimTilesOnError, super(e), this.on, this.once, this.un, (this.cacheSize_ = i), this.setPreload(void 0 !== t.preload ? t.preload : 0), this.setUseInterimTilesOnError(void 0 === t.useInterimTilesOnError || t.useInterimTilesOnError);
		}
		getCacheSize() {
	...
	class M_ extends F_ {
		...
		createRenderer() {
			return new T_(this, { cacheSize: this.getCacheSize() });
		}
	}
	const I_ = { image: ['Polygon', 'Circle', 'LineString', 'Image', 'Text'], hybrid: ['Polygon', 'LineString'], vector: [] },
		k_ = { hybrid: ['Image', 'Text', 'Default'], vector: ['Polygon', 'Circle', 'LineString', 'Image', 'Text', 'Default'] };
	class L_ extends T_ {
		constructor(t, e) {
		...
		drawTile(t, e, i, n, r, s, o, a) {
			this.updateExecutorGroup_(t, e.pixelRatio, e.viewState.projection), this.tileImageNeedsRender_(t) && this.renderTileImage_(t, e), super.drawTile(t, e, i, n, r, s, o, a);
		}
		getTile(t, e, i, n) {
			const r = this.getOrCreateTile(t, e, i, n);
			if (!r) return null;
			const s = n.viewState.resolution,
				o = n.viewHints;
			return (!!(o[mr] || o[_r]) && r.wantedResolution) || (r.wantedResolution = s), r;
		}
		prepareFrame(t) {
		...
		updateExecutorGroup_(t, e, i) {
			...
			for (let i = 0, r = d.length; i < r; ++i) {
				const r = d[i];
				if (r.getState() != hr) continue;
				const f = r.tileCoord,
					p = c.getTileCoordExtent(f),
					m = ds(u, p),
					_ = jr(m, n.getRenderBuffer() * o, this.tempExtent),
					y = Jr(p, m) ? null : _,
					x = new Uf(0, m, o, e),
					v = Qg(o, e),
					w = function (t, e) {
						...
						if ((r && (i = r(t, o)), i)) {
							const n = this.renderFeature(t, v, i, x, h, e);
							a.dirty = a.dirty || n;
						}
					},
					b = r.getFeatures();
				...
				for (let t = 0, e = b.length; t < e; ++t) {
					const e = b[t];
					(y && !ms(y, e.getGeometry().getExtent())) || w.call(this, e, t);
				}
				const S = x.finish(),
					C = 'vector' !== n.getRenderMode() && h && 1 === d.length ? null : m,
					E = new op(C, o, e, l.getOverlaps(), S, n.getRenderBuffer(), !0);
		...
		forEachFeatureAtCoordinate(t, e, i, n, r) {
			...
			let m;
			t: for (let e = 0, n = d.length; e < n; ++e) {
				const n = d[e];
				if (!ms(l.getTileCoordExtent(n.wrappedTileCoord), h)) continue;
				const r = n.executorGroups[g];
				for (let e = 0, n = r.length; e < n; ++e) if (((m = r[e].forEachFeatureAtCoordinate(t, s, o, i, u, p)), m)) break t;
			}
			return m;
		}
		getFeatures(t) {
			return 0 === this.renderedTiles.length
				...
				: new Promise((e, i) => {
						const n = this.getLayer(),
							...
							h = ga(this.renderedPixelToCoordinateTransform_, t.slice()),
							c = l.getTileCoordForCoordAndResolution(h, a).toString(),
							u = this.renderedTiles.find((t) => t.tileCoord.toString() === c && t.getState() === hr);
						if (!u || u.loadingSourceTiles > 0) return void e([]);
						r.getWrapX() && s.canWrapX() && !Vr(o, l.getTileCoordExtent(u.tileCoord)) && Fs(h, s);
						const d = In(n),
							g = gs(l.getTileCoordExtent(u.wrappedTileCoord)),
							f = [(h[0] - g[0]) / a, (g[1] - h[1]) / a],
							p = u.getSourceTiles().reduce((t, e) => t.concat(e.getFeatures()), []);
						let m = u.hitDetectionImageData[d];
						if (!m) {
							const t = Nc(l.getTileSize(l.getZForResolution(a, r.zDirection))),
								e = this.renderedRotation_;
							(m = hp(t, [this.getRenderTransform(l.getTileCoordCenter(u.wrappedTileCoord), a, 0, lp, t[0] * lp, t[1] * lp, 0)], p, n.getStyleFunction(), l.getTileCoordExtent(u.wrappedTileCoord), u.getReplayState(n).renderedResolution, e)), (u.hitDetectionImageData[d] = m);
						}
						e(cp(f, p, m));
				  });
		}
		getFeaturesInExtent(t) {
			...
			const n = this.getLayer().getSource().getTileGridForProjection(this.frameState.viewState.projection),
				r = n.getZForResolution(this.renderedResolution),
				s = {};
			return (
				i.forEach((i) => {
					if (i.tileCoord[0] !== r || i.getState() !== hr) return;
					const o = i.getSourceTiles();
					for (let i = 0, r = o.length; i < r; ++i) {
						...
						s[a] = !0;
						const l = r.tileCoord;
						if (ms(t, n.getTileCoordExtent(l))) {
							const i = r.getFeatures();
							if (i)
								for (let n = 0, r = i.length; n < r; ++n) {
									const r = i[n],
										s = r.getGeometry();
									ms(t, s.getExtent()) && e.push(r);
								}
						}
					}
				}),
		...
		renderDeclutter(t, e) {
			...
			for (let e = 0, i = c.length; e < i; ++e) {
				const i = c[e],
					n = i.executorGroups[h];
				if (n) for (let e = n.length - 1; e >= 0; --e) n[e].execute(this.context, o, this.getTileRenderTransform(i, t), t.viewState.rotation, s, rp, l);
			}
			i.globalAlpha = n;
		}
		renderDeferredInternal(t) {
			const e = this.renderedTiles,
				i = In(this.getLayer()),
				n = e.reduce((t, e, n) => (e.executorGroups[i].forEach((e) => t.push({ executorGroup: e, index: n })), t), []),
				r = n.map(({ executorGroup: t }) => t.getDeferredZIndexContexts()),
				s = {};
			for (let t = 0, e = n.length; t < e; ++t) {
				const e = n[t].executorGroup.getDeferredZIndexContexts();
			...
			Object.keys(s)
				...
				.forEach((t) => {
					r.forEach((e, i) => {
						e[t] &&
							(e[t].forEach((t) => {
								const { executorGroup: e, index: r } = n[i],
		...
		getTileRenderTransform(t, e) {
			...
			return ca(fa(this.inversePixelTransform.slice(), 1 / i, 1 / i), this.getRenderTransform(r, s, o, i, l, h, g));
		}
		postRender(t, e) {
			const i = e.viewHints,
				n = !(i[mr] || i[_r]);
			...
			const a = r.getDeclutter(),
				l = a ? k_[s].filter((t) => !rp.includes(t)) : k_[s],
				h = e.viewState,
				c = h.rotation,
				u = r.getSource(),
			...
			for (let i = g.length - 1; i >= 0; --i) {
				...
				let w,
					b = t;
				if (v) {
					(w = new Wf()), (b = w.getContext());
					for (let t = 0, e = f.length; t < e; ++t)
						if (d !== u && u < p[t]) {
							const e = f[t];
							ms([v[0], v[3], v[4], v[7]], [e[0], e[3], e[4], e[7]]) && (x || (b.save(), (x = !0)), b.beginPath(), b.moveTo(v[0], v[1]), b.lineTo(v[2], v[3]), b.lineTo(v[4], v[5]), b.lineTo(v[6], v[7]), b.moveTo(e[6], e[7]), b.lineTo(e[4], e[5]), b.lineTo(e[2], e[3]), b.lineTo(e[0], e[1]), b.clip());
						}
					f.push(v), p.push(u);
				}
				for (let i = 0, r = o.length; i < r; ++i) {
					o[i].execute(t, [t.canvas.width, t.canvas.height], h, c, n, l, e.declutter?.[a]);
				}
				x && (b === t ? b.restore() : (m[i] = w));
			}
		...
		renderFeature(t, e, i, n, r, s) {
			if (!i) return !1;
			let o = !1;
			if (Array.isArray(i)) for (let a = 0, l = i.length; a < l; ++a) o = ef(n, t, i[a], e, this.boundHandleStyleImageChange_, void 0, r, s) || o;
			else o = ef(n, t, i, e, this.boundHandleStyleImageChange_, void 0, r, s);
			return o;
		}
		...
		renderTileImage_(t, e) {
			...
			const _ = h / g;
			if (1 !== _) {
				const t = ha(this.tmpTransform_);
				fa(t, _, _), p.setTransform.apply(p, t);
			}
			const y = u.getTileCoordExtent(o, this.tempExtent),
				x = g / f,
				v = ha(this.tmpTransform_);
			fa(v, x, -x), pa(v, -y[0], -y[3]);
			for (let t = 0, e = s.length; t < e; ++t) {
				s[t].execute(p, [p.canvas.width * _, p.canvas.height * _], v, 0, !0, I_[i.getRenderMode()], null);
			}
	...
	class A_ extends Pg {
		constructor(t) {
			...
			const e = Object.assign({}, t);
			delete e.preload;
			const i = void 0 === t.cacheSize ? 0 : t.cacheSize;
			delete t.cacheSize, delete e.useInterimTilesOnError, super(e), this.on, this.once, this.un, (this.cacheSize_ = i);
			const n = t.renderMode || 'hybrid';
			dr('hybrid' == n || 'vector' == n, "`renderMode` must be `'hybrid'` or `'vector'`"), (this.renderMode_ = n), this.setPreload(t.preload ? t.preload : 0), this.setUseInterimTilesOnError(void 0 === t.useInterimTilesOnError || t.useInterimTilesOnError), this.getBackground, this.setBackground;
		}
		createRenderer() {
			return new L_(this, { cacheSize: this.cacheSize_ });
		}
		getFeatures(t) {
			return super.getFeatures(t);
		}
	...
	class O_ extends fd {
		constructor(t, e, i, n, r, s, o) {
			...
			const h = l ? ds(i, l) : i,
				c = p_(t, e, as(h), n),
				u = new __(t, e, h, a, 0.5 * c, n),
				d = u.calculateSourceExtent(),
				g = _s(d) ? null : s(d, c, r),
				f = g ? hd : gd,
				p = g ? g.getPixelRatio() : 1;
			super(i, n, p, f), (this.targetProj_ = e), (this.maxSourceExtent_ = a), (this.triangulation_ = u), (this.targetResolution_ = n), (this.targetExtent_ = i), (this.sourceImage_ = g), (this.sourcePixelRatio_ = p), (this.interpolate_ = o), (this.canvas_ = null), (this.sourceListenerKey_ = null);
		}
		disposeInternal() {
			this.state == cd && this.unlistenSource_(), super.disposeInternal();
		}
		getImage() {
			return this.canvas_;
		}
		...
		reproject_() {
			...
			if (t == ud) {
				const t = ps(this.targetExtent_) / this.targetResolution_,
					e = us(this.targetExtent_) / this.targetResolution_;
				this.canvas_ = m_(t, e, this.sourcePixelRatio_, D_(this.sourceImage_.getResolution()), this.maxSourceExtent_, this.targetResolution_, this.targetExtent_, this.triangulation_, [{ extent: this.sourceImage_.getExtent(), image: this.sourceImage_.getImage() }], 0, void 0, this.interpolate_, !0);
			}
			(this.state = t), this.changed();
		}
		load() {
			if (this.state == hd) {
				...
				t == ud || t == dd
					? this.reproject_()
					: ((this.sourceListenerKey_ = Sn(this.sourceImage_, qi, (t) => {
							const e = this.sourceImage_.getState();
							(e != ud && e != dd) || (this.unlistenSource_(), this.reproject_());
					  })),
					  this.sourceImage_.load());
			}
		}
		unlistenSource_() {
			En(this.sourceListenerKey_), (this.sourceListenerKey_ = null);
		}
	}
	const z_ = 'imageloadstart',
		N_ = 'imageloadend',
		G_ = 'imageloaderror';
	class j_ extends wn {
		constructor(t, e) {
	...
	class $_ extends hf {
		...
		getImage(t, e, i, n) {
			...
			if (!r || !n || Xo(r, n)) return r && (n = r), this.getImageInternal(t, e, i, n);
			if (this.reprojectedImage_) {
				if (this.reprojectedRevision_ == this.getRevision() && Xo(this.reprojectedImage_.getProjection(), n) && this.reprojectedImage_.getResolution() == e && Jr(this.reprojectedImage_.getExtent(), t)) return this.reprojectedImage_;
				this.reprojectedImage_.dispose(), (this.reprojectedImage_ = null);
			}
			return (this.reprojectedImage_ = new O_(r, n, t, e, i, (t, e, i) => this.getImageInternal(t, e, i, r), this.getInterpolate())), (this.reprojectedRevision_ = this.getRevision()), this.reprojectedImage_;
		}
		getImageInternal(t, e, i, n) {
			if (this.loader) {
				const r = U_(t, e, i, 1),
					s = this.findNearestResolution(e);
				if (this.image && (this.static_ || (this.wantedProjection_ === n && ((this.wantedExtent_ && Vr(this.wantedExtent_, r)) || Vr(this.image.getExtent(), r)) && ((this.wantedResolution_ && D_(this.wantedResolution_) === s) || D_(this.image.getResolution()) === s)))) return this.image;
				(this.wantedProjection_ = n), (this.wantedExtent_ = r), (this.wantedResolution_ = s), (this.image = new fd(r, s, i, this.loader)), this.image.addEventListener(qi, this.handleImageChange.bind(this));
			}
			return this.image;
		}
		handleImageChange(t) {
			...
			this.hasListener(i) && this.dispatchEvent(new j_(i, e));
		}
	}
	function B_(t, e) {
		t.getImage().src = e;
	...
	function U_(t, e, i, n) {
		const r = e / i,
			...
			o = Fr(ps(t) / r, 4),
			a = Fr(us(t) / r, 4);
		return hs(s, r, 0, [o + 2 * Fr(((n - 1) * o) / 2, 4), a + 2 * Fr(((n - 1) * a) / 2, 4)]);
	}
	const V_ = [0, 0, 0];
	class W_ {
		constructor(t) {
			...
			(this.zoomFactor_ = e), (this.maxZoom = this.resolutions_.length - 1), (this.origin_ = void 0 !== t.origin ? t.origin : null), (this.origins_ = null), void 0 !== t.origins && ((this.origins_ = t.origins), dr(this.origins_.length == this.resolutions_.length, 'Number of `origins` and `resolutions` must be equal'));
			const i = t.extent;
			void 0 === i || this.origin_ || this.origins_ || (this.origin_ = gs(i)),
				dr((!this.origin_ && this.origins_) || (this.origin_ && !this.origins_), 'Either `origin` or `origins` must be configured, never both'),
				(this.tileSizes_ = null),
				void 0 !== t.tileSizes && ((this.tileSizes_ = t.tileSizes), dr(this.tileSizes_.length == this.resolutions_.length, 'Number of `tileSizes` and `resolutions` must be equal')),
				(this.tileSize_ = void 0 !== t.tileSize ? t.tileSize : this.tileSizes_ ? null : vl),
				dr((!this.tileSize_ && this.tileSizes_) || (this.tileSize_ && !this.tileSizes_), 'Either `tileSize` or `tileSizes` must be configured, never both'),
				...
				void 0 !== t.sizes
					? (this.fullTileRanges_ = t.sizes.map((t, e) => {
							const n = new Ep(Math.min(0, t[0]), Math.max(t[0] - 1, -1), Math.min(0, t[1]), Math.max(t[1] - 1, -1));
							if (i) {
		...
		forEachTileCoordParentTileRange(t, e, i, n) {
			...
			for (2 === this.zoomFactor_ ? ((s = t[1]), (o = t[2])) : (a = this.getTileCoordExtent(t, n)); l >= this.minZoom; ) {
				if ((void 0 !== s && void 0 !== o ? ((s = Math.floor(s / 2)), (o = Math.floor(o / 2)), (r = Tp(s, s, o, o, i))) : (r = this.getTileRangeForExtentAndZ(a, l, i)), e(l, r))) return !0;
				--l;
			}
			return !1;
		}
		...
		getTileRangeForTileCoordAndZ(t, e, i) {
			...
			const n = t[0],
				r = t[1],
				s = t[2];
			if (e === n) return Tp(r, s, r, s, i);
			if (this.zoomFactor_) {
				const t = Math.pow(this.zoomFactor_, e - n),
					o = Math.floor(r * t),
					a = Math.floor(s * t);
				if (e < n) return Tp(o, o, a, a, i);
				return Tp(o, Math.floor(t * (r + 1)) - 1, a, Math.floor(t * (s + 1)) - 1, i);
			}
		...
		getTileRangeForExtentAndZ(t, e, i) {
			this.getTileCoordForXYAndZ_(t[0], t[3], e, !1, V_);
			const n = V_[1],
				r = V_[2];
			this.getTileCoordForXYAndZ_(t[2], t[1], e, !0, V_);
			return Tp(n, V_[1], r, V_[2], i);
		}
		getTileCoordCenter(t) {
			const e = this.getOrigin(t[0]),
				i = this.getResolution(t[0]),
				n = Nc(this.getTileSize(t[0]), this.tmpSize_);
			return [e[0] + (t[1] + 0.5) * n[0] * i, e[1] - (t[2] + 0.5) * n[1] * i];
		}
		getTileCoordExtent(t, e) {
			const i = this.getOrigin(t[0]),
				n = this.getResolution(t[0]),
				r = Nc(this.getTileSize(t[0]), this.tmpSize_),
				s = i[0] + t[1] * r[0] * n,
				o = i[1] - (t[2] + 1) * r[1] * n;
			return Zr(s, o, s + r[0] * n, o + r[1] * n, e);
		}
		...
		getTileCoordForXYAndResolution_(t, e, i, n, r) {
			const s = this.getZForResolution(i),
				...
				a = this.getOrigin(s),
				l = Nc(this.getTileSize(s), this.tmpSize_);
			let h = (o * (t - a[0])) / i / l[0],
				c = (o * (a[1] - e)) / i / l[1];
			return n ? ((h = Fr(h, 5) - 1), (c = Fr(c, 5) - 1)) : ((h = Rr(h, 5)), (c = Rr(c, 5))), v_(s, h, c, r);
		}
		getTileCoordForXYAndZ_(t, e, i, n, r) {
			const s = this.getOrigin(i),
				o = this.getResolution(i),
				a = Nc(this.getTileSize(i), this.tmpSize_);
			let l = (t - s[0]) / o / a[0],
				h = (s[1] - e) / o / a[1];
			return n ? ((l = Fr(l, 5) - 1), (h = Fr(h, 5) - 1)) : ((l = Rr(l, 5)), (h = Rr(h, 5))), v_(i, l, h, r);
		}
		...
		getZForResolution(t, e) {
			return xr(cn(this.resolutions_, t, e || 0), this.minZoom, this.maxZoom);
		}
		tileCoordIntersectsViewport(t, e) {
			return nl(e, 0, e.length, 2, this.getTileCoordExtent(t));
		}
	...
	function X_(t) {
		...
		return e || ((e = H_(t)), t.setDefaultTileGrid(e)), e;
	}
	function q_(t, e, i) {
		const n = e[0],
	...
	function Z_(t, e, i, n) {
		...
		const r = Y_(t, e, i);
		return new W_({ extent: t, origin: ls(t, n), resolutions: r, tileSize: i });
	}
	function K_(t) {
		const e = t || {},
			i = e.extent || Go('EPSG:3857').getExtent(),
			n = { extent: i, minZoom: e.minZoom, tileSize: e.tileSize, resolutions: Y_(i, e.maxZoom, e.tileSize, e.maxResolution) };
		return new W_(n);
	}
	function Y_(t, e, i, n) {
		(e = void 0 !== e ? e : 42), (i = Nc(void 0 !== i ? i : vl));
		const r = us(t),
			s = ps(t);
	...
	function H_(t, e, i, n) {
		return Z_(J_(t), e, i, n);
	}
	function J_(t) {
		let e = (t = Go(t)).getExtent();
		if (!e) {
			const i = (180 * $s.degrees) / t.getMetersPerUnit();
			e = Zr(-i, -i, i, i);
		}
		return e;
	}
	var Q_ = Object.freeze({
		...
		createForExtent: Z_,
		createForProjection: H_,
		createXYZ: K_,
		extentFromProjection: J_,
		getForProjection: X_,
		wrapX: q_,
	});
	class ty extends hf {
		constructor(t) {
			...
			const e = [256, 256];
			this.tileGrid && Nc(this.tileGrid.getTileSize(this.tileGrid.getMinZoom()), e), (this.tmpSize = [0, 0]), (this.key_ = t.key || In(this)), (this.tileOptions = { transition: t.transition, interpolate: t.interpolate }), (this.zDirection = t.zDirection ? t.zDirection : 0);
		}
		...
		getTileGridForProjection(t) {
			return this.tileGrid ? this.tileGrid : X_(t);
		}
		getTilePixelRatio(t) {
		...
		getTilePixelSize(t, e, i) {
			const n = this.getTileGridForProjection(i),
				...
				s = Nc(n.getTileSize(t), this.tmpSize);
			return 1 == r ? s : ((o = s), (a = r), void 0 === (l = this.tmpSize) && (l = [0, 0]), (l[0] = (o[0] * a + 0.5) | 0), (l[1] = (o[1] * a + 0.5) | 0), l);
			var o, a, l;
		}
		getTileCoordForTileUrlFunction(t, e) {
			const i = void 0 !== e ? e : this.getProjection(),
				n = void 0 !== e ? this.getTileGridForProjection(i) : this.tileGrid || this.getTileGridForProjection(i);
			return (
				this.getWrapX() && i.isGlobal() && (t = q_(n, t, i)),
				(function (t, e) {
					const i = t[0],
						n = t[1],
						r = t[2];
	...
	function iy(t) {
		return function (e) {
			...
			if (r) {
				const e = new Array(a);
				for (let t = 0; t < a; ++t) e[t] = new ImageData(new Uint8ClampedArray(i[t]), s, o);
				return t(e, n).data.buffer;
			}
			const h = new Uint8ClampedArray(l),
				c = new Array(a),
				u = new Array(a);
			for (let t = 0; t < a; ++t) (c[t] = new Uint8ClampedArray(i[t])), (u[t] = [0, 0, 0, 0]);
			for (let e = 0; e < l; e += 4) {
				for (let t = 0; t < a; ++t) {
					const i = c[t];
					(u[t][0] = i[e]), (u[t][1] = i[e + 1]), (u[t][2] = i[e + 2]), (u[t][3] = i[e + 3]);
				}
				const i = t(u, n);
				(h[e] = i[0]), (h[e + 1] = i[1]), (h[e + 2] = i[2]), (h[e + 3] = i[3]);
			}
			return h.buffer;
		};
	}
	function ny(t, e) {
		const i = Object.keys(t.lib || {})
				...
				.concat(['const __minion__ = (' + iy.toString() + ')(', t.operation.toString(), ');', 'self.addEventListener("message", function(event) {', '  const buffer = __minion__(event.data);', '  self.postMessage({buffer: buffer, meta: event.data.meta}, [buffer]);', '});']),
	...
	class ry extends an {
		constructor(t) {
			...
			const i = new Array(e);
			if (e) for (let n = 0; n < e; ++n) i[n] = ny(t, this.onWorkerMessage_.bind(this, n));
			else
				i[0] = (function (t, e) {
					const i = iy(t.operation);
					let n = !1;
					return {
			...
			(this.workers_ = i), (this.queue_ = []), (this.maxQueueLength_ = t.queue || 1 / 0), (this.running_ = 0), (this.dataLookup_ = {}), (this.job_ = null);
		}
		process(t, e, i) {
			this.enqueue_({ inputs: t, meta: e, callback: i }), this.dispatch_();
		}
		enqueue_(t) {
		...
		dispatch_() {
			...
			if (((this.running_ = r), 1 === r)) return void this.workers_[0].postMessage({ buffers: n, meta: t.meta, imageOps: this.imageOps_, width: e, height: i }, n);
			...
			for (let s = 0; s < r; ++s) {
				...
				this.workers_[s].postMessage({ buffers: a, meta: t.meta, imageOps: this.imageOps_, width: e, height: i }, a);
			}
		}
		...
		resolveJob_() {
			...
			let i, n;
			if (1 === e) (i = new Uint8ClampedArray(this.dataLookup_[0].buffer)), (n = this.dataLookup_[0].meta);
			else {
				...
				for (let t = 0; t < e; ++t) {
					const e = this.dataLookup_[t].buffer,
						r = t * s;
					i.set(new Uint8ClampedArray(e), r), (n[t] = this.dataLookup_[t].meta);
				}
			}
			(this.job_ = null), (this.dataLookup_ = {}), t.callback(null, new ImageData(i, t.inputs[0].width, t.inputs[0].height), n), this.dispatch_();
		}
		disposeInternal() {
	...
	class ly extends $_ {
		constructor(t) {
			super({ projection: null }),
				...
				(this.layers_ = (function (t) {
					const e = t.length,
						i = new Array(e);
					for (let n = 0; n < e; ++n) i[n] = uy(t[n]);
					return i;
				})(t.sources));
			const e = this.changed.bind(this);
			for (let t = 0, i = this.layers_.length; t < i; ++t) this.layers_[t].addEventListener(qi, e);
			var i;
			(this.useResolutions_ = null !== t.resolutions),
				(this.tileQueue_ = new pr(function () {
					return 1;
				...
				this.setAttributions(function (e) {
					...
					for (let n = 0, r = t.sources.length; n < r; ++n) {
						const r = t.sources[n],
							s = r instanceof hf ? r : r.getSource();
						if (!s) continue;
						const o = s.getAttributions()?.(e);
						'string' == typeof o ? i.push(o) : void 0 !== o && i.push(...o);
					}
					return i;
				}),
		...
		setOperation(t, e) {
			this.processor_ && this.processor_.dispose(), (this.processor_ = new ry({ operation: t, imageOps: 'image' === this.operationType_, queue: 1, lib: e, threads: this.threads_ })), this.changed();
		}
		updateFrameState_(t, e, i) {
			const n = Object.assign({}, this.frameState_);
			n.viewState = Object.assign({}, n.viewState);
			const r = as(t);
			(n.size[0] = Math.ceil(ps(t) / e)), (n.size[1] = Math.ceil(us(t) / e)), (n.extent = [r[0] - (n.size[0] * e) / 2, r[1] - (n.size[1] * e) / 2, r[0] + (n.size[0] * e) / 2, r[1] + (n.size[1] * e) / 2]), (n.time = Date.now());
			const s = n.viewState;
		...
		getImage(t, e, i, n) {
			...
			if (((this.requestedFrameState_ = r), this.renderedImageCanvas_)) {
				...
				(e === t && Jr(r.extent, i)) || (this.renderedImageCanvas_ = null);
			}
		...
		processSources_() {
			...
			for (let n = 0; n < e; ++n) {
				...
				const e = cy(this.layers_[n], t);
				if (!e) return;
				i[n] = e;
			}
			const n = {};
			this.dispatchEvent(new ay(sy, t, n)), this.processor_.process(i, n, this.onWorkerComplete_.bind(this, t));
		}
		onWorkerComplete_(t, e, i, n) {
			if (e || !i) return;
			const r = t.extent,
				s = t.viewState.resolution;
			if (s !== this.requestedFrameState_.viewState.resolution || !Jr(r, this.requestedFrameState_.extent)) return;
			let o;
			if (this.renderedImageCanvas_) o = this.renderedImageCanvas_.getImage().getContext('2d');
			else {
				(o = Ll(Math.round(ps(r) / s), Math.round(us(r) / s))), (this.renderedImageCanvas_ = new _p(r, s, 1, o.canvas));
			}
			o.putImageData(i, 0, 0), t.animate ? requestAnimationFrame(this.changed.bind(this)) : this.changed(), (this.renderedRevision_ = this.getRevision()), this.dispatchEvent(new ay(oy, t, n));
		}
		getResolutions(t) {
	...
	function cy(t, e) {
		...
		if (hy) {
			const t = hy.canvas;
			t.width !== n || t.height !== r ? (hy = Ll(n, r, void 0, { willReadFrequently: !0 })) : hy.clearRect(0, 0, n, r);
		} else hy = Ll(n, r, void 0, { willReadFrequently: !0 });
		return hy.drawImage(o, 0, 0, n, r), hy.getImageData(0, 0, n, r);
	}
	function uy(t) {
		let e;
		return t instanceof hf ? (t instanceof ty ? (e = new M_({ source: t })) : t instanceof $_ && (e = new o_({ source: t }))) : (e = t), e;
	}
	function dy(t, e) {
		const i = [];
	...
	function _y(t, e) {
		return function (i, n, r) {
			...
			return (function (t, e, i, n, r) {
				return t
					.replace(gy, e.toString())
					.replace(fy, i.toString())
					.replace(py, n.toString())
					.replace(my, function () {
	...
	function yy(t, e) {
		const i = t.length,
			n = new Array(i);
		for (let r = 0; r < i; ++r) n[r] = _y(t[r], e);
		return xy(n);
	}
	function xy(t) {
		return 1 === t.length
	...
	class Sy extends ty {
		...
		handleTileChange(t) {
			const e = t.target,
				...
				n = e.getState();
			let r;
			n == lr ? ((this.tileLoadingKeys_[i] = !0), (r = vy)) : i in this.tileLoadingKeys_ && (delete this.tileLoadingKeys_[i], (r = n == cr ? by : n == hr ? wy : void 0)), null != r && this.dispatchEvent(new ey(r, e));
		}
		...
		setUrls(t) {
			this.urls = t;
			const e = t.join('\n');
			this.generateTileUrlFunction_ ? this.setTileUrlFunction(yy(t, this.tileGrid), e) : this.setKey(e);
		}
	...
	class Cy extends Sy {
		constructor(t) {
			super({ attributions: t.attributions, cacheSize: t.cacheSize, projection: t.projection, state: t.state, tileGrid: t.tileGrid, tileLoadFunction: t.tileLoadFunction ? t.tileLoadFunction : Ey, tilePixelRatio: t.tilePixelRatio, tileUrlFunction: t.tileUrlFunction, url: t.url, urls: t.urls, wrapX: t.wrapX, transition: t.transition, interpolate: void 0 === t.interpolate || t.interpolate, key: t.key, attributionsCollapsible: t.attributionsCollapsible, zDirection: t.zDirection }),
				...
				(this.tileClass = void 0 !== t.tileClass ? t.tileClass : xp),
				(this.tileGridForProjection = {}),
				(this.reprojectionErrorThreshold_ = t.reprojectionErrorThreshold),
				(this.renderReprojectionEdges_ = !1);
		}
		getGutterForProjection(t) {
			return this.getProjection() && t && !Xo(this.getProjection(), t) ? 0 : this.getGutter();
		}
		getGutter() {
			return 0;
		}
		...
		getTileGridForProjection(t) {
			...
			if (this.tileGrid && (!e || Xo(e, t))) return this.tileGrid;
			const i = In(t);
			return i in this.tileGridForProjection || (this.tileGridForProjection[i] = X_(t)), this.tileGridForProjection[i];
		}
		createTile_(t, e, i, n, r, s) {
			const o = [t, e, i],
				a = this.getTileCoordForTileUrlFunction(o, r),
				l = a ? this.tileUrlFunction(a, n, r) : void 0,
				h = new this.tileClass(o, void 0 !== l ? ar : ur, void 0 !== l ? l : '', this.crossOrigin, this.tileLoadFunction, this.tileOptions);
			return (h.key = s), h.addEventListener(qi, this.handleTileChange.bind(this)), h;
		}
		getTile(t, e, i, n, r) {
			const s = this.getProjection();
			if (!s || !r || Xo(s, r)) return this.getTileInternal(t, e, i, n, s || r);
			const o = [t, e, i],
				a = this.getKey(),
				l = this.getTileGridForProjection(s),
				h = this.getTileGridForProjection(r),
				c = this.getTileCoordForTileUrlFunction(o, r),
				u = new y_(s, l, r, h, o, c, this.getTilePixelRatio(n), this.getGutter(), (t, e, i, n) => this.getTileInternal(t, e, i, n, s), this.reprojectionErrorThreshold_, this.renderReprojectionEdges_, this.tileOptions);
			return (u.key = a), u;
		}
	...
	class Ty extends Cy {
		...
		handleTileJSONResponse(t) {
			...
			if (((this.tileGrid = o), (this.tileUrlFunction = yy(t.tiles, o)), t.attribution && !this.getAttributions())) {
				const e = void 0 !== n ? n : r;
				this.setAttributions(function (i) {
					return ms(e, i.extent) ? [t.attribution] : null;
				});
			}
	...
	class Py extends Sy {
		constructor(t) {
			const e = t.projection || 'EPSG:3857',
				i = t.extent || J_(e),
				n = t.tileGrid || K_({ extent: i, maxResolution: t.maxResolution, maxZoom: void 0 !== t.maxZoom ? t.maxZoom : 22, minZoom: t.minZoom, tileSize: t.tileSize || 512 });
			super({ attributions: t.attributions, attributionsCollapsible: t.attributionsCollapsible, cacheSize: t.cacheSize, interpolate: !0, projection: e, state: t.state, tileGrid: n, tileLoadFunction: t.tileLoadFunction ? t.tileLoadFunction : Ry, tileUrlFunction: t.tileUrlFunction, url: t.url, urls: t.urls, wrapX: void 0 === t.wrapX || t.wrapX, transition: t.transition, zDirection: void 0 === t.zDirection ? 1 : t.zDirection }), (this.format_ = t.format ? t.format : null), (this.tileKeysBySourceTileUrl_ = {}), (this.sourceTiles_ = {}), (this.overlaps_ = null == t.overlaps || t.overlaps), (this.tileClass = t.tileClass ? t.tileClass : Fp), (this.tileGrids_ = {});
		}
		getOverlaps() {
			return this.overlaps_;
		}
		getSourceTiles(t, e, i) {
			if (i.getState() === ar) {
				...
				l.forEachTileCoord(s, c, (n) => {
					...
					this.sourceTiles_[r] || (this.sourceTiles_[r] = new this.tileClass(n, r ? ar : ur, r, this.format_, this.tileLoadFunction));
					const s = this.sourceTiles_[r];
					i.sourceTiles.push(s), this.tileKeysBySourceTileUrl_[r] || (this.tileKeysBySourceTileUrl_[r] = []), this.tileKeysBySourceTileUrl_[r].push(i.getKey());
					const o = s.getState();
					if (o < hr) {
						const t = (e) => {
							...
							if (n === hr || n === cr) {
								const e = s.getKey();
								e in i.errorTileKeys ? s.getState() === hr && delete i.errorTileKeys[e] : i.loadingSourceTiles--, n === cr ? (i.errorTileKeys[e] = !0) : s.removeEventListener(qi, t), 0 === i.loadingSourceTiles && i.setState(vn(i.errorTileKeys) ? hr : cr);
							}
						};
						s.addEventListener(qi, t), i.loadingSourceTiles++;
					}
					o === ar && ((s.extent = l.getTileCoordExtent(n)), (s.projection = e), (s.resolution = l.getResolution(n[0])), s.load());
				}),
					i.loadingSourceTiles || i.setState(i.sourceTiles.some((t) => t.getState() === cr) ? cr : hr);
			}
		...
		removeSourceTiles(t) {
			...
			for (let t = 0, n = i.length; t < n; ++t) {
				const n = i[t].getTileUrl();
				if (!this.tileKeysBySourceTileUrl_[n]) return;
				const r = this.tileKeysBySourceTileUrl_[n].indexOf(e);
				-1 !== r && (this.tileKeysBySourceTileUrl_[n].splice(r, 1), 0 === this.tileKeysBySourceTileUrl_[n].length && (delete this.tileKeysBySourceTileUrl_[n], delete this.sourceTiles_[n]));
			}
		}
		getTile(t, e, i, n, r) {
			const s = [t, e, i];
			...
			if (o && a) {
				...
				jr(e, -l.getResolution(t), e), ms(a, e) || (o = null);
			}
			let h = !0;
			if (null !== o) {
				...
				jr(a, -i, a),
					e.forEachTileCoord(a, s, (t) => {
						h = h && !this.tileUrlFunction(t, n, r);
					});
			}
			const c = new Rp(s, h ? ur : ar, o, this.getSourceTiles.bind(this, n, r), this.removeSourceTiles.bind(this));
		...
		getTileGridForProjection(t) {
			...
			if (!i) {
				...
				dr(null === n || Xo(n, t), 'A VectorTile source can only be rendered if it has a projection compatible with the view projection.');
				const r = this.tileGrid,
					s = r.getResolutions().slice(),
					o = s.map(function (t, e) {
						return r.getOrigin(e);
					}),
					a = s.map(function (t, e) {
						return r.getTileSize(e);
					}),
					l = 43;
				for (let t = s.length; t < l; ++t) s.push(s[t - 1] / 2), o.push(o[t - 1]), a.push(a[t - 1]);
				(i = new W_({ extent: r.getExtent(), origins: o, resolutions: s, tileSizes: a })), (this.tileGrids_[e] = i);
			}
			return i;
		}
		getTilePixelRatio(t) {
		...
		getTilePixelSize(t, e, i) {
			const n = Nc(this.getTileGridForProjection(i).getTileSize(t), this.tmpSize);
	...
	function Ry(t, e) {
		t.setLoader(function (i, n, r) {
			rf(e, t.getFormat(), i, n, r, t.onLoad.bind(t), t.onError.bind(t));
		});
	}
	function Fy(t, e) {
		const i = t[0],
			...
			x = e.accentColor,
			v = e.encoding;
		let w, b, S, C, E, T, P, R, F, M, I, k, L, A, D, O, z, N, G, j, $, B;
		function U(t, e = 'mapbox') {
		...
		for (b = 0; b <= h; ++b)
			for (E = 0 === b ? 0 : b - 1, T = b === h ? h : b + 1, w = 0; w <= l; ++w)
				(S = 0 === w ? 0 : w - 1),
					...
					(B = m * Math.cos(k) + p * Math.sin(k) * Math.cos(f - L)),
					(A = Math.cos(k)),
					(D = 255 * B),
					(G = Math.min(Math.max(2 * e.sunEl, 0), 1)),
					(j = 1.875 - 1.75 * e.opacity),
					($ = 0.5 !== e.opacity ? d * ((Math.pow(j, k) - 1) / (Math.pow(j, d) - 1)) : k),
					(z = { r: (1 - A) * x.r * G * 255, g: (1 - A) * x.g * G * 255, b: (1 - A) * x.b * G * 255, a: (1 - A) * x.a * G * 255 }),
					(O = Math.abs((((L + f) / Math.PI + 0.5) % 2) - 1)),
					(N = { r: (_.r * (1 - O) + y.r * O) * D, g: (_.g * (1 - O) + y.g * O) * D, b: (_.b * (1 - O) + y.b * O) * D, a: (_.a * (1 - O) + y.a * O) * D }),
					(P = 4 * (b * n + w)),
					(o[P] = z.r * (1 - O) + N.r),
					(o[P + 1] = z.g * (1 - O) + N.g),
					(o[P + 2] = z.b * (1 - O) + N.b),
					(o[P + 3] = s[P + 3] * e.opacity * G * Math.sin($));
		return new ImageData(o, n, r);
	}
	function My(t, e = 512) {
		return t.getExtent() ? K_({ extent: t.getExtent(), tileSize: e, maxZoom: 22 }).getResolutions() : Wp;
	}
	function Iy(t, e) {
		if (!e.accessToken) {
			e = Object.assign({}, e);
			new URL(t).searchParams.forEach((t, i) => {
				(e.accessToken = t), (e.accessTokenParam = i);
			});
		}
		return e;
	}
	function ky(t, e, i = '', n = {}, r = void 0) {
		let s,
			o,
			a,
			l,
			h = !0;
		return (
			'string' == typeof i || Array.isArray(i) ? (l = i) : ((a = i), (l = a.source || a.layers), (n = a)),
			'string' == typeof n ? ((s = n), (a = {})) : ((s = n.styleUrl), (a = n)),
			!1 === a.updateSource && (h = !1),
			r || (r = a.resolutions),
			s || 'string' != typeof e || e.trim().startsWith('{') || (s = e),
			s && ((s = s.startsWith('data:') ? location.href : Lp(s, a.accessToken)), (a = Iy(s, a))),
			new Promise(function (i, n) {
				Hp(e, a)
					.then(function (e) {
						if (8 != e.version) return n(new Error('glStyle version 8 required.'));
						if (!(t instanceof mp || t instanceof A_)) return n(new Error('Can only apply to VectorLayer or VectorTileLayer'));
						const c = t instanceof A_ ? 'vector' : 'geojson';
						if (
							(l
								? (o = Array.isArray(l)
										...
										: l)
								: ((o = e.layers.find(function (t) {
										return t.source && e.sources[t.source].type === c;
								  }).source),
								  (l = o)),
							!o)
						)
							return n(new Error(`No ${c} source found in the glStyle.`));
						function u() {
							if (!h) return Promise.resolve();
							if (t instanceof A_)
								return Ny(e.sources[o], s, a).then(function (e) {
									const i = t.getSource();
									i ? e !== i && (i.setTileUrlFunction(e.getTileUrlFunction()), 'function' == typeof i.setUrls && 'function' == typeof e.getUrls && i.setUrls(e.getUrls()), i.format_ || (i.format_ = e.format_), i.getAttributions() || i.setAttributions(e.getAttributions()), i.getTileLoadFunction() === Ry && i.setTileLoadFunction(e.getTileLoadFunction()), Xo(i.getProjection(), e.getProjection()) && (i.tileGrid = e.getTileGrid())) : t.setSource(e);
									const n = t.getSource().getTileGrid();
									!isFinite(t.getMaxResolution()) && !isFinite(t.getMinZoom()) && n.getMinZoom() > 0 && t.setMaxResolution(Zp(Math.max(0, n.getMinZoom() - 1e-12), n.getResolutions()));
								});
							const i = e.sources[o];
							let n = t.getSource();
							(n && n.get('mapbox-source') === i) || (n = By(i, s, a));
							const r = t.getSource();
						...
						const f = {},
							p = {};
						function m() {
							if (g || (e.sprite && !f)) g ? (t.setStyle(g), u().then(i).catch(n)) : n(new Error('Something went wrong trying to apply style.'));
							else {
								if (a.projection && !r) {
									const t = Go(a.projection).getUnits();
									'm' !== t && (r = Wp.map((e) => e / $s[t]));
								}
								(g = Pm(
									t,
									e,
									...
									(t, e = a.webfonts) =>
										(function (t, e = 'https://cdn.jsdelivr.net/npm/@fontsource/{font-family}/{fontweight}{-fontstyle}.css') {
											...
											for (let e = 0, n = t.length; e < n; ++e) {
												...
												if (n in um) continue;
												um[n] = !0;
												const r = Ui(n, 16).split(' ');
												i || (i = []), i.push([r.slice(3).join(' ').replace(/"/g, ''), r[1], r[0]]);
											}
											return i
												? ((async () => {
														...
														for (let t = 0, n = i.length; t < n; ++t) {
															const n = i[t],
																r = n[0];
															if (cm.includes(r)) continue;
															const s = n[1],
																o = n[2];
															if (!(await document.fonts.load(`${o} ${s} 16px "${r}"`)).some((t) => t.family.replace(/^['"]|['"]$/g, '').toLowerCase() === r.toLowerCase() && t.weight == s && t.style === o)) {
																const t = e.replace('{font-family}', r.replace(/ /g, '-').toLowerCase()).replace('{Font+Family}', r.replace(/ /g, '+')).replace('{fontweight}', s).replace('{-fontstyle}', o.replace('normal', '').replace(/(.+)/, '-$1')).replace('{fontstyle}', o);
									...
									t.getStyle() ? u().then(i).catch(n) : n(new Error(`Nothing to show for source [${o}]`));
							}
						}
						if (e.sprite) {
							const t = (function (t, e, i) {
								if ('string' == typeof t) return [{ id: 'default', url: kp(t, e, i) }];
								for (const n of t) n.url = kp(n.url, e, i);
								return t;
							...
							Promise.all(
								t.map(function (t) {
									...
									let r = e.origin + e.pathname + i + '.json' + e.search;
									return new Promise(function (t, i) {
										Yp('Sprite', r, a)
											.then(t)
											.catch(function (n) {
												(r = e.origin + e.pathname + '.json' + e.search), Yp('Sprite', r, a).then(t).catch(i);
											});
									})
										.then(function (r) {
											let s;
											if ((void 0 === r && n(new Error('No sprites found.')), (s = e.origin + e.pathname + i + '.png' + e.search), a.transformRequest)) {
												const t = a.transformRequest(s, 'SpriteImage') || s;
												(t instanceof Request || t instanceof Promise) && (s = t);
											}
											p[t.id] = s;
											for (const e in r) {
												const i = 'default' == t.id ? e : `${t.id}:${e}`;
												f[i] = r[e];
											}
										})
										.catch(function (t) {
			...
			!(function (t, e, i) {
				e.layers.some(function (e) {
					if ('background' === e.type) {
						...
						if (t instanceof Ag || t instanceof Vh) return t.getLayers().insertAt(0, zy(e, i, {})), !0;
					}
				});
			})(t, e, i);
		});
	...
	function Dy(t, e, i) {
		const n = new Ty({ tileJSON: e, tileSize: t.tileSize || e.tileSize || 512 }),
			r = n.getTileJSON(),
			s = n.getTileGrid(),
			o = Go(i.projection || 'EPSG:3857'),
			a = (function (t, e) {
				const i = t.bounds;
				if (i) {
					const t = Wo([i[0], i[1]], e),
						n = Wo([i[2], i[3]], e);
					return [t[0], t[1], n[0], n[1]];
				}
				return Go(e).getExtent();
			})(r, o),
			l = o.getExtent(),
			h = r.minzoom || 0,
			c = r.maxzoom || 22,
			u = { attributions: n.getAttributions(), projection: o, tileGrid: new W_({ origin: l ? gs(l) : s.getOrigin(0), extent: a || s.getExtent(), minZoom: h, resolutions: My(o, e.tileSize).slice(0, c + 1), tileSize: s.getTileSize(0) }) };
	...
	function Oy(t, e, i, n) {
		const r = { id: t.id, type: t.type },
			...
			o = t.paint || {};
		let a;
		(r.paint = o), (fm.zoom = qp(e, i.resolutions || Wp)), (fm.distanceFromCenter = 0);
		const l = _m(r, 'paint', 'background-color', Op, n);
		return void 0 !== o['background-opacity'] && (a = _m(r, 'paint', 'background-opacity', Op, n)), 'none' == s.visibility ? void 0 : wm(l, a);
	}
	function zy(t, e, i) {
		const n = document.createElement('div');
		return (
			(n.className = 'ol-mapbox-style-background'),
			...
			new Hh({
				source: new hf({}),
				render(r) {
					const s = Oy(t, r.viewState.resolution, e, i);
		...
		return new Promise(function (n, r) {
			Qp(t, e, i)
				.then(function ({ tileJson: e, tileLoadFunction: r }) {
					const s = Dy(t, e, i);
					(s.tileLoadFunction = r), (s.format = new Qm({ layerName: 'mvt:layer' }));
					const o = new Py(s);
					o.set('mapbox-source', t), n(o);
				})
				.catch(r);
		});
	}
	...
	function jy(t, e, i) {
		return new Promise(function (n, r) {
			Qp(t, e, i)
				.then(function ({ tileJson: e, tileLoadFunction: r }) {
					const s = new Ty({ interpolate: void 0 === i.interpolate || i.interpolate, transition: 0, crossOrigin: 'anonymous', tileJSON: e });
					(s.tileGrid = Dy(t, e, i).tileGrid), i.projection && (s.projection = Go(i.projection));
					const o = s.getTileUrlFunction();
					r && s.setTileLoadFunction(r),
						s.setTileUrlFunction(function (t, e, i) {
							const n = Gy(i);
							let r = o(t, e, i);
							if (-1 != r.indexOf(n)) {
								const e = s.getTileGrid().getTileCoordExtent(t);
								r = r.replace(n, e.toString());
							}
							return r;
						}),
	...
	function By(t, e, i) {
		const n = i.projection ? new Dm({ dataProjection: i.projection }) : new Dm(),
			r = t.data,
			s = {};
		if ('string' == typeof r) {
			const [s] = Dp(r, i.accessToken, i.accessTokenParam || 'access_token', e || location.href);
			if (/\{bbox-[0-9a-z-]+\}/.test(s)) {
				const e = (t, e, i) => {
					...
					r = new xf({
						...
						format: n,
						loader: (t, n, s, o, a) => {
							Yp('GeoJSON', 'function' == typeof e ? e(t, n, s) : e, i)
								.then((t) => {
			...
			const o = new xf({
				...
				loader: (t, e, n, r, a) => {
					Yp('GeoJSON', s, i)
						.then((t) => {
							const e = o.getFormat().readFeatures(t, { featureProjection: n });
							o.addFeatures(e), r(e);
						})
						.catch((e) => {
		...
		s.features = n.readFeatures(r, { featureProjection: ta() || 'EPSG:3857' });
		const o = new xf(Object.assign({ attributions: t.attribution, format: n }, s));
	...
	function Uy(t, e, i) {
		...
		return function (r) {
			t.paint &&
				...
				r.frameState.viewState.zoom !== n &&
				((n = r.frameState.viewState.zoom),
				delete i[t.id],
				(function (t, e, i, n) {
					(fm.zoom = i), (fm.distanceFromCenter = 0);
					const r = _m(t, 'paint', 'raster-opacity', Op, n);
					e.setOpacity(r);
				})(t, e, n, i));
		};
	}
	function Vy(t, e, i, n) {
		const r = Bp(t),
			s = t.layers,
			o = i.type,
			a = i.source || Ay(s, i.ref),
			l = t.sources[a];
		let h;
		if ('background' == o) h = zy(i, n, r);
		else if ('vector' == l.type)
			h = (function (t, e, i) {
				const n = new A_({ declutter: !0, visible: !1 });
				return (
					Ny(t, e, i)
						.then(function (t) {
							n.setSource(t);
		...
		else if ('raster' == l.type) (h = $y(l, e, n)), h.setVisible(!i.layout || 'none' !== i.layout.visibility), h.on('prerender', Uy(i, h, r));
		else if ('geojson' == l.type)
			h = (function (t, e, i) {
				return new mp({ declutter: !0, source: By(t, e, i), visible: !1 });
			})(l, e, n);
		else if ('raster-dem' == l.type && 'hillshade' == i.type) {
			const t = (function (t, e, i) {
				const n = $y(t, e, i);
				return new o_({ source: new ly({ operationType: 'image', operation: Fy, sources: [n] }) });
			})(l, e, n);
			(h = t),
				t.getSource().on('beforeoperations', function (t) {
					const e = t.data;
					(e.resolution = jo(n.projection || 'EPSG:3857', t.resolution, as(t.extent), 'm')), (fm.zoom = qp(t.resolution, n.resolutions || Wp)), (fm.distanceFromCenter = 0), (e.encoding = l.encoding), (e.vert = 5 * _m(i, 'paint', 'hillshade-exaggeration', Op, r)), (e.sunAz = _m(i, 'paint', 'hillshade-illumination-direction', Op, r)), (e.sunEl = 35), (e.opacity = 0.3), (e.highlightColor = _m(i, 'paint', 'hillshade-highlight-color', Op, r)), (e.shadowColor = _m(i, 'paint', 'hillshade-shadow-color', Op, r)), (e.accentColor = _m(i, 'paint', 'hillshade-accent-color', Op, r));
				}),
				h.setVisible(!i.layout || 'none' !== i.layout.visibility);
		}
		const c = a;
	...
	function Wy(t, e, i, n) {
		...
		if (e instanceof Ag) {
			if (((s = e.getView()), !s.isDef() && !s.getRotation() && !s.getResolutions())) {
				const t = n.projection ? Go(n.projection) : s.getProjection();
				(s = new wl(Object.assign(s.getProperties(), { maxResolution: Wp[0] / $s[t.getUnits()], projection: n.projection || s.getProjection() }))), e.setView(s);
			}
			'center' in t && !s.getCenter() && s.setCenter(Wo(t.center, s.getProjection())), 'zoom' in t && void 0 === s.getZoom() && s.setResolution(Wp[0] / $s[s.getProjection().getUnits()] / Math.pow(2, t.zoom)), (s.getCenter() && void 0 !== s.getZoom()) || s.fit(s.getProjection().getExtent(), { nearest: !0, size: e.getSize() });
		}
		e.set('mapbox-style', t), e.set('mapbox-metadata', { styleUrl: i, options: n });
		const o = t.layers;
		let a,
			l,
			h,
		...
		for (let s = 0, u = o.length; s < u; ++s) {
			const u = o[s],
				d = u.type;
			'heatmap' != d ? ((h = u.source || Ay(o, u.ref)), (h && h == l) || (c.length && (r.push(qy(a, c, t, i, e, n)), (c = [])), (a = Vy(t, i, u, n)), a instanceof mp || a instanceof A_ || (c = []), (l = a.get('mapbox-source'))), c.push(u.id)) : console.debug(`layers[${s}].type "${d}" not supported`);
		}
		return r.push(qy(a, c, t, i, e, n)), Promise.all(r);
	}
	function Xy(t, e, i = {}) {
		let n, r;
		if (((r = 'string' == typeof t || t instanceof HTMLElement ? new Ag({ target: t }) : t), 'string' == typeof e)) {
			const t = e.startsWith('data:') ? location.href : Lp(e, i.accessToken);
			(i = Iy(t, i)),
			...
			n = new Promise(function (t, n) {
				Wy(e, r, !i.styleUrl || i.styleUrl.startsWith('data:') ? location.href : Lp(i.styleUrl, i.accessToken), i)
					.then(function () {
						t(r);
					})
					.catch(n);
	...
	function qy(t, e, i, n, s, o = {}) {
		let a = 24,
			l = 0;
		const h = i.layers;
		for (let t = 0, i = h.length; t < i; ++t) {
			const i = h[t];
			-1 !== e.indexOf(i.id) && ((a = Math.min('minzoom' in i ? i.minzoom : 0, a)), (l = Math.max('maxzoom' in i ? i.maxzoom : 24, l)));
		}
				...
				if (u && 'error' !== u.getState()) {
					if ('getTileGrid' in u) {
						...
						if (e) {
							...
							(a > 0 || i > 0) && t.setMaxResolution(Math.min(Zp(Math.max(0, a - 1e-12), Wp), Zp(Math.max(0, i - 1e-12), e.getResolutions()))), l < 24 && t.setMinResolution(Zp(l, Wp));
						}
					} else a > 0 && t.setMaxResolution(Zp(Math.max(0, a - 1e-12), Wp));
					u instanceof xf || u instanceof Py
						? ky(t, i, e, Object.assign({ styleUrl: n }, o))
								.then(function () {
									!(function (t, e) {
										function i() {
	...
	function Zy(t, e) {
		const i = t.get('mapbox-style').layers.find(function (t) {
			return t.id === e;
		});
		return i;
	}
	function Ky(t, e) {
		const i = t.getLayers().getArray();
		for (let t = 0, n = i.length; t < n; ++t) {
			const n = i[t].get('mapbox-layers');
			if (n && -1 !== n.indexOf(e)) return i[t];
		}
	}
	function Yy(t, e) {
		const i = [],
			n = t.getLayers().getArray();
		for (let t = 0, r = n.length; t < r; ++t) n[t].get('mapbox-source') === e && i.push(n[t]);
		return i;
	}
	function Hy(t, e) {
		const i = t.getLayers().getArray();
		for (let t = 0, n = i.length; t < n; ++t) {
			const n = i[t].getSource();
			if (i[t].get('mapbox-source') === e) return n;
		}
	}
	class Jy extends wn {
		constructor(t) {
			super(Zi), (this.error = t);
		}
	}
	var Qy = Object.freeze({
		__proto__: null,
		MapboxVectorLayer: class extends A_ {
			constructor(t) {
				const e = !('declutter' in t) || t.declutter,
					i = new Py({ state: 'loading', format: new Qm({ layerName: 'mvt:layer' }) });
				super({ source: i, background: !1 === t.background ? null : t.background, declutter: e, className: t.className, opacity: t.opacity, visible: t.visible, zIndex: t.zIndex, minResolution: t.minResolution, maxResolution: t.maxResolution, minZoom: t.minZoom, maxZoom: t.maxZoom, renderOrder: t.renderOrder, renderBuffer: t.renderBuffer, renderMode: t.renderMode, map: t.map, updateWhileAnimating: t.updateWhileAnimating, updateWhileInteracting: t.updateWhileInteracting, preload: t.preload, useInterimTilesOnError: t.useInterimTilesOnError, properties: t.properties }), t.accessToken && (this.accessToken = t.accessToken);
				const n = [ky(this, t.styleUrl, t.layers || t.source, { accessToken: this.accessToken })];
				void 0 === this.getBackground() && n.push(Ly(this, t.styleUrl, { accessToken: this.accessToken })),
					Promise.all(n)
						.then(() => {
							i.setState('ready');
						})
						.catch((t) => {
							this.dispatchEvent(new Jy(t));
							this.getSource().setState('error');
						});
			}
		},
		addMapboxLayer: function (t, e, i) {
			...
			if (void 0 !== i) {
				const e = Zy(t, i);
				if (void 0 === e) throw new Error(`Layer with id "${i}" not found.`);
				s = r.indexOf(e);
			} else s = r.length;
			if ((s > 0 && r[s - 1].source === e.source ? ((a = s - 1), (o = -1)) : s < r.length && r[s].source === e.source && ((a = s), (o = 0)), -1 === a)) {
				...
				if (i) {
					const e = Ky(t, i),
						n = t.getLayers().getArray().indexOf(e);
					t.getLayers().insertAt(n, l);
				}
				return r.splice(s, 0, e), qy(l, [e.id], n, a, t, o);
			}
			if (r.some((t) => t.id === e.id)) throw new Error(`Layer with id "${e.id}" already exists.`);
			const l = r[a].id,
				h = Tm[$p(t.get('mapbox-style'), Ky(t, l))];
			if ((r.splice(s, 0, e), h)) {
				const [t, i, n, r, s, a, c, u] = h;
				if (Array.isArray(n)) {
					const t = n.indexOf(l) + o;
					n.splice(t, 0, e.id);
				}
				Pm(t, i, n, r, s, a, c, u);
			} else Ky(t, r[a].id).changed();
			return Promise.resolve();
		},
		apply: Xy,
		applyBackground: Ly,
		...
		getFeatureState: function (t, e) {
			const i = 'getLayers' in t ? Yy(t, e.source) : [t];
			for (let t = 0, n = i.length; t < n; ++t) {
				const n = i[t].get('mapbox-featurestate');
				if (n && n[e.id]) return n[e.id];
			}
		},
		getLayer: Ky,
		getLayers: Yy,
		getMapboxLayer: Zy,
		getSource: Hy,
		getStyleForLayer: function (t, e, i, n) {
			const r = i.getStyleFunction();
			if (3 === r.length) return r(t, e, n);
		},
		recordStyleLayer: function (t = !1) {
			Em = t;
		},
		removeMapboxLayer: function (t, e) {
			const i = 'string' == typeof e ? e : e.id,
				n = Ky(t, i),
				r = n.get('mapbox-layers');
			...
			const s = t.get('mapbox-style'),
				o = s.layers;
			o.splice(
				o.findIndex((t) => t.id === i),
				1
			);
			const a = Tm[$p(s, n)];
			if (a) {
				const [t, e, n, r, s, o, l, h] = a;
				Array.isArray(n) &&
					n.splice(
						n.findIndex((t) => t === i),
						1
		...
		renderTransparent: function (t) {
			t !== vm &&
				(!(function () {
					for (const t in zp) delete zp[t];
				})(),
				(vm = t));
		},
		setFeatureState: function (t, e, i) {
			const n = 'getLayers' in t ? Yy(t, e.source) : [t];
			for (let t = 0, r = n.length; t < r; ++t) {
				const r = n[t].get('mapbox-featurestate');
				if (!r) throw new Error(`Map or layer for source "${e.source}" not found.`);
				i ? (r[e.id] = i) : delete r[e.id], n[t].changed();
			}
		},
		stylefunction: Pm,
		updateMapboxLayer: function (t, e) {
			...
			if (n[r].source !== e.source) throw new Error('Updated layer and previous version must use the same source.');
			delete Bp(i)[e.id], delete Up(i)[e.id], (n[r] = e);
			const s = Tm[$p(t.get('mapbox-style'), Ky(t, e.id))];
			s ? Pm.apply(void 0, s) : Ky(t, e.id).changed();
		},
		updateMapboxSource: function (t, e, i) {
			const n = Hy(t, e),
				r = t
					.getLayers()
					.getArray()
					.filter(function (t) {
						return (t instanceof mp || t instanceof M_ || t instanceof A_) && t.getSource() === n;
					}),
				s = t.get('mapbox-metadata');
			let o;
			switch (i.type) {
				case 'vector':
					o = Ny(i, s.styleUrl, s.options);
					break;
				case 'geojson':
					o = Promise.resolve(By(i, s.styleUrl, s.options));
					break;
				case 'raster':
				case 'raster-dem':
					o = jy(i, s.styleUrl, s.options);
					break;
				default:
					return Promise.reject(new Error('Unsupported source type ' + i.type));
			}
			return (
				o.then(function (t) {
					...
					t.exports = (function (t, e, i) {
						...
						class r extends t {
							constructor(t) {
								...
								super({ element: i, target: e.target }),
									...
									(i.className = this.hiddenClassName),
									(this.button = document.createElement('button')),
									i.appendChild(this.button),
									(this.panel = document.createElement('div')),
									(this.panel.className = 'panel'),
									i.appendChild(this.panel),
									r.enableTouchScroll_(this.panel),
									i.classList.add(n + 'group-select-style-' + this.groupSelectStyle),
									i.classList.add(n + 'activation-mode-' + this.activationMode),
									'click' === this.activationMode
										? (i.classList.add('activationModeClick'),
							...
							static renderPanel(t, e, i) {
								...
								e.appendChild(s),
									r.renderLayers_(t, t, s, i, function (n) {
										r.renderPanel(t, e, i);
									});
							...
							static setVisible_(t, e, n, s) {
								e.setVisible(n),
									n &&
										'base' === e.get('type') &&
										r.forEachRecursive(t, function (t, i, n) {
											t != e && 'base' === t.get('type') && t.setVisible(!1);
										}),
									e instanceof i &&
										!e.get('combine') &&
										'children' === s &&
										e.getLayers().forEach((i) => {
							...
							static renderLayer_(t, e, s, o, a) {
								...
								if (e instanceof i && !e.get('combine')) {
									...
									if (!i && 'none' != o.groupSelectStyle) {
										...
										(i.type = 'checkbox'),
											(i.id = c),
											(i.checked = e.getVisible()),
											(i.indeterminate = e.get('indeterminate')),
									...
									l.className = 'layer';
									const i = document.createElement('input');
									'base' === e.get('type') ? (i.type = 'radio') : (i.type = 'checkbox'),
										(i.id = c),
										(i.checked = e.get('visible')),
										(i.indeterminate = e.get('indeterminate')),
										(i.onchange = function (i) {
											const n = i.target;
											r.setVisible_(t, e, n.checked, o.groupSelectStyle), a(e);
									...
									if (n >= e.getMaxResolution() || n < e.getMinResolution()) u.className += ' disabled';
									else if (e.getMinZoom && e.getMaxZoom) {
										const i = t.getView().getZoom();
										(i <= e.getMinZoom() || i > e.getMaxZoom()) && (u.className += ' disabled');
									}
									l.appendChild(u);
								}
								return l;
	...
	function vx(t, e, i) {
		...
		for (let e = s; e < o - 1; ++e) {
			a += yx(xx(t, e), xx(t, e + 1));
		}
		return a;
	}
	function wx(t, e, i) {
		if (e instanceof Ug) Sx(t, e.getCoordinates(), !1, i);
		else {
			if (e instanceof Vg) {
				const n = e.getCoordinates();
				for (let e = 0, r = n.length; e < r; ++e) Sx(t, n[e], !1, i);
				return;
			}
			if (e instanceof dl) {
				const n = e.getCoordinates();
				for (let e = 0, r = n.length; e < r; ++e) Sx(t, n[e], !0, i);
				return;
			}
			if (e instanceof Xg) {
				const n = e.getCoordinates();
				for (let e = 0, r = n.length; e < r; ++e) {
					const r = n[e];
					for (let e = 0, n = r.length; e < n; ++e) Sx(t, r[e], !0, i);
				}
				return;
			}
			if (e instanceof jg) {
				const n = e.getGeometries();
				for (let e = 0; e < n.length; ++e) wx(t, n[e], i);
				return;
			}
		}
	}
	const bx = { index: -1, endIndex: NaN };
	function Sx(t, e, i, n) {
		const r = t[0],
			s = t[1];
		for (let t = 0, o = e.length - 1; t < o; ++t) {
			const o = Ex(r, s, e[t], e[t + 1]);
	...
	const Cx = { along: 0, squaredDistance: 0 };
	function Ex(t, e, i, n) {
		const r = i[0],
			s = i[1],
			o = n[0] - r,
		...
		let l = 0,
			h = r,
			c = s;
		return (0 === o && 0 === a) || ((l = xr(((t - r) * o + (e - s) * a) / (o * o + a * a), 0, 1)), (h += o * l), (c += a * l)), (Cx.along = l), (Cx.squaredDistance = Tr(wr(t, e, h, c), 10)), Cx;
	}
	function Tx(t, e) {
		const i = t.length;
		let n = Math.floor(e);
	...
	const Rx = 'extentchanged';
	class Fx extends wn {
		constructor(t) {
			super(Rx), (this.extent = t);
		}
	}
	function Mx() {
		const t = tg();
	...
	function Ux(t, e, i) {
		...
		if ('Circle' === n.getType()) {
			...
			if (1 === e.index) {
				...
				const n = Ts(r.getCenter(), ia(t, i)),
					s = Math.sqrt(n) - r.getRadius();
				return s * s;
			}
		}
		const r = ia(t, i);
		return (Nx[0] = ia(e.segment[0], i)), (Nx[1] = ia(e.segment[1], i)), Rs(r, Nx);
	}
	function Vx(t, e, i) {
		const n = e.geometry;
		if ('Circle' === n.getType() && 1 === e.index) {
			let e = n;
			const r = ta();
			return r && (e = e.clone().transform(r, i)), ea(e.getClosestPoint(ia(t, i)), i);
		}
		const r = ia(t, i);
		return (Nx[0] = ia(e.segment[0], i)), (Nx[1] = ia(e.segment[1], i)), ea(Ss(r, Nx), i);
	}
	function Wx() {
		const t = tg();
		return function (e, i) {
	...
	class Kx extends Zl {
		constructor(t) {
			...
			if (
				...
				(this.condition_ = t.condition ? t.condition : nh),
				(this.addCondition_ = t.addCondition ? t.addCondition : ih),
				(this.removeCondition_ = t.removeCondition ? t.removeCondition : ih),
				(this.toggleCondition_ = t.toggleCondition ? t.toggleCondition : sh),
				(this.multi_ = !!t.multi && t.multi),
				(this.filter_ = t.filter ? t.filter : fn),
				...
				(this.style_ =
					void 0 !== t.style
						...
						: (function () {
								const t = tg();
								return (
									dn(t.Polygon, t.LineString),
									dn(t.GeometryCollection, t.LineString),
									function (e) {
										return e.getGeometry() ? t[e.getGeometry().getType()] : null;
									}
								);
						  })()),
				(this.features_ = t.features || new On()),
				t.layers)
			)
		...
		addFeatureLayerAssociation_(t, e) {
			this.featureLayerAssociation_[In(t)] = e;
		}
		getFeatures() {
			return this.features_;
		}
		...
		getLayer(t) {
			return this.featureLayerAssociation_[In(t)];
		}
		setHitTolerance(t) {
			this.hitTolerance_ = t;
		}
		setMap(t) {
			this.getMap() && this.style_ && this.features_.forEach(this.restorePreviousStyle_.bind(this)), super.setMap(t), t ? (this.features_.addEventListener(Vi, this.boundAddFeature_), this.features_.addEventListener(Wi, this.boundRemoveFeature_), this.style_ && this.features_.forEach(this.applySelectedStyle_.bind(this))) : (this.features_.removeEventListener(Vi, this.boundAddFeature_), this.features_.removeEventListener(Wi, this.boundRemoveFeature_));
		}
		addFeature_(t) {
			const e = t.element;
			if ((this.style_ && this.applySelectedStyle_(e), !this.getLayer(e))) {
				const t = this.getMap()
					.getAllLayers()
					.find(function (t) {
						if (t instanceof mp && t.getSource() && t.getSource().hasFeature(e)) return t;
					});
		...
		applySelectedStyle_(t) {
			const e = In(t);
			e in Zx || (Zx[e] = t.getStyle()), t.setStyle(this.style_);
		}
		restorePreviousStyle_(t) {
			const e = this.getMap().getInteractions().getArray();
			for (let i = e.length - 1; i >= 0; --i) {
				const n = e[i];
				if (n !== this && n instanceof Kx && n.getStyle() && -1 !== n.getFeatures().getArray().lastIndexOf(t)) return void t.setStyle(n.getStyle());
			}
			const i = In(t);
			t.setStyle(Zx[i]), delete Zx[i];
		}
		removeFeatureLayerAssociation_(t) {
			delete this.featureLayerAssociation_[In(t)];
		}
		handleEvent(t) {
			if (!this.condition_(t)) return !0;
			const e = this.addCondition_(t),
				...
				l = [];
			if (r) {
				xn(this.featureLayerAssociation_),
					s.forEachFeatureAtPixel(
						t.pixel,
						(t, e) => {
							if (t instanceof Dg && this.filter_(t, e)) return this.addFeatureLayerAssociation_(t, e), l.push(t), !this.multi_;
						},
				...
				s.forEachFeatureAtPixel(
					t.pixel,
					(t, r) => {
						if (t instanceof Dg && this.filter_(t, r)) return (!e && !n) || o.getArray().includes(t) ? (i || n) && o.getArray().includes(t) && (a.push(t), this.removeFeatureLayerAssociation_(t)) : (this.addFeatureLayerAssociation_(t, r), l.push(t)), !this.multi_;
					},
					{ layerFilter: this.layerFilter_, hitTolerance: this.hitTolerance_ }
				);
			...
			return (l.length > 0 || a.length > 0) && this.dispatchEvent(new qx(Xx, l, a, t)), !0;
		}
	}
	const Yx = 'snap',
		Hx = 'unsnap';
	...
	const Qx = {
		Circle(t, e) {
			let i = t;
			const n = ta();
			n && (i = i.clone().transform(n, e));
			const r = fl(i);
			return n && r.transform(e, n), Qx.Polygon(r);
		},
		GeometryCollection(t, e) {
			const i = [],
				n = t.getGeometriesArray();
			for (let t = 0; t < n.length; ++t) {
				const r = Qx[n[t].getType()];
				r && i.push(r(n[t], e));
			}
			return i.flat();
		},
		LineString(t) {
			const e = [],
				i = t.getFlatCoordinates(),
				n = t.getStride();
			for (let t = 0, r = i.length - n; t < r; t += n) e.push([i.slice(t, t + 2), i.slice(t + n, t + n + 2)]);
			return e;
		},
		MultiLineString(t) {
			const e = [],
			...
			for (let t = 0, o = r.length; t < o; ++t) {
				const o = r[t];
				for (let t = s, r = o - n; t < r; t += n) e.push([i.slice(t, t + 2), i.slice(t + n, t + n + 2)]);
				s = o;
			}
			return e;
		},
		MultiPoint(t) {
			const e = [],
				i = t.getFlatCoordinates(),
				n = t.getStride();
			for (let t = 0, r = i.length; t < r; t += n) e.push([i.slice(t, t + 2)]);
			return e;
		},
		MultiPolygon(t) {
			const e = [],
			...
			for (let t = 0, o = r.length; t < o; ++t) {
				...
				for (let t = 0, r = o.length; t < r; ++t) {
					const r = o[t];
					for (let t = s, o = r - n; t < o; t += n) e.push([i.slice(t, t + 2), i.slice(t + n, t + n + 2)]);
					s = r;
				}
			}
			return e;
		},
		Point: (t) => [[t.getFlatCoordinates().slice(0, 2)]],
		Polygon(t) {
			const e = [],
				i = t.getFlatCoordinates(),
				n = t.getStride(),
	...
	var lv = Object.freeze({
		__proto__: null,
		DblClickDragZoom: class extends Zl {
			constructor(t) {
				const e = t || {};
				super(e), e.stopDown && (this.stopDown = e.stopDown), (this.scaleDeltaByPixel_ = e.delta ? e.delta : 0.01), (this.duration_ = void 0 !== e.duration ? e.duration : 250), (this.handlingDownUpSequence_ = !1), (this.handlingDoubleDownSequence_ = !1), (this.doubleTapTimeoutId_ = void 0), (this.trackedPointers_ = {}), (this.down_ = null), (this.targetPointers = []);
			}
			handleEvent(t) {
				if (!t.originalEvent) return !0;
				let e = !1;
			...
			handleDownEvent(t) {
				if (1 == this.targetPointers.length) {
					const e = t.map;
					return (this.anchor_ = null), (this.lastDistance_ = void 0), (this.lastScaleDelta_ = 1), (this.down_ = t.originalEvent), this.handlingDownUpSequence_ || e.getView().beginInteraction(), !0;
				}
				return !1;
			}
			handleUpEvent(t) {
			...
			updateTrackedPointers_(t) {
				if (
					(function (t) {
						const e = t.type;
						return e === Gn.POINTERDOWN || e === Gn.POINTERDRAG || e === Gn.POINTERUP;
					})(t)
				) {
					const e = t.originalEvent,
						i = e.pointerId.toString();
					t.type == Gn.POINTERUP ? delete this.trackedPointers_[i] : (t.type == Gn.POINTERDOWN || i in this.trackedPointers_) && (this.trackedPointers_[i] = e), (this.targetPointers = Object.values(this.trackedPointers_));
				}
			}
			waitForDblTap_() {
		...
		DoubleClickZoom: Yl,
		DragAndDrop: class extends Zl {
			constructor(t) {
				(t = t || {}), super({ handleEvent: fn }), this.on, this.once, this.un, (this.readAsBuffer_ = !1), (this.formats_ = []);
				...
				(this.projection_ = t.projection ? Go(t.projection) : null), (this.dropListenKeys_ = null), (this.source_ = t.source || null), (this.target = t.target ? t.target : null);
			}
			handleResult_(t, e) {
				...
				for (let e = 0, n = o.length; e < n; ++e) {
					...
					if (l && l.length > 0) {
						this.source_ && (this.source_.clear(), this.source_.addFeatures(l)), this.dispatchEvent(new gx(dx, t, l, s));
						break;
					}
				}
			}
			registerListeners_() {
				...
				if (t) {
					...
					this.dropListenKeys_ = [Sn(e, tn, this.handleDrop, this), Sn(e, Ji, this.handleStop, this), Sn(e, Qi, this.handleStop, this), Sn(e, tn, this.handleStop, this)];
				}
			}
			setActive(t) {
			...
			unregisterListeners_() {
				this.dropListenKeys_ && (this.dropListenKeys_.forEach(En), (this.dropListenKeys_ = null));
			}
			handleDrop(t) {
				...
				for (let t = 0, i = e.length; t < i; ++t) {
					const i = e.item(t),
						n = new FileReader();
					n.addEventListener(rn, this.handleResult_.bind(this, i)), this.readAsBuffer_ ? n.readAsArrayBuffer(i) : n.readAsText(i);
				}
			}
			handleStop(t) {
		...
		DragPan: uh,
		DragRotate: dh,
		DragRotateAndZoom: class extends hh {
			constructor(t) {
				super((t = t || {})), (this.condition_ = t.condition ? t.condition : sh), (this.lastAngle_ = void 0), (this.lastMagnitude_ = void 0), (this.lastScaleDelta_ = 0), (this.duration_ = void 0 !== t.duration ? t.duration : 400);
			}
			handleDragEvent(t) {
				if (!ah(t)) return;
				const e = t.map,
			...
			handleDownEvent(t) {
				return !!ah(t) && !!this.condition_(t) && (t.map.getView().beginInteraction(), (this.lastAngle_ = void 0), (this.lastMagnitude_ = void 0), !0);
			}
		},
		DragZoom: vh,
		Draw: class extends hh {
			constructor(t) {
				const e = t;
				e.stopDown || (e.stopDown = pn),
					super(e),
					this.on,
					this.once,
					this.un,
					...
					(this.finishCondition_ = t.finishCondition ? t.finishCondition : fn),
				...
				if (!i) {
					...
					if ('Circle' === t)
						i = (t, e, i) => {
							const n = e || new Gg([NaN, NaN]),
								r = ia(t[0], i),
								s = Ts(r, ia(t[t.length - 1], i));
						...
						let e;
						'Point' === t ? (e = Za) : 'LineString' === t ? (e = Ug) : 'Polygon' === t && (e = dl), (i = (i, n, r) => (n ? ('Polygon' === t ? (i[0].length ? n.setCoordinates([i[0].concat([i[0][0]])], this.geometryLayout_) : n.setCoordinates([], this.geometryLayout_)) : n.setCoordinates(i, this.geometryLayout_)) : (n = new e(i, this.geometryLayout_)), n));
					}
				}
				(this.geometryFunction_ = i),
					...
					(this.overlay_ = new mp({ source: new xf({ useSpatialIndex: !1, wrapX: !!t.wrapX && t.wrapX }), style: t.style ? t.style : Px(), updateWhileInteracting: !0 })),
					(this.geometryName_ = t.geometryName),
					(this.condition_ = t.condition ? t.condition : rh),
					this.freehandCondition_,
					t.freehand ? (this.freehandCondition_ = th) : (this.freehandCondition_ = t.freehandCondition ? t.freehandCondition : sh),
					this.traceCondition_,
					this.setTrace(t.trace || !1),
					(this.traceState_ = { active: !1 }),
					(this.traceSource_ = t.traceSource || t.source || null),
					this.addChangeListener(ql, this.updateState_);
			}
			setTrace(t) {
				let e;
				(e = t ? (!0 === t ? th : t) : ih), (this.traceCondition_ = e);
			}
			setMap(t) {
			...
			handleEvent(t) {
				t.originalEvent.type === Ki && t.originalEvent.preventDefault(), (this.freehand_ = 'Point' !== this.mode_ && this.freehandCondition_(t));
				let e = t.type === Gn.POINTERMOVE,
					i = !0;
				if (!this.freehand_ && this.lastDragTime_ && t.type === Gn.POINTERDRAG) {
				...
				return this.freehand_ && t.type === Gn.POINTERDRAG && null !== this.sketchFeature_ ? (this.addToDrawing_(t.coordinate), (i = !1)) : this.freehand_ && t.type === Gn.POINTERDOWN ? (i = !1) : e && this.getPointerCount() < 2 ? ((i = t.type === Gn.POINTERMOVE), i && this.freehand_ ? (this.handlePointerMove_(t), this.shouldHandle_ && t.originalEvent.preventDefault()) : ('mouse' === t.originalEvent.pointerType || (t.type === Gn.POINTERDRAG && void 0 === this.downTimeout_)) && this.handlePointerMove_(t)) : t.type === Gn.DBLCLICK && (i = !1), super.handleEvent(t) && i;
			}
			handleDownEvent(t) {
				return (
					...
					this.freehand_
						...
						? ((this.lastDragTime_ = Date.now()),
						  (this.downTimeout_ = setTimeout(() => {
								this.handlePointerMove_(new Nn(Gn.POINTERMOVE, t.map, t.originalEvent, !1, t.frameState));
			...
			toggleTraceState_(t) {
				...
				const e = this.getMap(),
					i = Gr([e.getCoordinateFromPixel([t.pixel[0] - this.snapTolerance_, t.pixel[1] + this.snapTolerance_]), e.getCoordinateFromPixel([t.pixel[0] + this.snapTolerance_, t.pixel[1] - this.snapTolerance_])]),
					n = this.traceSource_.getFeaturesInExtent(i);
				if (0 === n.length) return;
				const r = (function (t, e) {
					const i = [];
					for (let n = 0; n < e.length; ++n) wx(t, e[n].getGeometry(), i);
					return i;
				})(t.coordinate, n);
			...
			addTracedCoordinates_(t, e, i) {
				...
				if (e < i) {
					...
					let s = Math.floor(i);
					s === i && (s -= 1);
					for (let e = r; e <= s; ++e) n.push(xx(t.coordinates, e));
				} else {
			...
			updateTrace_(t) {
				...
				if (!e.active) return;
				if (-1 === e.targetIndex && Ps(e.startPx, t.pixel) < this.snapTolerance_) return;
				const i = (function (t, e, i, n) {
					...
					if (e.targetIndex === a && c) {
						const t = Tx(h.coordinates, l);
						Ps(i.getPixelFromCoordinate(t), e.startPx) > n && (c = !1);
					}
					if (c) {
					...
					return (bx.index = a), (bx.endIndex = l), bx;
				...
				const r = Tx(n.coordinates, n.endIndex),
			...
			createOrUpdateSketchPoint_(t) {
				...
				} else (this.sketchPoint_ = new Dg(new Za(t))), this.updateSketchFeatures_();
			}
			createOrUpdateCustomSketchLine_(t) {
				this.sketchLine_ || (this.sketchLine_ = new Dg());
				const e = t.getLinearRing(0);
				let i = this.sketchLine_.getGeometry();
				i ? (i.setFlatCoordinates(e.getLayout(), e.getFlatCoordinates()), i.changed()) : ((i = new Ug(e.getFlatCoordinates(), e.getLayout())), this.sketchLine_.setGeometry(i));
			}
			startDrawing_(t) {
				const e = this.getMap().getView().getProjection(),
					i = Pa(this.geometryLayout_);
				for (; t.length < i; ) t.push(0);
				(this.finishCoordinate_ = t), 'Point' === this.mode_ ? (this.sketchCoords_ = t.slice()) : 'Polygon' === this.mode_ ? ((this.sketchCoords_ = [[t.slice(), t.slice()]]), (this.sketchLineCoords_ = this.sketchCoords_[0])) : (this.sketchCoords_ = [t.slice(), t.slice()]), this.sketchLineCoords_ && (this.sketchLine_ = new Dg(new Ug(this.sketchLineCoords_)));
				const n = this.geometryFunction_(this.sketchCoords_, void 0, e);
				(this.sketchFeature_ = new Dg()), this.geometryName_ && this.sketchFeature_.setGeometryName(this.geometryName_), this.sketchFeature_.setGeometry(n), this.updateSketchFeatures_(), this.dispatchEvent(new _x(fx, this.sketchFeature_));
			}
			modifyDrawing_(t) {
				const e = this.getMap(),
					i = this.sketchFeature_.getGeometry(),
					n = e.getView().getProjection(),
					r = Pa(this.geometryLayout_);
				let s, o;
			...
			finishDrawing() {
				...
				return 'LineString' === this.mode_ ? (e.pop(), this.geometryFunction_(e, i, n)) : 'Polygon' === this.mode_ && (e[0].pop(), this.geometryFunction_(e, i, n), (e = i.getCoordinates())), 'MultiPoint' === this.type_ ? t.setGeometry(new Wg([e])) : 'MultiLineString' === this.type_ ? t.setGeometry(new Vg([e])) : 'MultiPolygon' === this.type_ && t.setGeometry(new Xg([e])), this.dispatchEvent(new _x(px, t)), this.features_ && this.features_.push(t), this.source_ && this.source_.addFeature(t), t;
			}
			abortDrawing_() {
				this.finishCoordinate_ = null;
			...
			abortDrawing() {
				const t = this.abortDrawing_();
				t && this.dispatchEvent(new _x(mx, t));
			}
			appendCoordinates(t) {
				const e = this.mode_,
			...
			extend(t) {
				...
				(this.finishCoordinate_ = i.slice()), this.sketchCoords_.push(i.slice()), (this.sketchPoint_ = new Dg(new Za(i))), this.updateSketchFeatures_(), this.dispatchEvent(new _x(fx, this.sketchFeature_));
			}
		...
		Extent: class extends hh {
			constructor(t) {
				super((t = t || {})),
					this.on,
					this.once,
					this.un,
					(this.condition_ = t.condition ? t.condition : th),
					(this.extent_ = null),
					...
					t || (t = {}),
					(this.extentOverlay_ = new mp({ source: new xf({ useSpatialIndex: !1, wrapX: !!t.wrapX }), style: t.boxStyle ? t.boxStyle : Mx(), updateWhileAnimating: !0, updateWhileInteracting: !0 })),
					(this.vertexOverlay_ = new mp({ source: new xf({ useSpatialIndex: !1, wrapX: !!t.wrapX }), style: t.pointerStyle ? t.pointerStyle : Ix(), updateWhileAnimating: !0, updateWhileInteracting: !0 })),
					t.extent && this.setExtent(t.extent);
			}
			snapToVertex_(t, e) {
				const i = e.getCoordinateFromPixelInternal(t),
					n = function (t, e) {
						return Rs(i, t) - Rs(i, e);
					},
				...
				if (r) {
					...
					if (Ps(t, l) <= this.pixelTolerance_) {
			...
			createOrUpdateExtentFeature_(t) {
				...
				return e ? (t ? e.setGeometry(gl(t)) : e.setGeometry(void 0)) : ((e = new Dg(t ? gl(t) : {})), (this.extentFeature_ = e), this.extentOverlay_.getSource().addFeature(e)), e;
			}
			createOrUpdatePointerFeature_(t) {
				let e = this.vertexFeature_;
				if (e) {
					e.getGeometry().setCoordinates(t);
				} else (e = new Dg(new Za(t))), (this.vertexFeature_ = e), this.vertexOverlay_.getSource().addFeature(e);
				return e;
			}
			handleEvent(t) {
				return !t.originalEvent || !this.condition_(t) || (t.type != Gn.POINTERMOVE || this.handlingDownUpSequence || this.handlePointerMove_(t), super.handleEvent(t), !1);
			}
			handleDownEvent(t) {
				const e = t.pixel,
					i = t.map,
				...
				if (r && n) {
					...
					null !== t && null !== e ? (this.pointerHandler_ = kx(s(r))) : null !== t ? (this.pointerHandler_ = Lx(s([t, n[1]]), s([t, n[3]]))) : null !== e && (this.pointerHandler_ = Lx(s([n[0], e]), s([n[2], e])));
				} else (r = i.getCoordinateFromPixelInternal(e)), this.setExtent([r[0], r[1], r[0], r[1]]), (this.pointerHandler_ = kx(r));
				return !0;
			}
			handleDragEvent(t) {
			...
			handleUpEvent(t) {
				...
				return (e && 0 !== rs(e)) || this.setExtent(null), !1;
			}
			setMap(t) {
				this.extentOverlay_.setMap(t), this.vertexOverlay_.setMap(t), super.setMap(t);
			}
			getExtent() {
				return na(this.getExtentInternal(), this.getMap().getView().getProjection());
			}
			getExtentInternal() {
				return this.extent_;
			}
			setExtent(t) {
				(this.extent_ = t || null), this.createOrUpdateExtentFeature_(t), this.dispatchEvent(new Fx(this.extent_));
			}
		},
		Interaction: Zl,
		KeyboardPan: Eh,
		KeyboardZoom: Th,
		Link: class extends Zl {
			constructor(t) {
				let e;
			...
			registerListeners_(t) {
				this.listenerKeys_.push(Sn(t, tr, this.updateUrl_, this), Sn(t.getLayerGroup(), qi, this.updateUrl_, this), Sn(t, 'change:layergroup', this.handleChangeLayerGroup_, this)), this.replace_ || addEventListener('popstate', this.updateState_);
			}
			unregisterListeners_(t) {
				for (let t = 0, e = this.listenerKeys_.length; t < e; ++t) En(this.listenerKeys_[t]);
			...
			updateState_() {
				...
				const r = {},
					s = Ax(this.get_(t, 'z'));
				'z' in this.params_ && Ox(s, i.getZoom()) && ((n = !0), (r.zoom = s));
				const o = Ax(this.get_(t, 'r'));
				'r' in this.params_ && Ox(o, i.getRotation()) && ((n = !0), (r.rotation = o));
				const a = [Ax(this.get_(t, 'x')), Ax(this.get_(t, 'y'))];
				var l, h;
				('x' in this.params_ || 'y' in this.params_) && ((l = a), (h = i.getCenter()), Ox(l[0], h[0]) || Ox(l[1], h[1])) && ((n = !0), (r.center = a)), n && (!this.initial_ && this.animationOptions_ ? i.animate(Object.assign(r, this.animationOptions_)) : (r.center && i.setCenter(r.center), 'zoom' in r && i.setZoom(r.zoom), 'rotation' in r && i.setRotation(r.rotation)));
			...
			updateUrl_() {
				...
				const a = new URL(window.location.href),
					l = a.searchParams;
				this.set_(l, 'x', Dx(i[0])), this.set_(l, 'y', Dx(i[1])), this.set_(l, 'z', Dx(n)), this.set_(l, 'r', Dx(r)), this.set_(l, 'l', o.join('')), this.updateHistory_(a), (this.initial_ = !1);
			}
			updateHistory_(t) {
		...
		Modify: class extends hh {
			constructor(t) {
				...
				if (
					...
					(this.insertVertexCondition_ = t.insertVertexCondition ? t.insertVertexCondition : th),
					(this.vertexFeature_ = null),
					...
					(this.dragSegments_ = []),
					(this.overlay_ = new mp({ source: new xf({ useSpatialIndex: !1, wrapX: !!t.wrapX }), style: t.style ? t.style : Wx(), updateWhileAnimating: !0, updateWhileInteracting: !0 })),
					...
					t.features ? (e = t.features) : t.source && ((this.source_ = t.source), (e = new On(this.source_.getFeatures())), this.source_.addEventListener(uf, this.handleSourceAdd_.bind(this)), this.source_.addEventListener(ff, this.handleSourceRemove_.bind(this))),
					!e)
				)
					throw new Error('The modify interaction requires features, a source or a layer');
				t.hitDetection && (this.hitDetection_ = t.hitDetection), (this.features_ = e), this.features_.forEach(this.addFeature_.bind(this)), this.features_.addEventListener(Vi, this.handleFeatureAdd_.bind(this)), this.features_.addEventListener(Wi, this.handleFeatureRemove_.bind(this)), (this.lastPointerEvent_ = null), (this.delta_ = [0, 0]), (this.snapToPointer_ = void 0 === t.snapToPointer ? !this.hitDetection_ : t.snapToPointer);
			}
			addFeature_(t) {
				const e = t.getGeometry();
				if (e) {
				...
				const i = this.getMap();
				i && i.isRendered() && this.getActive() && this.handlePointerAtPixel_(i.getCoordinateFromPixel(this.lastPixel_)), t.addEventListener(qi, this.boundHandleFeatureChange_);
			}
			willModifyFeatures_(t, e) {
				if (!this.featuresBeingModified_) {
					this.featuresBeingModified_ = new On();
					const i = this.featuresBeingModified_.getArray();
					for (let t = 0, n = e.length; t < n; ++t) {
						const n = e[t].feature;
						n && !i.includes(n) && this.featuresBeingModified_.push(n);
					}
					0 === this.featuresBeingModified_.getLength() ? (this.featuresBeingModified_ = null) : this.dispatchEvent(new $x(Gx, this.featuresBeingModified_, t));
				}
			}
			removeFeature_(t) {
				this.removeFeatureSegmentData_(t), this.vertexFeature_ && 0 === this.features_.getLength() && (this.overlay_.getSource().removeFeature(this.vertexFeature_), (this.vertexFeature_ = null)), t.removeEventListener(qi, this.boundHandleFeatureChange_);
			}
			...
			writeCircleGeometry_(t, e) {
				const i = e.getCenter(),
					...
					s = [n, r];
				(n.featureSegments = s), (r.featureSegments = s), this.rBush_.insert(Yr(i), n);
				let o = e;
				const a = ta();
				if (a && this.getMap()) {
					const t = this.getMap().getView().getProjection();
					(o = o.clone().transform(a, t)), (o = fl(o).transform(t, a));
				}
			...
			createOrUpdateVertexFeature_(t, e, i, n) {
				...
				} else (r = new Dg(new Za(t))), (this.vertexFeature_ = r), this.overlay_.getSource().addFeature(r);
				return r.set('features', e), r.set('geometries', i), r.set('existing', n), r;
			}
			handleEvent(t) {
				if (!t.originalEvent) return !0;
				let e;
				return (this.lastPointerEvent_ = t), t.map.getView().getInteracting() || t.type != Gn.POINTERMOVE || this.handlingDownUpSequence || this.handlePointerMove_(t), this.vertexFeature_ && this.deleteCondition_(t) && (e = !(t.type != Gn.SINGLECLICK || !this.ignoreNextSingleClick_) || this.removePoint()), t.type == Gn.SINGLECLICK && (this.ignoreNextSingleClick_ = !1), super.handleEvent(t) && !e;
			}
			findInsertVerticesAndUpdateDragSegments_(t) {
				...
				for (let e = 0, s = o.length; e < s; ++e) {
					...
					if ((c && (h += '-' + c.join('-')), a[h] || (a[h] = new Array(2)), 'Circle' === s.geometry.getType() && 1 === s.index)) {
						Cs(Vx(t, s, i), r) && !a[h][0] && (this.dragSegments_.push([s, 0]), (a[h][0] = s));
						continue;
					}
					if (!Cs(l[0], r) || a[h][0])
						if (!Cs(l[1], r) || a[h][1]) !(In(l) in this.vertexSegments_) || a[h][0] || a[h][1] || n.push(s);
						else {
			...
			handleDragEvent(t) {
				...
				for (let r = 0, s = this.dragSegments_.length; r < s; ++r) {
					...
					switch (l.getType()) {
						...
						case 'Circle':
							const i = l;
							if (((u[0] = e), (u[1] = e), 0 === o.index)) (this.changingFeature_ = !0), i.setCenter(e), (this.changingFeature_ = !1);
							else {
								this.changingFeature_ = !0;
								const n = t.map.getView().getProjection();
								let r = Ps(ia(i.getCenter(), n), ia(e, n));
								const s = ta();
								if (s) {
									const t = i.clone().transform(s, n);
									t.setRadius(r), (r = t.transform(n, s).getRadius());
								}
								i.setRadius(r), (this.changingFeature_ = !1);
							}
					}
			...
			handleDownEvent(t) {
				...
				if (i?.length && this.insertVertexCondition_(t) && (this.willModifyFeatures_(t, i), this.vertexFeature_)) {
					const t = this.vertexFeature_.getGeometry().getCoordinates();
					for (let e = i.length - 1; e >= 0; --e) this.insertVertex_(i[e], t);
			...
			handleUpEvent(t) {
				for (let e = this.dragSegments_.length - 1; e >= 0; --e) {
					...
					if ('Circle' === n.getType()) {
						...
						(s.segment[0] = r), (s.segment[1] = r), (o.segment[0] = r), (o.segment[1] = r), this.rBush_.update(Yr(r), s);
						let a = e;
						const l = ta();
						if (l) {
							const e = t.map.getView().getProjection();
							(a = a.clone().transform(l, e)), (a = fl(a).transform(e, l));
						}
						this.rBush_.update(a.getExtent(), o);
					} else this.rBush_.update(Gr(i.segment), i);
				}
				return this.featuresBeingModified_ && (this.dispatchEvent(new $x(jx, this.featuresBeingModified_, t)), (this.featuresBeingModified_ = null)), !1;
			}
			handlePointerMove_(t) {
			...
			handlePointerAtPixel_(t) {
				...
				if (this.hitDetection_) {
					...
					e.forEachFeatureAtPixel(
						i,
						(t, e, i) => {
							i && 'Point' === i.getType() && (i = new Za(ea(i.getCoordinates(), n)));
							const r = i || t.getGeometry();
							if (r && 'Point' === r.getType() && t instanceof Dg && this.features_.getArray().includes(t)) {
								o = r;
				...
				if (!s) {
					const i = na(jr(ra(Yr(t, zx), n), e.getView().getResolution() * this.pixelTolerance_, zx), n);
				...
				if (s && s.length > 0) {
					...
					if (o || u <= this.pixelTolerance_) {
						const i = {};
						if (((i[In(l)] = !0), this.snapToPointer_ || ((this.delta_[0] = h[0] - t[0]), (this.delta_[1] = h[1] - t[1])), 'Circle' === a.geometry.getType() && 1 === a.index)) (this.snappedToVertex_ = !0), this.createOrUpdateVertexFeature_(h, [a.feature], [a.geometry], this.snappedToVertex_);
						else {
							const t = e.getPixelFromCoordinate(l[0]),
								n = e.getPixelFromCoordinate(l[1]),
								r = Ts(c, t),
								o = Ts(c, n);
							...
							for (let t = 1, e = s.length; t < e; ++t) {
								const e = s[t].segment;
								if (!((Cs(l[0], e[0]) && Cs(l[1], e[1])) || (Cs(l[0], e[1]) && Cs(l[1], e[0])))) break;
								{
									const n = In(s[t].geometry);
									n in d || ((d[n] = !0), (i[In(e)] = !0));
								}
							}
						}
						return void (this.vertexSegments_ = i);
					}
				}
			...
			insertVertex_(t, e) {
				...
				l.insert(Gr(h.segment), h), this.dragSegments_.push([h, 1]);
				const c = { segment: [e, i[1]], feature: n, geometry: r, depth: s, index: o + 1 };
				return l.insert(Gr(c.segment), c), this.dragSegments_.push([c, 0]), !0;
			}
			updatePointer_(t) {
			...
			getPoint() {
				const t = this.vertexFeature_?.getGeometry().getCoordinates();
				return t ? ea(t, this.getMap().getView().getProjection()) : null;
			}
			canRemovePoint() {
				...
				const t = this.vertexFeature_.getGeometry().getCoordinates();
				return this.rBush_.getInExtent(Gr([t])).some(({ segment: e }) => Cs(e[0], t) || Cs(e[1], t));
			}
			removePoint(t) {
				if ((t && ((t = ia(t, this.getMap().getView().getProjection())), this.updatePointer_(t)), !this.lastPointerEvent_ || (this.lastPointerEvent_ && this.lastPointerEvent_.type != Gn.POINTERDRAG))) {
					...
					return this.featuresBeingModified_ && this.dispatchEvent(new $x(jx, this.featuresBeingModified_, t)), (this.featuresBeingModified_ = null), e;
				}
				return !1;
			}
			removeVertex_() {
				...
				let i,
					...
					d,
					g = !1;
				for (o = t.length - 1; o >= 0; --o) (r = t[o]), (u = r[0]), (d = In(u.feature)), u.depth && (d += '-' + u.depth.join('-')), d in e || (e[d] = {}), 0 === r[1] ? ((e[d].right = u), (e[d].index = u.index)) : 1 == r[1] && ((e[d].left = u), (e[d].index = u.index + 1));
				for (d in e) {
					...
					if (g) {
						...
						if ((void 0 !== l && (this.rBush_.remove(l), e.push(l.segment[0])), void 0 !== c && (this.rBush_.remove(c), e.push(c.segment[1])), void 0 !== l && void 0 !== c)) {
							...
							this.rBush_.insert(Gr(t.segment), t);
						}
			...
			insertPoint(t) {
				const e = t ? ia(t, this.getMap().getView().getProjection()) : this.vertexFeature_?.getGeometry().getCoordinates();
				if (!e) return !1;
				return this.findInsertVerticesAndUpdateDragSegments_(e).reduce((t, i) => t || this.insertVertex_(i, e), !1);
			}
			...
			updateSegmentIndices_(t, e, i, n) {
				this.rBush_.forEachInExtent(t.getExtent(), function (r) {
					r.geometry === t && (void 0 === i || void 0 === r.depth || gn(r.depth, i)) && r.index > e && (r.index += n);
				});
			}
		},
		MouseWheelZoom: Ph,
		...
		Pointer: hh,
		Select: Kx,
		Snap: class extends hh {
			constructor(t) {
				const e = (t = t || {});
				e.handleDownEvent || (e.handleDownEvent = fn), e.stopDown || (e.stopDown = pn), super(e), this.on, this.once, this.un, (this.source_ = t.source ? t.source : null), (this.vertex_ = void 0 === t.vertex || t.vertex), (this.edge_ = void 0 === t.edge || t.edge), (this.intersection_ = void 0 !== t.intersection && t.intersection), (this.features_ = t.features ? t.features : null), (this.featuresListenerKeys_ = []), (this.featureChangeListenerKeys_ = {}), (this.indexedFeaturesExtents_ = {}), (this.pendingFeatures_ = {}), (this.pixelTolerance_ = void 0 !== t.pixelTolerance ? t.pixelTolerance : 10), (this.rBush_ = new lf()), (this.snapped_ = null), (this.segmenters_ = Object.assign({}, Qx, t.segmenters));
			}
			addFeature(t, e) {
				e = void 0 === e || e;
				const i = In(t),
					n = t.getGeometry();
				if (n) {
					const e = this.segmenters_[n.getType()];
					if (e) {
						this.indexedFeaturesExtents_[i] = n.getExtent([1 / 0, 1 / 0, -1 / 0, -1 / 0]);
						const r = e(n, this.getMap().getView().getProjection());
						let s = r.length;
						for (let e = 0; e < s; ++e) {
							const i = r[e];
							(iv[e] = Gr(i)), (nv[e] = { feature: t, segment: i });
						}
						if (((iv.length = s), (nv.length = s), this.intersection_))
							for (let e = 0, i = r.length; e < i; ++e) {
								const i = r[e];
								if (1 === i.length) continue;
								const n = iv[e];
								for (let o = 0, a = r.length; o < a; ++o) {
									if (e === o || e - 1 === o || e + 1 === o) continue;
									const a = r[o];
									if (!ms(n, iv[o])) continue;
									const l = el(i, a);
									if (!l) continue;
									const h = [l];
									(iv[s] = Gr(h)), (nv[s++] = { feature: t, segment: h, isIntersection: !0 });
								}
								const o = this.rBush_.getInExtent(iv[e]);
								for (const { segment: e } of o) {
									if (1 === e.length) continue;
									const n = el(i, e);
									if (!n) continue;
									const r = [n];
									(iv[s] = Gr(r)), (nv[s++] = { feature: t, segment: r, isIntersection: !0 });
								}
							}
						1 === s ? this.rBush_.insert(iv[0], nv[0]) : this.rBush_.load(iv, nv);
					}
				}
				e && (this.featureChangeListenerKeys_[i] = Sn(t, qi, this.handleFeatureChange_, this));
			}
			getFeatures_() {
				let t;
			...
			handleEvent(t) {
				...
				return e ? ((t.coordinate = e.vertex.slice(0, 2)), (t.pixel = e.vertexPixel), this.snapped_ && !this.areSnapDataEqual_(this.snapped_, e) && this.dispatchEvent(new Jx(Hx, this.snapped_)), (this.snapped_ = { vertex: t.coordinate, vertexPixel: t.pixel, feature: e.feature, segment: e.segment }), this.dispatchEvent(new Jx(Yx, this.snapped_))) : this.snapped_ && (this.dispatchEvent(new Jx(Hx, this.snapped_)), (this.snapped_ = null)), super.handleEvent(t);
			}
			handleFeatureAdd_(t) {
				const e = tv(t);
				e && this.addFeature(e);
			...
			handleUpEvent(t) {
				...
				if (e.length) for (const t of e) this.updateFeature_(t);
				return !1;
			}
			removeFeature(t, e) {
				const i = void 0 === e || e,
				...
				i && (En(this.featureChangeListenerKeys_[n]), delete this.featureChangeListenerKeys_[n]);
			}
			setMap(t) {
				const e = this.getMap(),
					i = this.featuresListenerKeys_;
				let n = this.getFeatures_();
				if ((Array.isArray(n) || (n = n.getArray()), e && (i.forEach(En), (i.length = 0), this.rBush_.clear(), Object.values(this.featureChangeListenerKeys_).forEach(En), (this.featureChangeListenerKeys_ = {})), super.setMap(t), t)) {
					this.features_ ? i.push(Sn(this.features_, Vi, this.handleFeatureAdd_, this), Sn(this.features_, Wi, this.handleFeatureRemove_, this)) : this.source_ && i.push(Sn(this.source_, uf, this.handleFeatureAdd_, this), Sn(this.source_, ff, this.handleFeatureRemove_, this));
					for (const t of n) this.addFeature(t);
				}
			}
			snapTo(t, e, i) {
				const n = i.getView().getProjection(),
					r = ia(e, n),
					s = na(jr(Gr([r]), i.getView().getResolution() * this.pixelTolerance_), n),
					o = this.rBush_.getInExtent(s),
					a = o.length;
				if (0 === a) return null;
				let l,
					...
					u = 1 / 0,
					d = null;
				const g = this.pixelTolerance_ * this.pixelTolerance_,
					f = () => {
						if (l) {
							const e = i.getPixelFromCoordinate(l);
							if (Ts(t, e) <= g && ((c && this.intersection_) || (!c && (this.vertex_ || this.edge_)))) return { vertex: l, vertexPixel: [Math.round(e[0]), Math.round(e[1])], feature: h, segment: d };
						}
						return null;
					};
				if (this.vertex_ || this.intersection_) {
					for (let t = 0; t < a; ++t) {
						const e = o[t];
						if ('Circle' !== e.feature.getGeometry().getType())
							for (const t of e.segment) {
								const i = Ts(r, ia(t, n));
								i < u && ((l = t), (u = i), (h = e.feature), (c = e.isIntersection));
							}
					}
					const t = f();
					if (t) return t;
				...
				if (this.edge_) {
					for (let t = 0; t < a; ++t) {
						...
						if ('Circle' === i.feature.getGeometry().getType()) {
							...
							const s = ta();
							s && (t = t.clone().transform(s, n)), (e = bs(r, t));
						} else {
							const [t, s] = i.segment;
							s && ((ev[0] = ia(t, n)), (ev[1] = ia(s, n)), (e = Ss(r, ev)));
						}
						if (e) {
							const t = Ts(r, e);
							t < u && ((l = ea(e, n)), (d = 'Circle' === i.feature.getGeometry().getType() ? null : i.segment), (u = t), (h = i.feature));
						}
					}
					const t = f();
					if (t) return t;
		...
		Translate: class extends hh {
			constructor(t) {
				...
				(this.layerFilter_ = e), (this.filter_ = t.filter && !this.features_ ? t.filter : fn), (this.hitTolerance_ = t.hitTolerance ? t.hitTolerance : 0), (this.condition_ = t.condition ? t.condition : th), (this.lastFeature_ = null), this.addChangeListener(ql, this.handleActiveChanged_);
			}
			handleDownEvent(t) {
				...
				if (((this.lastFeature_ = this.featuresAtPixel_(t.pixel, t.map)), !this.lastCoordinate_ && this.lastFeature_)) {
					...
					const e = this.features_ || new On([this.lastFeature_]);
					return this.dispatchEvent(new av(rv, e, t.coordinate, this.startCoordinate_, t)), !0;
				}
				return !1;
			}
			handleUpEvent(t) {
				if (this.lastCoordinate_) {
					...
					const e = this.features_ || new On([this.lastFeature_]);
					return this.dispatchEvent(new av(ov, e, t.coordinate, this.startCoordinate_, t)), (this.startCoordinate_ = null), !0;
				}
				return !1;
			}
			handleDragEvent(t) {
				if (this.lastCoordinate_) {
					const e = t.coordinate,
						...
						n = ia(e, i),
						r = ia(this.lastCoordinate_, i),
						s = n[0] - r[0],
						o = n[1] - r[1],
						a = this.features_ || new On([this.lastFeature_]),
						l = ta();
					a.forEach(function (t) {
						...
						this.dispatchEvent(new av(sv, a, e, this.startCoordinate_, t));
				}
			}
			handleMoveEvent(t) {
			...
			featuresAtPixel_(t, e) {
				return e.forEachFeatureAtPixel(
					t,
					(t, e) => {
						if (t instanceof Dg && this.filter_(t, e) && (!this.features_ || this.features_.getArray().includes(t))) return t;
					},
					{ layerFilter: this.layerFilter_, hitTolerance: this.hitTolerance_ }
				);
			}
	...
	const hv = 'http://www.w3.org/2001/XMLSchema-instance';
	function cv(t, e) {
		return Fv().createElementNS(t, e);
	}
	function uv(t, e) {
		return dv(t, e, []).join('');
	}
	function dv(t, e, i) {
		if (t.nodeType == Node.CDATA_SECTION_NODE || t.nodeType == Node.TEXT_NODE) i.push(t.nodeValue);
		else {
			let n;
			for (n = t.firstChild; n; n = n.nextSibling) dv(n, e, i);
		}
		return i;
	}
	function gv(t) {
	...
	function _v(t, e) {
		return function (e, i) {
			const n = t.call(this, e, i);
			void 0 !== n && (i[i.length - 1] = n);
		};
	}
	function yv(t, e, i) {
		return function (i, n) {
			const r = t.call(this, i, n);
			if (void 0 !== r) {
				n[n.length - 1][void 0 !== e ? e : i.localName] = r;
			}
		};
	}
	function xv(t, e) {
	...
	function vv(t, e) {
		return function (e, i, n) {
			const r = i[i.length - 1].node;
			let s = t;
			void 0 === s && (s = n);
			return cv(r.namespaceURI, s);
		};
	}
	const wv = vv();
	function bv(t, e) {
	...
	function Ev(t, e, i, n, r) {
		return n.push(t), Cv(e, i, n, r), n.pop();
	}
	function Tv(t, e, i, n, r, s, o) {
		return (
			r.push(t),
			(function (t, e, i, n, r, s) {
				const o = (void 0 !== r ? r : i).length;
				let a, l;
				for (let h = 0; h < o; ++h) (a = i[h]), void 0 !== a && ((l = e.call(s, a, n, void 0 !== r ? r[h] : void 0)), void 0 !== l && t[l.namespaceURI][l.localName].call(s, l, a, n));
			})(e, i, n, r, s, o),
			r.pop()
		);
	}
	let Pv, Rv;
	function Fv() {
		return void 0 === Rv && 'undefined' != typeof document && (Rv = document.implementation.createDocument('', '', null)), Rv;
	}
	class Mv extends Rm {
		constructor() {
			super(), (this.xmlSerializer_ = (void 0 === Pv && 'undefined' != typeof XMLSerializer && (Pv = new XMLSerializer()), Pv));
		}
		getType() {
			return 'xml';
		}
		readFeature(t, e) {
			...
			return gv(t) ? this.readFeatureFromDocument(t, e) : this.readFeatureFromNode(t, e);
		}
		...
		readFeatures(t, e) {
			...
			return gv(t) ? this.readFeaturesFromDocument(t, e) : this.readFeaturesFromNode(t, e);
		}
		readFeaturesFromDocument(t, e) {
			const i = [];
			for (let n = t.firstChild; n; n = n.nextSibling) n.nodeType == Node.ELEMENT_NODE && dn(i, this.readFeaturesFromNode(n, e));
			return i;
		}
		...
		readGeometry(t, e) {
			...
			return gv(t) ? this.readGeometryFromDocument(t, e) : this.readGeometryFromNode(t, e);
		}
		...
		readProjection(t) {
			...
			return gv(t) ? this.readProjectionFromDocument(t) : this.readProjectionFromNode(t);
		}
	...
	function Dv(t, e) {
		...
		t.appendChild(Fv().createTextNode(i));
	}
	const Ov = /^\s/,
		zv = /\s$/,
		Nv = /(\n|\t|\r|<|&| {2})/;
	function Gv(t, e) {
		'string' == typeof e && (Ov.test(e) || zv.test(e) || Nv.test(e))
			? e.split(']]>').forEach((e, i, n) => {
					i < n.length - 1 && (e += ']]'),
						i > 0 && (e = '>' + e),
						(function (t, e) {
							t.appendChild(Fv().createCDATASection(e));
						})(t, e);
			  })
			: t.appendChild(Fv().createTextNode(e));
	}
	const jv = ['http://www.google.com/kml/ext/2.2'],
		$v = [null, 'http://earth.google.com/kml/2.0', 'http://earth.google.com/kml/2.1', 'http://earth.google.com/kml/2.2', 'http://www.opengis.net/kml/2.2'],
		Bv = { fraction: 'fraction', pixels: 'pixels', insetPixels: 'pixels' },
		Uv = Sv(
			$v,
			{
				ExtendedData: Xw,
				Region: qw,
				MultiGeometry: yv(zw, 'geometry'),
				LineString: yv(Aw, 'geometry'),
				LinearRing: yv(Dw, 'geometry'),
				Point: yv(Nw, 'geometry'),
				Polygon: yv(jw, 'geometry'),
				Style: yv(Bw),
				StyleMap: function (t, e) {
					const i = vw.call(this, t, e);
					if (!i) return;
			...
			Sv(jv, {
				MultiTrack: yv(function (t, e) {
					const i = Ev([], Pw, t, e);
					if (!i) return;
					return new Vg(i);
				}, 'geometry'),
				Track: yv(Fw, 'geometry'),
			})
		),
		Vv = Sv($v, {
			ExtendedData: Xw,
		...
		Wv = Sv($v, { href: yv(mw) }),
		Xv = Sv($v, { Altitude: yv(kv), Longitude: yv(kv), Latitude: yv(kv), Tilt: yv(kv), AltitudeMode: yv(Lv), Heading: yv(kv), Roll: yv(kv) }),
		qv = Sv($v, {
		...
		Zv = Sv($v, ['Document', 'Placemark']),
		Kv = Sv($v, {
			Document: xv(function (t, e, i) {
				Tv({ node: t }, ib, nb, e, i, void 0, this);
			}),
			Placemark: xv(Pb),
		});
	let Yv,
	...
	function gw(t, e, i) {
		return Array.isArray(t) ? t : 'string' == typeof t ? gw(i[t], e, i) : e;
	}
	function fw(t) {
		const e = uv(t, !1),
	...
	function vw(t, e) {
		return Ev(void 0, xw, t, e, this);
	}
	const ww = Sv($v, {
		Icon: yv(function (t, e) {
			const i = Ev({}, Mw, t, e);
			if (i) return i;
			return null;
		}),
		color: yv(fw),
		heading: yv(kv),
		hotSpot: yv(function (t) {
			const e = t.getAttribute('xunits'),
				i = t.getAttribute('yunits');
			let n;
			return (n = 'insetPixels' !== e ? ('insetPixels' !== i ? 'bottom-left' : 'top-left') : 'insetPixels' !== i ? 'bottom-right' : 'top-right'), { x: parseFloat(t.getAttribute('x')), xunits: Bv[e], y: parseFloat(t.getAttribute('y')), yunits: Bv[i], origin: n };
		}),
		scale: yv(yw),
	});
	const bw = Sv($v, { color: yv(fw), scale: yv(yw) });
	const Sw = Sv($v, { color: yv(fw), width: yv(kv) });
	const Cw = Sv($v, { color: yv(fw), fill: yv(Iv), outline: yv(Iv) });
	const Ew = Sv($v, { coordinates: _v(pw) });
	function Tw(t, e) {
		return Ev(null, Ew, t, e);
	}
	const Pw = Sv(jv, { Track: mv(Fw) });
	const Rw = Sv(
		$v,
		{
			when: function (t, e) {
	...
	function Fw(t, e) {
		const i = Ev({ coordinates: [], whens: [] }, Rw, t, e);
		if (!i) return;
		const n = [],
			r = i.coordinates,
			s = i.whens;
		for (let t = 0, e = Math.min(r.length, s.length); t < e; ++t) 3 == r[t].length && n.push(r[t][0], r[t][1], r[t][2], s[t]);
		return new Ug(n, 'XYZM');
	}
	const Mw = Sv($v, { href: yv(mw) }, Sv(jv, { x: yv(kv), y: yv(kv), w: yv(kv), h: yv(kv) }));
	const Iw = Sv($v, { coordinates: _v(pw) });
	function kw(t, e) {
		return Ev(null, Iw, t, e);
	}
	const Lw = Sv($v, { extrude: yv(Iv), tessellate: yv(Iv), altitudeMode: yv(Lv) });
	function Aw(t, e) {
		const i = Ev({}, Lw, t, e),
			n = kw(t, e);
		if (n) {
			const t = new Ug(n, 'XYZ');
	...
	function Dw(t, e) {
		const i = Ev({}, Lw, t, e),
			n = kw(t, e);
		if (n) {
			const t = new dl(n, 'XYZ', [n.length]);
			return t.setProperties(i, !0), t;
		}
	}
	const Ow = Sv($v, { LineString: mv(Aw), LinearRing: mv(Dw), MultiGeometry: mv(zw), Point: mv(Nw), Polygon: mv(jw) });
	function zw(t, e) {
		const i = Ev([], Ow, t, e);
		if (!i) return null;
		if (0 === i.length) return new jg(i);
		let n,
			r = !0;
		const s = i[0].getType();
		let o;
		...
		if (r) {
			...
			if ('Point' == s) {
				...
				for (let t = 1, n = i.length; t < n; ++t) (o = i[t]), dn(e, o.getFlatCoordinates());
				(n = new Wg(e, t)), Uw(n, i);
			} else if ('LineString' == s) (n = new Vg(i)), Uw(n, i);
			else if ('Polygon' == s) (n = new Xg(i)), Uw(n, i);
			else {
	...
	function jw(t, e) {
		...
		if (n && n[0]) {
			const t = n[0],
				e = [t.length];
			for (let i = 1, r = n.length; i < r; ++i) dn(t, n[i]), e.push(t.length);
			const r = new dl(t, 'XYZ', e);
	...
	const $w = Sv($v, {
		IconStyle: function (t, e) {
			...
			const d = i.hotSpot;
			let g;
			d ? ((l = [d.x, d.y]), (h = d.xunits), (c = d.yunits), (u = d.origin)) : /^https?:\/\/maps\.(?:google|gstatic)\.com\//.test(o) && (o.includes('pushpin') ? ((l = Hv), (h = Jv), (c = Qv)) : o.includes('arrow-reverse') ? ((l = [54, 42]), (h = Jv), (c = Qv)) : o.includes('paddle') && ((l = [32, 1]), (h = Jv), (c = Qv)));
			const f = r.x,
				p = r.y;
			let m;
			...
			if (s) {
				o == ew && (m = tw);
				const t = new Kd({ anchor: l, anchorOrigin: u, anchorXUnits: h, anchorYUnits: c, crossOrigin: this.crossOrigin_, offset: g, offsetOrigin: 'bottom-left', rotation: x, scale: w, size: m, src: this.iconUrlFunction_(o), color: b }),
					e = t.getScaleArray()[0],
					i = t.getSize();
				if (null === i) {
					...
					if (i === hd || i === cd) {
						...
						t.listenImageChange(n), i === hd && t.load();
					}
				} else if (2 == i.length) {
					const n = uw(i);
					t.setScale(e * n);
				...
				n.imageStyle = t;
			} else n.imageStyle = iw;
		},
		LabelStyle: function (t, e) {
			const i = Ev({}, bw, t, e);
			if (!i) return;
			const n = e[e.length - 1],
				r = new ig({ fill: new qd({ color: 'color' in i ? i.color : Yv }), scale: i.scale });
			n.textStyle = r;
		},
		LineStyle: function (t, e) {
			...
			if (!i) return;
			const n = e[e.length - 1],
				r = new Yd({ color: 'color' in i ? i.color : Yv, width: 'width' in i ? i.width : 1 });
			n.strokeStyle = r;
		},
		PolyStyle: function (t, e) {
			...
			if (!i) return;
			const n = e[e.length - 1],
				r = new qd({ color: 'color' in i ? i.color : Yv });
			n.fillStyle = r;
			const s = i.fill;
			void 0 !== s && (n.fill = s);
			const o = i.outline;
	...
	function Bw(t, e) {
		const i = Ev({}, $w, t, e, this);
		if (!i) return null;
		let n = 'fillStyle' in i ? i.fillStyle : sw;
		const r = i.fill;
		let s;
		void 0 === r || r || (n = null), 'imageStyle' in i ? i.imageStyle != iw && (s = i.imageStyle) : (s = ow);
		const o = 'textStyle' in i ? i.textStyle : lw,
			a = 'strokeStyle' in i ? i.strokeStyle : aw,
			l = i.outline;
		return void 0 === l || l
			? [new Hd({ fill: n, image: s, stroke: a, text: o, zIndex: void 0 })]
			: [
					new Hd({
						geometry: function (t) {
							const e = t.getGeometry(),
	...
	const Vw = Sv($v, { displayName: yv(Lv), value: yv(Lv) });
	const Ww = Sv($v, {
		Data: function (t, e) {
	...
	const Zw = Sv($v, { Style: yv(Bw), key: yv(Lv), styleUrl: yv(_w) });
	const Kw = Sv($v, {
	...
	const Yw = Sv($v, { altitudeMode: yv(Lv), minAltitude: yv(kv), maxAltitude: yv(kv), north: yv(kv), south: yv(kv), east: yv(kv), west: yv(kv) });
	const Hw = Sv($v, { minLodPixels: yv(kv), maxLodPixels: yv(kv), minFadeExtent: yv(kv), maxFadeExtent: yv(kv) });
	const Jw = Sv($v, { LinearRing: mv(Tw) });
	const Qw = Sv($v, { LinearRing: _v(Tw) });
	function tb(t, e) {
		const i = Dc(e),
	...
	const eb = Sv($v, {
		Data: xv(function (t, e, i) {
			t.setAttribute('name', e.name);
			const n = { node: t },
				r = e.value;
			'object' == typeof r ? (null !== r && r.displayName && Tv(n, eb, wv, [r.displayName], i, ['displayName']), null !== r && r.value && Tv(n, eb, wv, [r.value], i, ['value'])) : Tv(n, eb, wv, [r], i, ['value']);
		}),
		value: xv(function (t, e) {
			Gv(t, e);
		}),
		displayName: xv(function (t, e) {
			Gv(t, e);
		}),
	});
	const ib = Sv($v, { Placemark: xv(Pb) }),
		nb = function (t, e, i) {
			return cv(e[e.length - 1].node.namespaceURI, 'Placemark');
		};
	const rb = vv('Data');
	const sb = Sv($v, ['href'], Sv(jv, ['x', 'y', 'w', 'h'])),
		ob = Sv($v, { href: xv(Gv) }, Sv(jv, { x: xv(Dv), y: xv(Dv), w: xv(Dv), h: xv(Dv) })),
		ab = function (t, e, i) {
			return cv(jv[0], 'gx:' + i);
		};
	const lb = Sv($v, ['scale', 'heading', 'Icon', 'color', 'hotSpot']),
		hb = Sv($v, {
			Icon: xv(function (t, e, i) {
				const n = { node: t },
					r = i[i.length - 1].node;
				let s = sb[r.namespaceURI],
					o = bv(e, s);
				Tv(n, ob, wv, o, i, s), (s = sb[jv[0]]), (o = bv(e, s)), Tv(n, ob, ab, o, i, s);
			}),
			color: xv(tb),
			heading: xv(Dv),
			hotSpot: xv(function (t, e) {
				t.setAttribute('x', String(e.x)), t.setAttribute('y', String(e.y)), t.setAttribute('xunits', e.xunits), t.setAttribute('yunits', e.yunits);
			}),
			scale: xv(zb),
		});
	const cb = Sv($v, ['color', 'scale']),
		ub = Sv($v, { color: xv(tb), scale: xv(zb) });
	const db = Sv($v, ['color', 'width']),
		gb = Sv($v, { color: xv(tb), width: xv(Dv) });
	const fb = { Point: 'Point', LineString: 'LineString', LinearRing: 'LinearRing', Polygon: 'Polygon', MultiPoint: 'MultiGeometry', MultiLineString: 'MultiGeometry', MultiPolygon: 'MultiGeometry', GeometryCollection: 'MultiGeometry' },
		pb = function (t, e, i) {
			if (t) {
				return cv(e[e.length - 1].node.namespaceURI, fb[t.getType()]);
			}
		},
		mb = vv('Point'),
		_b = vv('LineString'),
		yb = vv('LinearRing'),
		xb = vv('Polygon'),
		vb = Sv($v, { LineString: xv(Mb), Point: xv(Mb), Polygon: xv(Db), GeometryCollection: xv(wb) });
	function wb(t, e, i) {
		const n = { node: t },
			r = e.getType();
		let s,
		...
		if ('GeometryCollection' === r)
			e.getGeometriesArrayRecursive().forEach(function (t) {
				...
				(s = pb);
		else if ('MultiPoint' === r) (o = e.getPoints()), (s = mb);
		else if ('MultiLineString' === r) (o = e.getLineStrings()), (s = _b);
		else {
			if ('MultiPolygon' !== r) throw new Error('Unknown geometry type');
			(o = e.getPolygons()), (s = xb);
		}
		Tv(n, vb, s, o, i);
	}
	const bb = Sv($v, { LinearRing: xv(Mb) });
	function Sb(t, e, i) {
		Tv({ node: t }, bb, yb, [e], i);
	}
	const Cb = Sv($v, {
			ExtendedData: xv(function (t, e, i) {
				const n = { node: t },
					r = e.names,
					s = e.values,
					o = r.length;
				for (let t = 0; t < o; t++) Tv(n, eb, rb, [{ name: r[t], value: s[t] }], i);
			}),
			MultiGeometry: xv(wb),
			LineString: xv(Mb),
			LinearRing: xv(Mb),
		...
		Eb = Sv($v, ['name', 'open', 'visibility', 'address', 'phoneNumber', 'description', 'styleUrl', 'Style']),
		Tb = vv('ExtendedData');
	function Pb(t, e, i) {
		const n = { node: t };
		...
		const l = i[i.length - 1].node,
			h = Eb[l.namespaceURI],
			c = bv(r, h);
		if ((Tv(n, Cb, wv, c, i, h), o.length > 0)) {
			const t = bv(r, o);
			Tv(n, Cb, Tb, [{ names: o, values: t }], i);
		}
		const u = i[0];
		let d = e.getGeometry();
		d && (d = Fm(d, !0, u)), Tv(n, Cb, pb, [d], i);
	}
	const Rb = Sv($v, ['extrude', 'tessellate', 'altitudeMode', 'coordinates']),
		Fb = Sv($v, {
			extrude: xv(Av),
			tessellate: xv(Av),
			altitudeMode: xv(Gv),
			coordinates: xv(function (t, e, i) {
	...
	const Ib = Sv($v, ['color', 'fill', 'outline']),
		kb = Sv($v, { outerBoundaryIs: xv(Sb), innerBoundaryIs: xv(Sb) }),
		Lb = vv('innerBoundaryIs'),
		Ab = vv('outerBoundaryIs');
	function Db(t, e, i) {
		const n = e.getLinearRings(),
			r = n.shift(),
			s = { node: t };
		Tv(s, kb, Lb, n, i), Tv(s, kb, Ab, [r], i);
	}
	const Ob = Sv($v, { color: xv(tb), fill: xv(Av), outline: xv(Av) });
	function zb(t, e) {
		Dv(t, Math.round(1e6 * e) / 1e6);
	}
	const Nb = Sv($v, ['IconStyle', 'LabelStyle', 'LineStyle', 'PolyStyle']),
		Gb = Sv($v, {
			IconStyle: xv(function (t, e, i) {
				const n = { node: t },
					r = {},
					s = e.getSrc(),
					o = e.getSize(),
	...
	const $b = 34962,
		Bb = 34963,
		Ub = 35048,
		Vb = ['experimental-webgl', 'webgl', 'webkit-3d', 'moz-webgl'];
	const Wb = 35044;
	class Xb {
		constructor(t, e) {
			(this.array_ = null), (this.type_ = t), dr(t === $b || t === Bb, 'A `WebGLArrayBuffer` must either be of type `ELEMENT_ARRAY_BUFFER` or `ARRAY_BUFFER`'), (this.usage_ = void 0 !== e ? e : Wb);
		}
		ofSize(t) {
			return (this.array_ = new (qb(this.type_))(t)), this;
		}
		fromArray(t) {
			return (this.array_ = qb(this.type_).from(t)), this;
		}
		fromArrayBuffer(t) {
			return (this.array_ = new (qb(this.type_))(t)), this;
		}
	...
	var Zb = 'webglcontextlost',
		Kb = 'webglcontextrestored';
	class Yb {
		constructor(t) {
	...
	const Hb = { PROJECTION_MATRIX: 'u_projectionMatrix', SCREEN_TO_WORLD_MATRIX: 'u_screenToWorldMatrix', TIME: 'u_time', ZOOM: 'u_zoom', RESOLUTION: 'u_resolution', ROTATION: 'u_rotation', VIEWPORT_SIZE_PX: 'u_viewportSizePx', PIXEL_RATIO: 'u_pixelRatio', HIT_DETECTION: 'u_hitDetection' },
		Jb = 5121,
		Qb = 5123,
		tS = 5125,
		eS = 5126,
	...
	function sS(t) {
		...
		if (!e) {
			...
			const n = (function (t, e) {
				e = Object.assign({ preserveDrawingBuffer: !0, antialias: !$n }, e);
				const i = Vb.length;
				for (let n = 0; n < i; ++n)
					try {
						const i = t.getContext(Vb[n], e);
						if (i) return i;
					} catch {}
				return null;
			})(i);
			(e = { users: 0, context: n }), (iS[t] = e);
		}
	...
	class oS extends an {
		constructor(t) {
			super(),
				...
				(this.gl_ = sS(this.canvasCacheKey_)),
				(this.bufferCache_ = {}),
				(this.extensionCache_ = {}),
				(this.currentProgram_ = null),
				(this.needsToBeRecreated_ = !1);
			const e = this.gl_.canvas;
			e.addEventListener(Zb, this.boundHandleWebGLContextLost_),
				e.addEventListener(Kb, this.boundHandleWebGLContextRestored_),
				...
				(this.postProcessPasses_ = t.postProcesses ? t.postProcesses.map((t) => new Yb({ webGlContext: this.gl_, scaleRatio: t.scaleRatio, vertexShader: t.vertexShader, fragmentShader: t.fragmentShader, uniforms: t.uniforms })) : [new Yb({ webGlContext: this.gl_ })]),
		...
		canvasCacheKeyMatches(t) {
			return this.canvasCacheKey_ === nS(t);
		}
		getExtension(t) {
		...
		disposeInternal() {
			...
			t.removeEventListener(Zb, this.boundHandleWebGLContextLost_),
				t.removeEventListener(Kb, this.boundHandleWebGLContextRestored_),
				(function (t) {
					const e = iS[t];
					if (!e) return;
					...
					n && n.loseContext();
					const r = i.canvas;
					(r.width = 1), (r.height = 1), delete iS[t];
		...
		bindAttribute(t, e, i) {
			...
			n.enableVertexAttribArray(r), n.vertexAttribPointer(r, i, n.FLOAT, !1, 0, 0);
		}
		...
		applyFrameState(t) {
			const e = t.size,
				...
				n = t.pixelRatio;
			this.setUniformFloatValue(Hb.TIME, 0.001 * (Date.now() - this.startTime_)), this.setUniformFloatValue(Hb.ZOOM, t.viewState.zoom), this.setUniformFloatValue(Hb.RESOLUTION, t.viewState.resolution), this.setUniformFloatValue(Hb.PIXEL_RATIO, n), this.setUniformFloatVec2(Hb.VIEWPORT_SIZE_PX, [e[0], e[1]]), this.setUniformFloatValue(Hb.ROTATION, i);
		}
		applyHitDetectionUniform(t) {
			const e = this.getUniformLocation(Hb.HIT_DETECTION);
			this.getGL().uniform1i(e, t ? 1 : 0), t && this.setUniformFloatValue(Hb.PIXEL_RATIO, 0.5);
		}
		applyUniforms(t) {
			const e = this.gl_;
			let i,
			...
			this.uniforms_.forEach((r) => {
				if (((i = 'function' == typeof r.value ? r.value(t) : r.value), i instanceof HTMLCanvasElement || i instanceof HTMLImageElement || i instanceof ImageData || i instanceof WebGLTexture)) {
					i instanceof WebGLTexture && !r.texture ? ((r.prevValue = void 0), (r.texture = i)) : r.texture || ((r.prevValue = void 0), (r.texture = e.createTexture())), this.bindTexture(r.texture, n, r.name), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, e.LINEAR), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE);
					const t = !(i instanceof HTMLImageElement) || i.complete;
					i instanceof WebGLTexture || !t || r.prevValue === i || ((r.prevValue = i), e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, e.RGBA, e.UNSIGNED_BYTE, i)), n++;
				} else if (Array.isArray(i) && 6 === i.length) this.setUniformMatrixValue(r.name, jb(this.tmpMat4_, i));
		...
		getUniformLocation(t) {
			const e = In(this.currentProgram_);
		...
		makeProjectionTransform(t, e) {
			...
			return ma(e, 0, 0, 2 / (r * i[0]), 2 / (r * i[1]), -n, -s[0], -s[1]), e;
		}
		...
		disableAllAttributes_() {
			for (let t = 0; t < this.maxAttributeCount_; t++) this.gl_.disableVertexAttribArray(t);
		}
		...
		enableAttributes(t) {
			...
			for (let n = 0; n < t.length; n++) {
				const r = t[n];
				this.enableAttributeArray_(r.name, r.size, r.type || 5126, e, i), (i += r.size * aS(r.type));
			}
		}
		handleWebGLContextLost(t) {
			xn(this.bufferCache_), (this.currentProgram_ = null), t.preventDefault();
		}
		...
		createTexture(t, e, i, n) {
			const r = this.gl_;
			i = i || r.createTexture();
			const s = n ? r.NEAREST : r.LINEAR;
			r.bindTexture(r.TEXTURE_2D, i), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER, s), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MAG_FILTER, s), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S, r.CLAMP_TO_EDGE), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T, r.CLAMP_TO_EDGE);
			const o = r.RGBA,
				a = r.RGBA,
				l = r.UNSIGNED_BYTE;
			return e instanceof Uint8Array ? r.texImage2D(r.TEXTURE_2D, 0, o, t[0], t[1], 0, a, l, e) : e ? r.texImage2D(r.TEXTURE_2D, 0, o, a, l, e) : r.texImage2D(r.TEXTURE_2D, 0, o, t[0], t[1], 0, a, l, null), i;
		}
	}
	function aS(t) {
		switch (t) {
	...
	class lS extends up {
		constructor(t, e) {
			super(t),
				...
				t.addChangeListener(jh, this.onMapChanged_),
		...
		prepareFrame(t) {
			if (this.getLayer().getRenderSource()) {
				...
				(this.helper && this.helper.canvasCacheKeyMatches(r) && !this.helper.needsToBeRecreated()) || (this.removeHelper(), (this.helper = new oS({ postProcesses: this.postProcesses_, uniforms: this.uniforms_, canvasCacheKey: r })), e && (this.helper.getCanvas().className = e), this.afterHelperCreated());
			}
		...
		clearCache() {}
		disposeInternal() {
			this.clearCache(), this.removeHelper(), this.getLayer()?.removeChangeListener(jh, this.onMapChanged_), super.disposeInternal();
		}
		dispatchRenderEvent_(t, e, i) {
			const n = this.getLayer();
			if (n.hasListener(t)) {
				ma(this.inversePixelTransform_, 0, 0, i.pixelRatio, -i.pixelRatio, 0, 0, -i.size[1]);
				const r = new Rg(t, this.inversePixelTransform_, i, e);
				n.dispatchEvent(r);
			}
		}
		preRender(t, e) {
			this.dispatchRenderEvent_(Xh, t, e);
		}
		postRender(t, e) {
			this.dispatchRenderEvent_(qh, t, e);
		}
	}
	const hS = 'u_tileTextures',
		cS = 'u_texturePixelWidth',
		uS = 'u_texturePixelHeight';
	class dS {
		constructor(t, e) {
	...
	function fS(t) {
		...
		return `vec${t.length}(${t.map(gS).join(', ')})`;
	}
	function pS(t) {
		const e = Dc(t),
			i = e.length > 3 ? e[3] : 1;
		return fS([e[0] / 255, e[1] / 255, e[2] / 255, i]);
	}
	const mS = {};
	let _S = 0;
	function yS(t) {
		return t in mS || (mS[t] = _S++), mS[t];
	}
	function xS(t) {
		return gS(yS(t));
	}
	...
	function ES(t) {
		return (e, i, n) => {
			const r = i.args.length,
				s = new Array(r);
			for (let t = 0; t < r; ++t) s[t] = PS(i.args[t], n, e);
			return t(s, e);
		};
	}
	const TS = {
		[iu]: (t, e) => {
			...
			return i in t.properties || (t.properties[i] = { name: i, type: e.type }), 'a_prop_' + i;
		},
		[Vu]: (t) => ((t.featureId = !0), 'a_' + bS),
		[su]: (t) => ((t.geometryType = !0), 'a_' + SS),
		[ou]: () => 'currentLineMetric',
		[nu]: (t, e) => {
			const i = e.args[0].value;
			return i in t.variables || (t.variables[i] = { name: i, type: e.type }), vS(i);
		},
		[Zu]: (t, e) => {
			const i = e.args[0].value;
			return i in t.properties || (t.properties[i] = { name: i, type: e.type }), `(a_prop_${i} != ${gS(CS)})`;
		},
		[cu]: () => 'u_resolution',
		[uu]: () => 'u_zoom',
		[du]: () => 'u_time',
		...
		[Mu]: ES(([t]) => `sin(${t})`),
		[Iu]: ES(([t]) => `cos(${t})`),
		[ku]: ES(([t, e]) => (void 0 !== e ? `atan(${t}, ${e})` : `atan(${t})`)),
		[Lu]: ES(([t]) => `sqrt(${t})`),
		[Au]: ES((t) => {
			const e = t[0],
				i = t[t.length - 1];
		...
		[Ou]: ES(([t, e, ...i]) => {
			...
			for (let r = 0; r < i.length - 2; r += 2) {
				const s = i[r],
					...
					l = i[r + 3];
				let h;
				(h = t === gS(1) ? `(${e} - ${s}) / (${a} - ${s})` : `(pow(${t}, (${e} - ${s})) - 1.0) / (pow(${t}, (${a} - ${s})) - 1.0)`), (n = `mix(${o}, ${l}, clamp(${h}, 0.0, 1.0))`);
			}
			return n;
		}),
		[Nu]: ES((t) => {
		...
		[Wu]: ES(([t, e, i], n) => {
			if (!(wS in n.functions)) {
				...
				for (let i = 0; i < e; i++) {
					...
					let r = i % 4;
					i === e - 1 && 1 === r && (r = 3);
					t += `  if (band == ${i + 1}.0) {\n    return texture2D(${`${hS}[${n}]`}, v_textureCoord + vec2(dx, dy))[${r}];\n  }\n`;
				}
				n.functions[wS] = `float getBandValue(float band, float xOffset, float yOffset) {\n  float dx = xOffset / ${cS};\n  float dy = yOffset / ${uS};\n${t}\n}`;
			}
			return `${wS}(${t}, ${e ?? '0.0'}, ${i ?? '0.0'})`;
		}),
		[Xu]: (t, e) => {
			const [i, ...n] = e.args,
				r = n.length,
			...
			return `texture2D(${o}, vec2((${PS(i, $c, t)} + 0.5) / ${r}.0, 0.5))`;
		},
	};
	function PS(t, e, i) {
		if (t instanceof Qc) {
			const n = TS[t.operator];
			if (void 0 === n) throw new Error(`No compiler defined for this operator: ${JSON.stringify(t.operator)}`);
			return n(i, t, e);
		}
		if ((t.type & $c) > 0) return gS(t.value);
		if ((t.type & jc) > 0) return t.value.toString();
		if ((t.type & Bc) > 0) return xS(t.value.toString());
		if ((t.type & Uc) > 0) return pS(t.value);
		if ((t.type & Vc) > 0) return fS(t.value);
		if ((t.type & Wc) > 0) return fS(Nc(t.value));
		throw new Error(`Unexpected expression ${t.value} (expected type ${Kc(e)})`);
	}
	const RS = '#ifdef GL_FRAGMENT_PRECISION_HIGH\nprecision highp float;\n#else\nprecision mediump float;\n#endif\nuniform mat4 u_projectionMatrix;\nuniform mat4 u_screenToWorldMatrix;\nuniform vec2 u_viewportSizePx;\nuniform float u_pixelRatio;\nuniform float u_globalAlpha;\nuniform float u_time;\nuniform float u_zoom;\nuniform float u_resolution;\nuniform float u_rotation;\nuniform vec4 u_renderExtent;\nuniform vec2 u_patternOrigin;\nuniform float u_depth;\nuniform mediump int u_hitDetection;\n\nconst float PI = 3.141592653589793238;\nconst float TWO_PI = 2.0 * PI;\nfloat currentLineMetric = 0.; // an actual value will be used in the stroke shaders\n',
		FS = { 'fill-color': 'rgba(255,255,255,0.4)', 'stroke-color': '#3399CC', 'stroke-width': 1.25, 'circle-radius': 5, 'circle-fill-color': 'rgba(255,255,255,0.4)', 'circle-stroke-width': 1.25, 'circle-stroke-color': '#3399CC' };
	class MS {
		constructor() {
			(this.uniforms_ = []),
				(this.attributes_ = []),
				(this.hasSymbol_ = !1),
				(this.symbolSizeExpression_ = `vec2(${gS(FS['circle-radius'])} + ${gS(0.5 * FS['circle-stroke-width'])})`),
				(this.symbolRotationExpression_ = '0.0'),
				(this.symbolOffsetExpression_ = 'vec2(0.0)'),
				(this.symbolColorExpression_ = pS(FS['circle-fill-color'])),
				(this.texCoordExpression_ = 'vec4(0.0, 0.0, 1.0, 1.0)'),
				(this.discardExpression_ = 'false'),
				(this.symbolRotateWithView_ = !1),
				(this.hasStroke_ = !1),
				(this.strokeWidthExpression_ = gS(FS['stroke-width'])),
				(this.strokeColorExpression_ = pS(FS['stroke-color'])),
				(this.strokeOffsetExpression_ = '0.'),
				(this.strokeCapExpression_ = xS('round')),
				(this.strokeJoinExpression_ = xS('round')),
				(this.strokeMiterLimitExpression_ = '10.'),
				(this.strokeDistanceFieldExpression_ = '-1000.'),
				(this.hasFill_ = !1),
				(this.fillColorExpression_ = pS(FS['fill-color'])),
				(this.vertexShaderFunctions_ = []),
				(this.fragmentShaderFunctions_ = []);
		}
		addUniform(t, e) {
			return this.uniforms_.push({ name: t, type: e }), this;
		}
		addAttribute(t, e, i, n) {
			return this.attributes_.push({ name: t, type: e, varyingName: t.replace(/^a_/, 'v_'), varyingType: n ?? e, varyingExpression: i ?? t }), this;
		}
		...
		addVertexShaderFunction(t) {
			return this.vertexShaderFunctions_.includes(t) || this.vertexShaderFunctions_.push(t), this;
		}
		addFragmentShaderFunction(t) {
			return this.fragmentShaderFunctions_.includes(t) || this.fragmentShaderFunctions_.push(t), this;
		}
		getSymbolVertexShader() {
			return this.hasSymbol_
				? `${RS}\n${this.uniforms_.map((t) => `uniform ${t.type} ${t.name};`).join('\n')}\nattribute vec2 a_position;\nattribute float a_index;\nattribute vec4 a_hitColor;\n\nvarying vec2 v_texCoord;\nvarying vec2 v_quadCoord;\nvarying vec4 v_hitColor;\nvarying vec2 v_centerPx;\nvarying float v_angle;\nvarying vec2 v_quadSizePx;\n\n${this.attributes_.map((t) => `attribute ${t.type} ${t.name};\nvarying ${t.varyingType} ${t.varyingName};`).join('\n')}\n${this.vertexShaderFunctions_.join('\n')}\nvec2 pxToScreen(vec2 coordPx) {\n  vec2 scaled = coordPx / u_viewportSizePx / 0.5;\n  return scaled;\n}\n\nvec2 screenToPx(vec2 coordScreen) {\n  return (coordScreen * 0.5 + 0.5) * u_viewportSizePx;\n}\n\nvoid main(void) {\n  v_quadSizePx = ${
						...
						this.symbolRotateWithView_ ? ' + u_rotation' : ''
		...
		getStrokeVertexShader() {
			return this.hasStroke_
				? `${RS}\n${this.uniforms_.map((t) => `uniform ${t.type} ${t.name};`).join('\n')}\nattribute vec2 a_segmentStart;\nattribute vec2 a_segmentEnd;\nattribute float a_measureStart;\nattribute float a_measureEnd;\nattribute float a_parameters;\nattribute float a_distance;\nattribute vec2 a_joinAngles;\nattribute vec4 a_hitColor;\n\nvarying vec2 v_segmentStart;\nvarying vec2 v_segmentEnd;\nvarying float v_angleStart;\nvarying float v_angleEnd;\nvarying float v_width;\nvarying vec4 v_hitColor;\nvarying float v_distanceOffsetPx;\nvarying float v_measureStart;\nvarying float v_measureEnd;\n\n${this.attributes_
						...
						.map((t) => `  ${t.varyingName} = ${t.varyingExpression};`)
						.join('\n')}\n}`
				: null;
		}
	...
	function DS(t, e) {
		for (const i in e.variables) {
			const n = e.variables[i],
				r = vS(n.name);
			let s = AS(n.type);
			n.type === Uc && (s = 'vec4'), t.addUniform(r, s);
		}
		for (const i in e.properties) {
			const n = e.properties[i],
				r = AS(n.type),
				s = `a_prop_${n.name}`;
			n.type === Uc ? (t.addAttribute(s, r, `unpackColor(${s})`, 'vec4'), t.addVertexShaderFunction('vec4 unpackColor(vec2 packedColor) {\n  return vec4(\n    fract(floor(packedColor[0] / 256.0) / 256.0),\n    fract(packedColor[0] / 256.0),\n    fract(floor(packedColor[1] / 256.0) / 256.0),\n    fract(packedColor[1] / 256.0)\n  );\n}')) : t.addAttribute(s, r);
		}
		for (const i in e.functions) t.addVertexShaderFunction(e.functions[i]), t.addFragmentShaderFunction(e.functions[i]);
	}
	function OS(t, e) {
		const i = {};
		for (const n in t.variables) {
		...
		for (const i in t.properties) {
			const n = t.properties[i],
				r = (t) => {
					...
					return n.type === Uc ? kS([...Dc(e || '#eee')]) : 'string' == typeof e ? yS(e) : 'boolean' == typeof e ? (e ? 1 : 0) : e;
				};
			e[`prop_${n.name}`] = { size: LS(n.type), callback: r };
		}
		return e;
	}
	class NS {
		constructor() {
			(this.globalCounter_ = 0), (this.refToFeature_ = new Map()), (this.uidToRef_ = new Map()), (this.freeGlobalRef_ = []), (this.polygonBatch = { entries: {}, geometriesCount: 0, verticesCount: 0, ringsCount: 0 }), (this.pointBatch = { entries: {}, geometriesCount: 0 }), (this.lineStringBatch = { entries: {}, geometriesCount: 0, verticesCount: 0 });
		}
		addFeatures(t, e) {
		...
		clearFeatureEntryInLineStringBatch_(t) {
			const e = In(t),
				i = this.lineStringBatch.entries[e];
		...
		addGeometry_(t, e) {
			...
			switch (i) {
				case 'GeometryCollection': {
					...
					for (const t of i) this.addGeometry_(t, e);
					break;
				}
				case 'MultiPolygon': {
					const n = t;
					this.addCoordinates_(i, n.getFlatCoordinates(), n.getEndss(), e, In(e), n.getStride());
					break;
				}
				case 'MultiLineString': {
					const n = t;
					this.addCoordinates_(i, n.getFlatCoordinates(), n.getEnds(), e, In(e), n.getStride());
					break;
				}
				case 'MultiPoint': {
					const n = t;
					this.addCoordinates_(i, n.getFlatCoordinates(), null, e, In(e), n.getStride());
					break;
				}
				case 'Polygon': {
					const n = t;
				...
				case 'LinearRing': {
					const n = t,
						r = n.getStride();
					this.addCoordinates_(i, n.getFlatCoordinates(), null, e, In(e), r, n.getLayout?.());
					break;
				}
			}
		}
		addCoordinates_(t, e, i, n, r, s, o) {
			let a;
			switch (t) {
				case 'MultiPolygon': {
					const t = i;
					for (let i = 0, a = t.length; i < a; i++) {
						let a = t[i];
						const l = i > 0 ? t[i - 1] : null,
							h = l ? l[l.length - 1] : 0,
							c = a[a.length - 1];
						(a = h > 0 ? a.map((t) => t - h) : a), this.addCoordinates_('Polygon', e.slice(h, c), a, n, r, s, o);
					}
					break;
				}
				case 'MultiLineString': {
					...
					for (let i = 0, a = t.length; i < a; i++) {
						const a = i > 0 ? t[i - 1] : 0;
						this.addCoordinates_('LineString', e.slice(a, t[i]), null, n, r, s, o);
					}
					break;
				}
				case 'MultiPoint':
					for (let t = 0, i = e.length; t < i; t += s) this.addCoordinates_('Point', e.slice(t, t + 2), null, n, r, null, null);
					break;
				case 'Polygon': {
					const t = i;
					if (n instanceof Zg) {
						const i = ul(e, t);
						if (i.length > 1) return void this.addCoordinates_('MultiPolygon', e, i, n, r, s, o);
					}
					this.polygonBatch.entries[r] || (this.polygonBatch.entries[r] = this.addRefToEntry_(r, { feature: n, flatCoordss: [], verticesCount: 0, ringsCount: 0, ringsVerticesCounts: [] })), (a = e.length / s);
					const l = i.length,
						h = i.map((t, e, i) => (e > 0 ? (t - i[e - 1]) / s : t / s));
					(this.polygonBatch.verticesCount += a),
						(this.polygonBatch.ringsCount += l),
						this.polygonBatch.geometriesCount++,
						this.polygonBatch.entries[r].flatCoordss.push(
							(function (t, e) {
								if (2 === e) return t;
								return t.filter((t, i) => i % e < 2);
							})(e, s)
						),
						this.polygonBatch.entries[r].ringsVerticesCounts.push(h),
						(this.polygonBatch.entries[r].verticesCount += a),
						(this.polygonBatch.entries[r].ringsCount += l);
					for (let i = 0, a = t.length; i < a; i++) {
						const a = i > 0 ? t[i - 1] : 0;
						this.addCoordinates_('LinearRing', e.slice(a, t[i]), null, n, r, s, o);
					}
					break;
				}
				case 'Point':
					this.pointBatch.entries[r] || (this.pointBatch.entries[r] = this.addRefToEntry_(r, { feature: n, flatCoordss: [] })), this.pointBatch.geometriesCount++, this.pointBatch.entries[r].flatCoordss.push(e);
					break;
				case 'LineString':
				case 'LinearRing':
					this.lineStringBatch.entries[r] || (this.lineStringBatch.entries[r] = this.addRefToEntry_(r, { feature: n, flatCoordss: [], verticesCount: 0 })),
						(a = e.length / s),
						(this.lineStringBatch.verticesCount += a),
						this.lineStringBatch.geometriesCount++,
						this.lineStringBatch.entries[r].flatCoordss.push(
							(function (t, e, i) {
								if (3 === e && 'XYM' === i) return t;
								if (4 === e) return t.filter((t, i) => i % e !== 2);
								if (3 === e) return t.map((t, i) => (i % e !== 2 ? t : 0));
								return new Array(1.5 * t.length).fill(0).map((e, i) => (i % 3 == 2 ? 0 : t[Math.round(i / 1.5)]));
							})(e, s, o)
						),
						(this.lineStringBatch.entries[r].verticesCount += a);
			}
		}
		addRefToEntry_(t, e) {
			const i = this.uidToRef_.get(t),
				n = i || this.freeGlobalRef_.pop() || ++this.globalCounter_;
			return (e.ref = n), i || (this.refToFeature_.set(n, e.feature), this.uidToRef_.set(t, n)), e;
		}
		removeRef_(t, e) {
		...
		changeFeature(t, e) {
			if (!this.uidToRef_.get(In(t))) return;
		...
		removeFeature(t) {
			...
			(e = this.clearFeatureEntryInPolygonBatch_(t) || e), (e = this.clearFeatureEntryInLineStringBatch_(t) || e), e && this.removeRef_(e.ref, In(e.feature));
		}
		clear() {
	...
	const jS = 'GENERATE_POLYGON_BUFFERS',
		$S = 'GENERATE_POINT_BUFFERS',
		BS = 'GENERATE_LINE_STRING_BUFFERS';
	function US(t, e) {
		const i = 256,
			n = 255;
	...
	function WS(t, e, i, n) {
		...
		for (const s in e) {
			const o = e[s],
				a = o.callback.call(i, i.feature);
			let l = a?.[0] ?? a;
			l === CS && console.warn('The "has" operator might return false positives.'), void 0 === l ? (l = CS) : null === l && (l = 0), (t[n + r++] = l), o.size && 1 !== o.size && ((t[n + r++] = a[1]), o.size < 3 || ((t[n + r++] = a[2]), o.size < 4 || (t[n + r++] = a[3])));
		}
		return r;
	}
	function XS(t) {
	...
	function ZS(t, e, i, n) {
		if (`${n}radius` in t && 'icon-' !== n) {
			let r = IS(i, t[`${n}radius`], $c);
			if (`${n}radius2` in t) {
				r = `max(${r}, ${IS(i, t[`${n}radius2`], $c)})`;
			}
			`${n}stroke-width` in t && (r = `(${r} + ${IS(i, t[`${n}stroke-width`], $c)} * 0.5)`), e.setSymbolSizeExpression(`vec2(${r} * 2. + 0.5)`);
		}
		if (`${n}scale` in t) {
			const r = IS(i, t[`${n}scale`], Wc);
			e.setSymbolSizeExpression(`${e.getSymbolSizeExpression()} * ${r}`);
		}
		`${n}displacement` in t && e.setSymbolOffsetExpression(IS(i, t[`${n}displacement`], Vc)), `${n}rotation` in t && e.setSymbolRotationExpression(IS(i, t[`${n}rotation`], $c)), `${n}rotate-with-view` in t && e.setSymbolRotateWithView(!!t[`${n}rotate-with-view`]);
	}
	...
	function YS(t, e, i, n, r) {
		const s = new Image();
		(s.crossOrigin = void 0 === t[`${n}cross-origin`] ? 'anonymous' : t[`${n}cross-origin`]), dr('string' == typeof t[`${n}src`], `WebGL layers do not support expressions for the ${n}src style property`), (s.src = t[`${n}src`]), (i[`u_texture${r}_size`] = () => (s.complete ? [s.width, s.height] : [0, 0])), e.addUniform(`u_texture${r}_size`, 'vec2');
		const o = `u_texture${r}_size`;
		return (i[`u_texture${r}`] = s), e.addUniform(`u_texture${r}`, 'sampler2D'), o;
	}
	function HS(t, e, i, n, r) {
		let s = IS(i, t[`${e}offset`], Wc);
	...
	function JS(t, e, i) {
		const n = { variables: {}, properties: {}, functions: {}, bandCount: 0, featureId: !1, geometryType: !1 },
			r = new MS(),
			s = {};
		if (
			('icon-src' in t
				? (function (t, e, i, n) {
						let r = 'vec4(1.0)';
						'icon-color' in t && (r = IS(n, t['icon-color'], Uc)), 'icon-opacity' in t && (r = `${r} * vec4(1.0, 1.0, 1.0, ${IS(n, t['icon-opacity'], $c)})`);
						const s = qS(t['icon-src']),
							o = YS(t, e, i, 'icon-', s);
						if ((e.setSymbolColorExpression(`${r} * texture2D(u_texture${s}, v_texCoord)`).setSymbolSizeExpression(o), 'icon-width' in t && 'icon-height' in t && e.setSymbolSizeExpression(`vec2(${IS(n, t['icon-width'], $c)}, ${IS(n, t['icon-height'], $c)})`), 'icon-offset' in t && 'icon-size' in t)) {
							const i = IS(n, t['icon-size'], Vc),
								r = e.getSymbolSizeExpression();
							e.setSymbolSizeExpression(i);
							const s = HS(t, 'icon-', n, 'v_quadSizePx', i);
							e.setTextureCoordinateExpression(`(vec4((${s}).xyxy) + vec4(0., 0., ${i})) / (${r}).xyxy`);
						}
						if ((ZS(t, e, n, 'icon-'), 'icon-anchor' in t)) {
							const i = IS(n, t['icon-anchor'], Vc);
							let r,
								s = '1.0';
							'icon-scale' in t && (s = IS(n, t['icon-scale'], Wc)), (r = 'pixels' === t['icon-anchor-x-units'] && 'pixels' === t['icon-anchor-y-units'] ? `${i} * ${s}` : 'pixels' === t['icon-anchor-x-units'] ? `${i} * vec2(vec2(${s}).x, v_quadSizePx.y)` : 'pixels' === t['icon-anchor-y-units'] ? `${i} * vec2(v_quadSizePx.x, vec2(${s}).x)` : `${i} * v_quadSizePx`);
				...
				? (function (t, e, i, n) {
						(n.functions.round = 'float round(float v) {\n  return sign(v) * floor(abs(v) + 0.5);\n}'),
							...
							(n.functions.regularDistanceField =
								'float regularDistanceField(vec2 point, float numPoints, float radius, float angle) {\n  float startAngle = -PI * 0.5 + angle; // tip starts upwards and rotates clockwise with angle\n  float c = cos(startAngle);\n  float s = sin(startAngle);\n  vec2 pointRotated = vec2(c * point.x - s * point.y, s * point.x + c * point.y);\n  float alpha = TWO_PI / numPoints; // the angle of one sector\n  float radiusIn = radius * cos(PI / numPoints);\n  float beta = atan(pointRotated.y, pointRotated.x);\n  float gamma = round((beta - alpha * 0.5) / alpha) * alpha + alpha * 0.5; // angle in sector from mid\n  c = cos(-gamma);\n  s = sin(-gamma);\n  vec2 inSector = vec2(c * pointRotated.x - s * pointRotated.y, abs(s * pointRotated.x + c * pointRotated.y));\n  return inSector.x - radiusIn;\n}'),
							ZS(t, e, n, 'shape-');
						let r = null;
						'shape-opacity' in t && (r = IS(n, t['shape-opacity'], $c));
						let s = 'coordsPx';
						'shape-scale' in t && (s = `coordsPx / ${IS(n, t['shape-scale'], Wc)}`);
						let o = null;
						'shape-fill-color' in t && (o = IS(n, t['shape-fill-color'], Uc));
						let a = null;
						'shape-stroke-color' in t && (a = IS(n, t['shape-stroke-color'], Uc));
						let l = null;
						'shape-stroke-width' in t && (l = IS(n, t['shape-stroke-width'], $c));
						const h = IS(n, t['shape-points'], $c);
						let c,
							u = '0.';
						'shape-angle' in t && (u = IS(n, t['shape-angle'], $c));
						let d = IS(n, t['shape-radius'], $c);
						if ((null !== l && (d = `${d} + ${l} * 0.5`), 'shape-radius2' in t)) {
							let e = IS(n, t['shape-radius2'], $c);
							null !== l && (e = `${e} + ${l} * 0.5`), (c = `starDistanceField(${s}, ${h}, ${d}, ${e}, ${u})`);
						} else c = `regularDistanceField(${s}, ${h}, ${d}, ${u})`;
						const g = KS(c, o, a, l, r);
				...
				: 'circle-radius' in t &&
				  (function (t, e, i, n) {
						...
						let r = null;
						'circle-opacity' in t && (r = IS(n, t['circle-opacity'], $c));
						let s = 'coordsPx';
						'circle-scale' in t && (s = `coordsPx / ${IS(n, t['circle-scale'], Wc)}`);
						let o = null;
						'circle-fill-color' in t && (o = IS(n, t['circle-fill-color'], Uc));
						let a = null;
						'circle-stroke-color' in t && (a = IS(n, t['circle-stroke-color'], Uc));
						let l = IS(n, t['circle-radius'], $c),
							h = null;
						'circle-stroke-width' in t && ((h = IS(n, t['circle-stroke-width'], $c)), (l = `(${l} + ${h} * 0.5)`));
						const c = KS(`circleDistanceField(${s}, ${l})`, o, a, h, r);
						e.setSymbolColorExpression(c);
				  })(t, r, 0, n),
			(function (t, e, i, n) {
				if (('stroke-color' in t && e.setStrokeColorExpression(IS(n, t['stroke-color'], Uc)), 'stroke-pattern-src' in t)) {
					const r = qS(t['stroke-pattern-src']),
						s = YS(t, e, i, 'stroke-pattern-', r);
					let o = s,
						a = 'vec2(0.)';
					'stroke-pattern-offset' in t && 'stroke-pattern-size' in t && ((o = IS(n, t['stroke-pattern-size'], Vc)), (a = HS(t, 'stroke-pattern-', n, s, o)));
					let l = '0.';
					'stroke-pattern-spacing' in t && (l = IS(n, t['stroke-pattern-spacing'], $c)),
						(n.functions.sampleStrokePattern =
				...
				if (('stroke-width' in t && e.setStrokeWidthExpression(IS(n, t['stroke-width'], $c)), 'stroke-offset' in t && e.setStrokeOffsetExpression(IS(n, t['stroke-offset'], $c)), 'stroke-line-cap' in t && e.setStrokeCapExpression(IS(n, t['stroke-line-cap'], Bc)), 'stroke-line-join' in t && e.setStrokeJoinExpression(IS(n, t['stroke-line-join'], Bc)), 'stroke-miter-limit' in t && e.setStrokeMiterLimitExpression(IS(n, t['stroke-miter-limit'], $c)), 'stroke-line-dash' in t)) {
					n.functions.getSingleDashDistance = `float getSingleDashDistance(float distance, float radius, float dashOffset, float dashLength, float dashLengthTotal, float capType, float lineWidth) {\n  float localDistance = mod(distance, dashLengthTotal);\n  float distanceSegment = abs(localDistance - dashOffset - dashLength * 0.5) - dashLength * 0.5;\n  distanceSegment = min(distanceSegment, dashLengthTotal - localDistance);\n  if (capType == ${xS('square')}) {\n    distanceSegment -= lineWidth * 0.5;\n  } else if (capType == ${xS('round')}) {\n    distanceSegment = min(distanceSegment, sqrt(distanceSegment * distanceSegment + radius * radius) - lineWidth * 0.5);\n  }\n  return distanceSegment;\n}`;
					let i = t['stroke-line-dash'].map((t) => IS(n, t, $c));
					i.length % 2 == 1 && (i = [...i, ...i]);
					let r = '0.';
					'stroke-line-dash-offset' in t && (r = IS(n, t['stroke-line-dash-offset'], $c));
					const s = `dashDistanceField_${qS(t['stroke-line-dash'])}`,
						o = i.map((t, e) => `float dashLength${e}`).join(', '),
						a = i.map((t, e) => `dashLength${e}`).join(' + ');
					let l = '0.',
						h = `getSingleDashDistance(distance, radius, ${l}, dashLength0, totalDashLength, capType, lineWidth)`;
					for (let t = 2; t < i.length; t += 2) (l = `${l} + dashLength${t - 2} + dashLength${t - 1}`), (h = `min(${h}, getSingleDashDistance(distance, radius, ${l}, dashLength${t}, totalDashLength, capType, lineWidth))`);
					n.functions[s] = `float ${s}(float distance, float radius, float capType, float lineWidth, ${o}) {\n  float totalDashLength = ${a};\n  return ${h};\n}`;
					const c = i.map((t, e) => `${t}`).join(', ');
					e.setStrokeDistanceFieldExpression(`${s}(currentLengthPx + ${r}, currentRadiusPx, capType, v_width, ${c})`);
				}
			})(t, r, s, n),
			(function (t, e, i, n) {
				if (('fill-color' in t && e.setFillColorExpression(IS(n, t['fill-color'], Uc)), 'fill-pattern-src' in t)) {
					const r = qS(t['fill-pattern-src']),
						s = YS(t, e, i, 'fill-pattern-', r);
					let o = s,
						a = 'vec2(0.)';
					'fill-pattern-offset' in t && 'fill-pattern-size' in t && ((o = IS(n, t['fill-pattern-size'], Vc)), (a = HS(t, 'fill-pattern-', n, s, o))),
						(n.functions.sampleFillPattern =
			...
			const t = IS(n, i, jc);
			r.setFragmentDiscardExpression(`!${t}`);
		}
		const o = {};
		function a(t, e, i, s) {
			if (!n[t]) return;
			const a = AS(i),
				l = LS(i);
			r.addAttribute(`a_${e}`, a), (o[e] = { size: l, callback: s });
		}
		return (
			a('geometryType', SS, Bc, (t) => yS(rd(t.getGeometry()))),
			a('featureId', bS, Bc | $c, (t) => {
				const e = t.getId() ?? null;
				return 'string' == typeof e ? yS(e) : e;
			}),
			DS(r, n),
			{ builder: r, attributes: { ...o, ...zS(n) }, uniforms: { ...s, ...OS(n, e) } }
		);
	}
	const QS = [];
	let tC;
	...
	class dC {
		constructor(t, e, i, n, r) {
			...
			if (!('builder' in t)) {
				const i = t,
					n = JS(i.style, e, i.filter);
				s = { builder: n.builder, attributes: n.attributes, uniforms: n.uniforms };
			}
			this.fillProgram_,
				this.strokeProgram_,
				this.symbolProgram_,
				(this.hasFill_ = !!s.builder.getFillVertexShader()),
				this.hasFill_ && ((this.fillVertexShader_ = s.builder.getFillVertexShader()), (this.fillFragmentShader_ = s.builder.getFillFragmentShader())),
				(this.hasStroke_ = !!s.builder.getStrokeVertexShader()),
				this.hasStroke_ && ((this.strokeVertexShader_ = s.builder.getStrokeVertexShader()), (this.strokeFragmentShader_ = s.builder.getStrokeFragmentShader())),
				(this.hasSymbol_ = !!s.builder.getSymbolVertexShader()),
				this.hasSymbol_ && ((this.symbolVertexShader_ = s.builder.getSymbolVertexShader()), (this.symbolFragmentShader_ = s.builder.getSymbolFragmentShader())),
				(this.featureFilter_ = null),
				r && (this.featureFilter_ = this.computeFeatureFilter(r));
			const o = this.hitDetectionEnabled_
				? {
						hitColor: {
							callback() {
								return US(this.ref, QS);
							},
							size: 4,
						},
				  }
				: {};
			(this.customAttributes_ = Object.assign({}, o, s.attributes)), (this.uniforms_ = s.uniforms);
			const a = Object.entries(this.customAttributes_).map(([t, e]) => ({ name: `a_${t}`, size: e.size || 1, type: eS }));
			(this.polygonAttributesDesc_ = [{ name: nC, size: 2, type: eS }, ...a]), (this.lineStringAttributesDesc_ = [{ name: sC, size: 2, type: eS }, { name: aC, size: 1, type: eS }, { name: oC, size: 2, type: eS }, { name: lC, size: 1, type: eS }, { name: cC, size: 2, type: eS }, { name: uC, size: 1, type: eS }, { name: hC, size: 1, type: eS }, ...a]), (this.pointAttributesDesc_ = [{ name: nC, size: 2, type: eS }, { name: rC, size: 1, type: eS }, ...a]), this.setHelper(i);
		}
		computeFeatureFilter(t) {
			const e = tu();
			let i;
			try {
				i = sd(t, jc, e);
			...
			if (e.mapState || e.variables.size > 0) return null;
			const n = { variables: {}, properties: {}, resolution: NaN, featureId: null, geometryType: '' };
			return (t) => {
				if (((n.properties = t.getPropertiesInternal()), e.featureId)) {
					const e = t.getId();
					n.featureId = void 0 !== e ? e : null;
				}
				return (n.geometryType = rd(t.getGeometry())), i(n);
			};
		}
		async generateBuffers(t, e) {
			let i = t;
			if (this.featureFilter_ && ((i = i.filter(this.featureFilter_)), i.isEmpty())) return null;
			const n = this.generateRenderInstructions_(i, e),
				[r, s, o] = await Promise.all([this.generateBuffersForType_(n.polygonInstructions, 'Polygon', e), this.generateBuffersForType_(n.lineStringInstructions, 'LineString', e), this.generateBuffersForType_(n.pointInstructions, 'Point', e)]);
			return { polygonBuffers: r, lineStringBuffers: s, pointBuffers: o, invertVerticesTransform: _a([1, 0, 0, 1, 0, 0], e) };
		}
		generateRenderInstructions_(t, e) {
			const i = this.hasFill_
					? (function (t, e, i, n) {
							const r = 2 * t.verticesCount + (1 + XS(i)) * t.geometriesCount + t.ringsCount;
							...
							for (const r in t.entries) {
								...
								for (let t = 0, r = a.flatCoordss.length; t < r; t++) {
									(s.length = a.flatCoordss[t].length), va(a.flatCoordss[t], 0, s.length, 2, n, s), (o += WS(e, i, a, o)), (e[o++] = a.ringsVerticesCounts[t].length);
									for (let i = 0, n = a.ringsVerticesCounts[t].length; i < n; i++) e[o++] = a.ringsVerticesCounts[t][i];
									for (let t = 0, i = s.length; t < i; t += 2) (e[o++] = s[t]), (e[o++] = s[t + 1]);
								}
							}
							return e;
					  })(t.polygonBatch, new Float32Array(0), this.customAttributes_, e)
					: null,
				n = this.hasStroke_
					? (function (t, e, i, n) {
							const r = 3 * t.verticesCount + (1 + XS(i)) * t.geometriesCount;
							(e && e.length === r) || (e = new Float32Array(r));
							const s = [];
							let o = 0;
							for (const r in t.entries) {
								const a = t.entries[r];
								for (let t = 0, r = a.flatCoordss.length; t < r; t++) {
									(s.length = a.flatCoordss[t].length), va(a.flatCoordss[t], 0, s.length, 3, n, s, 3), (o += WS(e, i, a, o)), (e[o++] = s.length / 3);
									for (let t = 0, i = s.length; t < i; t += 3) (e[o++] = s[t]), (e[o++] = s[t + 1]), (e[o++] = s[t + 2]);
								}
							}
							return e;
					  })(t.lineStringBatch, new Float32Array(0), this.customAttributes_, e)
					: null,
				r = this.hasSymbol_
					? (function (t, e, i, n) {
							const r = (2 + XS(i)) * t.geometriesCount;
							(e && e.length === r) || (e = new Float32Array(r));
							const s = [];
							let o = 0;
							for (const r in t.entries) {
								const a = t.entries[r];
								for (let t = 0, r = a.flatCoordss.length; t < r; t++) (s[0] = a.flatCoordss[t][0]), (s[1] = a.flatCoordss[t][1]), ga(n, s), (e[o++] = s[0]), (e[o++] = s[1]), (o += WS(e, i, a, o));
							}
							return e;
					  })(t.pointBatch, new Float32Array(0), this.customAttributes_, e)
					: null;
			return { polygonInstructions: i, lineStringInstructions: n, pointInstructions: r };
		}
		generateBuffersForType_(t, e, i) {
			...
			const s = { id: n, type: r, renderInstructions: t.buffer, renderInstructionsTransform: i, customAttributesSize: XS(this.customAttributes_) },
				o = eC();
			return (
				o.postMessage(s, [t.buffer]),
				(t = null),
				new Promise((t) => {
					const e = (i) => {
						const r = i.data;
						if (r.id !== n) return;
						if ((o.removeEventListener('message', e), !this.helper_.getGL())) return;
						const s = new Xb($b, Ub).fromArrayBuffer(r.vertexBuffer),
							a = new Xb(Bb, Ub).fromArrayBuffer(r.indexBuffer);
						this.helper_.flushBufferData(s), this.helper_.flushBufferData(a), t([a, s]);
					};
		...
		renderInternal_(t, e, i, n, r, s) {
			const o = t.getSize();
			0 !== o && (this.helper_.useProgram(i, r), this.helper_.bindBuffer(e), this.helper_.bindBuffer(t), this.helper_.enableAttributes(n), s(), this.helper_.drawElements(0, o));
		}
		setHelper(t, e = null) {
			(this.helper_ = t),
				this.hasFill_ && (this.fillProgram_ = this.helper_.getProgram(this.fillFragmentShader_, this.fillVertexShader_)),
				this.hasStroke_ && (this.strokeProgram_ = this.helper_.getProgram(this.strokeFragmentShader_, this.strokeVertexShader_)),
				this.hasSymbol_ && (this.symbolProgram_ = this.helper_.getProgram(this.symbolFragmentShader_, this.symbolVertexShader_)),
				this.helper_.addUniforms(this.uniforms_),
				e && (e.polygonBuffers && (this.helper_.flushBufferData(e.polygonBuffers[0]), this.helper_.flushBufferData(e.polygonBuffers[1])), e.lineStringBuffers && (this.helper_.flushBufferData(e.lineStringBuffers[0]), this.helper_.flushBufferData(e.lineStringBuffers[1])), e.pointBuffers && (this.helper_.flushBufferData(e.pointBuffers[0]), this.helper_.flushBufferData(e.pointBuffers[1])));
		}
	}
	const gC = new Uint8Array(4);
	class fC {
		constructor(t, e) {
			this.helper_ = t;
			const i = t.getGL();
		...
		setSize(t) {
			gn(t, this.size_) || ((this.size_[0] = t[0]), (this.size_[1] = t[1]), this.updateSize_());
		}
		getSize() {
			return this.size_;
		}
		...
		readPixel(t, e) {
			if (t < 0 || e < 0 || t > this.size_[0] || e >= this.size_[1]) return (gC[0] = 0), (gC[1] = 0), (gC[2] = 0), (gC[3] = 0), gC;
			this.readAll();
			const i = Math.floor(t) + (this.size_[1] - Math.floor(e) - 1) * this.size_[0];
			return (gC[0] = this.data_[4 * i]), (gC[1] = this.data_[4 * i + 1]), (gC[2] = this.data_[4 * i + 2]), (gC[3] = this.data_[4 * i + 3]), gC;
		}
		getTexture() {
			return this.texture_;
		}
	...
	const mC = { ...Hb, RENDER_EXTENT: 'u_renderExtent', PATTERN_ORIGIN: 'u_patternOrigin', GLOBAL_ALPHA: 'u_globalAlpha' };
	class _C extends lS {
		constructor(t, e) {
			super(t, { uniforms: { [mC.RENDER_EXTENT]: [0, 0, 0, 0], [mC.PATTERN_ORIGIN]: [0, 0], [mC.GLOBAL_ALPHA]: 1 }, postProcesses: e.postProcesses }),
				(this.hitDetectionEnabled_ = !e.disableHitDetection),
		...
		addInitialFeatures_(t) {
			const e = this.getLayer().getSource(),
				i = ta();
			let n;
			i && (n = qo(i, t.viewState.projection)), this.batch_.addFeatures(e.getFeatures(), n), (this.sourceListenKeys_ = [Sn(e, uf, this.handleSourceFeatureAdded_.bind(this, n)), Sn(e, df, this.handleSourceFeatureChanged_.bind(this, n), this), Sn(e, ff, this.handleSourceFeatureDelete_, this), Sn(e, gf, this.handleSourceFeatureClear_, this)]);
		}
		applyOptions_(t) {
			(this.styleVariables_ = t.variables),
				(this.styles_ = (function (t) {
					...
					if ('style' in e[0]) {
						const t = [],
							...
							n = [];
						for (const e of i) {
							const i = Array.isArray(e.style) ? e.style : [e.style];
							let r = e.filter;
							e.else && n.length && ((r = ['all', ...n.map((t) => ['!', t])]), e.filter && r.push(e.filter), r.length < 3 && (r = r[1])), e.filter && n.push(e.filter);
							const s = i.map((t) => ({ style: t, ...(r && { filter: r }) }));
							t.push(...s);
						}
						return t;
					}
					return 'builder' in e[0] ? e : e.map((t) => ({ style: t }));
				})(t.style));
		}
		createRenderers_() {
			(this.buffers_ = []), (this.styleRenderers_ = this.styles_.map((t) => new dC(t, this.styleVariables_, this.helper, this.hitDetectionEnabled_, 'filter' in t ? t.filter : null)));
		}
		reset(t) {
			this.applyOptions_(t), this.helper && this.createRenderers_(), super.reset(t);
		}
		afterHelperCreated() {
			this.styleRenderers_.length ? this.styleRenderers_.forEach((t, e) => t.setHelper(this.helper, this.buffers_[e])) : this.createRenderers_(), this.hitDetectionEnabled_ && (this.hitRenderTarget_ = new fC(this.helper));
		}
		...
		applyUniforms_(t) {
			da(this.tmpTransform_, this.currentFrameStateTransform_), ca(this.tmpTransform_, t), this.helper.setUniformMatrixValue(mC.PROJECTION_MATRIX, jb(this.tmpMat4_, this.tmpTransform_)), _a(this.tmpTransform_, this.tmpTransform_), this.helper.setUniformMatrixValue(mC.SCREEN_TO_WORLD_MATRIX, jb(this.tmpMat4_, this.tmpTransform_)), (this.tmpCoords_[0] = 0), (this.tmpCoords_[1] = 0), _a(this.tmpTransform_, t), ga(this.tmpTransform_, this.tmpCoords_), this.helper.setUniformFloatVec2(mC.PATTERN_ORIGIN, this.tmpCoords_);
		}
		renderFrame(t) {
			const e = this.helper.getGL();
			this.preRender(e, t);
			const [i, n, r] = pC(t, this.getLayer());
			this.helper.prepareDraw(t), this.renderWorlds(t, !1, i, n, r), this.helper.finalizeDraw(t, this.dispatchPreComposeEvent, this.dispatchPostComposeEvent);
			const s = this.helper.getCanvas();
			return this.hitDetectionEnabled_ && (this.renderWorlds(t, !0, i, n, r), this.hitRenderTarget_.clearCachedData()), this.postRender(e, t), s;
		}
		prepareFrameInternal(t) {
			...
			const e = this.getLayer(),
				i = e.getSource(),
				n = t.viewState,
				r = !t.viewHints[mr] && !t.viewHints[_r],
				s = !Jr(this.previousExtent_, t.extent),
			...
			if ((o && (this.sourceRevision_ = i.getRevision()), r && (s || o))) {
				const r = n.projection,
					...
					a = jr(t.extent, o * s),
					l = ta();
				l ? i.loadFeatures(na(a, l), sa(s, r), l) : i.loadFeatures(a, s, r), (this.ready = !1);
				const h = this.helper.makeProjectionTransform(t, [1, 0, 0, 1, 0, 0]),
					c = this.styleRenderers_.map((t, e) =>
						t.generateBuffers(this.batch_, h).then((t) => {
							this.buffers_[e] && this.disposeBuffers(this.buffers_[e]), (this.buffers_[e] = t);
						})
					);
				Promise.all(c).then(() => {
		...
		renderWorlds(t, e, i, n, r) {
			let s = i;
			e && (this.hitRenderTarget_.setSize([Math.floor(t.size[0] / 2), Math.floor(t.size[1] / 2)]), this.helper.prepareDrawToRenderTarget(t, this.hitRenderTarget_, !0));
			do {
				this.helper.makeProjectionTransform(t, this.currentFrameStateTransform_), pa(this.currentFrameStateTransform_, s * r, 0);
				for (let i = 0, n = this.styleRenderers_.length; i < n; i++) {
					const n = this.styleRenderers_[i],
						r = this.buffers_[i];
					r &&
						n.render(r, t, () => {
							this.applyUniforms_(r.invertVerticesTransform), this.helper.applyHitDetectionUniform(e);
						});
				}
			} while (++s < n);
		}
		forEachFeatureAtCoordinate(t, e, i, n, r) {
			if ((dr(this.hitDetectionEnabled_, '`forEachFeatureAtCoordinate` cannot be used on a WebGL layer if the hit detection logic has been disabled using the `disableHitDetection: true` option.'), !this.styleRenderers_.length || !this.hitDetectionEnabled_)) return;
			const s = ga(e.coordinateToPixelTransform, t.slice()),
				o = this.hitRenderTarget_.readPixel(s[0] / 2, s[1] / 2),
				a = VS([o[0] / 255, o[1] / 255, o[2] / 255, o[3] / 255]),
				l = this.batch_.getFeatureFromRef(a);
			return l ? n(l, this.getLayer(), null) : void 0;
		}
		disposeBuffers(t) {
			const e = (t) => {
				for (const e of t) e && this.helper.deleteBuffer(e);
			};
	...
	const yC = 'blur',
		xC = 'gradient',
		vC = 'radius',
		wC = ['#00f', '#0ff', '#0f0', '#ff0', '#f00'];
	class bC extends r_ {
		constructor(t) {
			super(t), (this.vectorRenderer_ = new pp(t)), (this.layerImageRatio_ = t.getImageRatio()), (this.coordinateToVectorPixelTransform_ = [1, 0, 0, 1, 0, 0]), (this.renderedPixelToCoordinateTransform_ = null);
		}
		disposeInternal() {
		...
		getFeatures(t) {
			...
			const e = ga(this.coordinateToVectorPixelTransform_, ga(this.renderedPixelToCoordinateTransform_, t.slice()));
		...
		prepareFrame(t) {
			...
			if (!r[mr] && !r[_r] && !_s(o)) {
				...
				const r = s.context,
					...
					u = Object.assign({}, t, { extent: o, size: [a, l], viewState: Object.assign({}, t.viewState, { rotation: 0 }), layerStatesArray: [c], layerIndex: 0, declutter: null }),
					d = this.getLayer().getDeclutter();
				d && (u.declutter = { [d]: new ic(9) });
				const g = new _p(o, n, e, r.canvas, function (t) {
					s.prepareFrame(u) && s.replayGroupChanged && ((s.clipping = !1), s.renderFrame(u, null), s.renderDeclutter(u), s.renderDeferred(u), t());
				});
				g.addEventListener(qi, () => {
					if (g.getState() !== ud) return;
					this.image = g;
					const t = g.getPixelRatio(),
						n = (D_(g.getResolution()) * e) / t;
					(this.renderedResolution = n), (this.coordinateToVectorPixelTransform_ = ma(this.coordinateToVectorPixelTransform_, a / 2, l / 2, 1 / n, -1 / n, 0, -i.center[0], -i.center[1]));
				}),
					g.load();
			}
			return this.image && (this.renderedPixelToCoordinateTransform_ = t.pixelToCoordinateTransform.slice()), !this.getLayer().getSource()?.loading && !!this.image;
		}
		preRender() {}
		postRender() {}
		renderDeclutter() {}
	...
	class SC extends lS {
		constructor(t, e) {
			const i = e.uniforms || {},
				n = [1, 0, 0, 1, 0, 0];
			(i[Hb.PROJECTION_MATRIX] = n), super(t, { uniforms: i, postProcesses: e.postProcesses }), (this.sourceRevision_ = -1), (this.verticesBuffer_ = new Xb($b, Ub)), (this.indicesBuffer_ = new Xb(Bb, Ub)), (this.vertexShader_ = e.vertexShader), (this.fragmentShader_ = e.fragmentShader), this.program_, (this.hitDetectionEnabled_ = e.hitDetectionEnabled ?? !0);
			const r = e.attributes
				? e.attributes.map(function (t) {
						return { name: 'a_' + t.name, size: 1, type: eS };
				  })
				: [];
			(this.attributes = [
				{ name: 'a_position', size: 2, type: eS },
				{ name: 'a_index', size: 1, type: eS },
			]),
				this.hitDetectionEnabled_ && (this.attributes.push({ name: 'a_hitColor', size: 4, type: eS }), this.attributes.push({ name: 'a_featureUid', size: 1, type: eS })),
				...
				this.worker_.addEventListener('message', (t) => {
					...
					if (e.type === $S) {
						...
						this.verticesBuffer_.fromArrayBuffer(e.vertexBuffer), this.helper.flushBufferData(this.verticesBuffer_), this.indicesBuffer_.fromArrayBuffer(e.indexBuffer), this.helper.flushBufferData(this.indicesBuffer_), (this.renderTransform_ = i), _a(this.invertRenderTransform_, this.renderTransform_), (this.renderInstructions_ = new Float32Array(t.data.renderInstructions)), e.id === this.lastSentId && (this.ready = !0), this.getLayer().changed();
					}
				}),
				(this.featureCache_ = {}),
				(this.featureCount_ = 0);
			const s = this.getLayer().getSource();
			(this.sourceListenKeys_ = [Sn(s, uf, this.handleSourceFeatureAdded_, this), Sn(s, df, this.handleSourceFeatureChanged_, this), Sn(s, ff, this.handleSourceFeatureDelete_, this), Sn(s, gf, this.handleSourceFeatureClear_, this)]),
				s.forEachFeature((t) => {
					const e = t.getGeometry();
					e && 'Point' === e.getType() && ((this.featureCache_[In(t)] = { feature: t, properties: t.getProperties(), flatCoordinates: e.getFlatCoordinates() }), this.featureCount_++);
				});
		}
		afterHelperCreated() {
			(this.program_ = this.helper.getProgram(this.fragmentShader_, this.vertexShader_)), this.hitDetectionEnabled_ && (this.hitRenderTarget_ = new fC(this.helper)), this.verticesBuffer_.getArray() && this.helper.flushBufferData(this.verticesBuffer_), this.indicesBuffer_.getArray() && this.helper.flushBufferData(this.indicesBuffer_);
		}
		handleSourceFeatureAdded_(t) {
			const e = t.feature,
				i = e.getGeometry();
			i && 'Point' === i.getType() && ((this.featureCache_[In(e)] = { feature: e, properties: e.getProperties(), flatCoordinates: i.getFlatCoordinates() }), this.featureCount_++);
		}
		handleSourceFeatureChanged_(t) {
			const e = t.feature,
				i = In(e),
				n = this.featureCache_[i],
				r = e.getGeometry();
			n ? (r && 'Point' === r.getType() ? ((n.properties = e.getProperties()), (n.flatCoordinates = r.getFlatCoordinates())) : (delete this.featureCache_[i], this.featureCount_--)) : r && 'Point' === r.getType() && ((this.featureCache_[i] = { feature: e, properties: e.getProperties(), flatCoordinates: r.getFlatCoordinates() }), this.featureCount_++);
		}
		handleSourceFeatureDelete_(t) {
			const e = In(t.feature);
		...
		rebuildBuffers_(t) {
			...
			for (const t in this.featureCache_) {
				const n = this.featureCache_[t];
				if ((i ? (o = ia(n.flatCoordinates, h)) : ((o[0] = n.flatCoordinates[0]), (o[1] = n.flatCoordinates[1])), ga(e, o), (s[++l] = o[0]), (s[++l] = o[1]), this.hitDetectionEnabled_)) {
					const e = US(l + 5, a);
					(s[++l] = e[0]), (s[++l] = e[1]), (s[++l] = e[2]), (s[++l] = e[3]), (s[++l] = Number(t));
				}
				for (let t = 0; t < this.customAttributes.length; t++) {
					const e = this.customAttributes[t].callback(n.feature, n.properties);
					s[++l] = e;
				}
			}
			const c = { id: ++this.lastSentId, type: $S, renderInstructions: s.buffer, customAttributesSize: n - 2 };
			(c.projectionTransform = e), (this.ready = !1), this.worker_.postMessage(c, [s.buffer]);
		}
		forEachFeatureAtCoordinate(t, e, i, n, r) {
			if ((dr(this.hitDetectionEnabled_, '`forEachFeatureAtCoordinate` cannot be used on a WebGL layer if the hit detection logic has been disabled using the `disableHitDetection: true` option.'), !this.renderInstructions_ || !this.hitDetectionEnabled_)) return;
			const s = ga(e.coordinateToPixelTransform, t.slice()),
				o = this.hitRenderTarget_.readPixel(s[0] / 2, s[1] / 2),
				a = VS([o[0] / 255, o[1] / 255, o[2] / 255, o[3] / 255]),
		...
		renderWorlds(t, e, i, n, r) {
			...
			do {
				this.helper.makeProjectionTransform(t, this.currentTransform_), pa(this.currentTransform_, s * r, 0), ca(this.currentTransform_, this.invertRenderTransform_), this.helper.applyUniforms(t), this.helper.applyHitDetectionUniform(e);
	...
	class CC extends Cy {
		constructor(t) {
			const e = void 0 !== (t = t || {}).projection ? t.projection : 'EPSG:3857',
				i = void 0 !== t.tileGrid ? t.tileGrid : K_({ extent: J_(e), maxResolution: t.maxResolution, maxZoom: t.maxZoom, minZoom: t.minZoom, tileSize: t.tileSize });
	...
	function PC(t, e, i, n, r) {
		...
		const s = n.getAxisOrientation(),
			o = ws(r.VERSION, '1.3') >= 0;
		r[o ? 'CRS' : 'SRS'] = n.getCode();
		const a = o && s.startsWith('ne') ? [e[1], e[0], e[3], e[2]] : e;
		return (r.BBOX = a.join(',')), dy(t, r);
	}
	function RC(t, e, i, n, r, s, o) {
		s = Object.assign({ REQUEST: 'GetMap' }, s);
		const a = e / i,
			l = [Pr(ps(t) / a, 4), Pr(us(t) / a, 4)];
		if (1 != i)
			switch (o) {
				case 'geoserver':
					const t = (90 * i + 0.5) | 0;
	...
	function FC(t, e) {
		return Object.assign({ REQUEST: e, SERVICE: 'WMS', VERSION: EC, FORMAT: 'image/png', STYLES: '', TRANSPARENT: 'TRUE' }, t);
	}
	Tn.unByKey = Pn;
	let MC = {
			Control: $l,
			...
			ScaleLine: class extends $l {
				constructor(t) {
					...
					(this.innerElement_ = document.createElement('div')), (this.innerElement_.className = i + '-inner'), (this.element.className = i + ' ' + Tl), this.element.appendChild(this.innerElement_), (this.viewState_ = null), (this.minWidth_ = void 0 !== t.minWidth ? t.minWidth : 64), (this.maxWidth_ = t.maxWidth), (this.renderedVisible_ = !1), (this.renderedWidth_ = void 0), (this.renderedHTML_ = ''), this.addChangeListener(tx, this.handleUnitsChanged_), this.setUnits(t.units || 'metric'), (this.scaleBar_ = t.bar || !1), (this.scaleBarSteps_ = t.steps || 4), (this.scaleBarText_ = t.text || !1), (this.dpi_ = t.dpi || void 0);
				}
				getUnits() {
					return this.get(tx);
				}
				...
				updateElement_() {
					...
					let s = jo(i, t.resolution, e, r);
					const o = (this.minWidth_ * (this.dpi_ || ix)) / ix,
						a = void 0 !== this.maxWidth_ ? (this.maxWidth_ * (this.dpi_ || ix)) / ix : void 0;
					let l = o * s,
						h = '';
					if ('degrees' == n) {
						const t = $s.degrees;
						(l *= t), l < t / 60 ? ((h = '″'), (s *= 3600)) : l < t ? ((h = '′'), (s *= 60)) : (h = '°');
					} else if ('imperial' == n) l < 0.9144 ? ((h = 'in'), (s /= 0.0254)) : l < 1609.344 ? ((h = 'ft'), (s /= 0.3048)) : ((h = 'mi'), (s /= 1609.344));
					else if ('nautical' == n) (s /= 1852), (h = 'NM');
					else if ('metric' == n) l < 1e-6 ? ((h = 'nm'), (s *= 1e9)) : l < 0.001 ? ((h = 'μm'), (s *= 1e6)) : l < 1 ? ((h = 'mm'), (s *= 1e3)) : l < 1e3 ? (h = 'm') : ((h = 'km'), (s /= 1e3));
					else {
					...
					for (;;) {
						...
						if (((c = ex[((p % 3) + 3) % 3] * t), (u = Math.round(c / s)), isNaN(u))) return (this.element.style.display = 'none'), void (this.renderedVisible_ = !1);
						if (void 0 !== a && u >= a) {
							(c = m), (u = g), (d = f);
							break;
						}
				...
				getScaleForResolution() {
					return jo(this.viewState_.projection, this.viewState_.resolution, this.viewState_.center, 'm') * (1e3 / 25.4) * (this.dpi_ || ix);
				}
				render(t) {
					const e = t.frameState;
		...
		IC = {
			GeoJSON: Dm,
			KML: class extends Mv {
				constructor(t) {
					super(),
						(t = t || {}),
						cw || ((Yv = [255, 255, 255, 1]), (sw = new qd({ color: Yv })), (Hv = [20, 2]), (Jv = 'pixels'), (Qv = 'pixels'), (tw = [64, 64]), (ew = 'https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png'), (ow = new Kd({ anchor: Hv, anchorOrigin: 'bottom-left', anchorXUnits: Jv, anchorYUnits: Qv, crossOrigin: 'anonymous', rotation: 0, scale: uw(tw), size: tw, src: ew })), (iw = 'NO_IMAGE'), (aw = new Yd({ color: Yv, width: 1 })), (nw = new Yd({ color: [51, 51, 51, 1], width: 2 })), (lw = new ig({ font: 'bold 16px Helvetica', fill: sw, stroke: nw, scale: 0.8 })), (hw = new Hd({ fill: sw, image: ow, text: lw, stroke: aw, zIndex: 0 })), (cw = [hw])),
						(this.dataProjection = Go('EPSG:4326')),
						(this.defaultStyle_ = t.defaultStyle ? t.defaultStyle : cw),
						...
						(this.iconUrlFunction_ = t.iconUrlFunction ? t.iconUrlFunction : dw),
						(this.supportedMediaTypes = ['application/vnd.google-earth.kml+xml']);
				}
				readDocumentOrFolder_(t, e) {
					const i = Ev([], Sv($v, { Document: pv(this.readDocumentOrFolder_, this), Folder: pv(this.readDocumentOrFolder_, this), Placemark: mv(this.readPlacemark_, this), Style: this.readSharedStyle_.bind(this), StyleMap: this.readSharedStyleMap_.bind(this) }), t, e, this);
					if (i) return i;
				}
				readPlacemark_(t, e) {
					const i = Ev({ geometry: null }, Uv, t, e, this);
					if (!i) return;
					const n = new Dg(),
						r = t.getAttribute('id');
					null !== r && n.setId(r);
					const s = e[0],
						o = i.geometry;
					if ((o && Fm(o, !1, s), n.setGeometry(o), delete i.geometry, this.extractStyles_)) {
						const t = (function (t, e, i, n, r) {
							return function (s, o) {
								...
								a && ((l = s.get('name')), (a = a && !!l), a && /&[^&]+;/.test(l) && (rw || (rw = document.createElement('textarea')), (rw.innerHTML = l), (l = rw.value)));
								let c = i;
								if ((t ? (c = t) : e && (c = gw(e, i, n)), a)) {
									const t = (function (t, e) {
										const i = [0, 0];
										let n = 'start';
										const r = t.getImage();
										...
										let s = t.getText();
										s ? ((s = s.clone()), s.setFont(s.getFont() || lw.getFont()), s.setScale(s.getScale() || lw.getScale()), s.setFill(s.getFill() || lw.getFill()), s.setStroke(s.getStroke() || nw)) : (s = lw.clone());
										s.setText(e), s.setOffsetX(i[0]), s.setOffsetY(i[1]), s.setTextAlign(n);
										const o = new Hd({ image: r, text: s });
										return o;
									})(c[0], l);
									if (h.length > 0) {
										t.setGeometry(new jg(h));
										return [t, new Hd({ geometry: c[0].getGeometry(), image: null, fill: c[0].getFill(), stroke: c[0].getStroke(), text: null })].concat(c.slice(1));
									}
									return t;
								}
								return c;
				...
				readFeatureFromNode(t, e) {
					if (!$v.includes(t.namespaceURI)) return null;
					const i = this.readPlacemark_(t, [this.getReadOptions(t, e)]);
					return i || null;
				}
				readFeaturesFromNode(t, e) {
					if (!$v.includes(t.namespaceURI)) return [];
					let i;
					const n = t.localName;
				...
				readName(t) {
					if (t) {
						...
						return gv(t) ? this.readNameFromDocument(t) : this.readNameFromNode(t);
					}
				}
				...
				readNameFromNode(t) {
					for (let e = t.firstElementChild; e; e = e.nextElementSibling) if ($v.includes(e.namespaceURI) && 'name' == e.localName) return Lv(e);
					for (let e = t.firstElementChild; e; e = e.nextElementSibling) {
						const t = e.localName;
						if ($v.includes(e.namespaceURI) && ('Document' == t || 'Folder' == t || 'Placemark' == t || 'kml' == t)) {
							const t = this.readNameFromNode(e);
							if (t) return t;
						}
					}
				...
				readNetworkLinks(t) {
					...
					if ('string' == typeof t) {
						const i = fv(t);
						dn(e, this.readNetworkLinksFromDocument(i));
					} else gv(t) ? dn(e, this.readNetworkLinksFromDocument(t)) : dn(e, this.readNetworkLinksFromNode(t));
					return e;
				}
				readNetworkLinksFromDocument(t) {
					const e = [];
					for (let i = t.firstChild; i; i = i.nextSibling) i.nodeType == Node.ELEMENT_NODE && dn(e, this.readNetworkLinksFromNode(i));
					return e;
				}
				readNetworkLinksFromNode(t) {
					const e = [];
					for (let i = t.firstElementChild; i; i = i.nextElementSibling)
						if ($v.includes(i.namespaceURI) && 'NetworkLink' == i.localName) {
							const t = Ev({}, Vv, i, []);
							e.push(t);
						}
					for (let i = t.firstElementChild; i; i = i.nextElementSibling) {
						const t = i.localName;
						!$v.includes(i.namespaceURI) || ('Document' != t && 'Folder' != t && 'kml' != t) || dn(e, this.readNetworkLinksFromNode(i));
					}
					return e;
				}
				readRegion(t) {
					...
					if ('string' == typeof t) {
						const i = fv(t);
						dn(e, this.readRegionFromDocument(i));
					} else gv(t) ? dn(e, this.readRegionFromDocument(t)) : dn(e, this.readRegionFromNode(t));
					return e;
				}
				readRegionFromDocument(t) {
					const e = [];
					for (let i = t.firstChild; i; i = i.nextSibling) i.nodeType == Node.ELEMENT_NODE && dn(e, this.readRegionFromNode(i));
					return e;
				}
				readRegionFromNode(t) {
					const e = [];
					for (let i = t.firstElementChild; i; i = i.nextElementSibling)
						if ($v.includes(i.namespaceURI) && 'Region' == i.localName) {
							const t = Ev({}, qv, i, []);
							e.push(t);
						}
					for (let i = t.firstElementChild; i; i = i.nextElementSibling) {
						const t = i.localName;
						!$v.includes(i.namespaceURI) || ('Document' != t && 'Folder' != t && 'kml' != t) || dn(e, this.readRegionFromNode(i));
					}
					return e;
				}
				readCamera(t) {
					...
					if ('string' == typeof t) {
						const i = fv(t);
						dn(e, this.readCameraFromDocument(i));
					} else gv(t) ? dn(e, this.readCameraFromDocument(t)) : dn(e, this.readCameraFromNode(t));
					return e;
				}
				readCameraFromDocument(t) {
					const e = [];
					for (let i = t.firstChild; i; i = i.nextSibling) i.nodeType === Node.ELEMENT_NODE && dn(e, this.readCameraFromNode(i));
					return e;
				}
				readCameraFromNode(t) {
					const e = [];
					for (let i = t.firstElementChild; i; i = i.nextElementSibling)
						if ($v.includes(i.namespaceURI) && 'Camera' === i.localName) {
							const t = Ev({}, Xv, i, []);
							e.push(t);
						}
					for (let i = t.firstElementChild; i; i = i.nextElementSibling) {
						const t = i.localName;
						!$v.includes(i.namespaceURI) || ('Document' !== t && 'Folder' !== t && 'Placemark' !== t && 'kml' !== t) || dn(e, this.readCameraFromNode(i));
					}
					return e;
				}
				writeFeaturesNode(t, e) {
					...
					i.setAttributeNS(n, 'xmlns:gx', jv[0]), i.setAttributeNS(n, 'xmlns:xsi', hv), i.setAttributeNS(hv, 'xsi:schemaLocation', 'http://www.opengis.net/kml/2.2 https://developers.google.com/kml/schema/kml22gx.xsd');
					const r = { node: i },
						s = {};
					t.length > 1 ? (s.Document = t) : 1 == t.length && (s.Placemark = t[0]);
					const o = Zv[i.namespaceURI],
						a = bv(s, o);
					return Tv(r, Kv, wv, a, [e], o, this), i;
				}
			},
			MVT: Qm,
		},
		kC = {
			...
			VectorTile: A_,
			WebGLPoints: class extends Hh {
				constructor(t) {
					super(Object.assign({}, t)), (this.styleVariables_ = t.variables || {}), (this.parseResult_ = JS(t.style, this.styleVariables_, t.filter)), (this.hitDetectionDisabled_ = !!t.disableHitDetection);
				}
				createRenderer() {
					const t = Object.keys(this.parseResult_.attributes).map((t) => ({ name: t, ...this.parseResult_.attributes[t] }));
					return new SC(this, { vertexShader: this.parseResult_.builder.getSymbolVertexShader(), fragmentShader: this.parseResult_.builder.getSymbolFragmentShader(), hitDetectionEnabled: !this.hitDetectionDisabled_, uniforms: this.parseResult_.uniforms, attributes: t });
				}
			...
			Heatmap: class extends Pg {
				constructor(t) {
					t = t || {};
					const e = Object.assign({}, t);
					delete e.gradient, delete e.radius, delete e.blur, delete e.weight, super(e), (this.filter_ = t.filter ?? !0), (this.styleVariables_ = t.variables || {}), (this.gradient_ = null), this.addChangeListener(xC, this.handleGradientChanged_), this.setGradient(t.gradient ? t.gradient : wC), this.setBlur(void 0 !== t.blur ? t.blur : 15), this.setRadius(void 0 !== t.radius ? t.radius : 8);
				...
				setBlur(t) {
					const e = this.get(yC);
					this.set(yC, t), 'number' != typeof t || 'number' != typeof e ? this.clearRenderer() : this.changed();
				}
				setGradient(t) {
					this.set(xC, t);
				}
				setRadius(t) {
					const e = this.get(vC);
					this.set(vC, t), 'number' != typeof t || 'number' != typeof e ? this.clearRenderer() : this.changed();
				}
				setFilter(t) {
					(this.filter_ = t), this.changed(), this.clearRenderer();
				}
				setWeight(t) {
					(this.weight_ = t), this.changed(), this.clearRenderer();
				}
				createRenderer() {
					const t = new MS(),
						e = { variables: {}, properties: {}, functions: {}, bandCount: 0, featureId: !1, geometryType: !1 },
						i = IS(e, this.filter_, jc);
					let n = IS(e, this.getRadius(), $c),
						r = IS(e, this.getBlur(), $c);
					const s = {};
					'number' == typeof this.getBlur() && ((r = 'a_blur'), (s.a_blur = () => this.getBlur()), t.addUniform('a_blur', 'float')), 'number' == typeof this.getRadius() && ((n = 'a_radius'), (s.a_radius = () => this.getRadius()), t.addUniform('a_radius', 'float'));
					const o = {};
					let a = null;
					if ('string' == typeof this.weight_ || 'function' == typeof this.weight_) {
						const e = 'string' == typeof this.weight_ ? (t) => t.get(this.weight_) : this.weight_;
						(o.prop_weight = {
							size: 1,
							callback: (t) => {
								const i = e(t);
								return void 0 !== i ? xr(i, 0, 1) : 1;
							},
						}),
							(a = 'a_prop_weight'),
							t.addAttribute('a_prop_weight', 'float');
					} else {
						a = IS(e, ['clamp', this.weight_, 0, 1], $c);
					}
					t.addFragmentShaderFunction(`float getBlurSlope() {\n  float blur = max(1., ${r});\n  float radius = ${n};\n  return radius / blur;\n}`).setSymbolSizeExpression(`vec2(${n} + ${r}) * 2.`).setSymbolColorExpression(`vec4(smoothstep(0., 1., (1. - length(coordsPx * 2. / v_quadSizePx)) * getBlurSlope()) * ${a})`).setStrokeColorExpression(`vec4(smoothstep(0., 1., (1. - length(currentRadiusPx * 2. / v_width)) * getBlurSlope()) * ${a})`).setStrokeWidthExpression(`(${n} + ${r}) * 2.`).setFillColorExpression(`vec4(${a})`).setFragmentDiscardExpression(`!${i}`), DS(t, e);
					const l = zS(e),
						h = OS(e, this.styleVariables_);
					return new _C(this, {
						className: this.getClassName(),
						variables: this.styleVariables_,
						style: { builder: t, attributes: { ...l, ...o }, uniforms: { ...h, ...s } },
		...
		LC = { LineString: Ug, Point: Za, MultiPoint: Wg },
		AC = { Icon: Kd, Style: Hd, Text: ig, Stroke: Yd, Fill: qd, Circle: Xd },
		DC = {
			OSM: class extends CC {
				constructor(t) {
					let e;
			...
			TileWMS: class extends Cy {
				...
				getFeatureInfoUrl(t, e, i, n) {
					...
					Object.assign(f, FC(this.params_, 'GetFeatureInfo'), n);
				...
				getLegendUrl(t, e) {
					...
					const i = { SERVICE: 'WMS', VERSION: EC, REQUEST: 'GetLegendGraphic', FORMAT: 'image/png' };
					...
					return Object.assign(i, e), dy(this.urls[0], i);
				}
				getGutter() {
					return this.gutter_;
				}
				...
				getRequestUrl_(t, e, i, n, r) {
					...
					if (1 == s.length) o = s[0];
						...
						o = s[Cr(w_(t), s.length)];
					}
					return RC(e, (this.tileGrid || this.getTileGridForProjection(n)).getResolution(t[0]), i, n, o, r, this.serverType_);
				}
				getTilePixelRatio(t) {
				...
				updateV13_() {
					const t = this.params_.VERSION || EC;
					this.v13_ = ws(t, '1.3') >= 0;
				}
				tileUrlFunction(t, e, i) {
			...
			BingMaps: class extends Cy {
				...
				handleImageryMetadataResponse(t) {
					...
					if (
						...
						const t = qo(Go('EPSG:4326'), this.getProjection());
						this.setAttributions((i) => {
							...
							return (
								e.imageryProviders.map(function (e) {
									...
									for (let e = 0, n = s.length; e < n; ++e) {
										...
										if (a >= n.zoomMin && a <= n.zoomMax) {
											const e = n.bbox;
											if (ms(ys([e[1], e[0], e[3], e[2]], t), i.extent)) {
												r = !0;
												break;
											}
										}
								...
								n.push('<a class="ol-attribution-bing-tos" href="https://www.microsoft.com/maps/product/terms.html" target="_blank">Terms of Use</a>'),
								n
							);
						});
					}
			...
			ImageWMS: class extends $_ {
				...
				getLegendUrl(t, e) {
					return (function (t, e) {
						...
						const i = { SERVICE: 'WMS', VERSION: EC, REQUEST: 'GetLegendGraphic', FORMAT: 'image/png' };
						if (void 0 !== e) {
							const n = Go(t.projection || 'EPSG:3857').getMetersPerUnit() || 1,
								r = 28e-5;
							i.SCALE = (e * n) / r;
						}
						if ((Object.assign(i, t.params), void 0 !== t.params && void 0 === i.LAYER)) {
							const t = i.LAYERS;
							if (Array.isArray(t) && 1 === t.length) return;
							i.LAYER = t;
						}
				...
				getImageInternal(t, e, i, n) {
					return void 0 === this.url_
						? null
						: ((this.loader && this.loaderProjection_ === n) ||
								((this.loaderProjection_ = n),
								(this.loader = (function (t) {
									const e = void 0 === t.hidpi || t.hidpi,
										i = Go(t.projection || 'EPSG:3857'),
										n = t.ratio || 1.5,
										r = t.load || md,
										s = t.crossOrigin ?? null;
									return (o, a, l) => {
										(o = U_(o, a, l, n)), 1 == l || (e && void 0 !== t.serverType) || (l = 1);
										const h = RC(o, a, l, i, t.url, FC(t.params, 'GetMap'), t.serverType),
											c = new Image();
										return (c.crossOrigin = s), r(c, h).then((t) => ({ image: t, extent: o, pixelRatio: l }));
									};
								})({ crossOrigin: this.crossOrigin_, params: this.params_, projection: n, serverType: this.serverType_, hidpi: this.hidpi_, url: this.url_, ratio: this.ratio_, load: (t, e) => (this.image.setImage(t), this.imageLoadFunction_(this.image, e), md(t)) }))),
			...
			ImageStatic: class extends $_ {
				constructor(t) {
					const e = void 0 !== t.crossOrigin ? t.crossOrigin : null,
						i = void 0 !== t.imageLoadFunction ? t.imageLoadFunction : B_;
					super({ attributions: t.attributions, interpolate: t.interpolate, projection: Go(t.projection) }),
						(this.url_ = t.url),
						...
						(this.image = new fd(
							...
							(function (t) {
								const e = t.load || md,
									i = t.imageExtent,
									n = t.crossOrigin ?? null;
								return () => {
									const r = new Image();
									return (
										(r.crossOrigin = n),
										e(r, t.url).then((t) => {
											const e = ps(i) / t.width,
												n = us(i) / t.height;
											return { image: t, extent: i, resolution: e !== n ? [e, n] : n, pixelRatio: 1 };
										})
									);
								};
							})({ url: t.url, imageExtent: t.imageExtent, crossOrigin: e, load: (t, e) => (this.image.setImage(t), i(this.image, e), md(t)) })
						)),
						this.image.addEventListener(qi, this.handleImageChange.bind(this));
				}
				getImageExtent() {
					return this.imageExtent_;
				}
				getImageInternal(t, e, i, n) {
					return ms(t, this.image.getExtent()) ? this.image : null;
				}
				getUrl() {
					return this.url_;
				}
		...
		(t.Overlay = class extends Ln {
			constructor(t) {
				super(),
					...
					this.addChangeListener(vp, this.handleElementChanged),
					this.addChangeListener(wp, this.handleMapChanged),
					this.addChangeListener(bp, this.handleOffsetChanged),
					this.addChangeListener(Sp, this.handlePositionChanged),
					this.addChangeListener(Cp, this.handlePositioningChanged),
			...
			handleMapChanged() {
				this.mapPostrenderListenerKey && (this.element?.remove(), En(this.mapPostrenderListenerKey), (this.mapPostrenderListenerKey = null));
				const t = this.getMap();
				if (t) {
					(this.mapPostrenderListenerKey = Sn(t, Jn, this.render, this)), this.updatePixelPosition();
			...
			updateRenderedPosition(t, e) {
				...
				const a = `translate(${s}, ${o}) translate(${`${t[0] + n[0]}px`}, ${`${t[1] + n[1]}px`})`;
